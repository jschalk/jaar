...
from ch09_person_atom.atom_graphic import personatom_periodic_table0

# from ch08_person_logic.test._util.example_persons import (
...
# )
# from ch08_person_logic.person import personunit_shop
