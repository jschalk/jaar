...
def test_PersonAtom_to_dict_ReturnsObj():
    ...
    foot_str = "foot"
    foot_rope = create_rope("a", foot_str)
    x_dimen = kw.person_plan_factunit
    foot_reason_lower = 7
    foot_reason_upper = 13
    ...
    insert_factunit_personatom.set_jvalue(kw.fact_lower, foot_reason_lower)
    insert_factunit_personatom.set_jvalue(kw.fact_upper, foot_reason_upper)
    ...
    assert atom_dict == {
        kw.dimen: x_dimen,
        kw.crud: kw.INSERT,
        kw.jkeys: {kw.plan_rope: ball_rope, kw.fact_context: foot_rope},
        kw.jvalues: {
            kw.fact_lower: foot_reason_lower,
            kw.fact_upper: foot_reason_upper,
        },
    }
...
def test_get_personatom_from_dict_ReturnsObj():
    ...
    gen_personatom.set_jkey(kw.fact_context, foot_rope)
    gen_personatom.set_jvalue(kw.fact_lower, foot_reason_lower)
    gen_personatom.set_jvalue(kw.fact_upper, foot_reason_upper)
