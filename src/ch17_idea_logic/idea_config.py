...
def get_idea_formats_dir() -> str:
    idea_dir = create_path("src", "ch17_idea_logic")
    # return create_path(idea_dir, "idea_formats")
    return "src/ch17_idea_logic/idea_formats"
...
def get_idea_sqlite_types() -> dict[str, str]:
    ...
    return {
        ...
        "voice_cred_shares": "REAL",
        "voice_debt_shares": "REAL",
        "group_cred_shares": "REAL",
        "group_debt_shares": "REAL",
        "credor_respect": "REAL",
        "debtor_respect": "REAL",
        "fact_lower": "REAL",
        "fact_upper": "REAL",
        ...
        "inallocable_voice_debt_shares": "REAL",
        "irrational_voice_debt_shares": "REAL",
        "status": "INTEGER",
        "task": "INTEGER",
...
def get_idea_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "moment_label,belief_name,voice_name,group_title,group_cred_shares,group_debt_shares": idea_format_00020_belief_voice_membership_v0_0_0(),
        "moment_label,belief_name,voice_name,voice_cred_shares,voice_debt_shares": idea_format_00021_belief_voiceunit_v0_0_0(),
