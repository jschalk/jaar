...
def test_create_init_stance_idea_csv_strs_ReturnsObj_Scenario0_EmptyMomentUnit(
    ...
    expected_stance_csv_strs = {
        ...
        "br00020": "moment_label,belief_name,voice_name,group_title,group_cred_shares,group_debt_shares\n",
        "br00021": "moment_label,belief_name,voice_name,voice_cred_shares,voice_debt_shares\n",
