...
def test_get_idea_elements_sort_order_ReturnsObj():
    ...
    assert table_sorting_priority[105] == "voice_cred_shares"
    assert table_sorting_priority[106] == "voice_debt_shares"
    assert table_sorting_priority[107] == "group_cred_shares"
    assert table_sorting_priority[108] == "group_debt_shares"
    ...
    assert table_sorting_priority[160] == "inallocable_voice_debt_shares"
    ...
    assert table_sorting_priority[171] == "irrational_voice_debt_shares"
...
def test_get_idea_sqlite_types_ReturnsObj():
    ...
    assert sqlite_types.get(wx.voice_cred_shares) == "REAL"
    assert sqlite_types.get(wx.voice_debt_shares) == "REAL"
    assert sqlite_types.get(wx.group_cred_shares) == "REAL"
    assert sqlite_types.get(wx.group_debt_shares) == "REAL"
