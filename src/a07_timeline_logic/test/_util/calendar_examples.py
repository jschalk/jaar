...
def add_time_creg_conceptunit(x_ownerunit: OwnerUnit) -> OwnerUnit:
    """Add creg timeline conceptunit to ownerunit"""
    return add_newtimeline_conceptunit(x_ownerunit, get_creg_config())


def add_time_five_conceptunit(x_ownerunit: OwnerUnit) -> OwnerUnit:
    """Add five timeline conceptunit to ownerunit"""
    return add_newtimeline_conceptunit(x_ownerunit, get_five_config())


def add_time_squirt_conceptunit(x_ownerunit: OwnerUnit) -> OwnerUnit:
    """Add squirt timeline conceptunit to ownerunit"""
    return add_newtimeline_conceptunit(x_ownerunit, get_squirt_config())
...
def display_creg_five_squirt_time_attrs(graphics_bool: bool):
    if graphics_bool:
        ...
        sue_owner = add_time_creg_conceptunit(sue_owner)
        sue_owner = add_time_five_conceptunit(sue_owner)
        sue_owner = add_time_squirt_conceptunit(sue_owner)
        time_rope = sue_owner.make_l1_rope("time")
        creg_rope = sue_owner.make_rope(time_rope, creg_str())
        five_rope = sue_owner.make_rope(time_rope, five_str())
