...
def test_BeliefUnit_set_plantree_range_attrs_Sets_weeks_plan_gogo_calc_stop_calc():
    ...
    assert sue_beliefunit.get_plan_obj(sun_rope)._gogo_calc == 5760
    assert sue_beliefunit.get_plan_obj(mon_rope)._gogo_calc == 7200
    assert sue_beliefunit.get_plan_obj(tue_rope)._gogo_calc == 8640
    assert sue_beliefunit.get_plan_obj(wed_rope)._gogo_calc == 0
    assert sue_beliefunit.get_plan_obj(thu_rope)._gogo_calc == 1440
    assert sue_beliefunit.get_plan_obj(fri_rope)._gogo_calc == 2880
    assert sue_beliefunit.get_plan_obj(sat_rope)._gogo_calc == 4320
...
def test_BeliefUnit_set_plantree_range_attrs_Sets_c400_plan_gogo_calc_stop_calc():
    ...
    assert sue_beliefunit.get_plan_obj(c400_leap_rope)._gogo_calc == 0
...
def test_BeliefUnit_set_plantree_range_attrs_Sets_years_plan_gogo_calc_stop_calc():
    ...
    # THEN
    assert sue_beliefunit.get_plan_obj(creg_rope)._gogo_calc == 0
    assert sue_beliefunit.get_plan_obj(c400_leap_rope)._gogo_calc == 0
    assert sue_beliefunit.get_plan_obj(c400_clean_rope)._gogo_calc == 0
    assert sue_beliefunit.get_plan_obj(c100_clean_rope)._gogo_calc == 0
    assert sue_beliefunit.get_plan_obj(yr4_leap_rope)._gogo_calc == 0
    assert sue_beliefunit.get_plan_obj(yr4_clean_rope)._gogo_calc == 0
    assert sue_beliefunit.get_plan_obj(year_rope)._gogo_calc == 0
    ...
    assert sue_beliefunit.get_plan_obj(jan_rope)._gogo_calc == 440640
    assert sue_beliefunit.get_plan_obj(feb_rope)._gogo_calc == 485280
    assert sue_beliefunit.get_plan_obj(mar_rope)._gogo_calc == 0
    assert sue_beliefunit.get_plan_obj(apr_rope)._gogo_calc == 44640
    assert sue_beliefunit.get_plan_obj(may_rope)._gogo_calc == 87840
    assert sue_beliefunit.get_plan_obj(jun_rope)._gogo_calc == 132480
    assert sue_beliefunit.get_plan_obj(jul_rope)._gogo_calc == 175680
    assert sue_beliefunit.get_plan_obj(aug_rope)._gogo_calc == 220320
    assert sue_beliefunit.get_plan_obj(sep_rope)._gogo_calc == 264960
    assert sue_beliefunit.get_plan_obj(oct_rope)._gogo_calc == 308160
    assert sue_beliefunit.get_plan_obj(nov_rope)._gogo_calc == 352800
    assert sue_beliefunit.get_plan_obj(dec_rope)._gogo_calc == 396000
