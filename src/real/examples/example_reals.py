...
def create_example_real1() -> RealUnit:
    ...
    dallas_text = "dallas"
    dallas_road = yao_voice_world.make_road(texas_road, dallas_text)
    dallas_healerhold = healerhold_shop({yao_text})
    dallas_idea = ideaunit_shop(dallas_text, _healerhold=dallas_healerhold)
    elpaso_text = "el paso"
    elpaso_road = yao_voice_world.make_road(texas_road, elpaso_text)
...
def create_example_real2() -> RealUnit:
    ...
    yao_voice_world.add_charunit(wei_text, 10, 100)
    wei_voice_world.add_charunit(yao_text, 37, 100)
    wei_voice_world.add_charunit(wei_text, 11, 400)
    wei_voice_world.add_charunit(zia_text, 27, 250)
    zia_voice_world.add_charunit(yao_text, 14, 100)
    zia_voice_world.add_charunit(zia_text, 38, 400)
    texas_text = "Texas"
    texas_road = yao_voice_world.make_l1_road(texas_text)
    yao_voice_world.add_l1_idea(ideaunit_shop(texas_text, _problem_bool=True))
    wei_voice_world.add_l1_idea(ideaunit_shop(texas_text, _problem_bool=True))
    zia_voice_world.add_l1_idea(ideaunit_shop(texas_text, _problem_bool=True))
    dallas_text = "dallas"
    dallas_road = yao_voice_world.make_road(texas_road, dallas_text)
    ...
    yao_voice_world.add_idea(dallas_idea, texas_road)
    yao_voice_world.add_idea(elpaso_idea, texas_road)
    wei_voice_world.add_idea(dallas_idea, texas_road)
...
def create_example_real3() -> RealUnit:
    ...
    casa_text = "casa"
    casa_road = yao_voice_world.make_l1_road(casa_text)
    yao_voice_world.add_l1_idea(ideaunit_shop(casa_text))
    wei_voice_world.add_l1_idea(ideaunit_shop(casa_text))
    zia_voice_world.add_l1_idea(ideaunit_shop(casa_text))
    clean_text = "clean"
    clean_road = yao_voice_world.make_road(casa_road, clean_text)
    ...
    wei_voice_world.add_idea(ideaunit_shop(bath_text, pledge=True), clean_road)

    zia_voice_world.add_idea(ideaunit_shop(clean_text, pledge=True), casa_road)
    zia_voice_world.add_idea(ideaunit_shop(bath_text, pledge=True), clean_road)
