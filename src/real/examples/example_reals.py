...
def create_example_real1() -> RealUnit:
    ...
    yao_voice_bud.add_charunit(yao_text, 34, 600)
...
def create_example_real2() -> RealUnit:
    ...
    yao_voice_bud.add_charunit(yao_text, 34, 600)
    yao_voice_bud.add_charunit(zia_text, 57, 300)
    yao_voice_bud.add_charunit(wei_text, 10, 100)
    wei_voice_bud.add_charunit(yao_text, 37, 100)
    wei_voice_bud.add_charunit(wei_text, 11, 400)
    wei_voice_bud.add_charunit(zia_text, 27, 250)
    zia_voice_bud.add_charunit(yao_text, 14, 100)
    zia_voice_bud.add_charunit(zia_text, 38, 400)
    texas_text = "Texas"
    texas_road = yao_voice_bud.make_l1_road(texas_text)
    yao_voice_bud.add_l1_idea(ideaunit_shop(texas_text, _problem_bool=True))
