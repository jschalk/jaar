...
def test_get_pidgin_args_class_types_ReturnsObj():
    ...
    # THEN
    assert pidgin_args_class_types.get("acct_name") == NameTerm_str()
    ...
    assert pidgin_args_class_types.get("credit_score") == "float"
    ...
    assert pidgin_args_class_types.get("debt_score") == "float"
    assert pidgin_args_class_types.get("debt_vote") == "float"
