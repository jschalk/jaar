...
def test_TitleMap_Exists():
    ...
    assert not x_titlemap.unknown_term
...
def test_titlemap_shop_ReturnsObj_scenario0_NoParameters():
    ...
    assert x_titlemap.unknown_term == default_unknown_term_if_None()
...
def test_titlemap_shop_ReturnsObj_scenario1_WithParameters():
    ...
    assert x_titlemap.unknown_term == x_unknown_term
...
def test_TitleMap_set_all_otx2inx_RaisesErrorIf_unknown_term_IsKeyIn_otx2inx():
    # ESTABLISH
    xio_str = "Xio"
    sue_str = "Sue"
    zia_str = "Zia"
    x_unknown_term = "UnknownTerm"
    x_titlemap = titlemap_shop(unknown_term=x_unknown_term)
...
def test_TitleMap_unknown_term_in_otx2inx_ReturnsObj():
    # ESTABLISH
    xio_str = "Xio"
    sue_str = "Sue"
    zia_str = "Zia"
    ...
    x_titlemap = titlemap_shop(unknown_term=x_unknown_term)
    x_titlemap.set_otx2inx(xio_str, sue_str)
    assert x_titlemap._unknown_term_in_otx2inx() is False

    # WHEN
    x_titlemap.set_otx2inx(zia_str, x_unknown_term)

    # THEN
    assert x_titlemap._unknown_term_in_otx2inx()
...
def test_TitleMap_get_dict_ReturnsObj():
    ...
    x1_way_map_dict = {
        ...
        unknown_term_str(): x_titlemap.unknown_term,
        otx2inx_str(): {},
...
def test_inherit_titlemap_ReturnsObj_Scenario3_RaiseErrorWhenDifferent_x_unknown_term():
    # ESTABLISH
    sue_str = "Sue"
    x_unknown_term = "UnknownTerm"
    old_titlemap = titlemap_shop(sue_str, 0, unknown_term=x_unknown_term)
    new_titlemap = titlemap_shop(sue_str, 1)
