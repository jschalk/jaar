...
# from src.ch06_belief_logic.test._util.ch06_env import get_belief_examples_dir as env_dir
# from src.ch06_belief_logic.test._util.example_beliefs import beliefunit_v001, beliefunit_v002
...
def beliefunit_v001() -> BeliefUnit:
    belief1_path = "src/ch06_belief_logic/test/_util/example_belief1.json"
...
def beliefunit_v002() -> BeliefUnit:
    belief2_path = "src/ch06_belief_logic/test/_util/example_belief2.json"
