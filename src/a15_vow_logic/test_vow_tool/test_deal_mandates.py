...
from src.a15_vow_logic.vow_tool import create_deal_mandate_ledgers
...
def test_create_deal_mandate_ledgers_Scenaro1_DealExists(env_dir_setup_cleanup):
    ...
    tp37 = 37
    deal1_quota = 450
    accord23_vow.add_dealunit(bob_str, tp37, deal1_quota)
    a23_json_path = create_vow_json_path(mstr_dir, a23_str)
    save_json(a23_json_path, None, accord23_vow.get_dict())
    ...
    bob37_dealunit = accord23_vow.get_dealunit(bob_str, tp37)
