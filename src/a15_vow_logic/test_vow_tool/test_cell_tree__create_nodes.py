...
def test_create_cell_tree_Scenaro0_timepoint_Empty(env_dir_setup_cleanup):
    # ESTABLISH
    vow_mstr_dir = create_path(get_module_temp_dir(), "fizz_mstr")
    a23_str = "accord23"
    bob_str = "Bob"
    tp37 = 37

    a23_bob_tp37_path = cell_dir(vow_mstr_dir, a23_str, bob_str, tp37, [])
...
def test_create_cell_tree_Scenaro2_LedgerDepth1(env_dir_setup_cleanup):
    ...
    bob37_dir = cell_dir(vow_mstr_dir, a23_str, bob_str, tp37, [])
    ...
    bob37_node_path = node_path(vow_mstr_dir, a23_str, bob_str, tp37, [])
    bob37_bob_node_path = node_path(vow_mstr_dir, a23_str, bob_str, tp37, [bob_str])
    bob37_yao_node_path = node_path(vow_mstr_dir, a23_str, bob_str, tp37, [yao_str])
    bob37_zia_node_path = node_path(vow_mstr_dir, a23_str, bob_str, tp37, [zia_str])
    ...
    bob37_bob_dir = cell_dir(vow_mstr_dir, a23_str, bob_str, tp37, [bob_str])
    bob37_yao_dir = cell_dir(vow_mstr_dir, a23_str, bob_str, tp37, [yao_str])
    bob37_zia_dir = cell_dir(vow_mstr_dir, a23_str, bob_str, tp37, [zia_str])
