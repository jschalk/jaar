...
from src.a15_vow_logic.vow_tool import load_cells_budevent
...
def test_load_cells_budevent_SetsFiles_Scenario0_NoFacts(
    ...
    event300 = 300
    time5 = 5
    save_arbitrary_budevent(vow_mstr_dir, a23_str, bob_str, event300)
    bob3_budevent_path = create_budevent_path(vow_mstr_dir, a23_str, bob_str, event300)
    ...
    # WHEN
    load_cells_budevent(vow_mstr_dir, a23_str)
...
def test_load_cells_budevent_SetsFiles_Scenario1_WithFacts(
    ...
    save_arbitrary_budevent(vow_mstr_dir, a23_str, bob_str, event300, facts=x_facts)
    bob3_budevent_path = create_budevent_path(vow_mstr_dir, a23_str, bob_str, event300)
    print(f"{bob3_budevent_path=}")
    cellunit_add_json_file(vow_mstr_dir, a23_str, bob_str, time5, event300, [])
    bob5_cell_path = create_cell_json_path(vow_mstr_dir, a23_str, bob_str, time5)
