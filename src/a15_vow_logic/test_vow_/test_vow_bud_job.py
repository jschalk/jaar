...
def test_VowUnit_rotate_job_ReturnsObj_Scenario1(env_dir_setup_cleanup):
    ...
    assert sue_job.vow_label == example_bud.vow_label
...
def test_VowUnit_rotate_job_ReturnsObj_Scenario3_job_ChangesFromRotation(
    ...
    init_bob_job.add_concept(clean_way, pledge=True)
    save_job_file(vow_mstr_dir, init_sue_job)
...
#     # WHEN
#     bob_gut_bud = open_gut_file(vow_mstr_dir, a23_str, bob_str)
#     bob_gut_bud.add_acctunit(sue_str)
#     save_gut_file(a23_vow.vow_mstr_dir, bob_gut_bud)
...
#     bob_gut_bud.set_l1_concept(conceptunit_shop(texas_str, problem_bool=True))
#     bob_gut_bud.set_concept(elpaso_concept, texas_way)
#     save_gut_file(a23_vow.vow_mstr_dir, bob_gut_bud)
...
#     # THEN
#     expected_job = budunit_shop(sue_str, a23_str)
#     expected_job.add_concept(mop_way, pledge=True)
...
#     sue_bud.add_concept(dirty_way)
#     sue_bud.edit_reason(mop_way, casa_way, dirty_way)
#     sue_bud.add_fact(casa_way, clean_way, create_missing_concepts=True)
#     save_gut_file(vow_mstr_dir, sue_bud)
#     sue_gut = open_gut_file(vow_mstr_dir, a23_str, sue_str)
#     assert len(sue_gut.get_acctunits_dict()) == 0
...
def test_VowUnit_generate_all_jobs_Scenario2_jobs_rotated_InSortedOrder(
    ...
    zia_gut.add_concept(clean_way, pledge=True)
    save_gut_file(vow_mstr_dir, bob_gut)
    save_gut_file(vow_mstr_dir, sue_gut)
    save_gut_file(vow_mstr_dir, yao_gut)
...
#     a23_vow.create_init_job_from_guts(sue_str)
#     bob_gut_bud = a23_vow.rotate_job(bob_str)
#     sue_gut_bud = a23_vow.rotate_job(sue_str)
...
#     sue_gut_bud = open_gut_file(vow_mstr_dir, a23_str, sue_str)
...
#     save_gut_file(a23_vow.vow_mstr_dir, sue_gut_bud)

#     before_bob_job = a23_vow.get_job_file_bud(bob_str)
#     before_sue_job = a23_vow.get_job_file_bud(sue_str)
...
#     # THEN
#     after_bob_job = a23_vow.get_job_file_bud(bob_str)
#     after_sue_job = a23_vow.get_job_file_bud(sue_str)
#     assert after_bob_job.acct_exists(bob_str)
