...
def test_VowUnit_set_paypurchase_SetsAttr():
    ...
    x_vow = vowunit_shop("accord23", "temp_vow_mstr_dir")
...
def test_VowUnit_set_all_tranbook_SetsAttr():
    # ESTABLISH
    x_vow = vowunit_shop("accord23", "temp_vow_mstr_dir")
    x_vow._offi_time_max = 10101
    sue_str = "Sue"
    bob_str = "Bob"
    yao_str = "Yao"
    t55_t = 5505
    ...
    # THEN
    assert x_vow._all_tranbook.tranunit_exists(sue_str, bob_str, t55_t)
    assert x_vow._all_tranbook.tranunit_exists(yao_str, bob_str, t66_t)
    assert x_vow._all_tranbook.tranunit_exists(yao_str, sue_str, t77_t)
    assert x_vow._all_tranbook.tranunit_exists(sue_str, yao_str, t88_t)
    assert x_vow._all_tranbook.tranunit_exists(bob_str, sue_str, t99_t)
    assert x_vow._all_tranbook.tranunit_exists(sue_str, bob_str, x40000_tran_time)
    assert x_vow._all_tranbook.tranunit_exists(sue_str, zia_str, x70000_tran_time)
