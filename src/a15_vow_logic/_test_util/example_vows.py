...
def create_example_vow2() -> VowUnit:
    ...
    yao_gut_bud = open_gut_file(x_vow_mstr_dir, a45_str, yao_str)
    wei_gut_bud = open_gut_file(x_vow_mstr_dir, a45_str, wei_str)
    zia_gut_bud = open_gut_file(x_vow_mstr_dir, a45_str, zia_str)
    ...
    save_gut_file(x_vow_mstr_dir, zia_gut_bud)
