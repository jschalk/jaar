...
def get_example_zia_speaker() -> OwnerUnit:
    zia_str = "Zia"
    a23_str = "amy23"
...
def get_example_bob_speaker() -> OwnerUnit:
    bob_str = "Bob"
    a23_str = "amy23"
...
def get_example_yao_speaker() -> OwnerUnit:
    yao_str = "Yao"
    zia_str = "Zia"
    bob_str = "Bob"
    a23_str = "amy23"
    yao_speaker = ownerunit_shop(yao_str, a23_str)
