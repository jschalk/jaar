...
def sue_1owneratoms_packunit() -> PackUnit:
    ...
    x_packunit._ownerdelta.set_owneratom(get_atom_example_conceptunit_sports())
    return x_packunit


def sue_2owneratoms_packunit() -> PackUnit:
    x_packunit = packunit_shop(owner_name="Sue", _pack_id=53, face_name="Yao")
    x_packunit._ownerdelta.set_owneratom(get_atom_example_conceptunit_knee())
    x_packunit._ownerdelta.set_owneratom(get_atom_example_conceptunit_sports())
    return x_packunit
...
def sue_3owneratoms_packunit() -> PackUnit:
    ...
    x_packunit._ownerdelta.set_owneratom(get_atom_example_conceptunit_ball())
    x_packunit._ownerdelta.set_owneratom(get_atom_example_conceptunit_knee())
    return x_packunit
