...
def test_listen_to_agendas_create_init_job_from_guts_AddsChoresToOwnerWhenNo_laborlinkIsSet(
    env_dir_setup_cleanup,
):
    # ESTABLISH
...
def test_listen_to_agendas_create_init_job_from_guts_AddsChoresToOwner(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    belief_mstr_dir = env_dir()
...
def test_listen_to_agendas_create_init_job_from_guts_AddsChoresToOwnerWithDetailsDecidedBy_acct_debt_points(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    belief_mstr_dir = env_dir()
...
def test_listen_to_agendas_create_init_job_from_guts_ProcessesIrrationalOwner(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    belief_mstr_dir = env_dir()
...
def test_listen_to_agendas_create_init_job_from_guts_ProcessesMissingDebtorOwner(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    belief_mstr_dir = env_dir()
