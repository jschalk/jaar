...
from src.a13_owner_listen_logic.test._util.example_listen_hub import get_texas_hubunit
...
def test_listen_to_facts_duty_vision_SetsSingleFactUnitWithDifferentChore(
    ...
    yao_acct_debt_points = 41
    yao_pool = 87
    zia_str = "Zia"
    yao_duty.add_acctunit(zia_str, yao_acct_cred_points, yao_acct_debt_points)
...
def test_listen_to_facts_duty_vision_GetsFactsFromSrcOwnerSelfNotSpeakerSelf(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    ...
    sue_texas_hubunit.save_vision_owner(old_yao_vision)
...
def test_listen_to_facts_duty_vision_ConfirmNoFactfstateedFromOwnersSpeakerDirOwner_v1(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    yao_duty = get_example_yao_speaker()
...
def test_listen_to_facts_duty_vision_ConfirmNoFactfstateedFromOwnersSpeakerDirOwner_v2(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    zia_vision = get_example_zia_speaker()
    ...
    sue_texas_hubunit.save_vision_owner(bob_vision)
...
#     yao_str = "Yao"
#     sue_str = "Sue"
#     sue_speaker = ownerunit_shop(yao_str)
#     casa_str = "casa"
