...
def test_listen_to_agendas_jobs_into_job_AddsChoresToOwnerWhenNo_laborlinkIsSet(
    env_dir_setup_cleanup,
):
    # ESTABLISH
...
def test_listen_to_agendas_jobs_into_job_AddsChoresToOwner(env_dir_setup_cleanup):
    # ESTABLISH
    belief_mstr_dir = env_dir()
    a23_str = "amy23"
    yao_str = "Yao"
...
def test_listen_to_agendas_jobs_into_job_AddsChoresToOwnerWithDetailsDecidedBy_acct_debt_points(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    belief_mstr_dir = env_dir()
...
def test_listen_to_agendas_jobs_into_job_ProcessesMissingDebtorOwner(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    belief_mstr_dir = env_dir()
...
def test_listen_to_agendas_jobs_into_job_ListensToOwner_gut_AndNotOwner_job(
    ...
    yao_gut.add_acctunit(yao_str, yao_acct_cred_points, yao_acct_debt_points)
    zia_str = "Zia"
    zia_acct_cred_points = 47
    zia_acct_debt_points = 41
    yao_gut.add_acctunit(zia_str, zia_acct_cred_points, zia_acct_debt_points)
