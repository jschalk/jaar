    ...
    if graphics_bool:
        ...
        fig.add_trace(
            plotly_Scatter(
                ...
                y=[9.0, 8.75],
                text=[
                    "beliefity Owner Listening Structures",
                    "The gut owner listens to other's job owners and builds a new owner from itself and others",
                ],
                mode="text",
            )
        )
    ...
    if graphics_bool:
        ...
        fig.add_trace(
            plotly_Scatter(
                x=[2.0],
                y=[13],
                text=["Owner Listening Structures"],
                mode="text",
            )
        )
    ...
    if graphics_bool:
        ...
        fig.add_trace(
            plotly_Scatter(
                ...
                y=[9, 8.5, 8.0],
                text=[
                    "Owner Listening Structures",
                    "Flow of Owners to Keeps",
