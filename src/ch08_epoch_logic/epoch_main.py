...
from src.ch08_epoch_logic._ref.ch08_semantic_types import (
    EpochLabel,
    EpochPoint,
    RopeTerm,
)
...
def get_c400_constants() -> C400Constants:
    c400_constants_path = create_path("src/ch08_epoch_logic", "c400_constants.json")
...
def epoch_config_path() -> str:
    "Returns path: ch08_epoch_logic/default_epoch_config.json"

    src_dir = create_path(os_getcwd(), "src")
    chapter_dir = create_path(src_dir, "ch08_epoch_logic")
