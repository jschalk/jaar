...
from src.ch08_epoch_logic.epoch_main import add_newepoch_planunit
from src.ch08_epoch_logic.reason_str_func import (
    get_fact_state_readable_str,
    get_reason_case_readable_str,
)
from src.ch08_epoch_logic.test._util.ch08_examples import get_creg_config, get_thu
...
def test_get_reason_case_readable_str_ReturnsObj_Scenario4_Time_creg():
    ...
    sue_belief = add_newepoch_planunit(sue_belief, get_creg_config())
