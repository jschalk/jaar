...
from ch10_person_lesson.lesson_main import LessonUnit, lessonunit_shop
from ch99_glossary.ch_keyword import Ch10Keywords as kw, ExampleStrs as exx


def get_ch10_example_moment_rope() -> str:
    return ";FizzBuzz2;"


def get_ch10_example_moment_lasso() -> LassoUnit:
    return lassounit_shop(get_ch10_example_moment_rope())


def get_texas_rope() -> RopeTerm:
    moment_rope = get_ch10_example_moment_rope()
    nation_str = "nation"
    usa_str = "USA"
    texas_str = "Texas"
