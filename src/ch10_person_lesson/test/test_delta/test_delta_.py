...
def test_PersonDelta_set_personatom_Sets_PersonUnitSimpleAttrs():
    ...
    jkeys = {}
    person_poynt_personatom = personatom_shop(
        dimen,
        kw.UPDATE,
        jkeys=jkeys,
        jvalues=jvalues,
    ...
    assert ex1_persondelta.personatoms == {}
    assert person_poynt_personatom.atom_order is None

    # WHEN
    ex1_persondelta.set_personatom(person_poynt_personatom)
    ...
    assert x_dimen_personatom == person_poynt_personatom
    assert person_poynt_personatom.atom_order is not None
...
def test_PersonDelta_set_personatom_RaisesErrorWhen_is_valid_IsFalse():
    ...
    person_poynt_personatom = personatom_shop(x_dimen, kw.UPDATE)
...
#     dimen = kw.personunit
#     opt2_arg = kw.poynt
#     poynt_personatom = personatom_shop(dimen, kw.UPDATE)
#     poynt_personatom.set_jvalue(opt2_arg, opt2_value)
#     ex1_persondelta.set_personatom(poynt_personatom)
#     # THEN
#     assert len(ex1_persondelta.personatoms.get(kw.UPDATE).keys()) == 1
#     sue_personunit_dict = ex1_persondelta.personatoms.get(kw.UPDATE)
#     sue_poynt_personatom = sue_personunit_dict.get(dimen)
#     print(f"{sue_poynt_personatom=}")
#     assert poynt_personatom == sue_poynt_personatom
...
def test_person_built_from_delta_is_valid_ReturnsObjEstablishWithNoPerson_Scenario1():
    ...
    x_personatom.set_arg(kw.contact_cred_mass, "70 is the number")
    sue_persondelta.set_personatom(x_personatom)
...
def test_person_built_from_delta_is_valid_ReturnsObjEstablishWithNoPerson_Scenario2():
    ...
    x_personatom.set_arg(kw.contact_cred_mass, 30)
    sue_persondelta.set_personatom(x_personatom)
...
def test_PersonDelta_get_ordered_personatoms_ReturnsObj_EstablishWithNoStartingNumber():
    ...
    zia_personatom.set_arg(kw.contact_cred_mass, 70)
    ...
    yao_personatom.set_arg(kw.contact_cred_mass, 30)
