...
def test_get_minimal_persondelta_ReturnsObjUPDATEPersonAtom_person_contactunit():
    # ESTABLISH
    old_bob_contact_cred_mass = 34
    new_bob_contact_cred_mass = 7
    sue_person = personunit_shop("Sue")
    sue_person.add_contactunit(exx.bob, old_bob_contact_cred_mass)
    ...
    bob_atom.set_arg(kw.contact_cred_mass, new_bob_contact_cred_mass)
    ...
    assert new_jvalues == {kw.contact_cred_mass: new_bob_contact_cred_mass}
