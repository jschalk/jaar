...
from src.ch10_pack._ref.ch10_semantic_types import FaceName, default_knot_if_None
...
def test_PackUnit_Exists():
    ...
    assert not x_packunit.spark_num
...
def test_packunit_shop_ReturnsObjEstablishWithEmptyArgs():
    ...
    assert not bob_packunit.spark_num
...
def test_packunit_shop_ReturnsObjEstablishWithNonEmptyArgs():
    ...
    assert bob_packunit.spark_num == amy45_e5_spark_num
...
def test_get_packunit_from_dict_ReturnsObj_WithBeliefDeltaPopulated():
    ...
    bob_str = "Bob"
    sue_beliefdelta = get_beliefdelta_sue_example()
    bob_packunit = packunit_shop(bob_str, _beliefdelta=sue_beliefdelta, spark_num=778)
    ...
    assert generated_bob_packunit.spark_num == bob_packunit.spark_num
...
def test_PackUnit_get_deltametric_dict_ReturnsObj():
    ...
    bob_packunit.set_delta_start(x_delta_start)
    bob_packunit.set_face(yao_str)
    bob_packunit.spark_num = spark5_int
