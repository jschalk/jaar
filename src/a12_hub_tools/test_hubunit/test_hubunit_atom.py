...
def test_HubUnit_atom_filename_ReturnsObj():
    # ESTABLISH
    yao_str = "Yao"
    yao_hubunit = hubunit_shop(vow_mstr_dir(), vow_label(), yao_str)
    one_int = 1
...
def test_HubUnit_get_bud_from_atom_files_ReturnsFileWithZeroAtoms(
    ...
    assert yao_bud.vow_label == yao_hubunit.vow_label
    assert yao_bud.bridge == yao_hubunit.bridge
    assert yao_bud.fund_pool == yao_hubunit.fund_pool
    assert yao_bud.fund_iota == yao_hubunit.fund_iota
...
def test_HubUnit_get_bud_from_atom_files_ReturnsCorrectFile_SimpleConcept(
    ...
    # save atom files
    sports_atom = get_atom_example_conceptunit_sports(yao_hubunit.vow_label)
...
def test_HubUnit_get_bud_from_atom_files_ReturnsCorrectFile_WithFactUnit(
    ...
    # save atom files
    x_vow_label = yao_hubunit.vow_label
    yao_hubunit.save_atom_file(get_atom_example_conceptunit_sports(x_vow_label))
    yao_hubunit.save_atom_file(get_atom_example_conceptunit_ball(x_vow_label))
    yao_hubunit.save_atom_file(get_atom_example_conceptunit_knee(x_vow_label))
    yao_hubunit.save_atom_file(get_atom_example_factunit_knee(x_vow_label))
