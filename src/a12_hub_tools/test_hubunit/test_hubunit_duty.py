...
def test_HubUnit_save_vision_bud_CorrectlySavesFile(env_dir_setup_cleanup):
    # ESTABLISH
    sue_str = "Sue"
    nation_str = "nation"
    nation_way = create_way(root_label(), nation_str)
    ...
    # WHEN
    sue_hubunit.save_vision_bud(bob_bud)
...
def test_HubUnit_get_vision_bud_PopensFile(env_dir_setup_cleanup):
    # ESTABLISH
    sue_str = "Sue"
    nation_str = "nation"
    nation_way = create_way(root_label(), nation_str)
    ...
    # WHEN / THEN
    assert sue_hubunit.get_vision_bud(bob_str).get_dict() == bob_bud.get_dict()


def test_HubUnit_get_vision_bud_ReturnsNoneIfFileDoesNotExist(env_dir_setup_cleanup):
    # ESTABLISH
    sue_str = "Sue"
    nation_str = "nation"
    nation_way = create_way(root_label(), nation_str)
    ...
    # WHEN / THEN
    assert sue_hubunit.get_vision_bud(bob_str) is None


def test_HubUnit_delete_vision_file_DeletesBudFile(env_dir_setup_cleanup):
    # ESTABLISH
    texas_hubunit = get_texas_hubunit()
    sue_bud = get_budunit_with_4_levels()
    sue_str = sue_bud.owner_name
    texas_hubunit.save_vision_bud(sue_bud)
