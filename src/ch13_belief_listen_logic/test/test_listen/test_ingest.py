...
def test_generate_ingest_list_ReturnsList_v1():
    ...
    clean_str = "clean"
    zia_beliefunit.set_l1_plan(planunit_shop(clean_str, task=True))
    zia_debtor_pool = 78
    zia_resepect_bit = 2
...
def test_generate_ingest_list_ReturnsList_v2():
    ...
    cook_str = "cook"
    zia_beliefunit.set_l1_plan(planunit_shop(clean_str, task=True))
    zia_beliefunit.set_l1_plan(planunit_shop(cook_str, task=True))
    zia_debtor_pool = 32
    zia_resepect_bit = 2
...
def test_generate_ingest_list_ReturnsList_v3():
    ...
    cook_str = "cook"
    zia_beliefunit.set_l1_plan(planunit_shop(clean_str, task=True))
    zia_beliefunit.set_l1_plan(planunit_shop(cook_str, star=3, task=True))
    zia_debtor_pool = 32
    zia_resepect_bit = 2
    assert len(zia_beliefunit.get_agenda_dict()) == 2
...
def test_generate_ingest_list_ReturnsList_v4():
    ...
    cook_str = "cook"
    zia_beliefunit.set_l1_plan(planunit_shop(clean_str, task=True))
    zia_beliefunit.set_l1_plan(planunit_shop(cook_str, star=2, task=True))
    zia_debtor_pool = 32
    zia_resepect_bit = 2
    assert len(zia_beliefunit.get_agenda_dict()) == 2
