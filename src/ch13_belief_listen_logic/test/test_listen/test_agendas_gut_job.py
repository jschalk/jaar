...
from src.ch12_hub_toolbox.hub_tool import save_gut_file, save_job_file
...
def test_listen_to_agendas_jobs_into_job_AddsChoresToBeliefWhenNo_partyunitIsSet(
    ...
    zia_job.set_plan(planunit_shop(clean_str(), task=True), a23_casa_rope())
    zia_job.set_plan(planunit_shop(cook_str(), task=True), a23_casa_rope())
