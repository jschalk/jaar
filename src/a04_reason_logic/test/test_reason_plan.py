...
def test_ReasonCore_Exists():
    ...
    wkday_reason = ReasonCore(
        wkday_rope, premises=premises, rplan_active_requisite=False
    )

    # THEN
    assert wkday_reason.rcontext == wkday_rope
    assert wkday_reason.premises == premises
    assert wkday_reason.rplan_active_requisite is False
...
def test_ReasonHeir_set_status_BelieverTrueCorrectlySetsStatusTrue():
    ...
    wkday_str = "wkday"
    wkday_rope = create_rope(root_label(), wkday_str)
    wk_reason = reasonheir_shop(rcontext=wkday_rope, rplan_active_requisite=True)
...
def test_ReasonHeir_set_status_BelieverFalseCorrectlySetsStatusTrue():
    ...
    wkday_str = "wkday"
    wkday_rope = create_rope(root_label(), wkday_str)
    wkday_reason = reasonheir_shop(wkday_rope, rplan_active_requisite=False)
...
def test_ReasonHeir_set_status_BelieverTrueCorrectlySetsStatusFalse():
    ...
    wkday_str = "wkday"
    wkday_rope = create_rope(root_label(), wkday_str)
    wkday_reason = reasonheir_shop(wkday_rope, rplan_active_requisite=True)
    wkday_reason.set_rplan_active_value(bool_x=False)
    assert wkday_reason._status is None
...
def test_ReasonUnit_get_dict_ReturnsCorrectDictWith_rplan_active_requisite():
    # ESTABLISH
    wkday_str = "wkday"
    wkday_rope = create_rope(root_label(), wkday_str)
    wkday_rplan_active_requisite = True
    wkday_reason = reasonunit_shop(
        wkday_rope,
        rplan_active_requisite=wkday_rplan_active_requisite,
    )
...
def test_reasons_get_from_dict_ReturnsObj():
    ...
    wkday_str = "wkday"
    wkday_rope = create_rope(root_label(), wkday_str)
    wkday_rplan_active_requisite = False
