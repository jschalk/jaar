...
def test_create_teamunit_ReturnsObj():
    ...
    # WHEN
    swim_teamunit = create_teamunit(swim_team_tag)
...
def test_TeamUnit_get_dict_ReturnsCorrectDictWithSingle_teamlink():
    # ESTABLISH
    bob_team_tag = GroupLabel("Bob")
    x_teamlinks = {bob_team_tag: bob_team_tag}
    x_teamunit = teamunit_shop(_teamlinks=x_teamlinks)
    ...
    example_dict = {"_teamlinks": [bob_team_tag]}
...
def test_TeamUnit_del_teamlink_CorrectlyDeletes_teamlinks_v1():
    ...
    sue_str = "Sue"
    x_teamunit.set_teamlink(team_tag=yao_str)
    x_teamunit.set_teamlink(team_tag=sue_str)
    assert len(x_teamunit._teamlinks) == 2

    # WHEN
    x_teamunit.del_teamlink(team_tag=sue_str)
...
def test_TeamHeir_set_teamlink_TeamUnitNotEmpty_ParentTeamHeirIsNone():
    ...
    swim_str = ",swim"
    x_teamunit = teamunit_shop()
    x_teamunit.set_teamlink(team_tag=kent_str)
    x_teamunit.set_teamlink(team_tag=swim_str)
...
def test_TeamHeir_set_teamlink_TeamUnit_Empty_ParentTeamHeirNotEmpty():
    ...
    teamunit_swim.set_teamlink(team_tag=kent_str)
    teamunit_swim.set_teamlink(team_tag=swim_str)
...
def test_TeamHeir_set_teamlink_TeamUnit_NotEqual_ParentTeamHeir_NonEmpty():
    ...
    parent_teamunit.set_teamlink(team_tag=swim3_str)
    parent_teamheir = teamheir_shop()
    ...
    teamunit_swim2.set_teamlink(team_tag=swim2_str)
...
#     teamunit_swim3.set_teamlink(team_tag=swim3_str)
...
def test_TeamHeir_team_tag_in_ReturnsCorrectBoolWhen_teamlinksNotEmpty():
    # ESTABLISH
    swim_str = ",swim"
    hike_str = ",hike"
    swim_dict = {swim_str}
    ...
    x_teamunit = teamunit_shop()
    x_teamunit.set_teamlink(team_tag=swim_str)
    x_teamunit.set_teamlink(team_tag=hike_str)
    x_teamheir = teamheir_shop()
    x_teamheir.set_teamlinks(
