from src.f00_data_toolboxs.file_toolbox import save_json, create_path
...
def test_get_idea_elements_sort_order_ReturnsObj():
    ...
    assert table_sorting_priority[92] == "_task"
    assert table_sorting_priority[93] == "_status"
    assert table_sorting_priority[94] == "_credor_pool"
    assert table_sorting_priority[95] == "_debtor_pool"
    assert table_sorting_priority[96] == "_rational"
    assert table_sorting_priority[97] == "_fund_give"
    assert table_sorting_priority[98] == "_fund_take"
    assert table_sorting_priority[99] == "_fund_onset"
    assert table_sorting_priority[100] == "_fund_cease"
    assert table_sorting_priority[101] == "_fund_ratio"
    assert table_sorting_priority[102] == "_fund_agenda_give"
    assert table_sorting_priority[103] == "_fund_agenda_take"
    assert table_sorting_priority[104] == "_fund_agenda_ratio_give"
    assert table_sorting_priority[105] == "_fund_agenda_ratio_take"
    assert table_sorting_priority[106] == "_inallocable_debtit_belief"
    assert table_sorting_priority[107] == "_gogo_calc"
    assert table_sorting_priority[108] == "_stop_calc"
    assert table_sorting_priority[109] == "_level"
    assert table_sorting_priority[110] == "_range_evaluated"
    assert table_sorting_priority[111] == "_descendant_pledge_count"
    assert table_sorting_priority[112] == "_healerlink_ratio"
    assert table_sorting_priority[113] == "_all_acct_cred"
    assert table_sorting_priority[114] == "_keeps_justified"
    assert table_sorting_priority[115] == "_offtrack_fund"
    assert table_sorting_priority[116] == "_base_item_active_value"
    assert table_sorting_priority[117] == "_irrational_debtit_belief"
    assert table_sorting_priority[118] == "_sum_healerlink_share"
    assert table_sorting_priority[119] == "_keeps_buildable"
    assert table_sorting_priority[120] == "_all_acct_debt"
    assert table_sorting_priority[121] == "_tree_traverse_count"
