...
from src.f02_finance_toolboxs.deal import fisc_title_str, owner_name_str
...
from src.f10_idea.idea_config import get_idea_sqlite_types
from src.f10_idea.examples.idea_env import idea_env_setup_cleanup, idea_fiscs_dir
from src.f10_idea.idea_db_tool import create_idea_table_from_csv, insert_idea_csv
