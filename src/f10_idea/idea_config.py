...
def config_file_dir() -> str:
    ...
    return create_path(src_dir, "f10_idea")
...
def get_idea_formats_dir() -> str:
    idea_dir = create_path("src", "f10_idea")
...
def get_idea_format_headers() -> dict[str, list[str]]:
    return {
        "fisc_title,timeline_title,c400_number,yr1_jan1_offset,monthday_distortion,fund_coin,penny,respect_bit,bridge,plan_listen_count": idea_format_00000_fiscunit_v0_0_0(),
