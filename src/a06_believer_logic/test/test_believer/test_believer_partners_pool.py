...
def test_BelieverUnit_set_partner_respect_SetsAttrs():
    ...
    zia_believer.set_partner_respect(new_partner_pool)

    # THEN
    assert zia_believer.credor_respect == new_partner_pool
    assert zia_believer.debtor_respect == new_partner_pool
    assert zia_believer.fund_pool == new_partner_pool
