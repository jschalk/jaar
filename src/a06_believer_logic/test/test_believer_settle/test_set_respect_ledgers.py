...
def test_BelieverUnit_set_partnerunit_groupunit_respect_ledgers_SetsAttr_scenario0():
    # ESTABLISH
    sue_str = "Sue"
    sue_believerunit = believerunit_shop(sue_str)
    assert sue_believerunit._groupunits == {}
    ...
    # WHEN
    sue_believerunit._set_partnerunit_groupunit_respect_ledgers()

    # THEN
    assert sue_believerunit._groupunits == {}


def test_BelieverUnit_set_partnerunit_groupunit_respect_ledgers_Clears_groups():
    # ESTABLISH
    sue_str = "Sue"
    sue_believerunit = believerunit_shop(sue_str)
...
def test_BelieverUnit_set_partnerunit_groupunit_respect_ledgers_SetsAttr_scenario1():
    ...
    assert yao_partnerunit._credor_pool != 0
    assert yao_partnerunit._debtor_pool != 0
    assert yao_partnerunit._credor_pool == sue_believerunit.credor_respect
    assert yao_partnerunit._debtor_pool == sue_believerunit.debtor_respect
...
def test_BelieverUnit_set_partnerunit_groupunit_respect_ledgers_SetsAttr_scenario2():
    # ESTABLISH
    sue_str = "Sue"
    sue_believerunit = believerunit_shop(sue_str)
    yao_str = "Yao"
    ...
    # THEN
    assert sue_believerunit.get_partner(yao_str)._credor_pool != 0
    assert sue_believerunit.get_partner(yao_str)._debtor_pool != 0
    assert yao_partnerunit.get_membership(yao_str)._credor_pool != 0
    assert yao_partnerunit.get_membership(yao_str)._debtor_pool != 0
    yao_yao_membership = yao_partnerunit.get_membership(yao_str)
...
def test_BelieverUnit_set_partnerunit_groupunit_respect_ledgers_ResetPartnerUnitsAttrs():
    ...
    yao_str = "Yao"
    zia_str = "Zia"
    sue_believerunit.add_partnerunit(yao_str, 55, 55)
    sue_believerunit.add_partnerunit(zia_str, 55, 55)
    yao_partnerunit = sue_believerunit.get_partner(yao_str)
    zia_partnerunit = sue_believerunit.get_partner(zia_str)
