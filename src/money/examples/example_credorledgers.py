...
from src.money.examples.econ_env import temp_tribes_dir, temp_tribe_id, get_texas_road
from src.money.rivercycle import get_credorledger


def example_yao_hubunit() -> HubUnit:
    return hubunit_shop(temp_tribes_dir(), temp_tribe_id(), "Yao")


def example_yao_texas_hubunit() -> HubUnit:
    return hubunit_shop(temp_tribes_dir(), temp_tribe_id(), "Yao", get_texas_road())
