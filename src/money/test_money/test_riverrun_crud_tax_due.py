...
def test_get_credorledger_ReturnsCorrectObj():
    ...
    yao_bud.add_acctunit(bob_text, yao_credor_weight)
    yao_bud.add_acctunit(sue_text, bob_credor_weight)
    yao_bud.add_acctunit(yao_text, sue_credor_weight)
...
def test_get_credorledger_ReturnsCorrectObjWithNoEmpty_credor_weight():
    ...
    yao_bud.add_acctunit(sue_text, sue_credor_weight)
...
def test_get_debtorledger_ReturnsCorrectObj():
    ...
    yao_bud = budunit_shop(yao_text)
    yao_bud.add_acctunit(bob_text, 2, bob_debtor_weight)
    yao_bud.add_acctunit(sue_text, 2, sue_debtor_weight)
    yao_bud.add_acctunit(yao_text, 2, yao_debtor_weight)
...
def test_RiverRun_set_tax_dues_CorrectlySetsAttr():
    ...
    bob_bud.add_acctunit(bob_text, 2, bob_debtor_weight)
