...
# from src.a06_belief_logic.test._util.a06_env import get_belief_examples_dir as env_dir
# from src.a06_belief_logic.test._util.example_beliefs import beliefunit_v001, beliefunit_v002
...
def beliefunit_v001() -> BeliefUnit:
    belief1_path = "src/a06_belief_logic/test/_util/example_belief1.json"
...
def beliefunit_v002() -> BeliefUnit:
    belief2_path = "src/a06_belief_logic/test/_util/example_belief2.json"
...
def get_beliefunit_x1_3levels_1reason_1facts() -> BeliefUnit:
    tiger_str = "tiger"
    zia_belief = beliefunit_shop("Zia", coin_label=tiger_str)
    shave_str = "shave"
...
def get_beliefunit_irrational_example() -> BeliefUnit:
    ...
    # after hatter_belief.settle_belief these should be true:
