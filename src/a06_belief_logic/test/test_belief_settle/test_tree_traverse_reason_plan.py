...
def test_BeliefUnit_ReasonUnits_set_casePlanWithBeginCloseSetsCasereason_lower_reason_upper():
    ...
    sue_belief.set_plan(
        planunit_shop(ziet, begin=100, close=2000), sue_belief.coin_label
    )
...
def test_BeliefUnit_edit_plan_attr_beliefIsAbleToEdit_reason_active_requisite_AnyPlanIfInvaildThrowsError():
    ...
    sue_belief.set_plan(planunit_shop(run_str), sue_belief.coin_label)
    sue_belief.settle_belief()  # set tree metrics
...
def test_BeliefUnit_settle_belief_SetsRationalAttrToFalseWhen_max_tree_traverse_Is1():
    # ESTABLISH
    sue_belief = get_beliefunit_with_4_levels()
