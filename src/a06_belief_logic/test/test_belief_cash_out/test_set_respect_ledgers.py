...
def test_create_groupunits_metrics_SetsAttrScenario0():
    ...
    sue_beliefunit._groupunits = None
    assert sue_beliefunit._groupunits is None
...
def test_create_groupunits_metrics_SetsAttrScenario1():
    ...
    yao_yao_membership = yao_partnerunit.get_membership(yao_str)
...
def test_BeliefUnit_set_partnerunit_groupunit_respect_ledgers_SetsAttr_scenario0():
    # ESTABLISH
    sue_str = "Sue"
    sue_beliefunit = beliefunit_shop(sue_str)
    assert sue_beliefunit._groupunits == {}
...
def test_BeliefUnit_set_partnerunit_groupunit_respect_ledgers_SetsAttr_scenario1():
    # sourcery skip: extract-duplicate-method
    # ESTABLISH
    sue_str = "Sue"
    sue_beliefunit = beliefunit_shop(sue_str)
    ...
    assert yao_partnerunit.get_membership(yao_str)._credor_pool == 0
    assert yao_partnerunit.get_membership(yao_str)._debtor_pool == 0
    # assert sue_beliefunit._groupunits == {}
    ...
    assert yao_partnerunit._credor_pool != 0
    assert yao_partnerunit._debtor_pool != 0
    assert yao_partnerunit._credor_pool == sue_beliefunit.credor_respect
    assert yao_partnerunit._debtor_pool == sue_beliefunit.debtor_respect
    yao_membership = yao_partnerunit.get_membership(yao_str)
    assert yao_membership._credor_pool != 0
    assert yao_membership._debtor_pool != 0
    assert yao_membership._credor_pool == sue_beliefunit.credor_respect
...
def test_BeliefUnit_set_partnerunit_groupunit_respect_ledgers_SetsAttr_scenario2():
    # ESTABLISH
    sue_str = "Sue"
    sue_beliefunit = beliefunit_shop(sue_str)
    yao_str = "Yao"
    sue_beliefunit.add_partnerunit(yao_str)
    yao_partnerunit = sue_beliefunit.get_partner(yao_str)
    yao_partnerunit.add_membership(yao_str, 1, 4)
    ohio_str = ";Ohio"
    ...
    # THEN
    assert sue_beliefunit.get_partner(yao_str)._credor_pool != 0
    assert sue_beliefunit.get_partner(yao_str)._debtor_pool != 0
    assert yao_partnerunit.get_membership(yao_str)._credor_pool != 0
    assert yao_partnerunit.get_membership(yao_str)._debtor_pool != 0
    yao_yao_membership = yao_partnerunit.get_membership(yao_str)
    assert yao_yao_membership._credor_pool != 0
    assert yao_yao_membership._debtor_pool != 0
    assert yao_yao_membership._credor_pool == sue_beliefunit.credor_respect * 0.25
    ...
    assert yao_ohio_membership._credor_pool == sue_beliefunit.credor_respect * 0.75
...
def test_BeliefUnit_set_partnerunit_groupunit_respect_ledgers_ResetPartnerUnitsAttrs():
    # sourcery skip: extract-duplicate-method
    # ESTABLISH
    sue_str = "Sue"
    sue_beliefunit = beliefunit_shop(sue_str)
    yao_str = "Yao"
    zia_str = "Zia"
    sue_beliefunit.add_partnerunit(yao_str, 55, 55)
    sue_beliefunit.add_partnerunit(zia_str, 55, 55)
    yao_partnerunit = sue_beliefunit.get_partner(yao_str)
    zia_partnerunit = sue_beliefunit.get_partner(zia_str)
    yao_partnerunit.add_fund_give_take(0.5, 0.6, 0.1, 0.22)
    zia_partnerunit.add_fund_give_take(0.2, 0.1, 0.1, 0.22)
    zia_1 = 0.8
    zia_2 = 0.5
    zia_3 = 200
    zia_4 = 140
    zia_partnerunit.set_fund_agenda_ratio_give_take(
        ...
        partnerunits_partner_cred_points_sum=zia_3,
        partnerunits_partner_debt_points_sum=zia_4,
    )
    yao_1 = 0.2
    yao_2 = 0.5
    yao_3 = 204
    ...
    yao_partnerunit.set_fund_agenda_ratio_give_take(
        ...
        partnerunits_partner_cred_points_sum=yao_3,
        partnerunits_partner_debt_points_sum=yao_4,
    )
    assert zia_partnerunit._fund_agenda_ratio_give == 0.125
    assert zia_partnerunit._fund_agenda_ratio_take == 0.44
    assert yao_partnerunit._fund_agenda_ratio_give == 0.5
    assert yao_partnerunit._fund_agenda_ratio_take == 0.44

    # WHEN
    sue_beliefunit._set_partnerunit_groupunit_respect_ledgers()

    # THEN
    assert zia_partnerunit._fund_agenda_ratio_give == 0
    assert zia_partnerunit._fund_agenda_ratio_take == 0
