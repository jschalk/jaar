...
from src.ch09_belief_atom._ref.ch09_semantic_types import CRUD_command


def atom_config_path() -> str:
    "Returns Path: ch09_belief_atom/atom_config.json"
    src_dir = create_path(os_getcwd(), "src")
    chapter_dir = create_path(src_dir, "ch09_belief_atom")
