...
def test_sift_atom_ReturnsObj_BeliefAtom_INSERT_belief_plan_awardunit():
    ...
    casa_swim_atom = beliefatom_shop(kw.belief_plan_awardunit, kw.INSERT)
    casa_swim_atom.set_arg(kw.plan_rope, casa_rope)
    casa_swim_atom.set_arg(kw.awardee_title, swim_str)
    clean_swim_atom = beliefatom_shop(kw.belief_plan_awardunit, kw.INSERT)
...
def test_sift_atom_ReturnsObj_BeliefAtom_INSERT_belief_plan_reasonunit():
    ...
    casa_week_atom = beliefatom_shop(kw.belief_plan_reasonunit, kw.INSERT)
    casa_week_atom.set_arg(kw.plan_rope, casa_rope)
    casa_week_atom.set_arg(kw.reason_context, week_rope)
    clean_week_atom = beliefatom_shop(kw.belief_plan_reasonunit, kw.INSERT)
    clean_week_atom.set_arg(kw.plan_rope, clean_rope)
    clean_week_atom.set_arg(kw.reason_context, week_rope)
    sue_belief.add_plan(casa_rope)
    sue_belief.add_plan(clean_rope)
...
def test_sift_atom_ReturnsObj_BeliefAtom_INSERT_belief_plan_reason_caseunit_Exists():
    ...
    casa_week_atom = beliefatom_shop(kw.belief_plan_reason_caseunit, kw.INSERT)
    casa_week_atom.set_arg(kw.plan_rope, casa_rope)
    casa_week_atom.set_arg(kw.reason_context, week_rope)
    casa_week_atom.set_arg(kw.reason_state, thur_rope)
    clean_week_atom = beliefatom_shop(kw.belief_plan_reason_caseunit, kw.INSERT)
    clean_week_atom.set_arg(kw.plan_rope, clean_rope)
    clean_week_atom.set_arg(kw.reason_context, week_rope)
    clean_week_atom.set_arg(kw.reason_state, thur_rope)
    sue_belief.add_plan(casa_rope)
    sue_belief.add_plan(clean_rope)
...
def test_sift_atom_ReturnsObj_BeliefAtom_INSERT_belief_plan_factunit():
    ...
    casa_week_atom = beliefatom_shop(kw.belief_plan_factunit, kw.INSERT)
    casa_week_atom.set_arg(kw.plan_rope, casa_rope)
    casa_week_atom.set_arg(kw.fact_context, week_rope)
    clean_week_atom = beliefatom_shop(kw.belief_plan_factunit, kw.INSERT)
    clean_week_atom.set_arg(kw.plan_rope, clean_rope)
    clean_week_atom.set_arg(kw.fact_context, week_rope)
    sue_belief.add_plan(casa_rope)
    sue_belief.add_plan(clean_rope)
    assert sift_beliefatom(sue_belief, casa_week_atom)
    assert sift_beliefatom(sue_belief, clean_week_atom)
