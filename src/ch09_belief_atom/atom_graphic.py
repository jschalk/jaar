...
def beliefatom_periodic_table0() -> plotly_Figure:
    ...
    # belief_planunit_insert = get_insert_rect(kw.belief_planunit)
    # belief_plan_awardunit_insert = get_insert_rect(kw.belief_plan_awardunit)
    # belief_plan_partyunit_insert = get_insert_rect(kw.belief_plan_partyunit)
    # belief_plan_healerunit_insert = get_insert_rect(kw.belief_plan_healerunit)
    # belief_plan_factunit_insert = get_insert_rect(kw.belief_plan_factunit)
    # belief_plan_reasonunit_insert = get_insert_rect(kw.belief_plan_reasonunit)
    # belief_plan_reason_caseunit_insert = get_insert_rect(case_str)
    # belief_planunit_update = get_update_rect(kw.belief_planunit)
    # belief_plan_awardunit_update = get_update_rect(kw.belief_plan_awardunit)
    # belief_plan_factunit_update = get_update_rect(kw.belief_plan_factunit)
    # belief_plan_reason_caseunit_update = get_update_rect(case_str)
    # belief_plan_reasonunit_update = get_update_rect(kw.belief_plan_reasonunit)
    # belief_plan_reason_caseunit_delete = get_delete_rect(case_str)
    # belief_plan_reasonunit_delete = get_delete_rect(kw.belief_plan_reasonunit)
    # belief_plan_factunit_delete = get_delete_rect(kw.belief_plan_factunit)
    # belief_plan_partyunit_delete = get_delete_rect(kw.belief_plan_partyunit)
    # belief_plan_healerunit_delete = get_delete_rect(kw.belief_plan_healerunit)
    # belief_plan_awardunit_delete = get_delete_rect(kw.belief_plan_awardunit)
    # belief_planunit_delete = get_delete_rect(kw.belief_planunit)
