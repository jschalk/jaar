...
def get_brick_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "acct_id,fiscal_id,owner_id,quota,time_fid": brick_format_00001_fiscal_purview_episode_v0_0_0(),
        "acct_id,amount,fiscal_id,owner_id,time_fid": brick_format_00002_fiscal_cashbook_v0_0_0(),
        ...
        "credor_respect,debtor_respect,fiscal_id,fund_coin,fund_pool,max_tree_traverse,owner_id,penny,purview_time_fid,respect_bit,tally": brick_format_00029_budunit_v0_0_0(),
