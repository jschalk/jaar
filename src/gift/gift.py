...
from src._road.road import OwnerID, PecunID, get_default_pecun_id_roadnode
...
def giftunit_shop(
    ...
    pecun_id = get_default_pecun_id_roadnode() if pecun_id is None else pecun_id
    x_giftunit = GiftUnit(
        pecun_id=pecun_id,
        owner_id=owner_id,
...
def create_giftunit_from_files(
    ...
    x_pecun_id = gift_dict.get(pecun_id_str())
