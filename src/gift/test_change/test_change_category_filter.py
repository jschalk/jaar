...
from src.gift.atom_config import bud_charunit_text
...
def test_ChangeUnit_get_filtered_changeunit_ReturnsObjFilteredBy_charunit_insert():
    ...
    before_sue_bud.add_charunit(yao_text)
    after_sue_bud = budunit_shop(sue_text)
    bob_text = "Bob"
    bob_credor_weight = 33
    bob_debtor_weight = 44
    after_sue_bud.add_charunit(bob_text, bob_credor_weight, bob_debtor_weight)
    ...
    category_set = [bud_charunit_text()]
