...
def test_ChangeUnit_add_all_different_atomunits_Creates_AtomUnit_idea_healerhold_insert():
    # ESTABLISH
    sue_text = "Sue"
    before_sue_bud = budunit_shop(sue_text)
    xio_text = "Xio"
...
def test_ChangeUnit_add_all_different_atomunits_Creates_AtomUnit_idea_healerhold_delete():
    # ESTABLISH
    sue_text = "Sue"
    before_sue_bud = budunit_shop(sue_text)
    xio_text = "Xio"
