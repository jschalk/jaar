...
def atomunit_periodic_table0() -> plotly_Figure:
    ...
    world_idea_belieflink_insert = get_insert_rect("world_idea_belieflink")
    ...
    world_idea_belieflink_delete = get_delete_rect("world_idea_belieflink")
    ...
    world_idea_belieflink_insert.set_level(4, 0.2, 0.4)
    world_idea_belieflink_delete.set_level(4, 0.6, 0.8)
    ...
    add_atom_rect(fig, world_idea_belieflink_insert)
    ...
    add_atom_rect(fig, world_idea_belieflink_delete)
