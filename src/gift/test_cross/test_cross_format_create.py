...
def test_create_cross_Arg_jaar_format_0001_char_v0_0_0():
    ...
    sue_budunit.add_charunit(sue_text, sue_credor_weight, sue_debtor_weight)
    sue_budunit.add_charunit(bob_text, bob_credor_weight, bob_debtor_weight)
    sue_budunit.add_charunit(yao_text, yao_credor_weight, yao_debtor_weight)
    sue_budunit.set_char_respect(music_pool)

    # WHEN
    x_cross = jaar_format_0001_char_v0_0_0()
    char_dataframe = create_cross(sue_budunit, x_cross)
    ...
    assert char_dataframe.loc[0, owner_id_str()] == sue_budunit._owner_id
    ...
    assert char_dataframe.loc[1, owner_id_str()] == sue_budunit._owner_id
    ...
    assert char_dataframe.loc[2, owner_id_str()] == sue_budunit._owner_id
...
def test_create_cross_Arg_jaar_format_0002_lobbyship_v0_0_0():
    ...
    sue_charunit = sue_budunit.get_char(sue_text)
