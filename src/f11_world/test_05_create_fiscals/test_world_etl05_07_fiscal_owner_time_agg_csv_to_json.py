...
# """
#     save_file(a23_event_time_p, a23_event_time_csv)
#     save_file(a45_event_time_p, a45_event_time_csv)
...
#     assert os_path_exists(a23_event_time_json_path)
#     assert os_path_exists(a45_event_time_json_path)
#     a23_event_time_json = open_file(a23_event_time_json_path)
#     a45_event_time_json = open_file(a45_event_time_json_path)
#     assert a23_event_time_json == {(sue_str, event3): timepoint55})
#     assert a45_event_time_json == {}
