...
def test_world_event_bricks_to_fiscal_bricks_CreatesFaceBrickSheets_Scenario0_MultpleFaceIDs(
    ...
    upsert_sheet(event3_br00003_filepath, zoo_valid_str(), example_event3_df)
    upsert_sheet(event7_br00003_filepath, zoo_valid_str(), example_event7_df)
    upsert_sheet(event9_br00003_filepath, zoo_valid_str(), example_event9_df)
    ...
    assert sheet_exists(e3_music23_br00003_filepath, zoo_valid_str()) is False
    assert sheet_exists(e7_music23_br00003_filepath, zoo_valid_str()) is False
    assert sheet_exists(e9_music23_br00003_filepath, zoo_valid_str()) is False
    assert sheet_exists(e9_music55_br00003_filepath, zoo_valid_str()) is False

    # WHEN
    fizz_world.event_bricks_to_fiscal_bricks()

    # THEN
    assert sheet_exists(e7_music23_br00003_filepath, zoo_valid_str())
    assert sheet_exists(e3_music23_br00003_filepath, zoo_valid_str())
    assert sheet_exists(e9_music23_br00003_filepath, zoo_valid_str())
    assert sheet_exists(e9_music55_br00003_filepath, zoo_valid_str())
    gen_e3_music23_df = pandas_read_excel(e3_music23_br00003_filepath, zoo_valid_str())
    gen_e7_music23_df = pandas_read_excel(e7_music23_br00003_filepath, zoo_valid_str())
    gen_e9_music23_df = pandas_read_excel(e9_music23_br00003_filepath, zoo_valid_str())
    gen_e9_music55_df = pandas_read_excel(e9_music55_br00003_filepath, zoo_valid_str())
