...
def test_WorldUnit_idea_staging_to_fiscal_tables_PopulatesTable_fiscal_event_time(
    env_dir_setup_cleanup,
):  # sourcery skip: extract-method
    ...
    br00001_csv_str = f"""{face_name_str()},{event_int_str()},fiscal_title,owner_name,time_int,quota,ledger_depth
...
"""
    br00002_csv_str = f"""{face_name_str()},{event_int_str()},fiscal_title,owner_name,acct_name,time_int,amount
