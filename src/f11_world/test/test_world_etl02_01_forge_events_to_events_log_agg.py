...
def test_WorldUnit_forge_events_to_events_log_CreatesSheets_Scenario0(
    ...
    events_file_path = create_path(fizz_world._forge_dir, events_file_name)
    ...
    invalid_error_str = "invalid because of conflicting event_id"
    forge_dir = fizz_world._forge_dir
    src_file_name = "br00003.xlsx"
    oe_str = "forge_events"
    bob_row = [forge_dir, src_file_name, oe_str, bob_str, event3, ""]
    sue_row = [forge_dir, src_file_name, oe_str, sue_str, event1, invalid_error_str]
    yao1_row = [forge_dir, src_file_name, oe_str, yao_str, event1, invalid_error_str]
    yao9_row = [forge_dir, src_file_name, oe_str, yao_str, event9, ""]
    # el_rows = [forge_dir, events_file_name, elog, bob_row, sue_row, yao1_row, yao9_row]
...
def test_WorldUnit_forge_events_to_events_log_CreatesSheets_Scenario1_MultipleBricks(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    fizz_str = "fizz"
    ...
    oe_str = "forge_events"
    bob_row = [forge_dir, src3_file_name, oe_str, bob_str, event3, ""]
    sue_row = [forge_dir, src3_file_name, oe_str, sue_str, event1, invalid_error_str]
    yao1_row = [forge_dir, src3_file_name, oe_str, yao_str, event1, invalid_error_str]
    yao9_row = [forge_dir, src3_file_name, oe_str, yao_str, event9, ""]
    s5_0_row = [forge_dir, src5_file_name, oe_str, bob_str, event3, ""]
    s5_1_row = [forge_dir, src5_file_name, oe_str, yao_str, event9, ""]
    # el_rows = [forge_dir, events_file_name, elog, bob_row, sue_row, yao1_row, yao9_row]
