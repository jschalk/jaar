...
def test_WorldUnit_barn_agg_to_pidgin_staging_CreatesFile(env_dir_setup_cleanup):
    # ESTABLISH
    ...
    event2 = 2
    event5 = 5
    br00113_file_path = create_path(fizz_world._barn_dir, "br00113.xlsx")
    br00113_columns = [
        face_id_str(),
        event_id_str(),
        fiscal_id_str(),
    ...
    br00043_file_path = create_path(fizz_world._barn_dir, "br00043.xlsx")
    br00043_columns = [
        face_id_str(),
        event_id_str(),
        otx_acct_id_str(),
    ...
    pidgin_path = create_path(fizz_world._barn_dir, "pidgin.xlsx")

    br00115_file_path = create_path(fizz_world._barn_dir, "br00115.xlsx")
    br00115_columns = [
        face_id_str(),
        event_id_str(),
        fiscal_id_str(),
    ...
    br00042_file_path = create_path(fizz_world._barn_dir, "br00042.xlsx")
    br00042_columns = [
        face_id_str(),
        event_id_str(),
        otx_group_id_str(),
    ...
    upsert_sheet(br00115_file_path, barn_agg_str(), br00115_df)
    b40_rows = [sue2, sue3, yao1]
    br00042_df = DataFrame(b40_rows, columns=br00042_columns)
    upsert_sheet(br00042_file_path, barn_agg_str(), br00042_df)

    br00116_file_path = create_path(fizz_world._barn_dir, "br00116.xlsx")
    br00116_columns = [
        face_id_str(),
        event_id_str(),
        fiscal_id_str(),
    ...
    br00044_file_path = create_path(fizz_world._barn_dir, "br00044.xlsx")
    br00044_columns = [
        face_id_str(),
        event_id_str(),
        otx_idea_str(),
    ...
    upsert_sheet(br00116_file_path, barn_agg_str(), br00116_df)
    br00044_rows = [sue2, sue3, yao1]
    br00044_df = DataFrame(br00044_rows, columns=br00044_columns)
    upsert_sheet(br00044_file_path, barn_agg_str(), br00044_df)

    br00117_file_path = create_path(fizz_world._barn_dir, "br00117.xlsx")
    br00117_columns = [
        face_id_str(),
        event_id_str(),
        fiscal_id_str(),
    ...
    br00045_file_path = create_path(fizz_world._barn_dir, "br00045.xlsx")
    br00045_columns = [
        face_id_str(),
        event_id_str(),
        otx_road_str(),
    ...
    # WHEN
    fizz_world.barn_agg_to_pidgin_staging()
