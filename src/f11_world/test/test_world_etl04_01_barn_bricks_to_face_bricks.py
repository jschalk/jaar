...
def test_WorldUnit_barn_bricks_to_face_bricks_CreatesOtxSheets_Scenario0_GroupByWorks(
    ...
    br00003_agg_file_path = create_path(fizz_world._barn_dir, "br00003.xlsx")
    ...
    # WHEN
    fizz_world.barn_bricks_to_face_bricks()
...
#     br00003_agg_file_path = create_path(fizz_world._barn_dir, "br00003.xlsx")
#     barn_df = pandas_read_excel(br00003_agg_file_path, sheet_name=barn_staging_str())
#     assert len(barn_df) == 4
#     assert sheet_exists(br00003_agg_file_path, barn_valid_str()) is False
...
#     assert get_sheet_names(br00003_agg_file_path) == [barn_staging_str(), barn_valid_str()]
