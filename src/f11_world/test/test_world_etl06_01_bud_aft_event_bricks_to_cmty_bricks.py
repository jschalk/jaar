...
def test_WorldUnit_aft_event_bricks_to_cmty_bricks_CreatesFaceBrickSheets_Scenario0_MultpleFaceNames(
    ...
    # WHEN
    fizz_world.aft_event_bricks_to_cmty_bricks()
    ...
    # TODO confirm aft_event_bricks_to_cmty_bricks
