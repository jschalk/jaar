...
def test_etl_bow_event_ideas_to_boat_events_Scenario0_NoPidginUnit(
...
def test_etl_bow_event_ideas_to_boat_events_Scenario1_MultpleFaceNames_CreatesEventInxSheets(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_otx = "Sue"
