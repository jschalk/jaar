...
from src.f05_listen.hub_path import (
    ...
    create_event_all_stand_path as event_all_stand_path,
)
...
def test_WorldUnit_event_bud_csvs_to_stand_json_CreatesFiles(
...
"""
    ...
    e3_all_stand_path = event_all_stand_path(fisc_mstr_dir, a23_str, bob_inx, event3)
    e7_all_stand_path = event_all_stand_path(fisc_mstr_dir, a23_str, bob_inx, event7)
    assert os_path_exists(e3_all_stand_path) is False
    assert os_path_exists(e7_all_stand_path) is False

    # WHEN
    fizz_world.event_bud_csvs_to_stand_json()
