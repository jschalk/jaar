...
def test_WorldUnit_event_gift_json_to_event_inherited_budunits_SetsFiles_bud_json(
    ...
    a23_bob_e3_gift.add_budatom(budacct_dimen, insert_str, bob_jkeys, bob_jvalues)
    a23_bob_e3_gift.add_budatom(budacct_dimen, insert_str, yao_jkeys, yao_jvalues)
    sue_jkeys = {acct_name_str(): sue_inx}
    sue_jvalues = {credit_belief_str(): credit88, debtit_belief_str(): None}
    a23_bob_e7_gift.add_budatom(budacct_dimen, insert_str, bob_jkeys, bob_jvalues)
    a23_bob_e7_gift.add_budatom(budacct_dimen, insert_str, sue_jkeys, sue_jvalues)
...
def test_WorldUnit_event_gift_json_to_event_inherited_budunits_SetsFiles_expressed_gift(
    ...
    expected_e3_bob_gift.add_budatom(budacct_dimen, insert_str, bob_jkeys, bob_jvalues)
    expected_e3_bob_gift.add_budatom(budacct_dimen, insert_str, yao_jkeys, yao_jvalues)
    expected_e7_bob_gift.add_budatom(budacct_dimen, insert_str, sue_jkeys, sue_jvalues)
    ...
    # expected_e3_bob_gift.add_budatom()
    # expected_e3_bob_gift.add_budatom()
    # expected_e7_bob_gift.add_budatom()
    # expected_e7_bob_gift.add_budatom()
    # expected_e7_bob_gift.add_budatom()
