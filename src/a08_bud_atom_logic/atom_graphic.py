...
def budatom_periodic_table0() -> plotly_Figure:
    ...
    bud_concept_healerlink_insert.set_level(3, 0.2, 0.4)
    bud_concept_healerlink_delete.set_level(3, 0.6, 0.8)
    bud_concept_laborlink_insert.set_level(4, 0.2, 0.4)
    bud_concept_laborlink_delete.set_level(4, 0.6, 0.8)
    bud_concept_awardlink_insert.set_level(5, 0.2, 0.4, green_str)
    bud_concept_awardlink_update.set_level(5, 0.4, 0.6, green_str)
    bud_concept_awardlink_delete.set_level(5, 0.6, 0.8, green_str)
    bud_conceptunit_insert.set_level(6, 0, 0.3, green_str)
    bud_conceptunit_update.set_level(6, 0.3, 0.7, green_str)
    bud_conceptunit_delete.set_level(6, 0.7, 1, green_str)
    bud_concept_reasonunit_insert.set_level(7, 0.2, 0.4)
    bud_concept_reasonunit_update.set_level(7, 0.4, 0.6)
    bud_concept_reasonunit_delete.set_level(7, 0.6, 0.8)
    bud_concept_reason_premiseunit_insert.set_level(8, 0.2, 0.4)
    bud_concept_reason_premiseunit_update.set_level(8, 0.4, 0.6)
    bud_concept_reason_premiseunit_delete.set_level(8, 0.6, 0.8)
    bud_concept_factunit_insert.set_level(9, 0.2, 0.4)
    bud_concept_factunit_update.set_level(9, 0.4, 0.6)
    bud_concept_factunit_delete.set_level(9, 0.6, 0.8)
    ...
    add_atom_rect(fig, bud_concept_laborlink_insert)
    add_atom_rect(fig, bud_concept_healerlink_insert)
    add_atom_rect(fig, bud_concept_factunit_insert)
    add_atom_rect(fig, bud_concept_reasonunit_insert)
    add_atom_rect(fig, bud_concept_reason_premiseunit_insert)
    add_atom_rect(fig, bud_acctunit_update)
    add_atom_rect(fig, bud_acct_membership_update)
    add_atom_rect(fig, bud_concept_factunit_update)
    add_atom_rect(fig, bud_concept_reason_premiseunit_update)
    add_atom_rect(fig, bud_concept_reasonunit_update)
    add_atom_rect(fig, bud_concept_reason_premiseunit_delete)
    add_atom_rect(fig, bud_concept_reasonunit_delete)
    add_atom_rect(fig, bud_concept_factunit_delete)
    add_atom_rect(fig, bud_concept_laborlink_delete)
    add_atom_rect(fig, bud_concept_healerlink_delete)
    add_atom_rect(fig, bud_concept_awardlink_insert)
    add_atom_rect(fig, bud_concept_awardlink_update)
    add_atom_rect(fig, bud_concept_awardlink_delete)
    add_atom_rect(fig, bud_conceptunit_insert)
    add_atom_rect(fig, bud_conceptunit_update)
    add_atom_rect(fig, bud_conceptunit_delete)
