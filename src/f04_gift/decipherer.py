from src.f00_instrument.dict_tool import get_empty_dict_if_none
...
class Decipherer:
    ...
    def decipher_acct_id(self, out_atomunit: AtomUnit) -> AtomUnit:
...
def decipherer_shop(in_fiscal_id: FiscalID = None):
