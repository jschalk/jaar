...
def _modify_bud_update_budunit(x_bud: BudUnit, x_atom: AtomUnit):
    ...
    x_arg = "purview_time_fid"
    if x_atom.get_value(x_arg) is not None:
        x_bud.purview_time_fid = x_atom.get_value(x_arg)
    x_arg = "penny"
    if x_atom.get_value(x_arg) is not None:
