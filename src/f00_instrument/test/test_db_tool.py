...
def test_insert_csv(setup_database_and_csv: tuple[sqlite3_Connection, str, str]):
...
def test_changes_committed(setup_database_and_csv: tuple[sqlite3_Connection, str, str]):
