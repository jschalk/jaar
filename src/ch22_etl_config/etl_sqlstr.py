...
INSERT_PRNPLAN_SOUND_VLD_PUT_SQLSTR = "INSERT INTO person_planunit_put_s_vld (spark_num, spark_face, person_name, plan_rope, begin, close, addin, numor, denom, morph, gogo_want, stop_want, kar, pledge, problem_bool, knot) SELECT spark_num, spark_face, person_name, plan_rope, begin, close, addin, numor, denom, morph, gogo_want, stop_want, kar, pledge, problem_bool, knot FROM person_planunit_put_s_agg WHERE error_message IS NULL"
...
INSERT_PRNPLAN_HEARD_RAW_PUT_SQLSTR = "INSERT INTO person_planunit_put_h_raw (spark_num, spark_face_otx, person_name_otx, plan_rope_otx, begin, close, addin, numor, denom, morph, gogo_want, stop_want, kar, pledge, problem_bool, knot) SELECT spark_num, spark_face, person_name, plan_rope, begin, close, addin, numor, denom, morph, gogo_want, stop_want, kar, pledge, problem_bool, knot FROM person_planunit_put_s_vld "
...
INSERT INTO person_planunit_put_h_agg (spark_num, spark_face, person_name, plan_rope, begin, close, addin, numor, denom, morph, gogo_want, stop_want, kar, pledge, problem_bool, knot)
SELECT spark_num, spark_face_inx, person_name_inx, plan_rope_inx, begin, close, addin, numor, denom, morph, gogo_want, stop_want, kar, pledge, problem_bool, knot
FROM person_planunit_put_h_raw
GROUP BY spark_num, spark_face_inx, person_name_inx, plan_rope_inx, begin, close, addin, numor, denom, morph, gogo_want, stop_want, kar, pledge, problem_bool, knot
"""
...
INSERT INTO person_planunit_put_h_vld (spark_num, spark_face, person_name, plan_rope, begin, close, addin, numor, denom, morph, gogo_want, stop_want, kar, pledge, problem_bool, knot)
SELECT spark_num, spark_face, person_name, plan_rope, begin, close, addin, numor, denom, morph, gogo_want, stop_want, kar, pledge, problem_bool, knot
FROM person_planunit_put_h_agg
GROUP BY spark_num, spark_face, person_name, plan_rope, begin, close, addin, numor, denom, morph, gogo_want, stop_want, kar, pledge, problem_bool, knot
"""
...
CREATE_JOB_PRNPLAN_SQLSTR = """CREATE TABLE IF NOT EXISTS person_planunit_job (moment_rope TEXT, person_name TEXT, plan_rope TEXT, begin REAL, close REAL, addin REAL, numor INTEGER, denom INTEGER, morph INTEGER, gogo_want REAL, stop_want REAL, kar INTEGER, pledge INTEGER, problem_bool INTEGER, fund_grain REAL, knot TEXT, plan_active INTEGER, plan_task INTEGER, fund_onset REAL, fund_cease REAL, fund_ratio REAL, gogo_calc REAL, stop_calc REAL, tree_level INTEGER, range_evaluated INTEGER, descendant_pledge_count INTEGER, healerunit_ratio REAL, all_contact_cred INTEGER, all_contact_debt INTEGER)"""
