...
from src.s8_stone.stone import create_stone_df, get_stoneref, save_stone_csv
...
from src.s8_stone.examples.stone_env import (
    stone_examples_dir,
    stone_fiscals_dir,
...
def test_create_stone_df_Arg_stone_format_00020_bud_acct_membership_v0_0_0():
    ...
    assert membership_dataframe.loc[2, fiscal_id_str()] == music_fiscal_id
    ...
    assert membership_dataframe.loc[4, fiscal_id_str()] == music_fiscal_id
    ...
    assert membership_dataframe.loc[5, fiscal_id_str()] == music_fiscal_id
