...
def test_WorldUnit_creed_raw_to_fisc_prime_tables_CreatesFiscRawTables(
    env_dir_setup_cleanup,
):
    # ESTABLISH
...
def test_WorldUnit_creed_raw_to_fisc_prime_tables_Bud_dimen_creed_PopulatesFiscRawTables(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
...
def test_WorldUnit_set_creed_raw_error_message_ChangeAttrs(env_dir_setup_cleanup):
    # ESTABLISH
    sue_inx = "Suzy"
    bob_inx = "Bobby"
    event3 = 3
