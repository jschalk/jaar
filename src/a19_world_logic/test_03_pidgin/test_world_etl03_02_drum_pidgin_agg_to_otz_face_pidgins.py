...
def test_WorldUnit_drum_pidgin_agg_to_otz_face_pidgin_agg_Scenario1_AllMapDimens(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    ...
    agg_pidgin_path = create_drum_pidgin_path(fizz_world._drum_dir)
    ...
    # WHEN
    fizz_world.drum_pidgin_agg_to_otz_face_pidgin_agg()
