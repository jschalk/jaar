...
#     a23_event_time_csv = f"""{fisc_title_str()},{owner_name_str()},{event_int_str()},{tran_time_str()},error_message
# {accord23_str},{bob_str},{event3},{timepoint55},
# """
#     a45_event_time_csv = f"""{fisc_title_str()},{owner_name_str()},{event_int_str()},{tran_time_str()},error_message
