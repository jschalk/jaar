...
# def test_WorldUnit_inz_face_csv_files2creed_raw_tables_HasCreedDataFromCSV(
...
#         fizz_world.inz_face_csv_files2creed_raw_tables(fisc_db_conn)
...
# already tested in test_world_etl05_00_inz_face_creeds_to_creed_raw_tables
