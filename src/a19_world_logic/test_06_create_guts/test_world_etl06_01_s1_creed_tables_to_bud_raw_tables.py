...
def test_WorldUnit_creed_raw_to_bud_prime_tables_CreatesBudRawTables(
    env_dir_setup_cleanup,
...
def test_WorldUnit_creed_raw_to_bud_prime_tables_Bud_dimen_creed_PopulatesFiscRawTables(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
...
def test_WorldUnit_creed_raw_to_bud_prime_tables_Sets_error_message(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
