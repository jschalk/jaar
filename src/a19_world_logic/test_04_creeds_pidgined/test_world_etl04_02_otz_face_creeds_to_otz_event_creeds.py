...
def test_WorldUnit_otz_face_creeds_to_otz_event_otx_creeds_CreatesFaceCreedSheets_Scenario0_MultpleFaceNames(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_str = "Sue"
    ...
    # WHEN
    fizz_world.otz_face_creeds_to_otz_event_otx_creeds()
