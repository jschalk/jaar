...
def test_otz_inx_event_creeds_to_inz_faces_Scenario0(env_dir_setup_cleanup):
    # ESTABLISH
    sue_otx = "Sue"
    sue_inx = "Suzy"
    bob_inx = "Bob"
    ...
    # WHEN
    fizz_world.otz_inx_event_creeds_to_inz_faces()
...
def test_otz_inx_event_creeds_to_inz_faces_Scenario1(env_dir_setup_cleanup):
    # ESTABLISH
    sue_otx = "Sue"
    sue_inx = "Suzy"
    bob_inx = "Bob"
