...
def test_DoerHeir_set_owner_id_doer_CorrectlySetsAttribute_Emptyx_lobbyholds():
    ...
    # WHEN
    world_lobbyboxs = {}
    x_doerheir.set_owner_id_doer(world_lobbyboxs, world_owner_id="")
...
def test_DoerHeir_set_owner_id_doer_CorrectlySetsAttribute_NonEmptyx_lobbyholds_v1():
    ...
    yao_lobbybox.set_lobbylink(lobbylink_shop(yao_text, _char_id=yao_text))
    sue_lobbybox.set_lobbylink(lobbylink_shop(sue_text, _char_id=sue_text))
    ...
    # WHEN
    x_doerheir.set_owner_id_doer(x_lobbyboxs, world_owner_id)
...
def test_DoerHeir_set_owner_id_doer_CorrectlySetsAttribute_NonEmptyx_lobbyholds_v2():
    ...
    x_doerheir = doerheir_shop(_lobbyholds=x_lobbyholds)
    assert yao_lobbybox.get_lobbylink(yao_text) != None
    assert x_doerheir._owner_id_doer is False
...
def test_DoerHeir_set_owner_id_doer_CorrectlySetsAttribute_NonEmptyx_lobbyholds_v3():
    ...
    swim_lobbybox.set_lobbylink(lobbylink_shop(swim_text, _char_id=yao_text))
    swim_lobbybox.set_lobbylink(lobbylink_shop(swim_text, _char_id=sue_text))
    x_lobbyboxs = {
    ...
    x_doerheir = doerheir_shop(_lobbyholds=x_lobbyholds)
    assert x_doerheir._owner_id_doer is False
    x_doerheir.set_owner_id_doer(x_lobbyboxs, world_owner_id=yao_text)
    assert x_doerheir._owner_id_doer

    # WHEN
    swim_lobbybox.del_lobbylink(yao_text)
    x_doerheir.set_owner_id_doer(x_lobbyboxs, yao_text)
...
def test_DoerHeir_set_lobbyhold_DoerUnitNotEmpty_ParentDoerHeirEmpty():
    ...
    parent_doerheir_empty = doerheir_shop()
    x_doerheir.set_lobbyholds(
        parent_doerheir_empty, doerunit=x_doerunit, world_lobbyboxs=None
    )
...
def test_DoerHeir_set_lobbyhold_DoerUnitEmpty_ParentDoerHeirNotEmpty():
    ...
    parent_doerheir.set_lobbyholds(empty_doerheir, doerunit_swim, world_lobbyboxs=None)
    ...
    x_doerheir.set_lobbyholds(
        parent_doerheir, doerunit=doerunit_empty, world_lobbyboxs=None
    )
...
def test_DoerHeir_set_lobbyhold_DoerUnitEqualParentDoerHeir_NonEmpty():
    ...
    assert x_doerheir._lobbyholds == set()
    x_doerheir.set_lobbyholds(
        parent_doerheir, doerunit=doerunit_swim, world_lobbyboxs=None
    )
...
def test_DoerHeir_set_lobbyhold_DoerUnit_NotEqual_ParentDoerHeir_NonEmpty():
    ...
    swim2_lobbybox.set_lobbylink(lobbylink_shop(swim2_text, _char_id=yao_text))
    swim2_lobbybox.set_lobbylink(lobbylink_shop(swim2_text, _char_id=sue_text))

    swim3_text = ",swim3"
    swim3_lobbybox = lobbybox_shop(lobby_id=swim3_text)
    swim3_lobbybox.set_lobbylink(lobbylink_shop(swim3_text, _char_id=yao_text))
    swim3_lobbybox.set_lobbylink(lobbylink_shop(swim3_text, _char_id=sue_text))
    swim3_lobbybox.set_lobbylink(lobbylink_shop(swim3_text, _char_id=zia_text))
    ...
    parent_doerheir.set_lobbyholds(
        parent_doerheir=None, doerunit=parent_doerunit, world_lobbyboxs=None
    )
...
#     bob_lobbybox = lobbybox_shop(bob_text)
#     bob_lobbybox = lobbybox_shop(zia_text)
#     yao_lobbybox.set_lobbylink(lobbylink_shop(yao_text))
#     sue_lobbybox.set_lobbylink(lobbylink_shop(sue_text))
