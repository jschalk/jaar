...
def test_get_translate_args_class_types_ReturnsObj():
    ...
    assert translate_args_class_types.get(kw.offi_time) == kw.EpochPoint
    ...
    assert translate_args_class_types.get(kw.bud_time) == kw.EpochPoint
    assert translate_args_class_types.get(kw.tran_time) == kw.EpochPoint
