...
from src.a01_word_logic.road import GroupLabel, AcctName, default_bridge_if_None
from src.a02_finance_toolboxs.allot import allot_scale
from src.a02_finance_toolboxs.finance_config import FundCoin, default_fund_coin_if_None
...
def awardline_shop(awardee_title: GroupLabel, _fund_give: float, _fund_take: float):
