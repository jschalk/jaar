...
def test_listen_to_agenda_duty_vision_agenda_AddsChoresTovision_PlanWhenNo_laborlinkIsSet(
    ...
    zia_vision.add_acctunit(yao_str, debt_score=12)
...
def test_listen_to_agenda_duty_vision_agenda_AddsChoresTovisionPlanWithDetailsDecidedBy_debt_score(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    a23_str = "accord23"
...
def test_listen_to_agenda_duty_vision_agenda_ListensToOwner_duty_AndNotOwner_vision(
    ...
    yao_credit_score = 57
    yao_debt_score = 51
    yao_duty.add_acctunit(yao_str, yao_credit_score, yao_debt_score)
    zia_str = "Zia"
    zia_credit_score = 47
    zia_debt_score = 41
    yao_duty.add_acctunit(zia_str, zia_credit_score, zia_debt_score)
