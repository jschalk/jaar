...
def test_get_belief_viewer_template_ReturnsObj():
    ...
    expected_strs_in_template = {
        ...
        f"voice_{wx.irrational_voice_debt_shares}",
        f"voice_{wx.inallocable_voice_debt_shares}",
        ...
        f"voice_membership_{wx.group_cred_shares}",
        f"voice_membership_{wx.group_debt_shares}",
