...
def add_time_creg_planunit(x_beliefunit: BeliefUnit) -> BeliefUnit:
    """Add creg timeline planunit to beliefunit"""
    return add_newtimeline_planunit(x_beliefunit, get_creg_config())


def add_time_five_planunit(x_beliefunit: BeliefUnit) -> BeliefUnit:
    """Add five timeline planunit to beliefunit"""
    return add_newtimeline_planunit(x_beliefunit, get_five_config())


def add_time_squirt_planunit(x_beliefunit: BeliefUnit) -> BeliefUnit:
    """Add squirt timeline planunit to beliefunit"""
    return add_newtimeline_planunit(x_beliefunit, get_squirt_config())
...
def display_creg_five_squirt_time_attrs(graphics_bool: bool):
    if graphics_bool:
        ...
        creg_timelinepoint = belieftimelinepoint_shop(sue_belief, creg_rope, creg_min)
        five_timelinepoint = belieftimelinepoint_shop(sue_belief, five_rope, five_min)
        squirt_timelinepoint = belieftimelinepoint_shop(
            sue_belief, squirt_rope, squirt_min
        )
        creg_timelinepoint.calc_timeline()
        five_timelinepoint.calc_timeline()
