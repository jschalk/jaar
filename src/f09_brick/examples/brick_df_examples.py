...
def get_ex2_br00003_df() -> DataFrame:
    ...
    x_df.loc[22] = [MUSIC23_STR, "22-10pm", 1380]
    x_df.loc[23] = [MUSIC23_STR, "23-11pm", 1440]
    x_df.loc[24] = [JEFFY45_STR, "0hr", 60]
    x_df.loc[25] = [JEFFY45_STR, "1hr", 120]
    x_df.loc[26] = [JEFFY45_STR, "2hr", 180]
    x_df.loc[27] = [JEFFY45_STR, "3hr", 240]
    x_df.loc[28] = [JEFFY45_STR, "4hr", 300]
    x_df.loc[29] = [JEFFY45_STR, "5hr", 360]
    x_df.loc[30] = [JEFFY45_STR, "6hr", 420]
    x_df.loc[31] = [JEFFY45_STR, "7hr", 480]
    x_df.loc[32] = [JEFFY45_STR, "8hr", 540]
    x_df.loc[33] = [JEFFY45_STR, "9hr", 600]
    x_df.loc[34] = [JEFFY45_STR, "10hr", 660]
    x_df.loc[35] = [JEFFY45_STR, "11hr", 720]
    x_df.loc[36] = [JEFFY45_STR, "12hr", 780]
    x_df.loc[37] = [JEFFY45_STR, "13hr", 840]
    x_df.loc[38] = [JEFFY45_STR, "14hr", 900]
    x_df.loc[39] = [JEFFY45_STR, "15hr", 960]
    x_df.loc[40] = [JEFFY45_STR, "16hr", 1020]
    x_df.loc[41] = [JEFFY45_STR, "17hr", 1080]
    x_df.loc[42] = [JEFFY45_STR, "18hr", 1140]
    x_df.loc[43] = [JEFFY45_STR, "19hr", 1200]
    x_df.loc[44] = [JEFFY45_STR, "20hr", 1260]
    x_df.loc[45] = [JEFFY45_STR, "21hr", 1320]
    x_df.loc[46] = [JEFFY45_STR, "22hr", 1380]
    x_df.loc[47] = [JEFFY45_STR, "23hr", 1440]
    return x_df
