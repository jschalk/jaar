...
def test_create_brick_df_Arg_brick_format_00020_bud_acct_membership_v0_0_0():
    ...
    assert array_headers == acct_brickref.get_headers_list()
    assert membership_dataframe.loc[0, gov_idea_str()] == accord_gov_idea
    ...
    assert membership_dataframe.loc[2, gov_idea_str()] == accord_gov_idea
    ...
    assert membership_dataframe.loc[4, gov_idea_str()] == accord_gov_idea
    ...
    assert membership_dataframe.loc[5, gov_idea_str()] == accord_gov_idea
...
def test_save_brick_csv_Arg_brick_format_00019_itemunit_v0_0_0():
    ...
    # csv_example_path = create_path(brick_govs_dir(), acct_filename)
...
def test_save_brick_csv_Arg_brick_format_00021_bud_acctunit_v0_0_0_SaveToCSV(
    ...
    # WHEN
    save_brick_csv(j1_brickname, sue_budunit, brick_govs_dir(), acct_filename)

    # THEN
    assert os_path_exists(csv_example_path)
    sue1_acct_example_csv = """face_name,event_int,gov_idea,owner_name,acct_name,credit_belief,debtit_belief
,,accord56,Sue,Bob,13,29
,,accord56,Sue,Sue,11,23
,,accord56,Sue,Yao,41,37
"""
    brick_file_str = open_file(brick_govs_dir(), acct_filename)
    ...
    # THEN
    assert os_path_exists(csv_example_path)
    sue2_acct_example_csv = """face_name,event_int,gov_idea,owner_name,acct_name,credit_belief,debtit_belief
,,accord56,Sue,Bob,13,29
,,accord56,Sue,Sue,11,23
,,accord56,Sue,Yao,41,37
,,accord56,Sue,Zia,1,1
"""
    assert open_file(brick_govs_dir(), acct_filename) == sue2_acct_example_csv
...
def test_save_brick_csv_Arg_brick_format_00013_itemunit_v0_0_0(brick_env_setup_cleanup):
    ...
    # WHEN
    save_brick_csv(x_brick_name, sue_budunit, brick_govs_dir(), acct_filename)
