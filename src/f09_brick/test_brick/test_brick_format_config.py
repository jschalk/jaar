...
def test_get_sorted_headers_ReturnsObj():
    ...
    # THEN
    assert headers == "acct_name,credit_belief,deal_idea,debtit_belief,owner_name"

    # ESTABLISH / WHEN
    headers = get_sorted_headers(brick_format_00019_itemunit_v0_0_0())
    # THEN
    item_headers_str = "addin,begin,close,deal_idea,denom,gogo_want,idee,morph,numor,owner_name,parent_road,stop_want"
