...
def get_sorted_headers(brick_filename):
    ...
    brick_attributes.remove(face_name_str())
    brick_attributes.remove(event_int_str())
...
def test_get_sorted_headers_ReturnsObj():
    ...
    # THEN
    assert headers == "acct_name,cmty_idea,credit_belief,debtit_belief,owner_name"

    # ESTABLISH / WHEN
    headers = get_sorted_headers(brick_format_00019_itemunit_v0_0_0())
    # THEN
    item_headers_str = "addin,begin,close,cmty_idea,denom,gogo_want,item_idee,morph,numor,owner_name,parent_road,stop_want"
...
def test_get_brickref_obj_HasCorrectAttrs_brick_format_00021_bud_acctunit_v0_0_0():
    ...
    assert headers_list[2] == cmty_idea_str()
...
def test_get_brickref_obj_HasCorrectAttrs_brick_format_00013_itemunit_v0_0_0():
    ...
    assert headers_list[5] == item_idee_str()
