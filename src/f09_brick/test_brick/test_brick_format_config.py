...
def test_get_sorted_headers_ReturnsObj():
    ...
    # THEN
    assert headers == "acct_name,credit_belief,debtit_belief,gov_idea,owner_name"

    # ESTABLISH / WHEN
    headers = get_sorted_headers(brick_format_00019_itemunit_v0_0_0())
    # THEN
    item_headers_str = "addin,begin,close,denom,gogo_want,gov_idea,idee,morph,numor,owner_name,parent_road,stop_want"
...
def test_get_brickref_obj_HasCorrectAttrs_brick_format_00021_bud_acctunit_v0_0_0():
    ...
    assert headers_list[2] == gov_idea_str()
