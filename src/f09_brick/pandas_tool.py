...
def _get_cmty_brick_format_filenames() -> set[str]:
    brick_numbers = set(get_brick_category_ref().get("cmtyunit"))
    brick_numbers.update(set(get_brick_category_ref().get("cmty_cashbook")))
    brick_numbers.update(set(get_brick_category_ref().get("cmty_deal_episode")))
    brick_numbers.update(set(get_brick_category_ref().get("cmty_timeline_hour")))
    brick_numbers.update(set(get_brick_category_ref().get("cmty_timeline_month")))
    brick_numbers.update(set(get_brick_category_ref().get("cmty_timeline_weekday")))
    return {f"{brick_number}.xlsx" for brick_number in brick_numbers}
