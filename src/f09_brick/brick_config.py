...
def get_brick_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "cmty_idea,idee,mass,owner_name,parent_road,pledge": brick_format_00013_itemunit_v0_0_0(),
        "addin,begin,close,cmty_idea,denom,gogo_want,idee,morph,numor,owner_name,parent_road,stop_want": brick_format_00019_itemunit_v0_0_0(),
        ...
        "addin,begin,close,cmty_idea,denom,gogo_want,idee,mass,morph,numor,owner_name,parent_road,pledge,problem_bool,stop_want": brick_format_00028_bud_itemunit_v0_0_0(),
        ...
        "cmty_idea,healer_name,idee,owner_name,parent_road,problem_bool": brick_format_00036_problem_healer_v0_0_0(),
