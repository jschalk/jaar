...
def get_brick_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "acct_name,deal_idea,owner_name,quota,time_int": brick_format_00001_deal_purview_episode_v0_0_0(),
        ...
        "acct_name,deal_idea,group_id,owner_name": brick_format_00012_membership_v0_0_0(),
        "deal_idea,lx,mass,owner_name,parent_road,pledge": brick_format_00013_itemunit_v0_0_0(),
        "addin,begin,close,deal_idea,denom,gogo_want,lx,morph,numor,owner_name,parent_road,stop_want": brick_format_00019_itemunit_v0_0_0(),
        "acct_name,credit_vote,deal_idea,debtit_vote,group_id,owner_name": brick_format_00020_bud_acct_membership_v0_0_0(),
        "acct_name,credit_belief,deal_idea,debtit_belief,owner_name": brick_format_00021_bud_acctunit_v0_0_0(),
        "awardee_id,deal_idea,give_force,owner_name,road,take_force": brick_format_00022_bud_item_awardlink_v0_0_0(),
        "base,deal_idea,fnigh,fopen,owner_name,pick,road": brick_format_00023_bud_item_factunit_v0_0_0(),
        "deal_idea,owner_name,road,team_id": brick_format_00024_bud_item_teamlink_v0_0_0(),
        ...
        "addin,begin,close,deal_idea,denom,gogo_want,lx,mass,morph,numor,owner_name,parent_road,pledge,problem_bool,stop_want": brick_format_00028_bud_itemunit_v0_0_0(),
        ...
        "deal_idea,healer_name,lx,owner_name,parent_road,problem_bool": brick_format_00036_problem_healer_v0_0_0(),
        ...
        "acct_name,deal_idea,inx_group_id,otx_group_id,owner_name": brick_format_00115_group_map1_v0_0_0(),
