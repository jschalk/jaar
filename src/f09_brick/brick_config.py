...
def get_brick_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "inx_bridge,inx_group_label,otx_bridge,otx_group_label,unknown_word": brick_format_00042_map_group_label_v0_0_0(),
        ...
        "acct_name,deal_idea,inx_group_label,otx_group_label,owner_name": brick_format_00115_group_map1_v0_0_0(),
...
def get_brick_sqlite_type() -> dict[str, str]:
    return {
        ...
        "otx_name": "TEXT",
        "inx_name": "TEXT",
        "otx_group_label": "TEXT",
        "inx_group_label": "TEXT",
        "bridge": "TEXT",
        "c400_number": "INTEGER",
