...
def get_brick_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "bank_time_int,credor_respect,deal_idea,debtor_respect,fund_coin,fund_pool,max_tree_traverse,owner_name,penny,respect_bit,tally": brick_format_00029_budunit_v0_0_0(),
