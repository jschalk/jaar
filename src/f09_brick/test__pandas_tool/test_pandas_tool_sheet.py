...
from src.f09_brick.examples.brick_env import brick_env_setup_cleanup, brick_cmtys_dir
...
def test_append_df_to_excel_CreatesSheet(brick_env_setup_cleanup):
    # ESTABLISH
    test_file = create_path(brick_cmtys_dir(), "test.xlsx")
    append_data = {
        "Name": ["Alice", "Bob"],
        "Age": [25, 30],
...
def test_if_nan_return_None_ReturnsObj(brick_env_setup_cleanup):
    ...
    ex1_path = create_path(brick_cmtys_dir(), ex1_file_name)
