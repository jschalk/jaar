...
# from src.pecun.journal_sqlstr import get_atom_hx_table_insert_sqlstr
...
# def test_PecunUnit_get_atom_hx_table_insert_sqlstr_CorrectlyInsertsIntoDatabase(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     music_str = "music"
#     music_pecun = pecununit_shop(music_str, get_test_pecuns_dir())
#     # with music_pecun.get_journal_conn() as journal_conn:
...
#     # with music_pecun.get_journal_conn() as treasury_conn:
