...
def test_get_rope_from_epor_ReturnsObj_Not_default_knot():
    ...
    x_s = "/"
    root_label = "amy23"
    root_coin_rope = f"{x_s}{root_label}{x_s}"
    casa_str = "casa"
    casa_rope = f"{root_coin_rope}{casa_str}{x_s}"
    casa_epor = f"{x_s}{casa_str}{x_s}{root_label}{x_s}"
    bloomers_str = "bloomers"
    bloomers_rope = f"{root_coin_rope}{casa_str}{x_s}{bloomers_str}{x_s}"
    bloomers_epor = f"{x_s}{bloomers_str}{x_s}{casa_str}{x_s}{root_label}{x_s}"
    roses_str = "roses"
    roses_rope = (
        f"{x_s}{root_label}{x_s}{casa_str}{x_s}{bloomers_str}{x_s}{roses_str}{x_s}"
    ...
    assert get_rope_from_epor(root_coin_rope, x_s) == root_coin_rope
...
def test_get_epor_from_rope_ReturnsObj_Not_default_knot():
    ...
    bloomers_epor = f"{x_s}{bloomers_str}{x_s}{casa_str}{x_s}{root_label}{x_s}"
    roses_str = "roses"
    roses_rope = f"{root_coin_rope}{casa_str}{x_s}{bloomers_str}{x_s}{roses_str}{x_s}"
    roses_epor = (
        f"{x_s}{roses_str}{x_s}{bloomers_str}{x_s}{casa_str}{x_s}{root_label}{x_s}"
    )
    ...
    assert get_epor_from_rope(root_coin_rope, x_s) == root_coin_rope
