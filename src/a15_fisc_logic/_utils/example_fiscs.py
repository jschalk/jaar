...
from src.a15_fisc_logic._utils.env_a15 import get_module_temp_dir
...
def get_bob_mop_with_reason_budunit_example() -> BudUnit:
    """owner_name: bob, fisc_tag: accord23"""
...
def get_yao_run_with_reason_budunit_example() -> BudUnit:
    ...
    yao_bud.edit_idea_attr(ski_way, reason_base=weather_way, reason_premise=snow_way)
    yao_bud.edit_idea_attr(run_way, reason_base=weather_way, reason_premise=rain_way)
    return yao_bud
