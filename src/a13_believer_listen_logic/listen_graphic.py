    ...
    if graphics_bool:
        ...
        fig.add_trace(
            plotly_Scatter(
                ...
                y=[9.0, 8.75],
                text=[
                    "beliefity Believer Listening Structures",
                    "The gut believer listens to other's job believers and builds a new believer from itself and others",
                ],
                mode="text",
            )
        )
    ...
    if graphics_bool:
        ...
        fig.add_trace(
            plotly_Scatter(
                x=[2.0],
                y=[13],
                text=["Believer Listening Structures"],
                mode="text",
            )
        )
    ...
    if graphics_bool:
        ...
        fig.add_trace(
            plotly_Scatter(
                ...
                y=[9, 8.5, 8.0],
                text=[
                    "Believer Listening Structures",
                    "Flow of Believers to Keeps",
