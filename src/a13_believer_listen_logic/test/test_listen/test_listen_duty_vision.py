...
def get_example_yao_gut_with_3_healers():
    ...
    iowa_plan.healerunit.set_healer_name(get_yao_iowa_hubunit().believer_name)
    ohio_plan.healerunit.set_healer_name(get_yao_ohio_hubunit().believer_name)
    utah_plan.healerunit.set_healer_name(get_zia_utah_hubunit().believer_name)
