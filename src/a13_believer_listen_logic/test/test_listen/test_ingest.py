...
def test_allocate_irrational_acct_debt_points_CorrectlySetsBelieverAttr():
    yao_str = "Yao"
    zia_str = "Zia"
    ...
    # WHEN
    _allocate_irrational_acct_debt_points(yao_believer, zia_str)

    # THEN
    assert zia_acctunit._irrational_acct_debt_points == zia_acct_debt_points
