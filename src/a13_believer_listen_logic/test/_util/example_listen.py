...
def get_example_zia_speaker() -> BelieverUnit:
    zia_str = "Zia"
    a23_str = "amy23"
    zia_speaker = believerunit_shop(zia_str, a23_str)
...
def get_example_bob_speaker() -> BelieverUnit:
    bob_str = "Bob"
    a23_str = "amy23"
    bob_speaker = believerunit_shop(bob_str, a23_str)
    ...
    yao_str = "Yao"
    bob_speaker.add_partnerunit(yao_str, partner_debt_points=12)
...
def get_example_yao_speaker() -> BelieverUnit:
    yao_str = "Yao"
    zia_str = "Zia"
    bob_str = "Bob"
    a23_str = "amy23"
    yao_speaker = believerunit_shop(yao_str, a23_str)
    yao_speaker.add_partnerunit(yao_str, partner_debt_points=12)
    yao_speaker.add_partnerunit(zia_str, partner_debt_points=36)
    yao_speaker.add_partnerunit(bob_str, partner_debt_points=48)
