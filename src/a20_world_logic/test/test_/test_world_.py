...
def test_WorldUnit_Exists():
    ...
    assert not x_world._coin_mstr_dir
    assert not x_world._coinunits
...
def test_WorldUnit_set_input_dir_SetsDirsAndFiles(env_dir_setup_cleanup):
    ...
    assert not fay_world._coin_mstr_dir
...
def test_WorldUnit_set_world_dirs_SetsDirsAndFiles(env_dir_setup_cleanup):
    ...
    x_coin_mstr_dir = create_path(x_world_dir, "coin_mstr")
    ...
    assert os_path_exists(x_coin_mstr_dir) is False
    ...
    assert os_path_exists(x_coin_mstr_dir)
...
def test_worldunit_shop_ReturnsObj_Scenario0_WithParameters(env_dir_setup_cleanup):
    ...
    assert x_world._coinunits == world2_coinunits
...
def test_init_coinunits_from_dirs_ReturnsObj_Scenario0(env_dir_setup_cleanup):
    # ESTABLISH
    x_dir = worlds_dir()

    # WHEN
    x_coinunits = init_coinunits_from_dirs([])
