...
def test_WorldUnit_sheets_input_to_clarity_with_cursor_Scenario0_br000113PopulatesTables(
    ...
    with sqlite3_connect(":memory:") as db_conn:
        ...
        assert not db_table_exists(cursor, belief_partner_nets_str())
        assert not db_table_exists(cursor, belief_kpi001_partner_nets_str())
        ...
        assert get_row_count(cursor, belief_partner_nets_str()) == 0
        # assert get_row_count(cursor, belief_event_time_agg_str()) == 0
        # assert get_row_count(cursor, belief_ote1_agg_tablename) == 0
        assert get_row_count(cursor, belief_kpi001_partner_nets_str()) == 0
...
def test_WorldUnit_sheets_input_to_clarity_with_cursor_Scenario1_PopulateBudPayRows(
    ...
    with sqlite3_connect(":memory:") as db_conn:
        ...
        assert get_row_count(cursor, belief_partner_nets_str()) == 1
        assert get_row_count(cursor, belief_kpi001_partner_nets_str()) == 1
