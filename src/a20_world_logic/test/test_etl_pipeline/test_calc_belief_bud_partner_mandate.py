...
def test_WorldUnit_calc_belief_bud_partner_mandate_net_ledgers_Scenaro0_BudEmpty(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    ...
    a23_believers_path = create_belief_believers_dir_path(
        fay_world._belief_mstr_dir, a23_str
    )
    assert count_dirs_files(a23_believers_path) == 0

    # WHEN
    fay_world.calc_belief_bud_partner_mandate_net_ledgers()

    # THEN
    assert count_dirs_files(a23_believers_path) == 0


def test_WorldUnit_calc_belief_bud_partner_mandate_net_ledgers_Scenaro1_SimpleBud(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    fay_world = worldunit_shop("Fay", worlds_dir())
...
def test_WorldUnit_calc_belief_bud_partner_mandate_net_ledgers_Scenaro2_BudExists(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    fay_world = worldunit_shop("Fay", worlds_dir())
