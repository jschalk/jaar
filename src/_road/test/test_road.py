...
def test_road_road_validate_correctlyReturnsRoadUnit():
    ...
    _pecun_id = "x"
    casa_road = f"{_pecun_id}{x_s}casa"
    clean_road = f"{_pecun_id}{x_s}clean"
    fun_road = f"{_pecun_id}{x_s}fun"
    assert road_validate(None, x_s, _pecun_id) == ""
    assert road_validate("", x_s, _pecun_id) == ""
    assert road_validate(f"{_pecun_id}{x_s}casa", x_s, _pecun_id) == casa_road
    assert road_validate(f"A{x_s}casa", x_s, _pecun_id) == casa_road
    assert road_validate(f"{x_s}clean", x_s, _pecun_id) == clean_road
    assert road_validate(f"clean{x_s}fun", x_s, _pecun_id) == fun_road
    assert road_validate("clean", x_s, _pecun_id) == _pecun_id
    assert road_validate(f"AA{x_s}casa", x_s, _pecun_id) == casa_road
...
def test_road_get_default_pecun_id_roadnode_ReturnsCorrectObj():
