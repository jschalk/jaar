...
def add_newtimeline_itemunit(x_budunit: BudUnit, timeline_config: dict):
    x_item_idee = timeline_config.get(timeline_idea_str())
    ...
    new_road = x_budunit.make_road(time_road, x_item_idee)
    ...
    add_stan_itemunits(x_budunit, time_road, x_item_idee, x_c400_count)
