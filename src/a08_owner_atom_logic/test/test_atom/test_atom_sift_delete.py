...
def test_sift_atom_ReturnsObj_OwnerAtom_DELETE_owner_acctunit():
    # ESTABLISH
    bob_str = "Bob"
    zia_str = "Zia"
    ...
    assert new_zia_owneratom == zia_atom
    assert not new_bob_owneratom


def test_sift_atom_ReturnsObj_OwnerAtom_DELETE_owner_acct_membership():
    # ESTABLISH
    bob_str = "Bob"
    yao_str = "Yao"
    run_str = ";run"
    ...
    # THEN
    assert new_yao_run_owneratom
    assert new_yao_run_owneratom == yao_run_atom
