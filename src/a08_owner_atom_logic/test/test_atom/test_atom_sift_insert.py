...
def test_sift_atom_ReturnsObj_OwnerAtom_INSERT_owner_planunit():
    # ESTABLISH
    sue_owner = ownerunit_shop("Sue")
    ...
    root_atom = owneratom_shop(owner_planunit_str(), INSERT_str())
    root_atom.set_arg(plan_rope_str(), root_rope)
    casa_atom = owneratom_shop(owner_planunit_str(), INSERT_str())
    casa_atom.set_arg(plan_rope_str(), casa_rope)
    clean_atom = owneratom_shop(owner_planunit_str(), INSERT_str())
    clean_atom.set_arg(plan_rope_str(), clean_rope)
    sweep_atom = owneratom_shop(owner_planunit_str(), INSERT_str())
...
def test_sift_atom_ReturnsObj_OwnerAtom_INSERT_owner_plan_awardlink():
    # ESTABLISH
    sue_owner = ownerunit_shop("Sue")
    casa_str = "casa"
    casa_rope = sue_owner.make_l1_rope(casa_str)
    ...
    casa_swim_atom = owneratom_shop(owner_plan_awardlink_str(), INSERT_str())
    casa_swim_atom.set_arg(plan_rope_str(), casa_rope)
    casa_swim_atom.set_arg(awardee_title_str(), swim_str)
    clean_swim_atom = owneratom_shop(owner_plan_awardlink_str(), INSERT_str())
...
def test_sift_atom_ReturnsObj_OwnerAtom_INSERT_owner_plan_reasonunit():
    # ESTABLISH
    sue_owner = ownerunit_shop("Sue")
    casa_str = "casa"
    casa_rope = sue_owner.make_l1_rope(casa_str)
    ...
    casa_week_atom = owneratom_shop(owner_plan_reasonunit_str(), INSERT_str())
    casa_week_atom.set_arg(plan_rope_str(), casa_rope)
    casa_week_atom.set_arg(rcontext_str(), week_rope)
    clean_week_atom = owneratom_shop(owner_plan_reasonunit_str(), INSERT_str())
...
def test_sift_atom_ReturnsObj_OwnerAtom_INSERT_owner_plan_reason_premiseunit_exists():
    # ESTABLISH
    sue_owner = ownerunit_shop("Sue")
    casa_str = "casa"
    casa_rope = sue_owner.make_l1_rope(casa_str)
    ...
    casa_week_atom = owneratom_shop(owner_plan_reason_premiseunit_str(), INSERT_str())
    casa_week_atom.set_arg(plan_rope_str(), casa_rope)
    casa_week_atom.set_arg(rcontext_str(), week_rope)
    casa_week_atom.set_arg("pstate", thur_rope)
    clean_week_atom = owneratom_shop(owner_plan_reason_premiseunit_str(), INSERT_str())
    clean_week_atom.set_arg(plan_rope_str(), clean_rope)
    clean_week_atom.set_arg(rcontext_str(), week_rope)
...
def test_sift_atom_ReturnsObj_OwnerAtom_INSERT_owner_plan_laborlink():
    # ESTABLISH
    sue_owner = ownerunit_shop("Sue")
    casa_str = "casa"
    casa_rope = sue_owner.make_l1_rope(casa_str)
    ...
    casa_swim_atom = owneratom_shop(owner_plan_laborlink_str(), INSERT_str())
    casa_swim_atom.set_arg(plan_rope_str(), casa_rope)
    casa_swim_atom.set_arg(labor_title_str(), swim_str)
    clean_swim_atom = owneratom_shop(owner_plan_laborlink_str(), INSERT_str())
    clean_swim_atom.set_arg(plan_rope_str(), clean_rope)
...
def test_sift_atom_ReturnsObj_OwnerAtom_INSERT_owner_plan_healerlink():
    # ESTABLISH
    sue_owner = ownerunit_shop("Sue")
    casa_str = "casa"
    casa_rope = sue_owner.make_l1_rope(casa_str)
    ...
    casa_swim_atom = owneratom_shop(owner_plan_healerlink_str(), INSERT_str())
    casa_swim_atom.set_arg(plan_rope_str(), casa_rope)
    casa_swim_atom.set_arg(healer_name_str(), swim_str)
    clean_swim_atom = owneratom_shop(owner_plan_healerlink_str(), INSERT_str())
    clean_swim_atom.set_arg(plan_rope_str(), clean_rope)
...
def test_sift_atom_ReturnsObj_OwnerAtom_INSERT_owner_plan_factunit():
    # ESTABLISH
    sue_owner = ownerunit_shop("Sue")
    casa_str = "casa"
    casa_rope = sue_owner.make_l1_rope(casa_str)
    ...
    casa_week_atom = owneratom_shop(owner_plan_factunit_str(), INSERT_str())
    casa_week_atom.set_arg(plan_rope_str(), casa_rope)
    casa_week_atom.set_arg(fcontext_str(), week_rope)
    clean_week_atom = owneratom_shop(owner_plan_factunit_str(), INSERT_str())
    clean_week_atom.set_arg(plan_rope_str(), clean_rope)
