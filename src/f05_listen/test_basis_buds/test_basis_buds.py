...
def test_create_empty_bud_ReturnsCorrectObj():
    ...
    assert yao_empty_job.gov_idea == yao_voice.gov_idea
...
def test_create_listen_basis_ReturnsCorrectObj():
    ...
    assert yao_basis_job.gov_idea == yao_duty.gov_idea
...
def test_get_default_final_bud_ReturnsCorrectObj():
    ...
    assert default_final_bud.gov_idea == sue_budunit.gov_idea
    assert default_final_bud.gov_idea == blue_str
