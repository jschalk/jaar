...
def test_create_empty_bud_ReturnsCorrectObj():
    ...
    assert yao_empty_job.cmty_idea == yao_voice.cmty_idea
...
def test_create_listen_basis_ReturnsCorrectObj():
    ...
    assert yao_basis_job.cmty_idea == yao_duty.cmty_idea
...
def test_get_default_final_bud_ReturnsCorrectObj():
    ...
    assert default_final_bud.cmty_idea == sue_budunit.cmty_idea
    assert default_final_bud.cmty_idea == blue_str
