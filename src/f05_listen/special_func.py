...
def add_voice_pledge(
    ...
    next_favorunit = x_hubunit._default_favorunit()
    next_favorunit._buddelta.add_all_different_budatoms(old_voice_bud, voice_bud)
    next_favorunit.save_files()
    x_hubunit.append_favors_to_voice_file()
