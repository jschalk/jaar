...
def test_create_cell_credit_ledger_path_HasDocString():
    # ESTABLISH
    doc_str = create_cell_credit_ledger_path(
        fisc_mstr_dir="fisc_mstr_dir",
        fisc_title=fisc_title_str(),
        owner_name=owner_name_str(),
        time_int=time_int_str(),
    ...
    print(f"{doc_str=}")
    # WHEN / THEN
    assert LINUX_OS or inspect_getdoc(create_cell_credit_ledger_path) == doc_str
...
def test_create_cell_budadjust_path_HasDocString():
    # ESTABLISH
    doc_str = create_cell_budadjust_path(
        fisc_mstr_dir="fisc_mstr_dir",
        fisc_title=fisc_title_str(),
        owner_name=owner_name_str(),
        time_int=time_int_str(),
    ...
    print(f"{doc_str=}")
    # WHEN / THEN
    assert LINUX_OS or inspect_getdoc(create_cell_budadjust_path) == doc_str
...
def test_create_cell_boss_facts_path_HasDocString():
    # ESTABLISH
    doc_str = create_cell_boss_facts_path(
        fisc_mstr_dir="fisc_mstr_dir",
        fisc_title=fisc_title_str(),
        owner_name=owner_name_str(),
        time_int=time_int_str(),
    ...
    print(f"{doc_str=}")
    # WHEN / THEN
    assert LINUX_OS or inspect_getdoc(create_cell_boss_facts_path) == doc_str


def test_create_cell_adjust_ledger_path_HasDocString():
    # ESTABLISH
    doc_str = create_cell_adjust_ledger_path(
        fisc_mstr_dir="fisc_mstr_dir",
        fisc_title=fisc_title_str(),
        owner_name=owner_name_str(),
        time_int=time_int_str(),
    ...
    print(f"{doc_str=}")
    # WHEN / THEN
    assert LINUX_OS or inspect_getdoc(create_cell_adjust_ledger_path) == doc_str
