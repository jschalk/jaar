...
def test_HubUnit_default_voice_bud_ReturnsObj():
    ...
    assert sue_default_voice.last_gift_id == init_gift_id()
...
def test_HubUnit_create_initial_gift_files_from_default_CorrectlySavesGiftUnitFiles(
    ...
    init_gift_file_path = create_path(sue_hubunit._gifts_dir, init_gift_filename)
...
def test_HubUnit_create_initial_gift_files_from_voice_SavesOnlyGiftFiles(
    ...
    assert sue_hubunit.voice_file_exists()
    init_gift_file_path = create_path(sue_hubunit._gifts_dir, f"{init_gift_id()}.json")
    assert os_path_exists(init_gift_file_path) is False
