from src.f01_road.jaar_config import get_test_deal_id as deal_id
...
def test_HubUnit_rj_perspective_bud_ReturnsBudWith_owner_idSetToHubUnit_owner_id(
    ...
    nation_road = create_road(deal_id(), nation_str)
    ...
    sue_str = "Sue"
    sue_hubunit = hubunit_shop(env_dir(), deal_id(), sue_str, iowa_road)
