...
def test_HubUnit_get_bud_from_atom_files_ReturnsCorrectFile_SimpleItem(
    ...
    # save atom files
    sports_atom = get_atom_example_itemunit_sports(yao_hubunit.deal_id)
...
def test_HubUnit_get_bud_from_atom_files_ReturnsCorrectFile_WithFactUnit(
    ...
    # save atom files
    x_deal_id = yao_hubunit.deal_id
    yao_hubunit.save_atom_file(get_atom_example_itemunit_sports(x_deal_id))
    yao_hubunit.save_atom_file(get_atom_example_itemunit_ball(x_deal_id))
    yao_hubunit.save_atom_file(get_atom_example_itemunit_knee(x_deal_id))
    yao_hubunit.save_atom_file(get_atom_example_factunit_knee(x_deal_id))
