...
def test_add_voice_pledge_Addspledgefavor(env_dir_setup_cleanup):
    # ESTABLISH
    sue_str = "Sue"
    ...
    one_int = 1
    print(f"{sue_hubunit.favor_file_path(one_int)=}")
    assert sue_hubunit.favor_file_exists(one_int) is False
    old_sue_voice = sue_hubunit.get_voice_bud()
    ...
    # THEN
    assert sue_hubunit.favor_file_exists(one_int)
