...
def test_get_translate_args_class_types_ReturnsObj():
    ...
    assert translate_args_class_types.get("voice_cred_lumen") == "float"
    assert translate_args_class_types.get("group_cred_lumen") == "float"
    ...
    assert translate_args_class_types.get("voice_debt_lumen") == "float"
    assert translate_args_class_types.get("group_debt_lumen") == "float"
