...
from src.f04_favor.favor import FavorUnit
...
def add_favor_to_br00020_csv(
    x_csv: str, x_favorunit: FavorUnit, csv_delimiter: str
) -> str:
    for budatom in x_favorunit._buddelta.get_ordered_budatoms().values():
        if budatom.dimen == "bud_acct_membership":
            x_row = [
                x_favorunit.face_name,
                str(x_favorunit.event_int),
                x_favorunit.fisc_title,
                x_favorunit.owner_name,
...
def add_favor_to_br00029_csv(
    x_csv: str, x_favorunit: FavorUnit, csv_delimiter: str
) -> str:
    for budatom in x_favorunit._buddelta.get_ordered_budatoms().values():
        if budatom.dimen == "budunit":
            print(f"{budatom=} {x_favorunit.owner_name=}")
            x_row = [
                x_favorunit.face_name,
                str(x_favorunit.event_int),
                x_favorunit.fisc_title,
...
def add_favorunit_to_stance_csv_strs(
    x_favor: FavorUnit, fisc_csv_strs: dict[str, str], csv_delimiter: str
):
    br00020_csv = fisc_csv_strs.get("br00020")
    br00021_csv = fisc_csv_strs.get("br00021")
    br00022_csv = fisc_csv_strs.get("br00022")
    ...
    br00028_csv = fisc_csv_strs.get("br00028")
    br00029_csv = fisc_csv_strs.get("br00029")
    br00020_csv = add_favor_to_br00020_csv(br00020_csv, x_favor, csv_delimiter)
    br00021_csv = add_favor_to_br00021_csv(br00021_csv, x_favor, csv_delimiter)
    br00022_csv = add_favor_to_br00022_csv(br00022_csv, x_favor, csv_delimiter)
    br00023_csv = add_favor_to_br00023_csv(br00023_csv, x_favor, csv_delimiter)
    br00024_csv = add_favor_to_br00024_csv(br00024_csv, x_favor, csv_delimiter)
    br00025_csv = add_favor_to_br00025_csv(br00025_csv, x_favor, csv_delimiter)
    br00026_csv = add_favor_to_br00026_csv(br00026_csv, x_favor, csv_delimiter)
    br00027_csv = add_favor_to_br00027_csv(br00027_csv, x_favor, csv_delimiter)
    br00028_csv = add_favor_to_br00028_csv(br00028_csv, x_favor, csv_delimiter)
    br00029_csv = add_favor_to_br00029_csv(br00029_csv, x_favor, csv_delimiter)
    fisc_csv_strs["br00020"] = br00020_csv
    fisc_csv_strs["br00021"] = br00021_csv
    fisc_csv_strs["br00022"] = br00022_csv
    fisc_csv_strs["br00023"] = br00023_csv
