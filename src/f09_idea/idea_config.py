...
def get_idea_sqlite_types() -> dict[str, str]:
    return {
        ...
        "fiscal_title": "TEXT",
        "owner_name": "TEXT",
        "owner_name_DELETE": "TEXT",
        "acct_name": "TEXT",
        "acct_name_DELETE": "TEXT",
        "group_label": "TEXT",
        "group_label_DELETE": "TEXT",
        "parent_road": "TEXT",
        "parent_road_DELETE": "TEXT",
        "item_title": "TEXT",
        "item_title_DELETE": "TEXT",
        "road": "TEXT",
        "road_DELETE": "TEXT",
        "base": "TEXT",
        "base_DELETE": "TEXT",
        ...
        "pick": "TEXT",
        "team_tag": "TEXT",
        "team_tag_DELETE": "TEXT",
        "awardee_tag": "TEXT",
        "awardee_tag_DELETE": "TEXT",
        "healer_name": "TEXT",
        "healer_name_DELETE": "TEXT",
        "time_int": "INTEGER",
        "begin": "REAL",
        "close": "REAL",
        "addin": "REAL",
