...
def get_idea_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "awardee_label,cmty_title,give_force,owner_name,road,take_force": idea_format_00022_bud_item_awardlink_v0_0_0(),
        "base,cmty_title,fnigh,fopen,owner_name,pick,road": idea_format_00023_bud_item_factunit_v0_0_0(),
        "cmty_title,owner_name,road,team_label": idea_format_00024_bud_item_teamlink_v0_0_0(),
