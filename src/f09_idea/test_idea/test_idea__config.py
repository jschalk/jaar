...
def test_get_idea_elements_sort_order_ReturnsObj():
    ...
    assert table_sorting_priority[18] == f"{base_str()}_EXCISE"
    assert table_sorting_priority[19] == "need"
    assert table_sorting_priority[20] == get_delete_key_name("need")
    assert table_sorting_priority[21] == "pick"
    assert table_sorting_priority[22] == team_tag_str()
    assert table_sorting_priority[23] == get_delete_key_name(team_tag_str())
    assert table_sorting_priority[24] == awardee_tag_str()
    assert table_sorting_priority[25] == get_delete_key_name(awardee_tag_str())
    assert table_sorting_priority[26] == healer_name_str()
    assert table_sorting_priority[27] == get_delete_key_name(healer_name_str())
    assert table_sorting_priority[28] == time_int_str()
    assert table_sorting_priority[29] == begin_str()
    assert table_sorting_priority[30] == close_str()
    assert table_sorting_priority[31] == addin_str()
    assert table_sorting_priority[32] == numor_str()
    assert table_sorting_priority[33] == denom_str()
    assert table_sorting_priority[34] == morph_str()
    assert table_sorting_priority[35] == gogo_want_str()
    assert table_sorting_priority[36] == stop_want_str()
    assert table_sorting_priority[37] == base_item_active_requisite_str()
    assert table_sorting_priority[38] == credit_belief_str()
    assert table_sorting_priority[39] == debtit_belief_str()
    assert table_sorting_priority[40] == credit_vote_str()
    assert table_sorting_priority[41] == debtit_vote_str()
    assert table_sorting_priority[42] == credor_respect_str()
    assert table_sorting_priority[43] == debtor_respect_str()
    assert table_sorting_priority[44] == fopen_str()
    assert table_sorting_priority[45] == fnigh_str()
    assert table_sorting_priority[46] == "fund_pool"
    assert table_sorting_priority[47] == give_force_str()
    assert table_sorting_priority[48] == mass_str()
    assert table_sorting_priority[49] == "max_tree_traverse"
    assert table_sorting_priority[50] == "nigh"
    assert table_sorting_priority[51] == "open"
    ...
    assert table_sorting_priority[83] == dealdepth_str()
...
def test_get_idea_sqlite_types_ReturnsObj():
    ...
    assert sqlite_types.get(dealdepth_str()) == "INT"
