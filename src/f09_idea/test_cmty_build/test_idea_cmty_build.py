...
from src.f09_idea.examples.idea_env import idea_cmtys_dir, idea_env_setup_cleanup
...
from src.f09_idea.idea import cmty_build_from_df


# given a dataframe, build a cmty unit
def test_cmty_build_from_df_ReturnsObj_Scenario0_OneCmtyTitle(idea_env_setup_cleanup):
    # ESTABLISH
    ...
    x_respect_bit = 66
    x_penny = 77
    x_cmtys_dir = f"{idea_cmtys_dir()}/fizz"
