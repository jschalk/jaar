...
from src._road.jaar_config import get_test_tribe_id
...
def test_Translator_Exists():
    ...
    # THEN
    assert x_translator.in_tribe_id is None
...
def test_translator_shop_WithOutParametersReturnsObj():
    ...
    # THEN
    assert music_translator.in_tribe_id == get_test_tribe_id()
...
def test_translator_shop_WithParametersReturnsObj():
    ...
    assert music_translator.in_tribe_id == music_str
    assert music_translator.in_acct_ids == {}
