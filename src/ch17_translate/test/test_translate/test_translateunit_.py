...
from ch15_moment.moment_config import get_moment_args_obj_types
...
from ch17_translate.translate_main import TranslateUnit, translateunit_shop
...
def test_get_translate_args_obj_types_ReturnsObj():
    ...
    assert translate_args_obj_types.get(kw.contact_cred_mass) == "float"
    assert translate_args_obj_types.get(kw.group_cred_mass) == "float"
    ...
    assert translate_args_obj_types.get(kw.contact_debt_mass) == "float"
    assert translate_args_obj_types.get(kw.group_debt_mass) == "float"
