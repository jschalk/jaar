...
def test_get_deal_config_dict_ReturnsObj():
    ...
    assert deal_banklog_str() not in deal_config_categorys
    assert deal_bank_episode_str() in deal_config_categorys
    ...
    deal_bank_episode_dict = deal_config.get(deal_bank_episode_str())
    ...
    assert len(deal_bank_episode_dict.get(jkeys_str())) == 3
    ...
    assert len(deal_bank_episode_dict.get(jvalues_str())) == 1
