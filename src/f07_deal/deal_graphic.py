...
def get_deal_graphic_base_fig() -> plotly_Figure:
    fig = plotly_Figure()
...
def get_deal_structures0_fig(graphics_bool: bool = False) -> plotly_Figure:
    fig = get_deal_graphic_base_fig()
    rx0 = 0
    rx1 = 10
    ry0 = 0
    ry1 = 10
    ...
    sue1_p3 = ""
    sue1_p4 = ""
    add_deal__rect(fig, rx0, ry0, rx1, ry1, sue1_p1, sue1_p2, sue1_p3, sue1_p4)
