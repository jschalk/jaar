...
# def deal_pactlog_str()-> str: return "deal_pactlog"
# def deal_pact_episode_str()-> str: return "deal_pact_episode"
...
def deal_pactlog_str() -> str:
    return "deal_pactlog"


def deal_pact_episode_str() -> str:
    return "deal_pact_episode"
