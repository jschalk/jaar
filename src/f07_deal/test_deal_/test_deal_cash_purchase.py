...
def test_DealUnit_set_cashpurchase_RaisesErrorWhenBankEpisodeHas_time_int():
    # ESTABLISH
    ...
    x_deal.add_bankepisode("yao", t55_t, t55_money_magnitude)
    t55_amount = 37
    t6606_current_time = 6606
...
def test_DealUnit_set_all_tranbook_SetsAttr():
    ...
    x_deal.add_bankepisode(sue_str, x40000_time_int, 1)
    x_deal.add_bankepisode(sue_str, x70000_time_int, 1)
    bob_str = "Bob"
    zia_str = "Zia"
    zia_net_bank = 887
    bob_net_bank = 445
    sue_x40000_episode = x_deal.get_banklog(sue_str).get_episode(x40000_time_int)
    sue_x70000_episode = x_deal.get_banklog(sue_str).get_episode(x70000_time_int)
    sue_x40000_episode.set_net_bank(bob_str, bob_net_bank)
    sue_x70000_episode.set_net_bank(zia_str, zia_net_bank)
    ...
    assert sue_x40000_episode.net_bank_exists(bob_str)
    assert sue_x70000_episode.net_bank_exists(zia_str)
    # x_deal.add_bankepisode()
