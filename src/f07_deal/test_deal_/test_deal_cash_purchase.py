...
def test_DealUnit_set_cashpurchase_RaisesErrorWhenPactEpisodeHas_time_int():
    # ESTABLISH
    ...
    x_deal.add_pactepisode("yao", t55_t, t55_money_magnitude)
    t55_amount = 37
    t6606_current_time = 6606
...
def test_DealUnit_set_all_tranbook_SetsAttr():
    ...
    x_deal.add_pactepisode(sue_str, x40000_time_int, 1)
    x_deal.add_pactepisode(sue_str, x70000_time_int, 1)
    bob_str = "Bob"
    zia_str = "Zia"
    zia_net_pact = 887
    bob_net_pact = 445
    sue_x40000_episode = x_deal.get_pactlog(sue_str).get_episode(x40000_time_int)
    sue_x70000_episode = x_deal.get_pactlog(sue_str).get_episode(x70000_time_int)
