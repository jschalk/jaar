...
def test_listen_to_agendas_jobs_into_job_Addscase_tasksToPersonWhenNo_laborunitIsSet(
    ...
    zia_job.add_contactunit(exx.yao, contact_debt_mass=12)
...
def test_listen_to_agendas_jobs_into_job_Addscase_tasksToPersonWithDetailsDecidedBy_contact_debt_mass(
    temp3_fs,
):
    # ESTABLISH
    moment_mstr_dir = str(temp3_fs)
...
def test_listen_to_agendas_jobs_into_job_ListensToPerson_gut_AndNotPerson_job(
    ...
    yao_gut.add_contactunit(exx.yao, yao_contact_cred_mass, yao_contact_debt_mass)
    zia_contact_cred_mass = 47
    zia_contact_debt_mass = 41
    yao_gut.add_contactunit(exx.zia, zia_contact_cred_mass, zia_contact_debt_mass)
    yao_pool = 87
