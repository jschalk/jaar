...
def ch11_example_moment_rope() -> str:
    return ";Buzz;"
...
def get_example_zia_speaker() -> PersonUnit:
    ...
    zia_speaker.add_contactunit(exx.yao, contact_debt_mass=12)
...
def get_example_bob_speaker() -> PersonUnit:
    ...
    bob_speaker.add_contactunit(exx.yao, contact_debt_mass=12)
...
def get_example_yao_speaker() -> PersonUnit:
    ...
    yao_speaker.add_contactunit(exx.yao, contact_debt_mass=12)
    yao_speaker.add_contactunit(exx.zia, contact_debt_mass=36)
    yao_speaker.add_contactunit(exx.bob, contact_debt_mass=48)
...
def get_fund_breakdown_person() -> PersonUnit:
    ...
    sue_person.set_l1_plan(planunit_shop(exx.casa, poynt=30))
    sue_person.set_plan_obj(planunit_shop(cat_str, poynt=30), casa_rope)
    sue_person.set_plan_obj(planunit_shop(hun_n_str, poynt=30), cat_rope)
    sue_person.set_plan_obj(planunit_shop(hun_y_str, poynt=30), cat_rope)
    sue_person.set_plan_obj(planunit_shop(clean_str, poynt=30), casa_rope)
    sue_person.set_plan_obj(planunit_shop(exx.sweep, poynt=30, pledge=True), clean_rope)
    sue_person.set_plan_obj(planunit_shop(dish_str, poynt=30, pledge=True), clean_rope)
