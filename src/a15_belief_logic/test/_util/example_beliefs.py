...
def create_example_belief2() -> BeliefUnit:
    ...
    yao_gut_believer.add_personunit(yao_str, 34, 600)
    yao_gut_believer.add_personunit(zia_str, 57, 300)
    yao_gut_believer.add_personunit(wei_str, 10, 100)
    wei_gut_believer.add_personunit(yao_str, 37, 100)
    wei_gut_believer.add_personunit(wei_str, 11, 400)
    wei_gut_believer.add_personunit(zia_str, 27, 250)
    zia_gut_believer.add_personunit(yao_str, 14, 100)
    zia_gut_believer.add_personunit(zia_str, 38, 400)
    texas_str = "Texas"
...
def get_bob_mop_fact_clean_believerunit_example() -> BelieverUnit:
    ...
    bob_believer.add_personunit("Bob")
