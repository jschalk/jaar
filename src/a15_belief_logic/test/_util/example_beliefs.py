...
def create_example_belief2() -> BeliefUnit:
    ...
    yao_gut_believer.add_acctunit(yao_str, 34, 600)
    yao_gut_believer.add_acctunit(zia_str, 57, 300)
    yao_gut_believer.add_acctunit(wei_str, 10, 100)
    wei_gut_believer.add_acctunit(yao_str, 37, 100)
    wei_gut_believer.add_acctunit(wei_str, 11, 400)
    wei_gut_believer.add_acctunit(zia_str, 27, 250)
    zia_gut_believer.add_acctunit(yao_str, 14, 100)
    zia_gut_believer.add_acctunit(zia_str, 38, 400)
    texas_str = "Texas"
