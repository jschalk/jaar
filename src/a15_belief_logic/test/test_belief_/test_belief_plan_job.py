...
def test_BeliefUnit_rotate_job_ReturnsObj_Scenario1(env_dir_setup_cleanup):
    ...
    assert sue_job.belief_label == example_plan.belief_label
    assert sue_job.owner_name == example_plan.owner_name


def test_BeliefUnit_rotate_job_ReturnsObj_Scenario2_EmptyAcctsCause_inallocable_acct_debt_points(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    belief_mstr_dir = get_module_temp_dir()
...
# def test_BeliefUnit_rotate_job_ReturnsObj_Scenario3_Without_healerlink(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     a23_str = "accord23"
...
#     a23_belief = beliefunit_shop(a23_str, belief_mstr_dir)
#     bob_str = "Bob"
#     a23_belief.create_init_job_from_guts(bob_str)
#     before_bob_job = a23_belief.rotate_job(bob_str)
#     sue_str = "Sue"
#     assert before_bob_job.acct_exists(sue_str) is False

#     # WHEN
#     bob_gut_plan = open_gut_file(belief_mstr_dir, a23_str, bob_str)
#     bob_gut_plan.add_acctunit(sue_str)
#     save_gut_file(a23_belief.belief_mstr_dir, bob_gut_plan)

#     # WHEN
#     after_bob_job = a23_belief.rotate_job(bob_str)

#     # THEN
#     assert after_bob_job.acct_exists(sue_str)


# def test_BeliefUnit_rotate_job_ReturnsObj_Scenario4_With_healerlink(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     a23_str = "accord23"
...
# def test_BeliefUnit_rotate_job_ReturnsObj_Scenario0_Empty_gut(env_dir_setup_cleanup):
#     # ESTABLISH
#     a23_str = "accord23"
#     belief_mstr_dir = get_module_temp_dir()
#     a23_belief = beliefunit_shop(a23_str, belief_mstr_dir)
#     sue_str = "Sue"
#     a23_belief.set_gut_if_none(sue_str)
#     sue_gut = open_gut_file(belief_mstr_dir, a23_str, sue_str)
#     assert len(sue_gut.get_acctunits_dict()) == 0

#     # WHEN / THEN
#     assert not a23_belief.rotate_job(sue_str)


# def test_BeliefUnit_rotate_job_ReturnsObj_Scenario1_gut_accts_Equal_job_accts(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     belief_mstr_dir = get_module_temp_dir()
...
# def test_BeliefUnit_rotate_job_ReturnsObj_Scenario1_gut_with_Agenda(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     belief_mstr_dir = get_module_temp_dir()
...
#     save_gut_file(belief_mstr_dir, sue_plan)
#     sue_gut = open_gut_file(belief_mstr_dir, a23_str, sue_str)
#     assert len(sue_gut.get_acctunits_dict()) == 0
...
#     assert sue_job.belief_label == expected_job.belief_label
#     assert sue_job.owner_name == expected_job.owner_name
#     assert sue_job.get_agenda_dict() == expected_job.get_agenda_dict()
#     assert sue_job.get_dict() == expected_job.get_dict()


# def test_BeliefUnit_rotate_job_ReturnsObj_Scenario2_gut_with_FactUnit(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     belief_mstr_dir = get_module_temp_dir()
...
def test_BeliefUnit_generate_all_jobs_Scenario0_init_job_IsCreated(
    ...
    sue_dir = create_owner_dir_path(belief_mstr_dir, a23_str, sue_str)
    set_dir(sue_dir)
...
# def test_BeliefUnit_generate_all_jobs_Scenario2_job_limit_rotation_Changes_job(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     a23_str = "accord23"
...
#         a23_str, belief_mstr_dir, job_listen_rotations=x_job_listen_rotations
#     )
...
#     sue_str = "Sue"
#     a23_belief.create_init_job_from_guts(bob_str)
#     belief_mstr_dir = a23_belief.belief_mstr_dir
#     a23_belief.create_init_job_from_guts(sue_str)
#     bob_gut_plan = a23_belief.rotate_job(bob_str)
#     sue_gut_plan = a23_belief.rotate_job(sue_str)
...
#     sue_gut_plan = open_gut_file(belief_mstr_dir, a23_str, sue_str)
...
#     save_gut_file(a23_belief.belief_mstr_dir, sue_gut_plan)

#     before_bob_job = a23_belief.get_job_file_plan(bob_str)
#     before_sue_job = a23_belief.get_job_file_plan(sue_str)
#     assert a23_belief.job_listen_rotations == 9
...
#     # THEN
#     after_bob_job = a23_belief.get_job_file_plan(bob_str)
#     after_sue_job = a23_belief.get_job_file_plan(sue_str)
#     assert after_bob_job.acct_exists(bob_str)
