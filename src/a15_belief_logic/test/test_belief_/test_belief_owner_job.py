...
def test_BeliefUnit_rotate_job_ReturnsObj_Scenario1(env_dir_setup_cleanup):
    ...
    # THEN
    example_owner = ownerunit_shop(sue_str, a23_str)
    assert sue_job.belief_label == example_owner.belief_label
    assert sue_job.owner_name == example_owner.owner_name
...
def test_BeliefUnit_rotate_job_ReturnsObj_Scenario2_EmptyAcctsCause_inallocable_acct_debt_points(
    ...
    bob_str = "Bob"
    zia_str = "Zia"
    init_sue_job = ownerunit_shop(sue_str, a23_str)
    ...
    # THEN method should wipe over job owner
...
def a23_job(owner_name: str) -> OwnerUnit:
    belief_mstr_dir = get_module_temp_dir()
...
def test_BeliefUnit_rotate_job_ReturnsObj_Scenario3_job_ChangesFromRotation(
    ...
    init_sue_job = ownerunit_shop(sue_str, a23_str)
    init_sue_job.add_acctunit(yao_str)
    init_yao_job = ownerunit_shop(yao_str, a23_str)
    init_yao_job.add_acctunit(bob_str)
    init_bob_job = ownerunit_shop(bob_str, a23_str)
...
def test_BeliefUnit_generate_all_jobs_Scenario1_jobs_rotated(
    ...
    yao_gut = ownerunit_shop(yao_str, a23_str)
...
def test_BeliefUnit_generate_all_jobs_Scenario2_jobs_rotated_InSortedOrder(
    ...
    zia_gut = ownerunit_shop(zia_str, a23_str)
