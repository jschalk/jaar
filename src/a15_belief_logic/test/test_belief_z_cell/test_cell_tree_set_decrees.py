...
from src.a15_belief_logic.test._util.example_beliefs import (
    ...
    get_bob_mop_without_reason_ownerunit_example,
)
...
# create a world with, cell.json, found facts and owner events
# for every found_fact change ownerevent to that fact
...
def test_set_cell_trees_decrees_SetsRootAttr_Scenario1_Depth0AndOne_ownerevent_fact(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    mstr_dir = get_module_temp_dir()
...
def test_set_cell_trees_decrees_SetsChildCells_Scenario3_Depth1AndZero_boss_facts(
    ...
    bob_sue_cell = cellunit_shop(
        ...
        event_int=e7,
        celldepth=0,
        owneradjust=bob_sue_owneradjust,
    )
...
def test_set_cell_trees_decrees_SetsChildCells_Scenario7_NoCell_GetOwnerEvent(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    mstr_dir = get_module_temp_dir()
