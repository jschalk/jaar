...
# def test_set_cell_tree_cell_mandates_SetsRootAttr_Scenario1_Depth0AndOne_planevent_fact(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     mstr_dir = get_module_temp_dir()
...
# def test_set_cell_tree_cell_mandates_SetsChildCells_Scenario7_NoCell_GetPlanEvent(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     mstr_dir = get_module_temp_dir()
