...
from src.a15_belief_logic.belief_cell import load_cells_believerevent
...
def test_load_cells_believerevent_SetsFiles_Scenario0_NoFacts(
    ...
    event300 = 300
    time5 = 5
    save_arbitrary_believerevent(belief_mstr_dir, a23_str, bob_str, event300)
...
def test_load_cells_believerevent_SetsFiles_Scenario1_WithFacts(
    ...
    # THEN
    expected_believerevent_facts = {clean_fact.fcontext: clean_fact.get_dict()}
    assert (
