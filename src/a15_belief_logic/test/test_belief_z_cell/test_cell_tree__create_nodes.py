...
def test_create_cell_tree_Scenaro2_LedgerDepth1(env_dir_setup_cleanup):
    ...
    bob_e56_path = save_believerevent(
        belief_mstr_dir, a23_str, bob_str, event56, bob_partners
    )
    yao_e56_path = save_believerevent(
        belief_mstr_dir, a23_str, yao_str, event56, yao_partners
    )
    zia_e56_path = save_believerevent(
        belief_mstr_dir, a23_str, zia_str, event56, zia_partners
    )
...
def test_create_cell_tree_Scenaro3_LedgerDepth1_MostRecentEvent(env_dir_setup_cleanup):
    ...
    bob_e55_path = save_believerevent(
        belief_mstr_dir, a23_str, bob_str, event55, bob_partners
    )
    yao_e44_path = save_believerevent(
        belief_mstr_dir, a23_str, yao_str, event44, yao_partners
    )
    yao_e33_path = save_believerevent(
        belief_mstr_dir, a23_str, yao_str, event33, yao_partners
    )
    zia_e33_path = save_believerevent(
        belief_mstr_dir, a23_str, zia_str, event33, zia_partners
    )
...
def test_create_cell_tree_Scenaro4_LedgerDepth1_OneBelieverHasNoPast_believerevent(
    ...
    zia_e66_path = save_believerevent(
        belief_mstr_dir, a23_str, zia_str, event66, zia_partners
    )
    assert os_path_exists(bob_e55_path)
    assert os_path_exists(yao_e44_path)
