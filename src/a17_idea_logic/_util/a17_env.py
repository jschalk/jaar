...
def get_module_temp_dir() -> str:
    return "src/a17_idea_logic/_util"


def idea_examples_dir() -> str:
    return "src/a17_idea_logic/_util/idea_examples"


def idea_vow_mstr_dir() -> str:
    return "src/a17_idea_logic/_util/idea_examples/vow_mstr"


def idea_vows_dir() -> str:
    return "src/a17_idea_logic/_util/idea_examples/vow_mstr/vows"
