...
def setup_database_and_csv() -> tuple[sqlite3_Connection, str, str]:  # type: ignore
    ...
    with open(test_csv_filepath, "w", newline="", encoding="utf-8") as csv_file:
        csv_file.write(
            f"{event_int_str()},{face_name_str()},{coin_label_str()},{believer_name_str()},{partner_name_str()},{group_title_str()},{gogo_want_str()}\n"
        )
...
def test_create_idea_table_from_csv_ChangesDBState(
    ...
    expected_columns = [
        ...
        (2, coin_label_str(), "TEXT", 0, None, 0),
    ...
    get_idea_sqlite_types_columns = [
        ...
        (2, coin_label_str(), column_types.get(coin_label_str()), 0, None, 0),
