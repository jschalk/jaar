...
from src.a17_idea_logic.idea_csv_tool import (
    ...
    add_vowunits_to_stance_csv_strs,
...
def test_create_init_stance_idea_csv_strs_ReturnsObj_Scenario0_EmptyVowUnit(
    ...
    expected_stance_csv_strs = {
        ...
        "br00003": "vow_label,cumulative_minute,hour_label\n",
        "br00004": "vow_label,cumulative_day,month_label\n",
...
def test_add_vowunit_to_stance_csv_strs_ReturnsObj_Scenario0_OneVowUnit(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    ...
    a23_vowunit = x_vowunits.get("accord23")

    # WHEN
    add_vowunit_to_stance_csv_strs(a23_vowunit, x_csvs, csv_delimiter)
...
def test_add_vowunits_to_stance_csv_strs_ReturnsObj_Scenario1_TwoVowUnits(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    br00000_df = get_ex2_br00000_df()
    ...
    # WHEN
    add_vowunits_to_stance_csv_strs(x_vowunits, x_ideas, csv_delimiter)
