...
def test_create_init_stance_idea_csv_strs_ReturnsObj_Scenario0_EmptyCoinUnit(
...
def test_add_coinunit_to_stance_csv_strs_ReturnsObj_Scenario0_OneCoinUnit(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    ...
    a23_coinunit = x_coinunits.get("amy23")

    # WHEN
    add_coinunit_to_stance_csv_strs(a23_coinunit, x_csvs, csv_delimiter)
...
def test_add_coinunits_to_stance_csv_strs_ReturnsObj_Scenario1_TwoCoinUnits(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    br00000_df = get_ex2_br00000_df()
    ...
    # WHEN
    add_coinunits_to_stance_csv_strs(x_coinunits, x_ideas, csv_delimiter)
