...
from src.a17_idea_logic.idea_config import (
    ...
    idea_format_00020_believer_acct_membership_v0_0_0,
    idea_format_00021_believer_acctunit_v0_0_0,
)


def test_make_believerdelta_Arg_idea_format_00021_believer_acctunit_v0_0_0():
    # ESTABLISH
    sue_str = "Sue"
    bob_str = "Bob"
    yao_str = "Yao"
    ...
    sue_believerunit.add_acctunit(sue_str, sue_acct_cred_points, sue_acct_debt_points)
    sue_believerunit.add_acctunit(bob_str, bob_acct_cred_points, bob_acct_debt_points)
    sue_believerunit.add_acctunit(yao_str, yao_acct_cred_points, yao_acct_debt_points)
    x_idea_name = idea_format_00021_believer_acctunit_v0_0_0()
    acct_dataframe = create_idea_df(sue_believerunit, x_idea_name)
    print(f"{acct_dataframe.columns=}")
    acct_csv = acct_dataframe.to_csv(index=False)

    # WHEN
    sue_acct_believerdelta = make_believerdelta(acct_csv)

    # THEN
    assert sue_acct_believerdelta
    sue_believeratom = believeratom_shop(believer_acctunit_str(), INSERT_str())
    sue_believeratom.set_arg(acct_name_str(), sue_str)
    sue_believeratom.set_arg(acct_cred_points_str(), sue_acct_cred_points)
    sue_believeratom.set_arg(acct_debt_points_str(), sue_acct_debt_points)
    sue_believeratom.set_atom_order()
    bob_believeratom = believeratom_shop(believer_acctunit_str(), INSERT_str())
    bob_believeratom.set_arg(acct_name_str(), bob_str)
    bob_believeratom.set_arg(acct_cred_points_str(), bob_acct_cred_points)
    bob_believeratom.set_arg(acct_debt_points_str(), bob_acct_debt_points)
    bob_believeratom.set_atom_order()
    # print(f"{sue_acct_believerdelta.get_ordered_dict()=}")
    # print(
    #     f"{sue_acct_believerdelta.believeratoms.get(INSERT_str()).get(believer_acctunit_str()).get(sue_str)=}"
    # )
    print(f"{sue_believeratom=}")
    assert sue_acct_believerdelta.believeratom_exists(sue_believeratom)
    assert sue_acct_believerdelta.believeratom_exists(bob_believeratom)
    assert len(sue_acct_believerdelta.get_ordered_believeratoms()) == 3


# def test_make_believerdelta_Arg_idea_format_00020_believer_acct_membership_v0_0_0():
#     # ESTABLISH
#     sue_str = "Sue"
#     bob_str = "Bob"
#     yao_str = "Yao"
#     amy_belief_label = "amy56"
#     sue_believerunit = believerunit_shop(sue_str, amy_belief_label)
#     sue_believerunit.add_acctunit(sue_str)
#     sue_believerunit.add_acctunit(bob_str)
...
#     sue_acctunit = sue_believerunit.get_acct(sue_str)
...
#     x_idea_name = idea_format_00020_believer_acct_membership_v0_0_0()
...
#     sue_iowa_believeratom = believeratom_shop(believer_acct_membership_str(), INSERT_str())
#     bob_iowa_believeratom = believeratom_shop(believer_acct_membership_str(), INSERT_str())
#     yao_iowa_believeratom = believeratom_shop(believer_acct_membership_str(), INSERT_str())
#     yao_ohio_believeratom = believeratom_shop(believer_acct_membership_str(), INSERT_str())
...
#     sue_iowa_believeratom.set_arg(acct_name_str(), sue_str)
#     bob_iowa_believeratom.set_arg(acct_name_str(), bob_str)
#     yao_iowa_believeratom.set_arg(acct_name_str(), yao_str)
#     yao_ohio_believeratom.set_arg(acct_name_str(), yao_str)
