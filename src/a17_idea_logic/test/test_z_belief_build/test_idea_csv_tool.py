...
def test_create_init_stance_idea_csv_strs_ReturnsObj_Scenario0_EmptyBeliefUnit(
    ...
    expected_stance_csv_strs = {
        ...
        "br00002": "belief_label,believer_name,acct_name,tran_time,amount\n",
        ...
        "br00020": "belief_label,believer_name,acct_name,group_title,group_cred_points,group_debt_points\n",
        "br00021": "belief_label,believer_name,acct_name,acct_cred_points,acct_debt_points\n",
...
def test_add_believer_to_br00020_csv_ReturnsObj():
    ...
    run_credit = 33
    run_debt = 55
    bob_believer.get_acct(yao_str).add_membership(run_str, run_credit, run_debt)
...
def test_add_believer_to_br00021_csv_ReturnsObj():
    ...
    a23_str = "amy23"
    bob_believer = believerunit_shop(bob_str, a23_str)
    bob_believer.add_acctunit(yao_str, yao_credit, yao_debt)
