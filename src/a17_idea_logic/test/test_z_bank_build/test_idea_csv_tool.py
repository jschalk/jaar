...
from src.a17_idea_logic.idea_csv_tool import (
    ...
    add_bankunits_to_stance_csv_strs,
...
def test_create_init_stance_idea_csv_strs_ReturnsObj_Scenario0_EmptyBankUnit(
    ...
    expected_stance_csv_strs = {
        "br00000": "bank_label,timeline_label,c400_number,yr1_jan1_offset,monthday_distortion,fund_iota,penny,respect_bit,knot,job_listen_rotations\n",
        "br00001": "bank_label,owner_name,bud_time,quota,celldepth\n",
        "br00002": "bank_label,owner_name,acct_name,tran_time,amount\n",
        "br00003": "bank_label,cumulative_minute,hour_label\n",
        "br00004": "bank_label,cumulative_day,month_label\n",
        "br00005": "bank_label,weekday_order,weekday_label\n",
        # "br00006": "bank_label,offi_time,_offi_time_max\n",
        "br00020": "bank_label,owner_name,acct_name,group_title,group_cred_points,group_debt_points\n",
        "br00021": "bank_label,owner_name,acct_name,acct_cred_points,acct_debt_points\n",
        "br00022": "bank_label,owner_name,concept_rope,awardee_title,give_force,take_force\n",
        "br00023": "bank_label,owner_name,concept_rope,fcontext,fstate,fopen,fnigh\n",
        "br00024": "bank_label,owner_name,concept_rope,labor_title\n",
        "br00025": "bank_label,owner_name,concept_rope,healer_name\n",
        "br00026": "bank_label,owner_name,concept_rope,rcontext,pstate,pnigh,popen,pdivisor\n",
        "br00027": "bank_label,owner_name,concept_rope,rcontext,rconcept_active_requisite\n",
        "br00028": "bank_label,owner_name,concept_rope,begin,close,addin,numor,denom,morph,gogo_want,stop_want,mass,task,problem_bool\n",
        "br00029": "bank_label,owner_name,credor_respect,debtor_respect,fund_pool,max_tree_traverse,tally,fund_iota,penny,respect_bit\n",
...
def test_add_bankunit_to_stance_csv_strs_ReturnsObj_Scenario0_OneBankUnit(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    ...
    a23_bankunit = x_bankunits.get("accord23")

    # WHEN
    add_bankunit_to_stance_csv_strs(a23_bankunit, x_csvs, csv_delimiter)
...
def test_add_bankunits_to_stance_csv_strs_ReturnsObj_Scenario1_TwoBankUnits(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    br00000_df = get_ex2_br00000_df()
    ...
    # WHEN
    add_bankunits_to_stance_csv_strs(x_bankunits, x_ideas, csv_delimiter)
...
def test_add_pack_to_br00028_csv_ReturnsObj():
    ...
    # THEN
    # root_row = f"{sue_str},{event7},{a23_str},{bob_str},,{bob_plan.bank_label},,,,,,,,,1,False,False\n"
    # mop_row = f"{sue_str},{event7},{a23_str},{bob_str},{bob_plan.bank_label},mop,{casa_begin},{casa_close},{casa_addin},{casa_numor},{casa_denom},{casa_morph},{casa_gogo_want},{casa_stop_want},{casa_mass},{casa_task},{casa_problem_bool}\n"
