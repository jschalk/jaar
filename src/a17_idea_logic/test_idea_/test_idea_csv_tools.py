...
from src.a17_idea_logic.idea import (
    get_csv_fisc_tag_owner_name_metrics,
    fisc_tag_owner_name_nested_csv_dict,
)


def test_extract_csv_headers_ReturnsObj():
    # ESTABLISH
    x_csv = """fisc_tag,owner_name,acct_name,credit_belief,debtit_belief
...
def test_get_csv_fisc_tag_owner_name_metrics_ReturnsObj_Scenario2():
    # ESTABLISH
    accord_fisc_tag = "accord56"
    sue_str = "Sue"
    bob_str = "Bob"
    headerless_csv = f"""{accord_fisc_tag},{sue_str},Bob,13,29
{accord_fisc_tag},{sue_str},Sue,11,23
{accord_fisc_tag},{sue_str},Yao,41,37
{accord_fisc_tag},{sue_str},Zia,41,37
{accord_fisc_tag},{bob_str},Yao,41,37
"""

    # WHEN
    u_dict = get_csv_fisc_tag_owner_name_metrics(headerless_csv=headerless_csv)

    # THEN
    # print(f"{u_dict=}")

    assert u_dict != {accord_fisc_tag: {sue_str: 1}}
    assert u_dict == {accord_fisc_tag: {sue_str: 4, bob_str: 1}}


def test_fisc_tag_owner_name_nested_csv_dict_ReturnsObj_Scenario0():
    # ESTABLISH
    accord_fisc_tag = "accord56"
    sue_str = "Sue"
    bob_str = "Bob"
    headerless_csv = f"""face_x,event_x,{accord_fisc_tag},{sue_str},Bob,13,29
,,{accord_fisc_tag},{sue_str},Sue,11,23
,,{accord_fisc_tag},{sue_str},Yao,41,37
,,{accord_fisc_tag},{sue_str},Zia,41,37
,,{accord_fisc_tag},{bob_str},Yao,41,37
"""
    ...
    # WHEN
    u_dict = fisc_tag_owner_name_nested_csv_dict(headerless_csv=headerless_csv)

    # THEN
    # print(f"{u_dict=}")
    static_sue_csv = f"""face_x,event_x,{accord_fisc_tag},{sue_str},Bob,13,29
,,{accord_fisc_tag},{sue_str},Sue,11,23
,,{accord_fisc_tag},{sue_str},Yao,41,37
,,{accord_fisc_tag},{sue_str},Zia,41,37
"""
    static_bob_csv = f""",,{accord_fisc_tag},{bob_str},Yao,41,37
"""
    generated_owner_name_dict = u_dict.get(accord_fisc_tag)
    ...
    assert u_dict == {accord_fisc_tag: owner_name_csv_dict}
