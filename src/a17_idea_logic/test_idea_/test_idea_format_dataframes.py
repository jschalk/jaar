...
def test_create_idea_df_Arg_idea_format_00021_bud_acctunit_v0_0_0():
    ...
    sue_budunit = budunit_shop(sue_str, accord_vow_label)
...
def test_save_idea_csv_Arg_idea_format_00021_bud_acctunit_v0_0_0_SaveToCSV(
    ...
    # WHEN
    save_idea_csv(j1_ideaname, sue_budunit, idea_vows_dir(), name_filename)

    # THEN
    assert os_path_exists(csv_example_path)
    sue1_name_example_csv = """event_int,face_name,vow_label,owner_name,acct_name,credit_belief,debtit_belief
...
"""
    ...
    # THEN
    assert os_path_exists(csv_example_path)
    sue2_acct_example_csv = """event_int,face_name,vow_label,owner_name,acct_name,credit_belief,debtit_belief
,,accord56,Sue,Bob,13,29
,,accord56,Sue,Sue,11,23
,,accord56,Sue,Yao,41,37
...
def test_save_idea_csv_Arg_idea_format_00013_conceptunit_v0_0_0(
    ...
    # WHEN
    save_idea_csv(x_idea_name, sue_budunit, idea_vows_dir(), name_filename)
