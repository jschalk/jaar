...
def get_idea_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "fisc_tag,owner_name,item_tag,road,healer_name,problem_bool": idea_format_00036_problem_healer_v0_0_0(),
...
def get_idea_dimen_ref() -> dict[str, set[str]]:
    ...
    return {
        ...
        "bud_acct_membership": {"br00020", "br00012", "br00050"},
        "bud_itemunit": {
            "br00013",
            "br00028",
            "br00058",
        ...
        "bud_item_awardlink": {"br00052", "br00022"},
        "bud_item_reasonunit": {
            "br00057",
            "br00023",
            "br00056",
        ...
        "bud_item_healerlink": {"br00055", "br00036", "br00025"},
        "bud_item_reason_premiseunit": {"br00056", "br00026"},
        "pidgin_label": {"br00042", "br00115"},
        "pidgin_name": {"br00043", "br00113"},
        "pidgin_tag": {"br00116", "br00044"},
        "pidgin_road": {"br00117", "br00045"},
    }
