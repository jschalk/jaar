...
def get_idea_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "fisc_tag,owner_name,item_way,awardee_label,give_force,take_force": idea_format_00022_bud_item_awardlink_v0_0_0(),
        "fisc_tag,owner_name,item_way,fbase,fneed,fopen,fnigh": idea_format_00023_bud_item_factunit_v0_0_0(),
        "fisc_tag,owner_name,item_way,team_label": idea_format_00024_bud_item_teamlink_v0_0_0(),
        ...
        "fisc_tag,owner_name,item_way,awardee_label_ERASE": idea_format_00052_delete_bud_item_awardlink_v0_0_0(),
        "fisc_tag,owner_name,item_way,fbase_ERASE": idea_format_00053_delete_bud_item_factunit_v0_0_0(),
        "fisc_tag,owner_name,item_way,team_label_ERASE": idea_format_00054_delete_bud_item_teamlink_v0_0_0(),
