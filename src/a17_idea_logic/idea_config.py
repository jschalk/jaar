...
def get_idea_sqlite_types() -> dict[str, str]:
    ...
    return {
        ...
        "_inallocable_debtit_score": "REAL",
        "_irrational_debtit_score": "REAL",
        "_status": "INTEGER",
        "_chore": "INTEGER",
...
def get_idea_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "vow_label,owner_name,acct_name,credit_score,debtit_score": idea_format_00021_plan_acctunit_v0_0_0(),
