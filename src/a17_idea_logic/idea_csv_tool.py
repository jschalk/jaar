...
from src.a01_term_logic.term import BankLabel, FaceName
    ...
    for idea_number in stance_idea_numbers:
        ...
        for idea_columns, idea_file_name in idea_format_headers.items():
            if idea_file_name == idea_format_filename:
                bank_csv_strs[idea_number] = f"event_int,face_name,{idea_columns}\n"
    return bank_csv_strs


def add_bankunits_to_stance_csv_strs(
    banks_dict: dict[BankLabel, BankUnit],
    bank_csv_strs: dict[str, str],
    csv_delimiter: str,
):
    for x_bank in banks_dict.values():
        add_bankunit_to_stance_csv_strs(x_bank, bank_csv_strs, csv_delimiter)


def add_bankunit_to_stance_csv_strs(
    x_bank: BankUnit, bank_csv_strs: dict[str, str], csv_delimiter: str
) -> dict[str, str]:
    br00000_csv = bank_csv_strs.get("br00000")
    br00001_csv = bank_csv_strs.get("br00001")
    br00002_csv = bank_csv_strs.get("br00002")
    br00003_csv = bank_csv_strs.get("br00003")
    br00004_csv = bank_csv_strs.get("br00004")
    br00005_csv = bank_csv_strs.get("br00005")
    br00000_csv = _add_bankunit_to_br00000_csv(br00000_csv, x_bank, csv_delimiter)
    br00001_csv = _add_budunit_to_br00001_csv(br00001_csv, x_bank, csv_delimiter)
    br00002_csv = _add_paybook_to_br00002_csv(br00002_csv, x_bank, csv_delimiter)
    br00003_csv = _add_hours_to_br00003_csv(br00003_csv, x_bank, csv_delimiter)
    br00004_csv = _add_months_to_br00004_csv(br00004_csv, x_bank, csv_delimiter)
    br00005_csv = _add_weekdays_to_br00005_csv(br00005_csv, x_bank, csv_delimiter)
    bank_csv_strs["br00000"] = br00000_csv
    bank_csv_strs["br00001"] = br00001_csv
    bank_csv_strs["br00002"] = br00002_csv
    bank_csv_strs["br00003"] = br00003_csv
    bank_csv_strs["br00004"] = br00004_csv
    bank_csv_strs["br00005"] = br00005_csv


def _add_bankunit_to_br00000_csv(
    x_csv: str,
    x_bank: BankUnit,
    csv_delimiter: str,
    ...
    if x_bank.knot == csv_delimiter:
        x_knot = f"""\"{str(x_bank.knot)}\""""
    else:
        x_knot = x_bank.knot
    ...
    x_row = [
        ...
        x_bank.bank_label,
        x_bank.timeline.timeline_label,
        str(x_bank.timeline.c400_number),
        str(x_bank.timeline.yr1_jan1_offset),
        str(x_bank.timeline.monthday_distortion),
        str(x_bank.fund_iota),
        str(x_bank.penny),
        str(x_bank.respect_bit),
        x_knot,
        str(x_bank.job_listen_rotations),
    ]
...
def _add_budunit_to_br00001_csv(
    ...
    for broker_owner_name, brokerunits in x_bank.brokerunits.items():
...
def _add_paybook_to_br00002_csv(
    ...
    for owner_name, tranunit in x_bank.paybook.tranunits.items():
        for acct_name, time_dict in tranunit.items():
            for tran_time, amount in time_dict.items():
                bank_label = x_bank.bank_label
                x_row = [
                    if_none_str(face_name),
                    if_none_str(event_int),
                    bank_label,
...
def _add_hours_to_br00003_csv(
    ...
    for hour_concept in x_bank.timeline.hours_config:
        x_row = [
            if_none_str(face_name),
            if_none_str(event_int),
            x_bank.bank_label,
...
def _add_months_to_br00004_csv(
    ...
    for month_concept in x_bank.timeline.months_config:
        x_row = [
            if_none_str(face_name),
            if_none_str(event_int),
            x_bank.bank_label,
...
def _add_weekdays_to_br00005_csv(
    ...
    for count_x, weekday_label in enumerate(x_bank.timeline.weekdays_config):
        x_row = [
            if_none_str(face_name),
            if_none_str(event_int),
            x_bank.bank_label,
...
def add_planunit_to_stance_csv_strs(
    x_plan: PlanUnit, bank_csv_strs: dict[str, str], csv_delimiter: str
) -> str:
    br00020_csv = bank_csv_strs.get("br00020")
    br00021_csv = bank_csv_strs.get("br00021")
    br00022_csv = bank_csv_strs.get("br00022")
    br00023_csv = bank_csv_strs.get("br00023")
    br00024_csv = bank_csv_strs.get("br00024")
    br00025_csv = bank_csv_strs.get("br00025")
    br00026_csv = bank_csv_strs.get("br00026")
    br00027_csv = bank_csv_strs.get("br00027")
    br00028_csv = bank_csv_strs.get("br00028")
    br00029_csv = bank_csv_strs.get("br00029")
    ...
    bank_csv_strs["br00020"] = br00020_csv
    bank_csv_strs["br00021"] = br00021_csv
    bank_csv_strs["br00022"] = br00022_csv
    bank_csv_strs["br00023"] = br00023_csv
    bank_csv_strs["br00024"] = br00024_csv
    bank_csv_strs["br00025"] = br00025_csv
    bank_csv_strs["br00026"] = br00026_csv
    bank_csv_strs["br00027"] = br00027_csv
    bank_csv_strs["br00028"] = br00028_csv
    bank_csv_strs["br00029"] = br00029_csv
...
def add_pidginunit_to_stance_csv_strs(
    x_pidgin: PidginUnit, bank_csv_strs: dict[str, str], csv_delimiter: str
) -> str:
    br00042_csv = bank_csv_strs.get("br00042")
    br00043_csv = bank_csv_strs.get("br00043")
    br00044_csv = bank_csv_strs.get("br00044")
    br00045_csv = bank_csv_strs.get("br00045")
    ...
    bank_csv_strs["br00042"] = br00042_csv
    bank_csv_strs["br00043"] = br00043_csv
    bank_csv_strs["br00044"] = br00044_csv
    bank_csv_strs["br00045"] = br00045_csv
...
def add_packunit_to_stance_csv_strs(
    x_pack: PackUnit, bank_csv_strs: dict[str, str], csv_delimiter: str
):
    br00020_csv = bank_csv_strs.get("br00020")
    br00021_csv = bank_csv_strs.get("br00021")
    br00022_csv = bank_csv_strs.get("br00022")
