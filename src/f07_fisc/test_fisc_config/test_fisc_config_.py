...
def _validate_fisc_config(fisc_config: dict):
    ...
    for fisc_dimens, dimen_dict in fisc_config.items():
        print(f"_validate_fisc_config {fisc_dimens=}")
        ...
        for jkey_key in fisc_jkeys_keys:
            ...
            print(f"_validate_fisc_config {fisc_dimens=} {jkey_key=} ")
        ...
        for jvalue_key in fisc_jvalues_keys:
            ...
            print(f"_validate_fisc_config {fisc_dimens=} {jvalue_key=} ")
