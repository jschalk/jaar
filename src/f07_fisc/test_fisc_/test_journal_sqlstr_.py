...
from src.f07_fisc.journal_sqlstr import (
    ...
    get_delta2favor_table_create_sqlstr,
    get_delta_table_create_sqlstr,
    get_favor_table_create_sqlstr,
    get_favor2owner_table_create_sqlstr,
...
def test_get_favor_table_create_sqlstr_ReturnsCorrectStr():
    # ESTABLISH / WHEN / THEN
    example_sqlstr = """
...
;"""
    assert example_sqlstr == get_favor_table_create_sqlstr()


def test_get_delta2favor_table_create_sqlstr_ReturnsCorrectStr():
    # ESTABLISH / WHEN / THEN
    example_sqlstr = """
...
;"""
    assert example_sqlstr == get_delta2favor_table_create_sqlstr()


def test_get_favor2owner_table_create_sqlstr_ReturnsCorrectStr():
    # ESTABLISH / WHEN / THEN
    example_sqlstr = """
...
;"""
    assert example_sqlstr == get_favor2owner_table_create_sqlstr()
