...
def test_BudUnit_set_concept_dict_SetsAll_range_inheritors():
    # ESTABLISH
    ...
    # WHEN
    sue_budunit._set_concept_dict()
    sue_budunit._set_concepttree_range_attrs()
...
def test_BudUnit_set_concepttree_range_attrs_Sets_day_concept_gogo_calc_stop_calc():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
...
def test_BudUnit_set_concepttree_range_attrs_Sets_days_concept_gogo_calc_stop_calc():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
...
def test_BudUnit_set_concepttree_range_attrs_Sets_weeks_concept_gogo_calc_stop_calc():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
    ...
    weeks_concept = sue_budunit.get_concept_obj(weeks_way)
    ...
    assert sue_budunit.get_concept_obj(sun_way)._gogo_calc == 5760
    assert sue_budunit.get_concept_obj(mon_way)._gogo_calc == 7200
    assert sue_budunit.get_concept_obj(tue_way)._gogo_calc == 8640
    assert sue_budunit.get_concept_obj(wed_way)._gogo_calc == 0
    assert sue_budunit.get_concept_obj(thu_way)._gogo_calc == 1440
    assert sue_budunit.get_concept_obj(fri_way)._gogo_calc == 2880
    assert sue_budunit.get_concept_obj(sat_way)._gogo_calc == 4320
    assert sue_budunit.get_concept_obj(sun_way)._stop_calc == 7200
    assert sue_budunit.get_concept_obj(mon_way)._stop_calc == 8640
    assert sue_budunit.get_concept_obj(tue_way)._stop_calc == 10080
    assert sue_budunit.get_concept_obj(wed_way)._stop_calc == 1440
    assert sue_budunit.get_concept_obj(thu_way)._stop_calc == 2880
    assert sue_budunit.get_concept_obj(fri_way)._stop_calc == 4320
    assert sue_budunit.get_concept_obj(sat_way)._stop_calc == 5760


def test_BudUnit_set_concepttree_range_attrs_Sets_c400_concept_gogo_calc_stop_calc():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
    ...
    assert sue_budunit.get_concept_obj(c400_leap_way)._gogo_calc == 0
    assert sue_budunit.get_concept_obj(c400_leap_way)._stop_calc == 210379680
    assert 1472657760 % sue_budunit.get_concept_obj(c400_leap_way)._stop_calc == 0


def test_BudUnit_set_concepttree_range_attrs_Sets_years_concept_gogo_calc_stop_calc():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
    ...
    # THEN
    assert sue_budunit.get_concept_obj(creg_way)._gogo_calc == 0
    assert sue_budunit.get_concept_obj(c400_leap_way)._gogo_calc == 0
    assert sue_budunit.get_concept_obj(c400_clean_way)._gogo_calc == 0
    assert sue_budunit.get_concept_obj(c100_clean_way)._gogo_calc == 0
    assert sue_budunit.get_concept_obj(yr4_leap_way)._gogo_calc == 0
    assert sue_budunit.get_concept_obj(yr4_clean_way)._gogo_calc == 0
    assert sue_budunit.get_concept_obj(year_way)._gogo_calc == 0
    assert sue_budunit.get_concept_obj(creg_way)._stop_calc == 1472657760
    assert sue_budunit.get_concept_obj(c400_leap_way)._stop_calc == 210379680
    assert sue_budunit.get_concept_obj(c400_clean_way)._stop_calc == 210378240
    assert sue_budunit.get_concept_obj(c100_clean_way)._stop_calc == 52594560
    assert sue_budunit.get_concept_obj(yr4_leap_way)._stop_calc == 2103840
    assert sue_budunit.get_concept_obj(yr4_clean_way)._stop_calc == 2102400
    assert sue_budunit.get_concept_obj(year_way)._stop_calc == 525600
    ...
    assert sue_budunit.get_concept_obj(jan_way)._gogo_calc == 440640
    assert sue_budunit.get_concept_obj(feb_way)._gogo_calc == 485280
    assert sue_budunit.get_concept_obj(mar_way)._gogo_calc == 0
    assert sue_budunit.get_concept_obj(apr_way)._gogo_calc == 44640
    assert sue_budunit.get_concept_obj(may_way)._gogo_calc == 87840
    assert sue_budunit.get_concept_obj(jun_way)._gogo_calc == 132480
    assert sue_budunit.get_concept_obj(jul_way)._gogo_calc == 175680
    assert sue_budunit.get_concept_obj(aug_way)._gogo_calc == 220320
    assert sue_budunit.get_concept_obj(sep_way)._gogo_calc == 264960
    assert sue_budunit.get_concept_obj(oct_way)._gogo_calc == 308160
    assert sue_budunit.get_concept_obj(nov_way)._gogo_calc == 352800
    assert sue_budunit.get_concept_obj(dec_way)._gogo_calc == 396000

    assert sue_budunit.get_concept_obj(jan_way)._stop_calc == 485280
    assert sue_budunit.get_concept_obj(feb_way)._stop_calc == 525600
    assert sue_budunit.get_concept_obj(mar_way)._stop_calc == 44640
    assert sue_budunit.get_concept_obj(apr_way)._stop_calc == 87840
    assert sue_budunit.get_concept_obj(may_way)._stop_calc == 132480
    assert sue_budunit.get_concept_obj(jun_way)._stop_calc == 175680
    assert sue_budunit.get_concept_obj(jul_way)._stop_calc == 220320
    assert sue_budunit.get_concept_obj(aug_way)._stop_calc == 264960
    assert sue_budunit.get_concept_obj(sep_way)._stop_calc == 308160
    assert sue_budunit.get_concept_obj(oct_way)._stop_calc == 352800
    assert sue_budunit.get_concept_obj(nov_way)._stop_calc == 396000
    assert sue_budunit.get_concept_obj(dec_way)._stop_calc == 440640
