...
def test_BudUnit_get_agenda_dict_ReturnsDictWith_day_concept_Scenario1():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
...
def test_BudUnit_get_agenda_dict_ReturnsDictWith_day_concept_Scenario2():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
...
def test_BudUnit_get_agenda_dict_ReturnsDictWith_days_concept_Scenario0():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
    ...
    # THEN
    clean_concept = sue_budunit.get_concept_obj(clean_way)
    print(f"{clean_concept._factheirs.keys()=}")
    print(f"{clean_concept._factheirs.get(days_way)=}")
    assert sue_agenda.get(clean_way)


def test_BudUnit_get_agenda_dict_ReturnsDictWith_week_concept_Scenario0():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
...
def test_BudUnit_get_agenda_dict_ReturnsDictWith_week_concept_Scenario1():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
...
def test_BudUnit_get_agenda_dict_ReturnsDictWith_weeks_concept_Scenario0():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
...
def test_BudUnit_get_agenda_dict_ReturnsDictWith_year_concept_Scenario0():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
    ...
    # WHEN
    sue_budunit.add_fact(creg_way, creg_way, 1444, 2880)
    sue_agenda = sue_budunit.get_agenda_dict()
    print(f"{sue_agenda=}")
...
def test_BudUnit_get_agenda_dict_ReturnsDictWith_year_concept_Scenario1():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
...
def test_BudUnit_get_agenda_dict_ReturnsDictWith_year_concept_Scenario2():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
    ...
    sue_budunit.add_fact(creg_way, creg_way, yr2000mar1, yr2000mar1 + 1440)
    assert len(sue_budunit.get_agenda_dict()) == 1
    sue_budunit.add_fact(creg_way, creg_way, yr2000mar2, yr2000mar2 + 1440)
    assert len(sue_budunit.get_agenda_dict()) == 0
    sue_budunit.add_fact(creg_way, creg_way, yr2004mar1, yr2004mar1 + 1440)
    assert len(sue_budunit.get_agenda_dict()) == 1
    sue_budunit.add_fact(creg_way, creg_way, yr2000mar2, yr2004mar2 + 1440)
    assert len(sue_budunit.get_agenda_dict()) == 1
...
def test_BudUnit_add_time_creg_conceptunit_SyncsWeekDayAndYear_Wednesday_March1_2000():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
    ...
    clean_concept = sue_budunit.get_concept_obj(clean_way)
    sue_budunit.add_fact(creg_way, creg_way, yr2000_mar6day, yr2000_mar7day)
    ...
    # WHEN / THEN
    sue_budunit.add_fact(creg_way, creg_way, yr2000_mar7day, yr2000_mar8day)
    sue_budunit.settle_bud()
    print(f"{clean_concept._factheirs.get(wed_way).fopen=}")
    print(f"{clean_concept._factheirs.get(wed_way).fnigh=}")
    print(f"{clean_concept.get_reasonheir(wed_way)._status=}")
    ...
    # WHEN / THEN
    sue_budunit.add_fact(creg_way, creg_way, yr2000_mar1day, yr2000_mar2day)
    sue_budunit.settle_bud()
    print(f"{clean_concept._factheirs.get(wed_way).fopen=}")
    print(f"{clean_concept._factheirs.get(wed_way).fnigh=}")
    print(f"{clean_concept.get_reasonheir(wed_way)._status=}")
    ...
    # WHEN / THEN
    sue_budunit.add_fact(creg_way, creg_way, yr2000_mar2day, yr2000_mar3day)
    sue_budunit.settle_bud()
    print(f"{clean_concept._factheirs.get(wed_way).fopen=}")
    print(f"{clean_concept._factheirs.get(wed_way).fnigh=}")
    print(f"{clean_concept.get_reasonheir(wed_way)._status=}")
    ...
    # WHEN / THEN
    sue_budunit.add_fact(creg_way, creg_way, yr2000_mar3day, yr2000_mar4day)
    sue_budunit.settle_bud()
    print(f"{clean_concept._factheirs.get(wed_way).fopen=}")
    print(f"{clean_concept._factheirs.get(wed_way).fnigh=}")
    print(f"{clean_concept.get_reasonheir(wed_way)._status=}")
    ...
    # WHEN / THEN
    sue_budunit.add_fact(creg_way, creg_way, yr2000_mar4day, yr2000_mar5day)
    sue_budunit.settle_bud()
    print(f"{clean_concept._factheirs.get(wed_way).fopen=}")
    print(f"{clean_concept._factheirs.get(wed_way).fnigh=}")
    print(f"{clean_concept.get_reasonheir(wed_way)._status=}")
    ...
    # WHEN / THEN
    sue_budunit.add_fact(creg_way, creg_way, yr2000_mar5day, yr2000_mar6day)
    sue_budunit.settle_bud()
    print(f"{clean_concept._factheirs.get(wed_way).fopen=}")
    print(f"{clean_concept._factheirs.get(wed_way).fnigh=}")
    print(f"{clean_concept.get_reasonheir(wed_way)._status=}")
...
def test_BudUnit_add_time_creg_conceptunit_SyncsWeekDayAndYear_Thursday_March2_2000():
    # ESTABLISH
    sue_budunit = budunit_shop("Sue")
    time_way = sue_budunit.make_l1_way(time_str())
    creg_way = sue_budunit.make_way(time_way, get_cregtime_str())
