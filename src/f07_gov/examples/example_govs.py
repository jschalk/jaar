...
# def create_example_gov1(graphics_bool) -> GovUnit:
#     # ESTABLISH
...
#         govs_dir=yao_hubunit.govs_dir,
#         gov_idea=yao_hubunit.gov_idea,
...
def create_example_gov2() -> GovUnit:
    # ESTABLISH
    accord45_str = "accord45"
    accord_gov = govunit_shop(accord45_str, get_test_govs_dir(), in_memory_journal=True)
    yao_str = "Yao"
    ...
    accord_gov.init_owner_keeps(wei_str)
    accord_gov.init_owner_keeps(zia_str)
    yao_voice_bud = yao_hubunit.get_voice_bud()
    ...
    accord_gov._set_all_healer_dutys(yao_str)
    accord_gov._set_all_healer_dutys(wei_str)
    accord_gov._set_all_healer_dutys(zia_str)

    return accord_gov


def create_example_gov3() -> GovUnit:
    # ESTABLISH
    accord45_str = "accord45"
    accord_gov = govunit_shop(accord45_str, get_test_govs_dir(), in_memory_journal=True)
    yao_str = "Yao"
...
def create_example_gov4() -> GovUnit:
    # ESTABLISH
    accord45_str = "accord45"
    accord_gov = govunit_shop(accord45_str, get_test_govs_dir(), in_memory_journal=True)
    yao_str = "Yao"
