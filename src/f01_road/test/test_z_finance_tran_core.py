...
def test_TranUnit_Exists():
    ...
    assert not x_tranunit.time_fid
...
def test_tranunit_shop_WithParametersReturnsObj():
    ...
    # WHEN
    x_tranunit = tranunit_shop(sue_str, yao_str, t55_time_fid, t55_fundnum)

    # THEN
    assert x_tranunit
    assert x_tranunit.src == sue_str
    assert x_tranunit.dst == yao_str
    assert x_tranunit.time_fid == t55_time_fid
...
def test_TranBook_set_tranunit_SetsAttrWithBlocktime_fid():
    # ESTABLISH
    music23_str = "music23"
    x_tranbook = tranbook_shop(music23_str)
    sue_str = "Sue"
    ...
    # WHEN
    x_blocked_time_fids = {44}
    x_tranbook.set_tranunit(sue_yao_t55_tranunit, x_blocked_time_fids)
...
def test_TranBook_set_tranunit_SetsAttrWithBlocktime_fid_RaisesError():
    # ESTABLISH
    music23_str = "music23"
    x_tranbook = tranbook_shop(music23_str)
    sue_str = "Sue"
...
def test_TranBook_set_tranunit_SetsAttrWithCurrenttime_fid():
    # ESTABLISH
    music23_str = "music23"
    x_tranbook = tranbook_shop(music23_str)
    sue_str = "Sue"
...
def test_TranBook_set_tranunit_SetsAttrWithCurrenttime_fid_RaisesError():
    # ESTABLISH
    music23_str = "music23"
    x_tranbook = tranbook_shop(music23_str)
    sue_str = "Sue"
    ...
    exception_str = f"Cannot set tranunit for time_fid={t55_t}, timelinepoint is greater than current time={t55_t}"
    assert str(excinfo.value) == exception_str

    # WHEN / THEN
    with pytest_raises(Exception) as excinfo:
        x_tranbook.set_tranunit(sue_yao_t55_tranunit, x_current_time=33)
    exception_str = f"Cannot set tranunit for time_fid={t55_t}, timelinepoint is greater than current time=33"
    assert str(excinfo.value) == exception_str
...
def test_TranBook_add_tranunit_SetsAttr():
    ...
    t55_time_fid = 5505
    t55_yao_amount = -55
    x_tranbook.add_tranunit(sue_str, yao_str, t55_time_fid, t55_yao_amount)

    # THEN
    assert x_tranbook.tranunits != {}
    assert x_tranbook.tranunits == {sue_str: {yao_str: {t55_time_fid: t55_yao_amount}}}

    # WHEN
    bob_str = "Bob"
    t55_bob_amount = 600
    x_tranbook.add_tranunit(sue_str, bob_str, t55_time_fid, t55_bob_amount)

    # THEN
    assert x_tranbook.tranunits != {}
    assert x_tranbook.tranunits == {
        sue_str: {
            yao_str: {t55_time_fid: t55_yao_amount},
            bob_str: {t55_time_fid: t55_bob_amount},
        }
    }
    ...
    t66_time_fid = 6606
    t66_yao_amount = -66
    x_tranbook.add_tranunit(sue_str, yao_str, t66_time_fid, t66_yao_amount)

    # THEN
    assert x_tranbook.tranunits != {}
    assert x_tranbook.tranunits == {
        sue_str: {
            yao_str: {t55_time_fid: t55_yao_amount, t66_time_fid: t66_yao_amount},
            bob_str: {t55_time_fid: t55_bob_amount},
        }
    }
    ...
    t77_time_fid = 7707
    t77_yao_amount = -77
    x_tranbook.add_tranunit(yao_str, yao_str, t77_time_fid, t77_yao_amount)
    ...
    assert x_tranbook.tranunits == {
        ...
        yao_str: {yao_str: {t77_time_fid: t77_yao_amount}},
    }
...
def test_TranBook_get_tranunit_ReturnsObj():
    ...
    assert sue_yao_t55_tranunit.time_fid == t55_t
...
def test_TranBook_get_time_fids_ReturnsObj():
    # ESTABLISH
    music23_str = "music23"
    music23_tranbook = tranbook_shop(music23_str)
    sue_str = "Sue"
    ...
    t77_time_fid = 7707
    t77_bob_amount = -77
    music23_tranbook.add_tranunit(sue_str, yao_str, t55_time_fid, t55_yao_amount)
    music23_tranbook.add_tranunit(sue_str, yao_str, t66_time_fid, t66_yao_amount)
    music23_tranbook.add_tranunit(sue_str, bob_str, t77_time_fid, t77_bob_amount)

    # WHEN
    music23_time_fids = music23_tranbook.get_time_fids()

    # THEN
    assert music23_time_fids
    assert len(music23_time_fids)
    assert music23_time_fids == {t55_time_fid, t66_time_fid, t77_time_fid}
...
def test_TranBook_get_owners_accts_net_ReturnObj_Scenario0():
    ...
    t55_time_fid = 5505
    t55_bob_amount = 600
    music23_tranbook.add_tranunit(sue_str, bob_str, t55_time_fid, t55_bob_amount)
    assert music23_tranbook.tranunits == {
        sue_str: {bob_str: {t55_time_fid: t55_bob_amount}}
    }
...
def test_TranBook_get_accts_net_dict_ReturnObj_Scenario1():
    ...
    music23_tranbook.add_tranunit(yao_str, yao_str, t77_time_fid, t77_yao_amount)
    assert music23_tranbook.tranunits == {
        sue_str: {
            yao_str: {t55_time_fid: t55_yao_amount, t66_time_fid: t66_yao_amount},
            bob_str: {t55_time_fid: t55_bob_amount},
...
#     # THEN
#     assert x_tranbook
#     assert x_tranbook.time_fid == x_time_fid
...
#     x_time_fid = 4
#     x_amount = 55
#     x_tranbook = tranbook_shop(x_time_fid, x_amount)

#     # WHEN
#     x_dict = x_tranbook.get_dict()

#     # THEN
#     assert x_dict == {"time_fid": x_time_fid, "amount": x_amount}


# def test_TranBook_calc_magnitude_SetsAttr_Scenario0():
#     # ESTABLISH
#     x_time_fid = 4
#     x_tranbook = tranbook_shop(x_time_fid)
...
#     x_tranbook = tranbook_shop(x_time_fid, net_purviews=x_net_purviews)
#     assert x_tranbook._magnitude == 0
...
#     x_net_purviews = {"Sue": -4}
#     x_magnitude = 67
#     x_tranbook = tranbook_shop(x_time_fid, x_amount, x_net_purviews)
