...
def test_TranBook_Exists():
    ...
    # THEN
    assert x_tranbook
    assert not x_tranbook.cmty_idea
...
def test_tranbook_shop_WithParametersReturnsObj():
    ...
    # THEN
    assert x_tranbook
    assert x_tranbook.cmty_idea == accord23_str
...
def test_TranBook_get_dict_ReturnsObj():
    ...
    # THEN
    cmty_idea_str = "cmty_idea"
    tranunits_str = "tranunits"
    assert x_dict
    assert cmty_idea_str in x_dict.keys()
    assert x_dict.get(cmty_idea_str) == accord23_str
...
def test_get_tranbook_from_dict_ReturnsObj_Sccenario0():
    ...
    assert generated_tranbook.cmty_idea == accord23_str
