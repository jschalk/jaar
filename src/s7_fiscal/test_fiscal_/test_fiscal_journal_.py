from src.s0_instrument.python_tool import get_dict_from_json, get_nested_value
from src.s0_instrument.file import delete_dir, save_file, open_file
from src.s0_instrument.db_tool import (
    get_db_tables,
    get_db_columns,
    check_connection,
...
def test_fiscal_set_fiscal_dirs_CorrectlyCreatesDBTables(env_dir_setup_cleanup):
    ...
    # THEN
    # grab config.json
    config_str = open_file(dest_dir="src/s7_fiscal", file_name="journal_db_check.json")
