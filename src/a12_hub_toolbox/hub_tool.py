...
def save_gut_file(coin_mstr_dir: str, believerunit: BelieverUnit):
    gut_path = create_gut_path(
        coin_mstr_dir, believerunit.coin_label, believerunit.believer_name
    )
    save_believer_file(gut_path, None, believerunit)


def open_gut_file(
    coin_mstr_dir: str, coin_label: str, believer_name: BelieverName
) -> BelieverUnit:
...
def job_file_exists(
    ...
    job_path = create_job_path(coin_mstr_dir, coin_label, believer_name)
    return os_path_exists(job_path)


def save_job_file(coin_mstr_dir: str, believerunit: BelieverUnit):
...
def collect_believer_event_dir_sets(
    ...
    x_dict = {}
    believers_dir = create_coin_believers_dir_path(coin_mstr_dir, coin_label)
...
def save_arbitrary_believerevent(
    ...
    x_believerunit = believerunit_shop(believer_name, coin_label)
...
def cellunit_add_json_file(
    ...
    cell_dir = create_cell_dir_path(
        coin_mstr_dir, coin_label, time_believer_name, bud_time, bud_ancestors
    )
...
def save_bud_file(
    ...
    bud_json_path = create_budunit_json_path(
        coin_mstr_dir, coin_label, believer_name, x_bud.bud_time
    )
...
def bud_file_exists(
    ...
    bud_json_path = create_budunit_json_path(
        coin_mstr_dir, coin_label, believer_name, x_bud_time
    )
...
def open_bud_file(
    ...
    if bud_file_exists(coin_mstr_dir, coin_label, believer_name, x_bud_time):
...
def get_timepoint_dirs(
    ...
    buds_dir = create_buds_dir_path(coin_mstr_dir, coin_label, believer_name)
