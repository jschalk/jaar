...
from src.a05_plan_logic.plan import get_default_coin_label as coin_label
from src.a12_hub_toolbox.hubunit import hubunit_shop
from src.a12_hub_toolbox.test._util.a12_env import (
    env_dir_setup_cleanup,
    get_module_temp_dir as coin_mstr_dir,
)
...
def test_HubUnit_get_believer_from_atom_files_ReturnsFile_SimplePlan(
    ...
    # save atom files
    sports_atom = get_atom_example_planunit_sports(yao_hubunit.coin_label)
...
def test_HubUnit_get_believer_from_atom_files_ReturnsFile_WithFactUnit(
    ...
    # save atom files
    x_coin_label = yao_hubunit.coin_label
    yao_hubunit.save_atom_file(get_atom_example_planunit_sports(x_coin_label))
    yao_hubunit.save_atom_file(get_atom_example_planunit_ball(x_coin_label))
    yao_hubunit.save_atom_file(get_atom_example_planunit_knee(x_coin_label))
    yao_hubunit.save_atom_file(get_atom_example_factunit_knee(x_coin_label))
