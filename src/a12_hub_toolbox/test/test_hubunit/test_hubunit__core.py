...
from src.a12_hub_toolbox.hubunit import HubUnit, get_keep_rope_path, hubunit_shop
...
def test_hubunit_shop_ReturnsObjWhenEmpty():
    ...
    assert sue_hubunit.keep_path() == get_keep_rope_path(x_hubunit, texas_rope)
    bob_str = "Bob"
...
def test_get_keep_rope_path_ReturnsObj():
    # ESTABLISH
    sue_str = "Sue"
    peru_str = "peru"
    ...
    # WHEN
    texas_path = get_keep_rope_path(sue_hubunit, texas_rope)
    dallas_path = get_keep_rope_path(sue_hubunit, dallas_rope)
    elpaso_path = get_keep_rope_path(sue_hubunit, elpaso_rope)
    kern_path = get_keep_rope_path(sue_hubunit, kern_rope)
    ...
    assert texas_path == get_keep_rope_path(sue_hubunit, diff_root_texas_rope)
    assert dallas_path == get_keep_rope_path(sue_hubunit, diff_root_dallas_rope)
    assert elpaso_path == get_keep_rope_path(sue_hubunit, diff_root_elpaso_rope)
