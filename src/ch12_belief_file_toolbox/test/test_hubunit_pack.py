...
def test_HubUnit_save_pack_file_RaisesErrorIfPackUnit_belief_name_IsWrong(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_str = "Sue"
...
def test_HubUnit_validate_packunit_ReturnsObjWithAttributesFixed(
    ...
    invalid_sue_packunit = packunit_shop(
        ...
        _atoms_dir=create_path(sue_hubunit._atoms_dir, "swimming"),
        _packs_dir=create_path(sue_hubunit._atoms_dir, "swimming"),
    )
...
def test_HubUnit_save_pack_file_CanCreateAndModify3packunits(
    ...
    sue_hubunit.save_pack_file(sue_3beliefatoms_packunit())
    sue_hubunit.save_pack_file(sue_4beliefatoms_packunit())
...
def test_HubUnit_save_pack_file_ReturnsValidObj(env_dir_setup_cleanup):
    ...
    sue2_packunit._atoms_dir = create_path(sue_hubunit._atoms_dir, "swimming")
    sue2_packunit._packs_dir = create_path(sue_hubunit._atoms_dir, "swimming")
...
def test_HubUnit_merge_any_packs_ReturnsObjThatIsEqual(env_dir_setup_cleanup):
    ...
    # WHEN
    new_belief = sue_hubunit._merge_any_packs(gut_belief)
