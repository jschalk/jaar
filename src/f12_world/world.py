...
from src.f11_etl.transformers import (
    ...
    etl_event_bud_csvs_to_vow_json,
    etl_event_vow_json_to_event_inherited_budunits,
...
class WorldUnit:
    ...
    def event_bud_csvs_to_vow_json(self):
        etl_event_bud_csvs_to_vow_json(self._fisc_mstr_dir)

    def event_vow_json_to_event_inherited_budunits(self):
        etl_event_vow_json_to_event_inherited_budunits(self._fisc_mstr_dir)
    ...
    def mine_to_burdens(
        ...
        self.event_bud_csvs_to_vow_json()
        self.event_vow_json_to_event_inherited_budunits()
