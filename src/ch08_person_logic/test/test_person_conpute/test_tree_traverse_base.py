...
from ch06_reason.reason_main import factheir_shop
...
def test_PersonUnit_clear_plan_dict_and_person_obj_settle_attrs_SetsAttrs_Scenario0():
    ...
    sue_person.offtrack_kids_poynt_set = "example"
    ...
    assert sue_person.offtrack_kids_poynt_set != set()
...
def test_PersonUnit_thinkout_Resets_offtrack_kids_poynt_set():
    # ESTABLISH
    sue_personunit = personunit_shop("Sue")
    sue_personunit.offtrack_kids_poynt_set = set("YY")
    x_set = set()

    assert sue_personunit.offtrack_kids_poynt_set != x_set
...
def test_PersonUnit_thinkout_WhenPlanRootHas_poyntButAll_kidsHaveZero_poyntAddTo_offtrack_kids_poynt_set_Scenario0():
    # ESTABLISH
    sue_personunit = personunit_shop("Sue")
    casa_rope = sue_personunit.make_l1_rope(exx.casa)
    casa_plan = planunit_shop(exx.casa, poynt=0)
    sue_personunit.set_l1_plan(casa_plan)
    assert sue_personunit.offtrack_kids_poynt_set == set()
    ...
    assert sue_personunit.offtrack_kids_poynt_set == {root_rope}

    # WHEN
    sue_personunit.edit_plan_attr(casa_rope, poynt=2)
    sue_personunit.thinkout()
...
def test_PersonUnit_thinkout_WhenPlanUnitHas_poyntButAll_kidsHaveZero_poyntAddTo_offtrack_kids_poynt_set():
    # ESTABLISH
    sue_personunit = personunit_shop("Sue")
    casa_rope = sue_personunit.make_l1_rope(exx.casa)
    ...
    # THEN
    assert sue_personunit.offtrack_kids_poynt_set == {clean_rope}
