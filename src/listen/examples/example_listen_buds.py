...
def get_budunit_with_4_levels() -> BudUnit:
    ...
    casa = "casa"
    sue_bud.set_l1_idea(ideaunit_shop(casa, _mass=30, pledge=True))

    cat = "cat have dinner"
    sue_bud.set_l1_idea(ideaunit_shop(cat, _mass=30, pledge=True))
...
def get_fund_explanation_bud() -> BudUnit:
    ...
    sue_bud.set_l1_idea(ideaunit_shop(casa_text, _mass=30))
    sue_bud.set_idea(ideaunit_shop(cat_text, _mass=30), casa_road)
    sue_bud.set_idea(ideaunit_shop(hun_n_text, _mass=30), cat_road)
    sue_bud.set_idea(ideaunit_shop(hun_y_text, _mass=30), cat_road)
    sue_bud.set_idea(ideaunit_shop(clean_text, _mass=30), casa_road)
    sue_bud.set_idea(ideaunit_shop(sweep_text, _mass=30, pledge=True), clean_road)
    sue_bud.set_idea(ideaunit_shop(dish_text, _mass=30, pledge=True), clean_road)
    ...
    # week_text = "weekdays"
    # week_road = sue_bud.make_l1_road(week_text)
    # idea_kid_weekdays = ideaunit_shop(week_text, _mass=25)
    # sue_bud.set_l1_idea(idea_kid_weekdays)
