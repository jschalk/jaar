...
def get_budunit_with_4_levels() -> BudUnit:
    ...
    idea_grandkidT = ideaunit_shop(tue_text, mass=20)
    idea_grandkidW = ideaunit_shop(wed_text, mass=20)
    idea_grandkidR = ideaunit_shop(thu_text, mass=30)
    idea_grandkidF = ideaunit_shop(fri_text, mass=40)
    idea_grandkidA = ideaunit_shop(sat_text, mass=50)
...
def get_fund_explanation_bud() -> BudUnit:
    ...
    sue_bud.set_l1_idea(ideaunit_shop(casa_text, mass=30))
    sue_bud.set_idea(ideaunit_shop(cat_text, mass=30), casa_road)
    sue_bud.set_idea(ideaunit_shop(hun_n_text, mass=30), cat_road)
    sue_bud.set_idea(ideaunit_shop(hun_y_text, mass=30), cat_road)
    sue_bud.set_idea(ideaunit_shop(clean_text, mass=30), casa_road)
    sue_bud.set_idea(ideaunit_shop(sweep_text, mass=30, pledge=True), clean_road)
    sue_bud.set_idea(ideaunit_shop(dish_text, mass=30, pledge=True), clean_road)
    ...
    # week_text = "weekdays"
    # week_road = sue_bud.make_l1_road(week_text)
    # idea_kid_weekdays = ideaunit_shop(week_text, mass=25)
    # sue_bud.set_l1_idea(idea_kid_weekdays)
