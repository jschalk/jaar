...
def get_example_yao_voice_with_3_healers():
    ...
    iowa_idea._healerhold.set_healer_id(get_yao_iowa_hubunit().owner_id)
    ohio_idea._healerhold.set_healer_id(get_yao_ohio_hubunit().owner_id)
    utah_idea._healerhold.set_healer_id(get_zia_utah_hubunit().owner_id)
