...
def get_listen_structures0_fig() -> plotly_Figure:
    ...
    add_world_rect(fig, 1.0, 7.0, 2.0, 8.0, sue_voice_text, green_text)
    ...
    fig.add_trace(
        plotly_Scatter(
            ...
            text=[
                ...
                "The voice world listens to other's action worlds and builds a new world from itself and others",
            ],
            mode="text",
        )
    )
...
def bud_explanation0(x_world: WorldUnit, mode: str = None) -> plotly_Figure:
    ...
    add_world_rect(fig, 4, -1.2, 5, -0.8, doerunit_text)
    ...
    belieflink_text = "belieflink"
    darkred_text = "DarkRed"
    add_world_rect(fig, 7, 0.4, 7.75, 1, belieflink_text, darkred_text)
    add_world_rect(fig, 7, -0.2, 7.75, 0.4, belieflink_text, darkred_text)
    add_world_rect(fig, 7, -0.8, 7.75, -0.2, belieflink_text, darkred_text)
    add_world_rect(fig, 7, -1.4, 7.75, -0.8, belieflink_text, darkred_text)
