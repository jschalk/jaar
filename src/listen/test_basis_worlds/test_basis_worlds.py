...
def test_create_empty_world_ReturnsCorrectObj():
    ...
    assert yao_empty_job._budget == yao_voice._budget
...
def test_create_listen_basis_ReturnsCorrectObj():
    ...
    assert yao_basis_job._budget == yao_duty._budget
...
def test_get_default_action_world_ReturnsCorrectObj():
    ...
    sue_worldunit = worldunit_shop(
        sue_text, blue_text, slash_text, x_budget, x_coin, x_pixel
    )
    ...
    assert default_action_world._budget == x_budget
