...
def test_BudUnit_set_fact_CorrectlyModifiesAttr_1():
    ...
    sunday_bud_fact = factunit_shop(base=weekday_road, fpick=sunday_road)
    ...
    # ESTABLISH
    sue_bud.add_fact(base=weekday_road, fpick=sunday_road)
    ...
    # WHEN
    sue_bud.add_fact(base=usa_week_road, fpick=usa_week_road, fopen=608, fnigh=610)
...
def test_BudUnit_set_fact_CorrectlyModifiesAttrWhen_fpick_IsNone():
    # ESTABLISH
    sue_bud = get_budunit_with_4_levels()
    weekday_road = sue_bud.make_l1_road("weekdays")
...
def test_BudUnit_set_fact_FailsToCreateWhenBaseAndFactAreDifferenctAndFactItemIsNot_RangeRoot():
    ...
    with pytest_raises(Exception) as excinfo:
        bob_bud.add_fact(base=a1e1_road, fpick=a1e1_road, fopen=20, fnigh=23)
...
def test_BudUnit_get_rangeroot_factunits_ReturnsObjsScenario0():
    ...
    sue_bud.add_fact(base=time_road, fpick=time_road, fopen=5, fnigh=10)
    ...
    sue_bud.add_fact(base=place_road, fpick=place_road, fopen=5, fnigh=10)
    ...
    sue_bud.add_fact(base=m_road, fpick=m_road)
...
def test_BudUnit_get_rangeroot_factunits_ReturnsObjsScenario1():
    ...
    sue_bud.add_fact(base=time_road, fpick=time_road, fopen=5, fnigh=10)
    sue_bud.add_fact(base=m_x_road, fpick=sue_bud.make_road(m_x_road, happy))
    print(
