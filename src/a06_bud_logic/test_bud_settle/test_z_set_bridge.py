...
def test_bud_set_fisc_label_CorrectlySetsAttr():
    ...
    assert yao_bud.conceptroot.concept_label == x_fisc_label
    casa_concept = yao_bud.get_concept_obj(new_casa_way)
    assert casa_concept.parent_way == to_way(x_fisc_label)
...
def test_bud_set_bridge_CorrectlyModifies_parent_way():
    ...
    semicolon_cook_way = zia_bud.make_way(semicolon_casa_way, cook_str)
    # print(f"{zia_bud.fisc_label=} {zia_bud.conceptroot.concept_label=} {casa_way=}")
