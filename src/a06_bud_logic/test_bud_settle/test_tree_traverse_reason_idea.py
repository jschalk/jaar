...
def test_BudUnit_reasonheirs_AreCorrectlyInheritedTo4LevelsFromLevel2():
    ...
    casa_str = "casa"
    casa_way = a4_bud.make_l1_way(casa_str)
    week_idea_label = "weekdays"
    week_way = a4_bud.make_l1_way(week_idea_label)
    wed_str = "Wednesday"
    wed_way = a4_bud.make_way(week_way, wed_str)
...
def test_BudUnit_ReasonUnits_set_premiseIdeaWithBeginCloseSetsPremisePopen_Pnigh():
    ...
    sue_bud.set_idea(ideaunit_shop(time, begin=100, close=2000), sue_bud.fisc_label)
...
def test_BudUnit_edit_idea_attr_budIsAbleToEdit_rcontext_idea_active_requisite_AnyIdeaIfInvaildThrowsError():
    ...
    sue_bud.set_idea(ideaunit_shop(run_str), sue_bud.fisc_label)
