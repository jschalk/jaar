...
def test_FilterUnit_Exists():
    # ESTABLISH
    x_filterunit = FilterUnit()

    # WHEN / THEN
    assert not x_filterunit.time_wid
    ...
    assert not x_filterunit.face_id


def test_filterunit_shop_ReturnsObj_scenario0():
    # ESTABLISH
    sue_str = "Sue"
    ...
    assert sue_filterunit.time_wid == 0
...
def test_filterunit_shop_ReturnsObj_scenario1():
    ...
    # THEN
    assert sue_filterunit.time_wid == five_time_wid
...
def test_FilterUnit_set_otx_to_inx_SetsAttr_Scenario0_type_AcctID_str():
    # ESTABLISH
    zia_str = "Zia"
    sue_otx = "Sue"
    sue_inx = "Suita"
...
def test_FilterUnit_otx_to_inx_exists_ReturnsObj():
    ...
    assert zia_filterunit.otx_to_inx_exists(road_type, sue_otx, sue_inx) is False

    # WHEN
    zia_filterunit.set_otx_to_inx(type_RoadNode_str(), sue_otx, sue_inx)

    # THEN
    assert zia_filterunit.otx_to_inx_exists(road_type, sue_otx, sue_inx)


def test_FilterUnit_get_inx_value_ReturnsObj():
    # ESTABLISH
    zia_str = "Zia"
    sue_otx = "Sue"
    sue_inx = "Suita"
    zia_filterunit = filterunit_shop(zia_str)
    assert zia_filterunit._get_inx_value(type_AcctID_str(), sue_otx) != sue_inx
...
def test_FilterUnit_del_otx_to_inx_ReturnsObj():
    # ESTABLISH
    zia_str = "Zia"
    sue_otx = "Sue"
    sue_inx = "Suita"
    ...
    road_type = type_RoadNode_str()
    zia_filterunit.set_otx_to_inx(type_RoadNode_str(), sue_otx, sue_inx)
    zia_filterunit.set_otx_to_inx(type_RoadNode_str(), zia_str, zia_str)
    assert zia_filterunit.otx_to_inx_exists(road_type, sue_otx, sue_inx)
    assert zia_filterunit.otx_to_inx_exists(road_type, zia_str, zia_str)

    # WHEN
    zia_filterunit.del_otx_to_inx(road_type, sue_otx)
...
def test_FilterUnit_set_explicit_label_SetsAttr_Scenario0_type_AcctID_str():
    # ESTABLISH
    zia_str = "Zia"
    sue_otx = "Sue"
    sue_inx = "Suita"
...
def test_FilterUnit_explicit_label_exists_ReturnsObj():
    ...
    zia_filterunit = filterunit_shop(zia_str)
    road_type = type_RoadNode_str()
    sue_exists = zia_filterunit.explicit_label_exists(road_type, sue_otx, sue_inx)
    ...
    # THEN
    assert zia_filterunit.explicit_label_exists(road_type, sue_otx, sue_inx)


def test_FilterUnit_get_explicit_inx_label_ReturnsObj():
    # ESTABLISH
    zia_str = "Zia"
    sue_otx = "Sue"
    sue_inx = "Suita"
    zia_filterunit = filterunit_shop(zia_str)
    assert zia_filterunit._get_explicit_inx_label(type_AcctID_str(), sue_otx) != sue_inx
...
def test_FilterUnit_del_explicit_label_ReturnsObj():
    # ESTABLISH
    zia_str = "Zia"
    sue_otx = "Sue"
    sue_inx = "Suita"
    ...
    road_type = type_RoadNode_str()
    zia_filterunit.set_explicit_label(type_RoadNode_str(), sue_otx, sue_inx)
    zia_filterunit.set_explicit_label(type_RoadNode_str(), zia_str, zia_str)
    assert zia_filterunit.explicit_label_exists(road_type, sue_otx, sue_inx)
    assert zia_filterunit.explicit_label_exists(road_type, zia_str, zia_str)

    # WHEN
    zia_filterunit.del_explicit_label(road_type, sue_otx)
