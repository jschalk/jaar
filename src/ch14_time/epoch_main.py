...
from ch14_time._ref.ch14_semantic_types import (
    EpochLabel,
    KnotTerm,
    LabelTerm,
    RopeTerm,
...
def get_c400_constants() -> C400Constants:
    c400_constants_path = create_path("src", "ch14_time", "c400_constants.json")
...
def epoch_config_path() -> str:
    "Returns path: src/ch14_time/epoch_configs/default_epoch_config.json"
    return create_path("src", "ch14_time", "epoch_configs", "default_epoch_config.json")
