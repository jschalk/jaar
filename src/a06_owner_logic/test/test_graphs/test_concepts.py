...
def test_ownerunit_graph_Showsgraph0OwnerGraph(graphics_bool):
    # ESTABLISH / WHEN / THEN
    display_concepttree(get_ownerunit_with_4_levels(), graphics_bool)
    display_concepttree(
        get_ownerunit_with_4_levels_and_2reasons(), "Chore", graphics_bool
    )
    display_concepttree(get_ownerunit_x1_3levels_1reason_1facts(), graphics_bool)
