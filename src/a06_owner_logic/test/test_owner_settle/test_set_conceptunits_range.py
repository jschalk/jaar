...
def test_OwnerUnit_set_concepttree_range_attrs_SetsInitialConcept_gogo_calc_stop_calc_UnitDoesNotErrorWithEmptyOwnerUnit():
    # ESTABLISH
    ...
    # WHEN
    yao_owner._set_concepttree_range_attrs()
...
def test_OwnerUnit_set_concepttree_range_attrs_SetsInitialConcept_gogo_calc_stop_calc_DoesNotErrorWhenNoMathLabels():
    # ESTABLISH
...
def test_OwnerUnit_set_concepttree_range_attrs_SetsInitialConcept_gogo_calc_stop_calc_SimpleLabel():
    # ESTABLISH
    yao_owner = ownerunit_shop("Yao")
    root_rope = to_rope(yao_owner.belief_label)
    time0_begin = 7
    time0_close = 31
    yao_owner.edit_concept_attr(root_rope, begin=time0_begin, close=time0_close)
    yao_owner._set_concept_dict()
    root_concept = yao_owner.get_concept_obj(root_rope)
...
def test_OwnerUnit_set_concepttree_range_attrs_SetsInitialConcept_gogo_calc_stop_calc_LabelWith_denom():
    # ESTABLISH
    yao_owner = ownerunit_shop("Yao")
    root_rope = to_rope(yao_owner.belief_label)
    time0_begin = 6
...
def test_OwnerUnit_set_concepttree_range_attrs_SetsInitialConcept_gogo_calc_stop_calc_LabelWith_denom_numor():
    # ESTABLISH
    yao_owner = ownerunit_shop("Yao")
    root_rope = to_rope(yao_owner.belief_label)
    time0_begin = 6
...
def test_OwnerUnit_set_concepttree_range_attrs_SetsInitialConcept_gogo_calc_stop_calc_LabelWith_addin():
    # ESTABLISH
    yao_owner = ownerunit_shop("Yao")
    root_rope = to_rope(yao_owner.belief_label)
    time0_begin = 6
...
def test_OwnerUnit_set_concepttree_range_attrs_SetsInitialConcept_gogo_calc_stop_calc_LabelWith_denom_addin():
    # ESTABLISH
    yao_owner = ownerunit_shop("Yao")
    root_rope = to_rope(yao_owner.belief_label)
    time0_begin = 6
...
def test_OwnerUnit_set_concepttree_range_attrs_SetsDescendentConcept_gogo_calc_stop_calc_Simple0():
    # ESTABLISH
    yao_owner = ownerunit_shop("Yao")
    root_rope = to_rope(yao_owner.belief_label)
    time0_str = "time0"
    ...
    yao_owner.set_l1_concept(time0_concept)

    time1_str = "time1"
    time1_rope = yao_owner.make_rope(time0_rope, time1_str)
    yao_owner.set_concept(conceptunit_shop(time1_str), time0_rope)
    time1_concept = yao_owner.get_concept_obj(time1_rope)
    root_concept = yao_owner.get_concept_obj(root_rope)
    yao_owner._set_concept_dict()
    assert not root_concept._gogo_calc
    assert not root_concept._stop_calc
...
def test_OwnerUnit_set_concepttree_range_attrs_SetsDescendentConcept_gogo_calc_stop_calc_LabelWith_denom():
    # ESTABLISH
    yao_owner = ownerunit_shop("Yao")
    time0_str = "time0"
    time0_rope = yao_owner.make_l1_rope(time0_str)
    ...
    time1_denom = 7
    time1_rope = yao_owner.make_rope(time0_rope, time1_str)
    yao_owner.set_concept(conceptunit_shop(time1_str, denom=time1_denom), time0_rope)
    time1_concept = yao_owner.get_concept_obj(time1_rope)
    root_rope = to_rope(yao_owner.belief_label)
    root_concept = yao_owner.get_concept_obj(root_rope)
    yao_owner._set_concept_dict()
...
def test_OwnerUnit_set_concepttree_range_attrs_SetsDescendentConcept_gogo_calc_stop_calc_LabelWith_denom_numor():
    # ESTABLISH
    yao_owner = ownerunit_shop("Yao")
    time0_str = "time0"
    time0_rope = yao_owner.make_l1_rope(time0_str)
    ...
    yao_owner.set_concept(temp_concept, time0_rope)
    time1_concept = yao_owner.get_concept_obj(time1_rope)
    root_rope = to_rope(yao_owner.belief_label)
    root_concept = yao_owner.get_concept_obj(root_rope)
    yao_owner._set_concept_dict()
...
def test_OwnerUnit_set_concepttree_range_attrs_SetsDescendentConcept_gogo_calc_stop_calc_LabelWith_addin():
    # ESTABLISH
    yao_owner = ownerunit_shop("Yao")
    time0_str = "time0"
    time0_rope = yao_owner.make_l1_rope(time0_str)
...
def test_OwnerUnit_set_concepttree_range_attrs_Sets2LevelsDescendentConcept_gogo_calc_stop_calc_LabelWith_addin():
    # ESTABLISH
    yao_owner = ownerunit_shop("Yao")
    time0_str = "time0"
    time0_rope = yao_owner.make_l1_rope(time0_str)
    ...
    time1_str = "time1"
    time1_rope = yao_owner.make_rope(time0_rope, time1_str)
    yao_owner.add_concept(time1_rope)
    time2_str = "time2"
    time2_rope = yao_owner.make_rope(time1_rope, time2_str)
    time2_addin = 5
    x_time2_concept = conceptunit_shop(time2_str, addin=time2_addin)
    yao_owner.set_concept(x_time2_concept, time1_rope)
    time2_concept = yao_owner.get_concept_obj(time2_rope)
    root_rope = to_rope(yao_owner.belief_label)
    root_concept = yao_owner.get_concept_obj(root_rope)
    yao_owner._set_concept_dict()
    assert not root_concept._gogo_calc
...
def test_OwnerUnit_set_concepttree_range_attrs_SetsDescendentConcept_gogo_calc_stop_calc_LabelWith_denom_addin():
    # ESTABLISH
    yao_owner = ownerunit_shop("Yao")
    time0_str = "time0"
    time0_rope = yao_owner.make_l1_rope(time0_str)
...
def test_OwnerUnit_set_concepttree_range_attrs_SetsDescendentConcept_When_knot_IsNonDefault():
    # ESTABLISH
    slash_str = "/"
