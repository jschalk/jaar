...
def test_create_groupunits_metrics_SetsAttrScenario0():
    ...
    sue_ownerunit._groupunits = None
    assert sue_ownerunit._groupunits is None

    # WHEN
    sue_ownerunit._create_groupunits_metrics()

    # THEN
    assert sue_ownerunit._groupunits == {}
...
def test_create_groupunits_metrics_SetsAttrScenario1():
    ...
    # THEN
    assert len(sue_ownerunit._groupunits) == 2
    assert set(sue_ownerunit._groupunits.keys()) == {yao_str, ohio_str}
    ohio_groupunit = sue_ownerunit.get_groupunit(ohio_str)
    assert ohio_groupunit._credor_pool == 77
    assert ohio_groupunit._debtor_pool == 88
    yao_groupunit = sue_ownerunit.get_groupunit(yao_str)
    assert yao_groupunit._credor_pool == 66
    assert yao_groupunit._debtor_pool == 44


def test_OwnerUnit_set_acctunit_groupunit_respect_ledgers_SetsAttr_scenario0():
    # ESTABLISH
    sue_str = "Sue"
    sue_ownerunit = ownerunit_shop(sue_str)
    assert sue_ownerunit._groupunits == {}
    ...
    # WHEN
    sue_ownerunit._set_acctunit_groupunit_respect_ledgers()

    # THEN
    assert sue_ownerunit._groupunits == {}


def test_OwnerUnit_set_acctunit_groupunit_respect_ledgers_Clears_groups():
    # ESTABLISH
    sue_str = "Sue"
    sue_ownerunit = ownerunit_shop(sue_str)
    sue_ownerunit._groups = "yeah"
    sue_ownerunit._groupunits = "ohio"
    assert sue_ownerunit._groups != {}
    assert sue_ownerunit._groupunits != {}
...
def test_OwnerUnit_set_acctunit_groupunit_respect_ledgers_SetsAttr_scenario1():
    # ESTABLISH
    sue_str = "Sue"
    sue_ownerunit = ownerunit_shop(sue_str)
    yao_str = "Yao"
    ...
    assert yao_acctunit._credor_pool != 0
    assert yao_acctunit._debtor_pool != 0
    assert yao_acctunit._credor_pool == sue_ownerunit.credor_respect
    assert yao_acctunit._debtor_pool == sue_ownerunit.debtor_respect
    ...
    assert yao_membership._credor_pool == sue_ownerunit.credor_respect
    assert yao_membership._debtor_pool == sue_ownerunit.debtor_respect
...
def test_OwnerUnit_set_acctunit_groupunit_respect_ledgers_SetsAttr_scenario2():
    # ESTABLISH
    sue_str = "Sue"
    sue_ownerunit = ownerunit_shop(sue_str)
    yao_str = "Yao"
    ...
    # THEN
    assert sue_ownerunit.get_acct(yao_str)._credor_pool != 0
    assert sue_ownerunit.get_acct(yao_str)._debtor_pool != 0
    assert yao_acctunit.get_membership(yao_str)._credor_pool != 0
    assert yao_acctunit.get_membership(yao_str)._debtor_pool != 0
    yao_yao_membership = yao_acctunit.get_membership(yao_str)
    assert yao_yao_membership._credor_pool != 0
    assert yao_yao_membership._debtor_pool != 0
    assert yao_yao_membership._credor_pool == sue_ownerunit.credor_respect * 0.25
    assert yao_yao_membership._debtor_pool == sue_ownerunit.debtor_respect * 0.8
    ...
    assert yao_ohio_membership._credor_pool == sue_ownerunit.credor_respect * 0.75
    assert yao_ohio_membership._debtor_pool == sue_ownerunit.debtor_respect * 0.2
...
def test_OwnerUnit_set_acctunit_groupunit_respect_ledgers_ResetAcctUnitsAttrs():
    # ESTABLISH
    sue_str = "Sue"
    sue_ownerunit = ownerunit_shop(sue_str)
    yao_str = "Yao"
    zia_str = "Zia"
    sue_ownerunit.add_acctunit(yao_str, 55, 55)
    sue_ownerunit.add_acctunit(zia_str, 55, 55)
    yao_acctunit = sue_ownerunit.get_acct(yao_str)
    zia_acctunit = sue_ownerunit.get_acct(zia_str)
