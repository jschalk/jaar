...
def test_get_credit_ledger_ReturnsObj_Scenario1_acctunits_Exist():
    ...
    sue_plan.add_acctunit(yao_str, yao_acct_cred_points)
    sue_plan.add_acctunit(bob_str, bob_acct_cred_points)
    sue_plan.add_acctunit(xio_str, xio_acct_cred_points)
