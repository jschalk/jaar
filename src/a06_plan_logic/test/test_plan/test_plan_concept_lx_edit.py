...
def test_PlanUnit_edit_concept_label_RaisesErrorForLevel0ConceptWhen_belief_label_isNone():
    # ESTABLISH
    yao_str = "Yao"
    ...
    assert (
        str(excinfo.value)
        == f"Cannot set conceptroot to string different than '{yao_plan.belief_label}'"
    )
...
def test_PlanUnit_edit_concept_label_RaisesErrorForLevel0When_belief_label_IsDifferent():
    # ESTABLISH
    yao_str = "Yao"
    yao_plan = planunit_shop(owner_name=yao_str)
    casa_str = "casa"
    ...
    yao_plan.set_concept(conceptunit_shop(swim_str), parent_rope=casa_rope)
    sun_str = "sun"
    yao_plan.belief_label = sun_str
    yao_plan.conceptroot.belief_label = sun_str
    assert yao_plan.owner_name == yao_str
    assert yao_plan.belief_label == sun_str
    assert yao_plan.conceptroot.belief_label == sun_str
...
def test_plan_set_owner_name_CorrectlyModifiesBoth():
    ...
    assert sue_plan.conceptroot.concept_label == sue_plan.belief_label
