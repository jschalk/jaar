...
def test_PlanUnit_set_concepttree_range_attrs_SetsDescendentConcept_gogo_calc_stop_calc_Simple0():
    ...
    root_way = to_way(yao_plan.vow_label)
    time0_str = "time0"
    time0_way = yao_plan.make_l1_way(time0_str)
    time0_begin = 7
    time0_close = 31
    ...
    time1_str = "time1"
    time1_way = yao_plan.make_way(time0_way, time1_str)
    yao_plan.set_concept(conceptunit_shop(time1_str), time0_way)
    time1_concept = yao_plan.get_concept_obj(time1_way)
    root_concept = yao_plan.get_concept_obj(root_way)
    yao_plan._set_concept_dict()
    assert not root_concept._gogo_calc
    assert not root_concept._stop_calc
    ...
    assert yao_plan._range_inheritors == {time1_way: time0_way}
...
def test_PlanUnit_set_concepttree_range_attrs_SetsDescendentConcept_gogo_calc_stop_calc_LabelWith_denom():
    ...
    time1_denom = 7
    time1_way = yao_plan.make_way(time0_way, time1_str)
    yao_plan.set_concept(conceptunit_shop(time1_str, denom=time1_denom), time0_way)
    time1_concept = yao_plan.get_concept_obj(time1_way)
    root_way = to_way(yao_plan.vow_label)
    root_concept = yao_plan.get_concept_obj(root_way)
    yao_plan._set_concept_dict()
...
def test_PlanUnit_set_concepttree_range_attrs_SetsDescendentConcept_gogo_calc_stop_calc_LabelWith_denom_numor():
    ...
    yao_plan.set_concept(temp_concept, time0_way)
    time1_concept = yao_plan.get_concept_obj(time1_way)
    root_way = to_way(yao_plan.vow_label)
    root_concept = yao_plan.get_concept_obj(root_way)
    yao_plan._set_concept_dict()
...
def test_PlanUnit_set_concepttree_range_attrs_Sets2LevelsDescendentConcept_gogo_calc_stop_calc_LabelWith_addin():
    ...
    time1_str = "time1"
    time1_way = yao_plan.make_way(time0_way, time1_str)
    yao_plan.add_concept(time1_way)
    time2_str = "time2"
    time2_way = yao_plan.make_way(time1_way, time2_str)
    time2_addin = 5
    x_time2_concept = conceptunit_shop(time2_str, addin=time2_addin)
    yao_plan.set_concept(x_time2_concept, time1_way)
    time2_concept = yao_plan.get_concept_obj(time2_way)
    root_way = to_way(yao_plan.vow_label)
    root_concept = yao_plan.get_concept_obj(root_way)
    yao_plan._set_concept_dict()
    assert not root_concept._gogo_calc
    ...
    assert yao_plan._range_inheritors == {time1_way: time0_way, time2_way: time0_way}
