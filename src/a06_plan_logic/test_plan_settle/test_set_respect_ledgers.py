...
def test_create_groupunits_metrics_SetsAttrScenario0():
    ...
    sue_planunit._groupunits = None
    assert sue_planunit._groupunits is None

    # WHEN
    sue_planunit._create_groupunits_metrics()

    # THEN
    assert sue_planunit._groupunits == {}
...
def test_create_groupunits_metrics_SetsAttrScenario1():
    ...
    # THEN
    assert len(sue_planunit._groupunits) == 2
    assert set(sue_planunit._groupunits.keys()) == {yao_str, ohio_str}
    ...
    yao_groupunit = sue_planunit.get_groupunit(yao_str)
    assert yao_groupunit._credor_pool == 66
    assert yao_groupunit._debtor_pool == 44


def test_PlanUnit_set_acctunit_groupunit_respect_ledgers_SetsAttr_scenario0():
    # ESTABLISH
    sue_str = "Sue"
    sue_planunit = planunit_shop(sue_str)
    assert sue_planunit._groupunits == {}
    ...
    # WHEN
    sue_planunit._set_acctunit_groupunit_respect_ledgers()

    # THEN
    assert sue_planunit._groupunits == {}


def test_PlanUnit_set_acctunit_groupunit_respect_ledgers_Clears_groups():
    # ESTABLISH
    sue_str = "Sue"
    sue_planunit = planunit_shop(sue_str)
    sue_planunit._groups = "yeah"
    sue_planunit._groupunits = "ohio"
    assert sue_planunit._groups != {}
    assert sue_planunit._groupunits != {}
...
def test_PlanUnit_set_acctunit_groupunit_respect_ledgers_SetsAttr_scenario1():
    # ESTABLISH
    sue_str = "Sue"
    sue_planunit = planunit_shop(sue_str)
    yao_str = "Yao"
    ...
    assert yao_acctunit._credor_pool != 0
    assert yao_acctunit._debtor_pool != 0
    assert yao_acctunit._credor_pool == sue_planunit.credor_respect
    assert yao_acctunit._debtor_pool == sue_planunit.debtor_respect
    ...
    assert yao_membership._credor_pool == sue_planunit.credor_respect
    assert yao_membership._debtor_pool == sue_planunit.debtor_respect
...
def test_PlanUnit_set_acctunit_groupunit_respect_ledgers_SetsAttr_scenario2():
    # ESTABLISH
    sue_str = "Sue"
    sue_planunit = planunit_shop(sue_str)
    yao_str = "Yao"
    ...
    # THEN
    assert sue_planunit.get_acct(yao_str)._credor_pool != 0
    assert sue_planunit.get_acct(yao_str)._debtor_pool != 0
    assert yao_acctunit.get_membership(yao_str)._credor_pool != 0
    assert yao_acctunit.get_membership(yao_str)._debtor_pool != 0
    yao_yao_membership = yao_acctunit.get_membership(yao_str)
    assert yao_yao_membership._credor_pool != 0
    assert yao_yao_membership._debtor_pool != 0
    assert yao_yao_membership._credor_pool == sue_planunit.credor_respect * 0.25
    assert yao_yao_membership._debtor_pool == sue_planunit.debtor_respect * 0.8
    ...
    assert yao_ohio_membership._credor_pool == sue_planunit.credor_respect * 0.75
    assert yao_ohio_membership._debtor_pool == sue_planunit.debtor_respect * 0.2
...
def test_PlanUnit_set_acctunit_groupunit_respect_ledgers_ResetAcctUnitsAttrs():
    # ESTABLISH
    sue_str = "Sue"
    sue_planunit = planunit_shop(sue_str)
    yao_str = "Yao"
    zia_str = "Zia"
    sue_planunit.add_acctunit(yao_str, 55, 55)
    sue_planunit.add_acctunit(zia_str, 55, 55)
    yao_acctunit = sue_planunit.get_acct(yao_str)
    zia_acctunit = sue_planunit.get_acct(zia_str)
    ...
    zia_acctunit.set_fund_agenda_ratio_give_take(
        ...
        acctunits_credit_belief_sum=zia_3,
        acctunits_debtit_belief_sum=zia_4,
    )
    yao_1 = 0.2
    yao_2 = 0.5
    yao_3 = 204
    ...
    yao_acctunit.set_fund_agenda_ratio_give_take(
        ...
        acctunits_credit_belief_sum=yao_3,
        acctunits_debtit_belief_sum=yao_4,
    )
