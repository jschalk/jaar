...
CREATE_BLFUNIT_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS momentunit_s_raw (idea_number TEXT, event_int INTEGER, face_name TEXT, moment_label TEXT, timeline_label TEXT, c400_number INTEGER, yr1_jan1_offset INTEGER, monthday_index INTEGER, fund_grain REAL, penny REAL, respect_grain REAL, knot TEXT, job_listen_rotations INTEGER, error_message TEXT)"""
...
CREATE_BLFUNIT_SOUND_VLD_SQLSTR = """CREATE TABLE IF NOT EXISTS momentunit_s_vld (event_int INTEGER, face_name TEXT, moment_label TEXT, timeline_label TEXT, c400_number INTEGER, yr1_jan1_offset INTEGER, monthday_index INTEGER, fund_grain REAL, penny REAL, respect_grain REAL, knot TEXT, job_listen_rotations INTEGER)"""
CREATE_BLFUNIT_HEARD_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS momentunit_h_raw (event_int INTEGER, face_name_otx TEXT, face_name_inx TEXT, moment_label_otx TEXT, moment_label_inx TEXT, timeline_label_otx TEXT, timeline_label_inx TEXT, c400_number INTEGER, yr1_jan1_offset INTEGER, monthday_index INTEGER, fund_grain REAL, penny REAL, respect_grain REAL, knot TEXT, job_listen_rotations INTEGER, error_message TEXT)"""
CREATE_BLFUNIT_HEARD_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS momentunit_h_agg (moment_label TEXT, timeline_label TEXT, c400_number INTEGER, yr1_jan1_offset INTEGER, monthday_index INTEGER, fund_grain REAL, penny REAL, respect_grain REAL, knot TEXT, job_listen_rotations INTEGER)"""
...
CREATE_BLRUNIT_SOUND_PUT_VLD_STR = "CREATE TABLE IF NOT EXISTS beliefunit_s_put_vld (event_int INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, credor_respect REAL, debtor_respect REAL, fund_pool REAL, max_tree_traverse INTEGER, tally INTEGER, fund_grain REAL, penny REAL, respect_grain REAL)"
...
CREATE_BLRUNIT_HEARD_PUT_RAW_STR = "CREATE TABLE IF NOT EXISTS beliefunit_h_put_raw (translate_event_int INTEGER, event_int INTEGER, face_name_otx TEXT, face_name_inx TEXT, moment_label_otx TEXT, moment_label_inx TEXT, belief_name_otx TEXT, belief_name_inx TEXT, credor_respect REAL, debtor_respect REAL, fund_pool REAL, max_tree_traverse INTEGER, tally INTEGER, fund_grain REAL, penny REAL, respect_grain REAL)"
CREATE_BLRUNIT_HEARD_PUT_AGG_STR = "CREATE TABLE IF NOT EXISTS beliefunit_h_put_agg (event_int INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, credor_respect REAL, debtor_respect REAL, fund_pool REAL, max_tree_traverse INTEGER, tally INTEGER, fund_grain REAL, penny REAL, respect_grain REAL)"
...
INSERT_BLRUNIT_SOUND_VLD_PUT_SQLSTR = "INSERT INTO beliefunit_s_put_vld (event_int, face_name, moment_label, belief_name, credor_respect, debtor_respect, fund_pool, max_tree_traverse, tally, fund_grain, penny, respect_grain) SELECT event_int, face_name, moment_label, belief_name, credor_respect, debtor_respect, fund_pool, max_tree_traverse, tally, fund_grain, penny, respect_grain FROM beliefunit_s_put_agg WHERE error_message IS NULL"
...
INSERT_BLFUNIT_SOUND_VLD_SQLSTR = "INSERT INTO momentunit_s_vld (event_int, face_name, moment_label, timeline_label, c400_number, yr1_jan1_offset, monthday_index, fund_grain, penny, respect_grain, knot, job_listen_rotations) SELECT event_int, face_name, moment_label, timeline_label, c400_number, yr1_jan1_offset, monthday_index, fund_grain, penny, respect_grain, knot, job_listen_rotations FROM momentunit_s_agg WHERE error_message IS NULL"
...
INSERT_BLFUNIT_HEARD_RAW_SQLSTR = "INSERT INTO momentunit_h_raw (event_int, face_name_otx, moment_label_otx, timeline_label_otx, c400_number, yr1_jan1_offset, monthday_index, fund_grain, penny, respect_grain, knot, job_listen_rotations) SELECT event_int, face_name, moment_label, timeline_label, c400_number, yr1_jan1_offset, monthday_index, fund_grain, penny, respect_grain, knot, job_listen_rotations FROM momentunit_s_vld "
...
INSERT_BLRUNIT_HEARD_RAW_PUT_SQLSTR = "INSERT INTO beliefunit_h_put_raw (event_int, face_name_otx, moment_label_otx, belief_name_otx, credor_respect, debtor_respect, fund_pool, max_tree_traverse, tally, fund_grain, penny, respect_grain) SELECT event_int, face_name, moment_label, belief_name, credor_respect, debtor_respect, fund_pool, max_tree_traverse, tally, fund_grain, penny, respect_grain FROM beliefunit_s_put_vld "
...
INSERT INTO momentunit_h_agg (moment_label, timeline_label, c400_number, yr1_jan1_offset, monthday_index, fund_grain, penny, respect_grain, knot, job_listen_rotations)
SELECT moment_label_inx, timeline_label_inx, c400_number, yr1_jan1_offset, monthday_index, fund_grain, penny, respect_grain, knot, job_listen_rotations
FROM momentunit_h_raw
GROUP BY moment_label_inx, timeline_label_inx, c400_number, yr1_jan1_offset, monthday_index, fund_grain, penny, respect_grain, knot, job_listen_rotations
"""
...
INSERT INTO beliefunit_h_put_agg (event_int, face_name, moment_label, belief_name, credor_respect, debtor_respect, fund_pool, max_tree_traverse, tally, fund_grain, penny, respect_grain)
SELECT event_int, face_name_inx, moment_label_inx, belief_name_inx, credor_respect, debtor_respect, fund_pool, max_tree_traverse, tally, fund_grain, penny, respect_grain
FROM beliefunit_h_put_raw
GROUP BY event_int, face_name_inx, moment_label_inx, belief_name_inx, credor_respect, debtor_respect, fund_pool, max_tree_traverse, tally, fund_grain, penny, respect_grain
"""
...
BLFUNIT_FU2_SELECT_SQLSTR = "SELECT moment_label, timeline_label, c400_number, yr1_jan1_offset, monthday_index, fund_grain, penny, respect_grain, knot, job_listen_rotations FROM momentunit_h_agg WHERE moment_label = "
...
CREATE_JOB_BLRUNIT_SQLSTR = """CREATE TABLE IF NOT EXISTS beliefunit_job (moment_label TEXT, belief_name TEXT, credor_respect REAL, debtor_respect REAL, fund_pool REAL, max_tree_traverse INTEGER, tally INTEGER, fund_grain REAL, penny REAL, respect_grain REAL, rational INTEGER, keeps_justified INTEGER, offtrack_fund REAL, sum_healerunit_share REAL, keeps_buildable INTEGER, tree_traverse_count INTEGER)"""
