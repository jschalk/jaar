...
def test_etl_moment_ote1_agg_csvs_to_jsons_CreatesFile_Scenaro0(
    ...
    a23_event_time_csv = f"""{moment_label_str()},{belief_name_str()},{event_int_str()},{wx.bud_time},{error_message_str()}
{amy23_str},{bob_str},{event3},{timepoint55},
"""
    a45_event_time_csv = f"""{moment_label_str()},{belief_name_str()},{event_int_str()},{wx.bud_time},{error_message_str()}
