from src.f02_bud.bud import BudUnit, budunit_shop, itemunit_shop, DealIdea
from src.f06_keep.examples.keep_env import temp_deal_idea


def get_1idea_bud() -> BudUnit:
    x_bud = budunit_shop("A")
    x_bud.set_deal_idea(temp_deal_idea())
    x_bud.settle_bud()
    return x_bud
...
def get_2idea_bud(deal_idea: DealIdea = None) -> BudUnit:
