...
def get_belief_calc_args_type_dict() -> dict[str, str]:
    return {
        ...
        "_inallocable_voice_debt_points": "float",
        "_irrational_voice_debt_points": "float",
...
def get_belief_calc_args_sqlite_datatype_dict() -> dict[str, str]:
    return {
        ...
        "_inallocable_voice_debt_points": "REAL",
        "_irrational_voice_debt_points": "REAL",
        ...
        "_active": "INTEGER",
        "_all_voice_cred": "INTEGER",
        "_all_voice_debt": "INTEGER",
