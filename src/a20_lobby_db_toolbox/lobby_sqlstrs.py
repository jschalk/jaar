...
def create_budacct_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    real_str = "REAL"
    return f"""INSERT INTO bud_acctunit_job (world_id, fisc_word, owner_name, acct_name, credit_belief, debtit_belief, _credor_pool, _debtor_pool, _fund_give, _fund_take, _fund_agenda_give, _fund_agenda_take, _fund_agenda_ratio_give, _fund_agenda_ratio_take, _inallocable_debtit_belief, _irrational_debtit_belief)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_word, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budfact_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_idea_factunit_job (world_id, fisc_word, owner_name, idea_way, fcontext, fbranch, fopen, fnigh)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_word, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budheal_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_idea_healerlink_job (world_id, fisc_word, owner_name, idea_way, healer_name)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_word, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budprem_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_idea_reason_premiseunit_job (world_id, fisc_word, owner_name, idea_way, rcontext, pbranch, pnigh, popen, pdivisor, _task, _status)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_word, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budreas_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_idea_reasonunit_job (world_id, fisc_word, owner_name, idea_way, rcontext, rcontext_idea_active_requisite, _task, _status, _rcontext_idea_active_value)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_word, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budunit_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO budunit_job (world_id, fisc_word, owner_name, credor_respect, debtor_respect, fund_pool, max_tree_traverse, tally, fund_coin, penny, respect_bit, _rational, _keeps_justified, _offtrack_fund, _sum_healerlink_share, _keeps_buildable, _tree_traverse_count)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_word, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
