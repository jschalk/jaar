...
CREATE_JOB_BUDAWAR_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_concept_awardlink_job (world_id TEXT, fisc_label TEXT, owner_name TEXT, concept_way TEXT, awardee_title TEXT, give_force REAL, take_force REAL, _fund_give REAL, _fund_take REAL)"""
CREATE_JOB_BUDFACT_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_concept_factunit_job (world_id TEXT, fisc_label TEXT, owner_name TEXT, concept_way TEXT, fcontext TEXT, fbranch TEXT, fopen REAL, fnigh REAL)"""
CREATE_JOB_BUDHEAL_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_concept_healerlink_job (world_id TEXT, fisc_label TEXT, owner_name TEXT, concept_way TEXT, healer_name TEXT)"""
...
def create_budawar_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    _fund_give = values_dict.get("_fund_give")
    _fund_take = values_dict.get("_fund_take")
    return f"""INSERT INTO bud_concept_awardlink_job (world_id, fisc_label, owner_name, concept_way, awardee_title, give_force, take_force, _fund_give, _fund_take)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budfact_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_concept_factunit_job (world_id, fisc_label, owner_name, concept_way, fcontext, fbranch, fopen, fnigh)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budheal_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_concept_healerlink_job (world_id, fisc_label, owner_name, concept_way, healer_name)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budprem_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_concept_reason_premiseunit_job (world_id, fisc_label, owner_name, concept_way, rcontext, pbranch, pnigh, popen, pdivisor, _task, _status)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budreas_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_concept_reasonunit_job (world_id, fisc_label, owner_name, concept_way, rcontext, rcontext_concept_active_requisite, _task, _status, _rcontext_concept_active_value)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budlabor_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_concept_laborlink_job (world_id, fisc_label, owner_name, concept_way, labor_title, _owner_name_labor)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budconcept_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_conceptunit_job (world_id, fisc_label, owner_name, concept_way, begin, close, addin, numor, denom, morph, gogo_want, stop_want, mass, pledge, problem_bool, fund_coin, _active, _task, _fund_onset, _fund_cease, _fund_ratio, _gogo_calc, _stop_calc, _level, _range_evaluated, _descendant_pledge_count, _healerlink_ratio, _all_acct_cred, _all_acct_debt)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
