...
CREATE_JOB_BUDMEMB_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_acct_membership_job (world_id TEXT, fisc_label TEXT, owner_name TEXT, acct_name TEXT, group_title TEXT, credit_vote REAL, debtit_vote REAL, _credor_pool REAL, _debtor_pool REAL, _fund_give REAL, _fund_take REAL, _fund_agenda_give REAL, _fund_agenda_take REAL, _fund_agenda_ratio_give REAL, _fund_agenda_ratio_take REAL)"""
CREATE_JOB_BUDACCT_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_acctunit_job (world_id TEXT, fisc_label TEXT, owner_name TEXT, acct_name TEXT, credit_belief REAL, debtit_belief REAL, _credor_pool REAL, _debtor_pool REAL, _fund_give REAL, _fund_take REAL, _fund_agenda_give REAL, _fund_agenda_take REAL, _fund_agenda_ratio_give REAL, _fund_agenda_ratio_take REAL, _inallocable_debtit_belief REAL, _irrational_debtit_belief REAL)"""
CREATE_JOB_BUDGROU_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_groupunit_job (world_id TEXT, fisc_label TEXT, owner_name TEXT, group_title TEXT, fund_coin REAL, bridge TEXT, _credor_pool REAL, _debtor_pool REAL, _fund_give REAL, _fund_take REAL, _fund_agenda_give REAL, _fund_agenda_take REAL)"""
CREATE_JOB_BUDAWAR_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_idea_awardlink_job (world_id TEXT, fisc_label TEXT, owner_name TEXT, idea_way TEXT, awardee_title TEXT, give_force REAL, take_force REAL, _fund_give REAL, _fund_take REAL)"""
CREATE_JOB_BUDFACT_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_idea_factunit_job (world_id TEXT, fisc_label TEXT, owner_name TEXT, idea_way TEXT, fcontext TEXT, fbranch TEXT, fopen REAL, fnigh REAL)"""
CREATE_JOB_BUDHEAL_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_idea_healerlink_job (world_id TEXT, fisc_label TEXT, owner_name TEXT, idea_way TEXT, healer_name TEXT)"""
CREATE_JOB_BUDPREM_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_idea_reason_premiseunit_job (world_id TEXT, fisc_label TEXT, owner_name TEXT, idea_way TEXT, rcontext TEXT, pbranch TEXT, pnigh REAL, popen REAL, pdivisor INTEGER, _task INTEGER, _status INTEGER)"""
CREATE_JOB_BUDREAS_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_idea_reasonunit_job (world_id TEXT, fisc_label TEXT, owner_name TEXT, idea_way TEXT, rcontext TEXT, rcontext_idea_active_requisite INTEGER, _task INTEGER, _status INTEGER, _rcontext_idea_active_value INTEGER)"""
CREATE_JOB_BUDLABOR_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_idea_laborlink_job (world_id TEXT, fisc_label TEXT, owner_name TEXT, idea_way TEXT, labor_title TEXT, _owner_name_labor INTEGER)"""
CREATE_JOB_BUDIDEA_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_ideaunit_job (world_id TEXT, fisc_label TEXT, owner_name TEXT, idea_way TEXT, begin REAL, close REAL, addin REAL, numor INTEGER, denom INTEGER, morph INTEGER, gogo_want REAL, stop_want REAL, mass INTEGER, pledge INTEGER, problem_bool INTEGER, fund_coin REAL, _active INTEGER, _task INTEGER, _fund_onset REAL, _fund_cease REAL, _fund_ratio REAL, _gogo_calc REAL, _stop_calc REAL, _level INTEGER, _range_evaluated INTEGER, _descendant_pledge_count INTEGER, _healerlink_ratio REAL, _all_acct_cred INTEGER, _all_acct_debt INTEGER)"""
...
def create_budmemb_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    real_str = "REAL"
    return f"""INSERT INTO bud_acct_membership_job (world_id, fisc_label, owner_name, acct_name, group_title, credit_vote, debtit_vote, _credor_pool, _debtor_pool, _fund_give, _fund_take, _fund_agenda_give, _fund_agenda_take, _fund_agenda_ratio_give, _fund_agenda_ratio_take)
VALUES (
...
def create_budacct_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    real_str = "REAL"
    return f"""INSERT INTO bud_acctunit_job (world_id, fisc_label, owner_name, acct_name, credit_belief, debtit_belief, _credor_pool, _debtor_pool, _fund_give, _fund_take, _fund_agenda_give, _fund_agenda_take, _fund_agenda_ratio_give, _fund_agenda_ratio_take, _inallocable_debtit_belief, _irrational_debtit_belief)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budgrou_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    real_str = "REAL"
    return f"""INSERT INTO bud_groupunit_job (world_id, fisc_label, owner_name, group_title, fund_coin, bridge, _credor_pool, _debtor_pool, _fund_give, _fund_take, _fund_agenda_give, _fund_agenda_take)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budawar_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    _fund_give = values_dict.get("_fund_give")
    _fund_take = values_dict.get("_fund_take")
    return f"""INSERT INTO bud_idea_awardlink_job (world_id, fisc_label, owner_name, idea_way, awardee_title, give_force, take_force, _fund_give, _fund_take)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budfact_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_idea_factunit_job (world_id, fisc_label, owner_name, idea_way, fcontext, fbranch, fopen, fnigh)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budheal_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_idea_healerlink_job (world_id, fisc_label, owner_name, idea_way, healer_name)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budprem_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_idea_reason_premiseunit_job (world_id, fisc_label, owner_name, idea_way, rcontext, pbranch, pnigh, popen, pdivisor, _task, _status)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budreas_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_idea_reasonunit_job (world_id, fisc_label, owner_name, idea_way, rcontext, rcontext_idea_active_requisite, _task, _status, _rcontext_idea_active_value)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budlabor_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO bud_idea_laborlink_job (world_id, fisc_label, owner_name, idea_way, labor_title, _owner_name_labor)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_budunit_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO budunit_job (world_id, fisc_label, owner_name, credor_respect, debtor_respect, fund_pool, max_tree_traverse, tally, fund_coin, penny, respect_bit, _rational, _keeps_justified, _offtrack_fund, _sum_healerlink_share, _keeps_buildable, _tree_traverse_count)
VALUES (
  {sqlite_obj_str(world_id, "TEXT")}
, {sqlite_obj_str(fisc_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
