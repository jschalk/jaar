...
def test_sift_atom_ReturnsObj_BelieverAtom_DELETE_believer_acctunit():
    # ESTABLISH
    bob_str = "Bob"
    zia_str = "Zia"
...
def test_sift_atom_ReturnsObj_BelieverAtom_DELETE_believer_acct_membership():
    # ESTABLISH
    bob_str = "Bob"
    yao_str = "Yao"
    run_str = ";run"
...
def test_sift_atom_SetsBelieverDeltaBelieverAtom_believer_plan_reason_premiseunit_exists():
    # ESTABLISH
    sue_believer = believerunit_shop("Sue")
    casa_str = "casa"
    casa_rope = sue_believer.make_l1_rope(casa_str)
