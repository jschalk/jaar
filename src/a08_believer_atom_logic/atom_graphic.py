...
def believeratom_periodic_table0() -> plotly_Figure:
    ...
    believer_acctunit_insert = get_insert_rect("believer_acctunit")
    believer_acct_membership_insert = get_insert_rect("believer_acct_membership")
    ...
    believer_acctunit_update = get_update_rect("believer_acctunit")
    believer_acct_membership_update = get_update_rect("believer_acct_membership")
    ...
    believer_acct_membership_delete = get_delete_rect("believer_acct_membership")
    believer_acctunit_delete = get_delete_rect("believer_acctunit")
    believerunit_update = get_update_rect("believerunit")

    green_str = "Green"
    believer_acctunit_insert.set_level(0, 0, 0.25, green_str)
    believer_acctunit_update.set_level(0, 0.25, 0.75, green_str)
    believer_acctunit_delete.set_level(0, 0.75, 1, green_str)
    believer_acct_membership_insert.set_level(1, 0, 0.3, green_str)
    believer_acct_membership_update.set_level(1, 0.3, 0.7, green_str)
    believer_acct_membership_delete.set_level(1, 0.7, 1, green_str)
    ...
    # Add shapes
    add_atom_rect(fig, believer_acctunit_insert)
    add_atom_rect(fig, believer_acct_membership_insert)
    ...
    add_atom_rect(fig, believer_acctunit_update)
    add_atom_rect(fig, believer_acct_membership_update)
    ...
    add_atom_rect(fig, believer_acct_membership_delete)
    add_atom_rect(fig, believer_acctunit_delete)
