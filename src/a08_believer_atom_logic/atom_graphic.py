...
def believeratom_periodic_table0() -> plotly_Figure:
    ...
    premise_str = "believer_plan_reason_premiseunit"
    believer_personunit_insert = get_insert_rect("believer_personunit")
    believer_person_membership_insert = get_insert_rect("believer_person_membership")
    believer_planunit_insert = get_insert_rect("believer_planunit")
    believer_plan_awardlink_insert = get_insert_rect("believer_plan_awardlink")
    believer_plan_laborlink_insert = get_insert_rect("believer_plan_laborlink")
    ...
    believer_plan_reason_premiseunit_insert = get_insert_rect(premise_str)
    believer_personunit_update = get_update_rect("believer_personunit")
    believer_person_membership_update = get_update_rect("believer_person_membership")
    believer_planunit_update = get_update_rect("believer_planunit")
    believer_plan_awardlink_update = get_update_rect("believer_plan_awardlink")
    believer_plan_factunit_update = get_update_rect("believer_plan_factunit")
    believer_plan_reason_premiseunit_update = get_update_rect(premise_str)
    believer_plan_reasonunit_update = get_update_rect("believer_plan_reasonunit")
    believer_plan_reason_premiseunit_delete = get_delete_rect(premise_str)
    ...
    believer_plan_laborlink_delete = get_delete_rect("believer_plan_laborlink")
    believer_plan_healerlink_delete = get_delete_rect("believer_plan_healerlink")
    believer_plan_awardlink_delete = get_delete_rect("believer_plan_awardlink")
    believer_planunit_delete = get_delete_rect("believer_planunit")
    believer_person_membership_delete = get_delete_rect("believer_person_membership")
    believer_personunit_delete = get_delete_rect("believer_personunit")
    believerunit_update = get_update_rect("believerunit")

    green_str = "Green"
    believer_personunit_insert.set_level(0, 0, 0.25, green_str)
    believer_personunit_update.set_level(0, 0.25, 0.75, green_str)
    believer_personunit_delete.set_level(0, 0.75, 1, green_str)
    believer_person_membership_insert.set_level(1, 0, 0.3, green_str)
    believer_person_membership_update.set_level(1, 0.3, 0.7, green_str)
    believer_person_membership_delete.set_level(1, 0.7, 1, green_str)
    believer_plan_healerlink_insert.set_level(3, 0.2, 0.4)
    believer_plan_healerlink_delete.set_level(3, 0.6, 0.8)
    believer_plan_laborlink_insert.set_level(4, 0.2, 0.4)
    believer_plan_laborlink_delete.set_level(4, 0.6, 0.8)
    believer_plan_awardlink_insert.set_level(5, 0.2, 0.4, green_str)
    believer_plan_awardlink_update.set_level(5, 0.4, 0.6, green_str)
    believer_plan_awardlink_delete.set_level(5, 0.6, 0.8, green_str)
    ...
    believer_plan_reason_premiseunit_insert.set_level(8, 0.2, 0.4)
    believer_plan_reason_premiseunit_update.set_level(8, 0.4, 0.6)
    believer_plan_reason_premiseunit_delete.set_level(8, 0.6, 0.8)
    ...
    # believer_plan_awardlink_insert = get_insert_rect(believer_plan_awardlink_str())
    # believer_plan_laborlink_insert = get_insert_rect(believer_plan_laborlink_str())
    ...
    # believer_plan_awardlink_update = get_update_rect(believer_plan_awardlink_str())
    ...
    # believer_plan_laborlink_delete = get_delete_rect(believer_plan_laborlink_str())
    # believer_plan_healerlink_delete = get_delete_rect(believer_plan_healerlink_str())
    # believer_plan_awardlink_delete = get_delete_rect(believer_plan_awardlink_str())
    ...
    # Add shapes
    add_atom_rect(fig, believer_personunit_insert)
    add_atom_rect(fig, believer_person_membership_insert)
    add_atom_rect(fig, believer_plan_laborlink_insert)
    ...
    add_atom_rect(fig, believer_plan_reason_premiseunit_insert)
    add_atom_rect(fig, believer_personunit_update)
    add_atom_rect(fig, believer_person_membership_update)
    add_atom_rect(fig, believer_plan_factunit_update)
    add_atom_rect(fig, believer_plan_reason_premiseunit_update)
    add_atom_rect(fig, believer_plan_reasonunit_update)
    add_atom_rect(fig, believer_plan_reason_premiseunit_delete)
    add_atom_rect(fig, believer_plan_reasonunit_delete)
    add_atom_rect(fig, believer_plan_factunit_delete)
    add_atom_rect(fig, believer_plan_laborlink_delete)
    add_atom_rect(fig, believer_plan_healerlink_delete)
    add_atom_rect(fig, believer_plan_awardlink_insert)
    add_atom_rect(fig, believer_plan_awardlink_update)
    add_atom_rect(fig, believer_plan_awardlink_delete)
    ...
    add_atom_rect(fig, believer_person_membership_delete)
    add_atom_rect(fig, believer_personunit_delete)
