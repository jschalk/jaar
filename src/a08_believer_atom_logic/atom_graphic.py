...
def believeratom_periodic_table0() -> plotly_Figure:
    ...
    believer_plan_healerunit_insert = get_insert_rect("believer_plan_healerunit")
    ...
    believer_plan_healerunit_delete = get_delete_rect("believer_plan_healerunit")
    ...
    believer_plan_healerunit_insert.set_level(3, 0.2, 0.4)
    believer_plan_healerunit_delete.set_level(3, 0.6, 0.8)
    ...
    # believer_plan_healerunit_insert = get_insert_rect(believer_plan_healerunit_str())
    ...
    # believer_plan_healerunit_delete = get_delete_rect(believer_plan_healerunit_str())
    ...
    add_atom_rect(fig, believer_plan_healerunit_insert)
    ...
    add_atom_rect(fig, believer_plan_healerunit_delete)
