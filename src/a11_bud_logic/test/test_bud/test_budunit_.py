...
def test_BudUnit_set_bud_partner_net_SetsAttr():
    ...
    # THEN
    assert yao_budunit._bud_partner_nets != {}
    assert yao_budunit._bud_partner_nets.get(sue_str) == sue_bud_partner_net
...
def test_BudUnit_bud_partner_net_exists_ReturnsObj():
    ...
    # THEN
    assert yao_budunit.bud_partner_net_exists(sue_str)
...
def test_BudUnit_get_bud_partner_net_ReturnsObj():
    ...
    # WHEN / THEN
    assert yao_budunit.get_bud_partner_net(sue_str)
    assert yao_budunit.get_bud_partner_net(sue_str) == sue_bud_partner_net
...
def test_BudUnit_del_bud_partner_net_SetsAttr():
    ...
    # WHEN
    yao_budunit.del_bud_partner_net(sue_str)
...
def test_BudUnit_to_dict_ReturnsObjWith_bud_partner_net():
    ...
    assert t4_dict == {
        ...
        bud_partner_nets_str(): t4_bud_partner_nets,
...
def test_BudUnit_get_json_ReturnsObj():
    ...
    t4_budunit = budunit_shop(
        t4_bud_time, t4_quota, t4_bud_partner_nets, celldepth=t4_celldepth
    )
...
def test_get_budunit_from_json_ReturnsObj():
    ...
    t4_bud_time = 4
    t4_quota = 55
    t4_bud_partner_nets = {"Sue": -57}
    t4_budunit = budunit_shop(t4_bud_time, t4_quota, t4_bud_partner_nets)
    t4_json = t4_budunit.get_json()
