...
def brick_config_path() -> str:
    """Returns src\\ch20_brick\\brick_config.json"""
    return create_path("src", "ch20_brick", "brick_config.json")
...
def get_brick_formats_dir() -> str:
    """src/ch20_brick/brick_formats"""
    return create_path("src", "ch20_brick", "brick_formats")
...
def get_brick_sqlite_types() -> dict[str, str]:
    ...
    return {
        ...
        "celldepth": "INTEGER",
        "close": "REAL",
        "contact_cred_mass": "REAL",
        "contact_debt_mass": "REAL",
        "contact_name": "TEXT",
        ...
        "gogo_calc": "REAL",
        "gogo_want": "REAL",
        "group_cred_mass": "REAL",
        "group_debt_mass": "REAL",
        "group_title": "TEXT",
        ...
        "hour_label_otx": "TEXT",
        "brick_type": "TEXT",
        "inallocable_contact_debt_mass": "REAL",
        ...
        "inx_time": "INTEGER",
        "inx_title": "TEXT",
        "irrational_contact_debt_mass": "REAL",
...
def get_brick_format_headers() -> dict[str, list[str]]:
    ...
    return {
        ...
        "moment_rope,person_name,plan_rope,poynt,pledge": ifx.bk00002_planunit_v0_0_0,
        "moment_rope,person_name,plan_rope,reason_context,reason_state,poynt,pledge": ifx.bk00005_plan_reason,
        ...
        "moment_rope,person_name,contact_name,group_title,group_cred_mass,group_debt_mass,knot": ifx.bk00120_person_contact_membership_v0_0_0,
        "moment_rope,person_name,contact_name,contact_cred_mass,contact_debt_mass,knot": ifx.bk00121_person_contactunit_v0_0_0,
        ...
        "person_name,plan_rope,begin,close,addin,numor,denom,morph,gogo_want,stop_want,poynt,pledge,problem_bool,knot": ifx.bk00128_person_planunit_v0_0_0,
