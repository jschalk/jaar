...
def test_BridgeUnit_otx_wall_in_otx_words_ReturnsObj():
    # ESTABLISH
    xio_str = "Xio"
    sue_str = "Sue"
    otx_wall = "/"
    ...
    acct_id_bridgeunit = bridgeunit_shop(None, otx_wall)
    acct_id_bridgeunit.set_otx2inx(xio_str, sue_str)
    assert acct_id_bridgeunit._otx_wall_in_otx_words() is False

    # WHEN
    acct_id_bridgeunit.set_otx2inx(zia_otx, zia_inx)

    # THEN
    assert acct_id_bridgeunit._otx_wall_in_otx_words()


def test_BridgeUnit_inx_wall_in_otx_words_ReturnsObj():
    # ESTABLISH
    xio_str = "Xio"
    sue_str = "Sue"
    inx_wall = "/"
    zia_inx = "Zia"
    zia_otx = f"Zia{inx_wall}"
    acct_id_bridgeunit = bridgeunit_shop(None, None, inx_wall)
    acct_id_bridgeunit.set_otx2inx(xio_str, sue_str)
    assert acct_id_bridgeunit._inx_wall_in_otx_words() is False

    # WHEN
    acct_id_bridgeunit.set_otx2inx(zia_otx, zia_inx)

    # THEN
    assert acct_id_bridgeunit._inx_wall_in_otx_words()


def test_BridgeUnit_otx_wall_in_inx_words_ReturnsObj():
    # ESTABLISH
    xio_str = "Xio"
    sue_str = "Sue"
    otx_wall = "/"
    zia_otx = "Zia"
    zia_inx = f"Zia{otx_wall}"
    acct_id_bridgeunit = bridgeunit_shop(None, otx_wall)
    acct_id_bridgeunit.set_otx2inx(xio_str, sue_str)
    assert acct_id_bridgeunit._otx_wall_in_inx_words() is False

    # WHEN
    acct_id_bridgeunit.set_otx2inx(zia_otx, zia_inx)

    # THEN
    assert acct_id_bridgeunit._otx_wall_in_inx_words()


def test_BridgeUnit_inx_wall_in_inx_words_ReturnsObj():
    # ESTABLISH
    xio_str = "Xio"
    sue_str = "Sue"
    inx_wall = "/"
    ...
    acct_id_bridgeunit = bridgeunit_shop(None, None, inx_wall)
    acct_id_bridgeunit.set_otx2inx(xio_str, sue_str)
    assert acct_id_bridgeunit._inx_wall_in_inx_words() is False
...
def test_BridgeUnit_all_otx_parent_roads_exist_ReturnsObj_RoadUnit():
    ...
    # WHEN
    road_bridgeunit.set_otx2inx(clean_otx_road, "any")
    # THEN
    assert road_bridgeunit.otx_exists(clean_otx_parent_road) is False
    ...
    # WHEN
    road_bridgeunit.set_otx2inx(clean_otx_parent_road, "any")
    # THEN
...
def test_BridgeUnit_is_valid_ReturnsObj_Scenario0_label_str():
    ...
    casa_otx = f"casa{otx_wall}"
    casa_inx = "casa"
    roadnode_bridgeunit = bridgeunit_shop(type_RoadNode_str(), otx_wall)
...
def test_BridgeUnit_is_valid_ReturnsObj_Scenario1_road_str():
    ...
    assert road_bridgeunit.otx2inx_exists(clean_otx_road, clean_inx_road) is False

    # WHEN
    road_bridgeunit.set_otx2inx(clean_otx_road, clean_inx_road)
    # THEN
    assert road_bridgeunit.is_valid()
    assert road_bridgeunit.otx2inx_exists(clean_otx_road, clean_inx_road)
...
def test_BridgeUnit_is_valid_ReturnsObj_Scenario2_group_id_str():
    ...
    zia_otx = "Zia"
    zia_inx = f"Zia{inx_wall}"
    group_id_bridgeunit = bridgeunit_shop(type_GroupID_str(), otx_wall, inx_wall)
