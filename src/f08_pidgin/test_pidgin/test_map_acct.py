...
def test_NameMap_Exists():
    ...
    assert not x_namemap.unknown_word
...
def test_namemap_shop_ReturnsObj_scenario0():
    ...
    assert x_namemap.unknown_word == default_unknown_word_if_None()
...
def test_namemap_shop_ReturnsObj_scenario1_WithParameters():
    ...
    assert x_namemap.unknown_word == x_unknown_word
...
def test_NameMap_set_all_otx2inx_RaisesErrorIf_unknown_word_IsKeyIn_otx2inx():
    # ESTABLISH
    xio_str = "Xio"
    sue_str = "Sue"
    zia_str = "Zia"
    x_unknown_word = "UnknownWord"
    x_namemap = namemap_shop(None, unknown_word=x_unknown_word)
...
def test_NameMap_unknown_word_in_otx2inx_ReturnsObj():
    # ESTABLISH
    xio_str = "Xio"
    sue_str = "Sue"
    zia_str = "Zia"
    ...
    x_namemap = namemap_shop(None, unknown_word=x_unknown_word)
    x_namemap.set_otx2inx(xio_str, sue_str)
    assert x_namemap._unknown_word_in_otx2inx() is False

    # WHEN
    x_namemap.set_otx2inx(zia_str, x_unknown_word)

    # THEN
    assert x_namemap._unknown_word_in_otx2inx()
...
def test_NameMap_get_dict_ReturnsObj():
    ...
    x1_road_map_dict = {
        "otx_bridge": x_namemap.otx_bridge,
        "inx_bridge": x_namemap.inx_bridge,
        "unknown_word": x_namemap.unknown_word,
        "otx2inx": {},
        "face_name": x_namemap.face_name,
        "event_int": x_namemap.event_int,
    }
    assert x_namemap.get_dict() == x1_road_map_dict
    ...
    assert x_namemap.get_dict() == x2_road_map_dict
...
def test_NameMap_get_json_ReturnsObj():
  ...
  "unknown_word": "{x_namemap.unknown_word}"
    ...
    assert x_namemap.get_json() == x1_road_map_json
  ...
  "unknown_word": "{x_namemap.unknown_word}"
    ...
    print(f"{x_namemap.get_json()=}")
    assert x_namemap.get_json() == x2_road_map_json
...
def test_inherit_namemap_ReturnsObj_Scenario3_RaiseErrorWhenDifferent_x_unknown_word():
    # ESTABLISH
    sue_str = "Sue"
    x_unknown_word = "UnknownWord"
    old_namemap = namemap_shop(sue_str, 0, unknown_word=x_unknown_word)
    new_namemap = namemap_shop(sue_str, 1)
