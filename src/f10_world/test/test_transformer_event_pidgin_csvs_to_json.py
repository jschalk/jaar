...
"""
    x_faces_dir = create_path(get_test_worlds_dir(), "faces")
    ...
    assert e3_json_pidginunit.unknown_word == default_unknown_word()
    ...
    assert e7_json_pidginunit.unknown_word == default_unknown_word()
