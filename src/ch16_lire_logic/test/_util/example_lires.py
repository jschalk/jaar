...
def get_sue_lireunit() -> LireUnit:
    ...
    sue_lireunit.ropemap.labelmap = get_clean_labelmap()
    return sue_lireunit
...
def get_casa_maison_lireunit_set_by_otx2inx() -> LireUnit:
    otx_amy45_str = "amy45"
    inx_amy87_str = "amy87"
    otx_amy45_rope = to_rope(otx_amy45_str)
    inx_amy87_rope = to_rope(inx_amy87_str)
    ...
    sue_lireunit = lireunit_shop("Sue", 7)
    rx = RopeTerm_str()
    sue_lireunit.set_otx2inx(rx, otx_amy45_rope, inx_amy87_rope)
    sue_lireunit.set_otx2inx(rx, casa_otx_rope, casa_inx_rope)
    sue_lireunit.set_otx2inx(rx, clean_otx_rope, clean_inx_rope)
    sue_lireunit.set_otx2inx(rx, sweep_otx_rope, sweep_inx_rope)
    return sue_lireunit


def get_casa_maison_lireunit_set_by_label() -> LireUnit:
    otx_amy45_str = "amy45"
    inx_amy87_str = "amy87"
    casa_otx_str = "casa"
    casa_inx_str = "maison"
    ...
    sue_lireunit = lireunit_shop("Sue", 7)
    sue_lireunit.set_label(otx_amy45_str, inx_amy87_str)
    sue_lireunit.set_label(casa_otx_str, casa_inx_str)
    sue_lireunit.set_label(clean_otx_str, clean_inx_str)
    return sue_lireunit
...
def get_lire_core_attrs_are_none_namemap() -> NameMap:
    xio_otx = "Xio"
    sue_otx = "Sue"
    bob_otx = "Bob"
    xio_inx = "Xioita"
