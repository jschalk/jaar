...
def test_create_event_all_vow_path_HasDocString():
    # ESTABLISH
    doc_str = create_event_all_vow_path(
        fisc_mstr_dir="fisc_mstr_dir",
        fisc_title=fisc_title_str(),
        owner_name=owner_name_str(),
        event_int=event_int_str(),
    ...
    doc_str = f"Returns path: {doc_str}"
    # WHEN / THEN
    assert LINUX_OS or inspect_getdoc(create_event_all_vow_path) == doc_str


def test_create_event_expressed_vow_path_HasDocString():
    # ESTABLISH
    doc_str = create_event_expressed_vow_path(
        fisc_mstr_dir="fisc_mstr_dir",
        fisc_title=fisc_title_str(),
        owner_name=owner_name_str(),
        event_int=event_int_str(),
    ...
    doc_str = f"Returns path: {doc_str}"
    # WHEN / THEN
    assert LINUX_OS or inspect_getdoc(create_event_expressed_vow_path) == doc_str
