...
from src.f06_listen.special_func import add_voice_pledge, add_voice_fact
...
def test_add_voice_pledge_Addspledgekick(env_dir_setup_cleanup):
    # ESTABLISH
    sue_str = "Sue"
    sue_hubunit = hubunit_shop(env_dir(), root_title(), sue_str)
    sue_hubunit.initialize_kick_voice_files()
    old_sue_voice = open_voice_file(env_dir(), root_title(), sue_str)
    clean_str = "clean"
    ...
    new_sue_voice = open_voice_file(env_dir(), root_title(), sue_str)
