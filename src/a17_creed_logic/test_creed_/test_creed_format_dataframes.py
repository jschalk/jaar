...
def test_create_creed_df_Arg_creed_format_00021_bud_acctunit_v0_0_0():
    # ESTABLISH
    sue_str = "Sue"
    bob_str = "Bob"
    yao_str = "Yao"
...
def test_create_creed_df_Arg_creed_format_00020_bud_acct_membership_v0_0_0():
    # ESTABLISH
    sue_str = "Sue"
    bob_str = "Bob"
    yao_str = "Yao"
...
def test_create_creed_df_Arg_creed_format_00013_conceptunit_v0_0_0():
    # ESTABLISH
    sue_str = "Sue"
    accord_fisc_label = "accord56"
    sue_budunit = budunit_shop(sue_str, accord_fisc_label)
    ...
    # WHEN
    x_creed_name = creed_format_00013_conceptunit_v0_0_0()
    conceptunit_format = create_creed_df(sue_budunit, x_creed_name)
...
def test_save_creed_csv_Arg_creed_format_00019_conceptunit_v0_0_0():
    # ESTABLISH
    ...
    x_creed_name = creed_format_00019_conceptunit_v0_0_0()
    ...
    # THEN
    array_headers = list(creed_df.columns)
    assert array_headers == get_creedref_obj(x_creed_name).get_headers_list()
    # for x_array_header in array_headers:
    #     print(f"{x_array_header=}")


def test_save_creed_csv_Arg_creed_format_00021_bud_acctunit_v0_0_0_SaveToCSV(
    ...
    sue_budunit.add_acctunit(bob_str, bob_credit_belief, bob_debtit_belief)
    sue_budunit.add_acctunit(yao_str, yao_credit_belief, yao_debtit_belief)
    j1_creedname = creed_format_00021_bud_acctunit_v0_0_0()
    ...
    # WHEN
    save_creed_csv(j1_creedname, sue_budunit, creed_fiscs_dir(), name_filename)
...
"""
    creed_file_str = open_file(creed_fiscs_dir(), name_filename)
    print(f"      {creed_file_str=}")
    print(f"{sue1_name_example_csv=}")
    assert creed_file_str == sue1_name_example_csv
...
def test_save_creed_csv_Arg_creed_format_00013_conceptunit_v0_0_0(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_str = "Sue"
    ...
    # WHEN
    save_creed_csv(x_creed_name, sue_budunit, creed_fiscs_dir(), name_filename)
