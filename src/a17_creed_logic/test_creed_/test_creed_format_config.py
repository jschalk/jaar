...
def test_config_str_functions_ReturnObjs():
    ...
    x0003_creed = "creed_format_00013_itemunit_v0_0_0"
    assert creed_format_00013_itemunit_v0_0_0() == x0003_creed
...
def test_get_sorted_headers_str_ReturnsObj():
    ...
    # ESTABLISH / WHEN
    br00019_headers = get_sorted_headers_str(creed_format_00019_itemunit_v0_0_0())
...
def test_get_creedref_obj_HasCorrectAttrs_creed_format_00013_itemunit_v0_0_0():
    # ESTABLISH
    creed_name = creed_format_00013_itemunit_v0_0_0()
...
def test_get_creedref_obj_HasCorrectAttrs_creed_format_00019_itemunit_v0_0_0():
    # ESTABLISH
    creed_name = creed_format_00019_itemunit_v0_0_0()
