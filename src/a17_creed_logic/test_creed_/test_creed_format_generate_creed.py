...
def test_make_buddelta_Arg_creed_format_00013_conceptunit_v0_0_0():
    # ESTABLISH
    sue_str = "Sue"
    bob_str = "Bob"
    accord_fisc_label = "accord56"
    ...
    conceptunit_dataframe = create_creed_df(sue_budunit, x_creed_name)
...
def test_create_creed_df_Arg_creed_format_00013_conceptunit_v0_0_0_Scenario_budunit_v001(
    big_volume,
):
    ...
    if big_volume:
        ...
        # WHEN
        conceptunit_format = create_creed_df(budunit_v001(), x_creed_name)
