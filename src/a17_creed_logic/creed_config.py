...
def get_creed_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "fisc_tag,owner_name,idea_way,context,branch,nigh,open,divisor": creed_format_00026_bud_idea_reason_premiseunit_v0_0_0(),
        ...
        "fisc_tag,owner_name,idea_way,context,branch_ERASE": creed_format_00056_delete_bud_idea_reason_premiseunit_v0_0_0(),
