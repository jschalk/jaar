...
def get_creed_sqlite_types() -> dict[str, str]:
    ...
    return {
        ...
        "gogo_want": "REAL",
        "stop_want": "REAL",
        "context_idea_active_requisite": "INTEGER",
        "credit_belief": "REAL",
        "debtit_belief": "REAL",
        "credit_vote": "REAL",
        "debtit_vote": "REAL",
        ...
        "_context_idea_active_value": "INTEGER",
...
def get_creed_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "fisc_tag,owner_name,idea_way,fcontext,fneed,fopen,fnigh": creed_format_00023_bud_idea_factunit_v0_0_0(),
        ...
        "fisc_tag,owner_name,idea_way,context,need,nigh,open,divisor": creed_format_00026_bud_idea_reason_premiseunit_v0_0_0(),
        "fisc_tag,owner_name,idea_way,context,context_idea_active_requisite": creed_format_00027_bud_idea_reasonunit_v0_0_0(),
        ...
        "fisc_tag,owner_name,idea_way,context,need_ERASE": creed_format_00056_delete_bud_idea_reason_premiseunit_v0_0_0(),
        "fisc_tag,owner_name,idea_way,context_ERASE": creed_format_00057_delete_bud_idea_reasonunit_v0_0_0(),
