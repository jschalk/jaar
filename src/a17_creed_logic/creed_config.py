...
def get_creed_sqlite_types() -> dict[str, str]:
    ...
    return {
        ...
        "gogo_want": "REAL",
        "stop_want": "REAL",
        "base_idea_active_requisite": "INTEGER",
        "credit_belief": "REAL",
        "debtit_belief": "REAL",
        "credit_vote": "REAL",
        "debtit_vote": "REAL",
        ...
        "_base_idea_active_value": "INTEGER",
...
def get_creed_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "fisc_tag,owner_name,idea_way,mass,pledge": creed_format_00013_ideaunit_v0_0_0(),
        "fisc_tag,owner_name,idea_way,begin,close,addin,numor,denom,morph,gogo_want,stop_want": creed_format_00019_ideaunit_v0_0_0(),
        ...
        "fisc_tag,owner_name,idea_way,fbase,fneed,fopen,fnigh": creed_format_00023_bud_idea_factunit_v0_0_0(),
        ...
        "fisc_tag,owner_name,idea_way,base,need,nigh,open,divisor": creed_format_00026_bud_idea_reason_premiseunit_v0_0_0(),
        "fisc_tag,owner_name,idea_way,base,base_idea_active_requisite": creed_format_00027_bud_idea_reasonunit_v0_0_0(),
        ...
        "fisc_tag,owner_name,idea_way,healer_name,problem_bool": creed_format_00036_problem_healer_v0_0_0(),
        ...
        "fisc_tag,owner_name,idea_way,fbase_ERASE": creed_format_00053_delete_bud_idea_factunit_v0_0_0(),
        ...
        "fisc_tag,owner_name,idea_way,base,need_ERASE": creed_format_00056_delete_bud_idea_reason_premiseunit_v0_0_0(),
        "fisc_tag,owner_name,idea_way,base_ERASE": creed_format_00057_delete_bud_idea_reasonunit_v0_0_0(),
        "fisc_tag,owner_name,idea_way_ERASE": creed_format_00058_delete_bud_ideaunit_v0_0_0(),
