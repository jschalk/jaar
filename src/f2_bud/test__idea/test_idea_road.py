...
from src.f2_bud.reason_idea import reasonunit_shop, premiseunit_shop, factunit_shop
from src.f1_road.road import get_default_fiscal_id_roadnode as root_label, create_road
...
def test_IdeaUnit_find_replace_road_CorrectlyModifies_parent_road():
    ...
    x_idea = ideaunit_shop(roses_str, _parent_road=old_bloomers_road)
...
def test_IdeaUnit_set_road_delimiter_CorrectlyModifiesReasonRoadUnits():
    ...
    # WHEN
    slash_str = "/"
    casa_idea.set_road_delimiter(slash_str)
