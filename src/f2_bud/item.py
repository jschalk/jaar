...
from src.f1_road.range_toolbox import get_morphed_rangeunit, RangeUnit
...
from src.f2_bud.healer import HealerLink, healerlink_shop, healerlink_get_from_dict
...
from src.f2_bud.origin import OriginUnit, originunit_get_from_dict
...
class ItemUnit:
    ...
    def _set_attrs_to_itemunit(self, item_attr: ItemAttrFilter):
        ...
        if item_attr.awardlink_del is not None:
            self.del_awardlink(group_id=item_attr.awardlink_del)
