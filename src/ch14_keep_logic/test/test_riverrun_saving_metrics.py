...
def test_RiverRun_save_rivergrade_file_SavesFile(env_dir_setup_cleanup):
    ...
    yao_keep_grade_path = create_keep_grade_path(
        moment_mstr_dir=x_riverrun.hubunit.moment_mstr_dir,
        belief_name=x_riverrun.hubunit.belief_name,
        moment_label=x_riverrun.hubunit.moment_label,
        keep_rope=x_riverrun.hubunit.keep_rope,
        knot=x_riverrun.hubunit.knot,
