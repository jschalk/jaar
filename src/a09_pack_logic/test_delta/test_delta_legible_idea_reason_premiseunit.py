...
def test_create_legible_list_ReturnsObj_idea_reason_premiseunit_INSERT_WithNumberArgs():
    ...
    # THEN
    x_str = f"PremiseUnit '{need_value}' created for reason '{base_value}' for idea '{way_value}'. Open={open_value}. Nigh={nigh_value}. Divisor={divisor_value}."
    print(f"{x_str=}")
    assert legible_list[0] == x_str
...
def test_create_legible_list_ReturnsObj_idea_reason_premiseunit_UPDATE_WithNumberArgs():
    ...
    # THEN
    x_str = f"PremiseUnit '{need_value}' updated for reason '{base_value}' for idea '{way_value}'. Open={open_value}. Nigh={nigh_value}. Divisor={divisor_value}."
    print(f"{x_str=}")
    assert legible_list[0] == x_str
