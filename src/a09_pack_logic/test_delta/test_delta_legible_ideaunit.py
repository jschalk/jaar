...
def test_create_legible_list_ReturnsObj_ideaunit_INSERT():
    ...
    # THEN
    x_str = f"Created Idea '{clean_way}'. addin={addin_value}.begin={begin_value}.close={close_value}.denom={denom_value}.numor={numor_value}.problem_bool={problem_bool_value}.morph={morph_value}.mass={mass_value}.pledge={pledge_value}."
    print(f"{x_str=}")
...
def test_create_legible_list_ReturnsObj_ideaunit_UPDATE():
    ...
    # THEN
    x_str = f"Idea '{clean_way}' set these attributes: addin={addin_value}.begin={begin_value}.close={close_value}.denom={denom_value}.numor={numor_value}.problem_bool={problem_bool_value}.morph={morph_value}.mass={mass_value}.pledge={pledge_value}."
    print(f"{x_str=}")
    assert legible_list[0] == x_str
...
def test_create_legible_list_ReturnsObj_ideaunit_DELETE():
    ...
    # THEN
    x_str = f"Idea '{clean_way}' was deleted."
    print(f"{x_str=}")
    assert legible_list[0] == x_str
