...
def test_BudDelta_get_edited_bud_ReturnsObj_BudUnit_update_idea_reason_premiseunit():
    ...
    assert damaged_premiseunit.branch == damaged_way
    ...
    update_disc_budatom.set_jkey("branch", damaged_way)
    ...
    assert after_damaged_premiseunit.branch == damaged_way
...
def test_BudDelta_get_edited_bud_ReturnsObj_BudUnit_insert_idea_reason_premiseunit():
    ...
    update_disc_budatom.set_jkey(idea_way_str(), ball_way)
    update_disc_budatom.set_jkey("context", knee_way)
    update_disc_budatom.set_jkey("branch", medical_way)
    ...
    assert after_medical_premiseunit.branch == medical_way
