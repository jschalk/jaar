...
def test_PlanDelta_get_dimens_cruds_plandelta_ReturnsObjWithCorrectDimensAndCRUDsBy_acctunit_insert():
    ...
    after_sue_plan.add_acctunit(bob_str, bob_credit_belief, bob_debtit_belief)
    ...
    assert bob_planatom.get_value("credit_belief") == bob_credit_belief
    assert bob_planatom.get_value("debtit_belief") == bob_debtit_belief
