...
def test_BelieverDelta_add_all_different_believeratoms_Creates_BelieverAtom_plan_awardunit_delete():
    # ESTABLISH
    sue_str = "Sue"
    ...
    after_sue_believer.edit_plan_attr(disc_rope, awardunit_del=run_str)
    ...
    x_keylist = [DELETE_str(), believer_plan_awardunit_str(), disc_rope, run_str]
    run_believeratom = get_from_nested_dict(sue_believerdelta.believeratoms, x_keylist)
...
def test_BelieverDelta_add_all_different_believeratoms_Creates_BelieverAtom_plan_awardunit_insert():
    # ESTABLISH
    sue_str = "Sue"
    before_sue_au = believerunit_shop(sue_str)
    xio_str = "Xio"
    ...
    x_keylist = [INSERT_str(), believer_plan_awardunit_str(), disc_rope, run_str]
    run_believeratom = get_from_nested_dict(sue_believerdelta.believeratoms, x_keylist)
    assert run_believeratom.get_value(plan_rope_str()) == disc_rope
    assert run_believeratom.get_value(awardee_title_str()) == run_str
    assert run_believeratom.get_value(plan_rope_str()) == disc_rope
...
def test_BelieverDelta_add_all_different_believeratoms_Creates_BelieverAtom_plan_awardunit_update():
    # ESTABLISH
    sue_str = "Sue"
    before_sue_au = believerunit_shop(sue_str)
    xio_str = "Xio"
    ...
    x_keylist = [UPDATE_str(), believer_plan_awardunit_str(), ball_rope, run_str]
    ball_believeratom = get_from_nested_dict(sue_believerdelta.believeratoms, x_keylist)
    assert ball_believeratom.get_value(plan_rope_str()) == ball_rope
...
def test_BelieverDelta_add_all_different_believeratoms_Creates_BelieverAtom_plan_reason_caseunit_insert():
    ...
    ball_believeratom = get_from_nested_dict(sue_believerdelta.believeratoms, x_keylist)
    assert ball_believeratom.get_value(plan_rope_str()) == ball_rope
    assert ball_believeratom.get_value("reason_context") == knee_rope
    assert ball_believeratom.get_value("reason_state") == damaged_rope
    assert ball_believeratom.get_value("reason_lower") == damaged_reason_lower
    assert ball_believeratom.get_value("reason_upper") == damaged_reason_upper
    assert ball_believeratom.get_value("reason_divisor") == damaged_reason_divisor
    assert get_believeratom_total_count(sue_believerdelta) == 1
...
def test_BelieverDelta_add_all_different_believeratoms_Creates_BelieverAtom_plan_reason_caseunit_update():
    ...
    assert ball_believeratom.get_value("reason_context") == knee_rope
    assert ball_believeratom.get_value("reason_state") == damaged_rope
    assert ball_believeratom.get_value("reason_lower") == after_damaged_reason_lower
    assert ball_believeratom.get_value("reason_upper") == after_damaged_reason_upper
    assert ball_believeratom.get_value("reason_divisor") == after_damaged_reason_divisor
    assert get_believeratom_total_count(sue_believerdelta) == 1
...
def test_BelieverDelta_add_all_different_believeratoms_Creates_BelieverAtom_plan_reasonunit_insert():
    ...
    assert (
        ball_believeratom.get_value(reason_active_requisite_str())
...
def test_BelieverDelta_add_all_different_believeratoms_Creates_BelieverAtom_plan_partyunit_insert():
    # ESTABLISH
    sue_str = "Sue"
    before_sue_believer = believerunit_shop(sue_str)
    xio_str = "Xio"
    ...
    ball_believeratom = get_from_nested_dict(sue_believerdelta.believeratoms, x_keylist)
    assert ball_believeratom.get_value(plan_rope_str()) == ball_rope
    assert ball_believeratom.get_value(party_title_str()) == xio_str
    assert get_believeratom_total_count(sue_believerdelta) == 1


def test_BelieverDelta_add_all_different_believeratoms_Creates_BelieverAtom_plan_partyunit_delete():
    # ESTABLISH
    sue_str = "Sue"
    before_sue_believer = believerunit_shop(sue_str)
    xio_str = "Xio"
