...
def test_create_legible_list_ReturnsObj_plan_laborlink_DELETE():
    # ESTABLISH
    sue_believer = believerunit_shop("Sue")
    dimen = believer_plan_laborlink_str()
    casa_rope = sue_believer.make_l1_rope("casa")
