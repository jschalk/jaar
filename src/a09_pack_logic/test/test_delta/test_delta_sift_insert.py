...
def test_get_minimal_believerdelta_ReturnsObjWithoutUnecessaryINSERT_believer_partnerunit():
    # ESTABLISH
    bob_str = "Bob"
    yao_str = "Yao"
    zia_str = "Zia"
...
def test_sift_ReturnsObjWithoutUnecessaryINSERT_believer_partner_membership():
    # ESTABLISH
    bob_str = "Bob"
    yao_str = "Yao"
    zia_str = "Zia"
    ...
    zia_run_atom = believeratom_shop(believer_partner_membership_str(), INSERT_str())
