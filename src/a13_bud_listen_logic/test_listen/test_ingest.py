...
def test_generate_ingest_list_ReturnsCorrectList_v1():
    ...
    clean_str = "clean"
    zia_budunit.set_l1_concept(conceptunit_shop(clean_str, pledge=True))
    zia_debtor_pool = 78
    zia_resepect_bit = 2
    ...
    ingested_list = generate_ingest_list(
        concept_list=list(zia_budunit.get_agenda_dict().values()),
    ...
    clean_way = zia_budunit.make_l1_way(clean_str)
    clean_conceptunit = zia_budunit.get_concept_obj(clean_way)
...
def test_generate_ingest_list_ReturnsCorrectList_v2():
    ...
    cook_str = "cook"
    zia_budunit.set_l1_concept(conceptunit_shop(clean_str, pledge=True))
    zia_budunit.set_l1_concept(conceptunit_shop(cook_str, pledge=True))
    zia_debtor_pool = 32
    zia_resepect_bit = 2
    ...
    clean_conceptunit = zia_budunit.get_concept_obj(clean_way)
    cook_conceptunit = zia_budunit.get_concept_obj(cook_way)
...
def test_generate_ingest_list_ReturnsCorrectList_v3():
    ...
    cook_str = "cook"
    zia_budunit.set_l1_concept(conceptunit_shop(clean_str, pledge=True))
    zia_budunit.set_l1_concept(conceptunit_shop(cook_str, mass=3, pledge=True))
    zia_debtor_pool = 32
    zia_resepect_bit = 2
    assert len(zia_budunit.get_agenda_dict()) == 2
...
def test_generate_ingest_list_ReturnsCorrectList_v4():
    ...
    cook_str = "cook"
    zia_budunit.set_l1_concept(conceptunit_shop(clean_str, pledge=True))
    zia_budunit.set_l1_concept(conceptunit_shop(cook_str, mass=2, pledge=True))
    zia_debtor_pool = 32
    zia_resepect_bit = 2
    assert len(zia_budunit.get_agenda_dict()) == 2
