...
def test_generate_ingest_list_ReturnsCorrectList_v1():
    ...
    clean_str = "clean"
    zia_budunit.set_l1_concept(conceptunit_shop(clean_str, task=True))
    zia_debtor_pool = 78
    zia_resepect_bit = 2
...
def test_generate_ingest_list_ReturnsCorrectList_v2():
    ...
    cook_str = "cook"
    zia_budunit.set_l1_concept(conceptunit_shop(clean_str, task=True))
    zia_budunit.set_l1_concept(conceptunit_shop(cook_str, task=True))
    zia_debtor_pool = 32
    zia_resepect_bit = 2
...
def test_generate_ingest_list_ReturnsCorrectList_v3():
    ...
    cook_str = "cook"
    zia_budunit.set_l1_concept(conceptunit_shop(clean_str, task=True))
    zia_budunit.set_l1_concept(conceptunit_shop(cook_str, mass=3, task=True))
    zia_debtor_pool = 32
    zia_resepect_bit = 2
    assert len(zia_budunit.get_agenda_dict()) == 2
...
def test_generate_ingest_list_ReturnsCorrectList_v4():
    ...
    cook_str = "cook"
    zia_budunit.set_l1_concept(conceptunit_shop(clean_str, task=True))
    zia_budunit.set_l1_concept(conceptunit_shop(cook_str, mass=2, task=True))
    zia_debtor_pool = 32
    zia_resepect_bit = 2
    assert len(zia_budunit.get_agenda_dict()) == 2
