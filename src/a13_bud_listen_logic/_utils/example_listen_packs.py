...
def sue_1budatoms_packunit() -> PackUnit:
    ...
    x_packunit._buddelta.set_budatom(get_atom_example_ideaunit_sports())
    return x_packunit


def sue_2budatoms_packunit() -> PackUnit:
    x_packunit = packunit_shop(owner_name="Sue", _pack_id=53, face_name="Yao")
    x_packunit._buddelta.set_budatom(get_atom_example_ideaunit_knee())
    x_packunit._buddelta.set_budatom(get_atom_example_ideaunit_sports())
    return x_packunit
...
def sue_3budatoms_packunit() -> PackUnit:
    ...
    x_packunit._buddelta.set_budatom(get_atom_example_ideaunit_ball())
    x_packunit._buddelta.set_budatom(get_atom_example_ideaunit_knee())
    return x_packunit
