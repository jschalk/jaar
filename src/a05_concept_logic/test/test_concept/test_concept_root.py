...
def test_ConceptUnit_set_concept_label_get_default_bank_label_DoesNotRaisesError():
    # ESTABLISH
    x_conceptroot = conceptunit_shop(root=True)
...
def test_ConceptUnit_set_concept_label_DoesNotRaisesError():
    # ESTABLISH
    el_paso_str = "El Paso"
    x_conceptroot = conceptunit_shop(root=True, bank_label=el_paso_str)
...
def test_ConceptUnit_set_concept_label_RaisesErrorWhenbank_label_IsNone():
    # ESTABLISH
    x_conceptroot = conceptunit_shop(root=True)
