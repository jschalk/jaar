...
def test_ConceptUnit_set_reasonheirs_CorrectlyAcceptsNewValues():
    ...
    # WHEN
    ball_concept.set_reasonheirs(reasonheirs=reasonheirs, owner_concept_dict={})
...
def test_ConceptUnit_set_reasonheirs_CorrectlyRefusesNewValues():
    ...
    # WHEN
    ball_concept.set_reasonheirs(reasonheirs={}, owner_concept_dict={})
...
def test_ConceptUnit_set_range_factheirs_SetsAttrNoParameters():
    ...
    # WHEN
    ball_concept.set_range_factheirs(owner_concept_dict={}, range_inheritors={})
...
def test_ConceptUnit_set_range_factheirs_SetsAttrNewFactHeir():
    ...
    # WHEN
    ball_concept.set_range_factheirs(x_owner_concept_dict, x_range_inheritors)
...
def test_ConceptUnit_get_reasonheir_ReturnsObj():
    ...
    clean_concept.set_reasonheirs(reasonheirs=x_reasonheirs, owner_concept_dict={})
