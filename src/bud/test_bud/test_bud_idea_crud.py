...
def test_BudUnit_set_idea_RaisesErrorWhen_parent_road_IsInvalid():
    ...
    assert invalid_rootnode_swim_road != zia_bud._tribe_id
    casa_str = "casa"
...
def test_BudUnit_set_idea_CorrectlySetsAttr():
    ...
    # WHEN
    zia_bud.set_idea(ideaunit_shop(casa_str), parent_road=zia_bud._tribe_id)
...
def test_BudUnit_del_idea_obj_Level1CanBeDeleted_ChildrenInherited():
    ...
    assert new_sunday_idea._parent_road == sue_bud._tribe_id
...
def test_BudUnit_get_idea_obj_ReturnsIdea():
    ...
    # WHEN
    root_idea = sue_bud.get_idea_obj(road=sue_bud._tribe_id)

    # THEN
    assert root_idea is not None
    assert root_idea._label == sue_bud._tribe_id
...
def test_BudUnit_idea_exists_ReturnsCorrectBool():
    ...
    assert sue_bud.idea_exists(sue_bud._tribe_id)
...
def test_BudUnit_set_offtrack_fund_ReturnsObj():
    ...
    casa_idea._parent_road = bob_budunit._tribe_id
    week_idea._parent_road = bob_budunit._tribe_id
