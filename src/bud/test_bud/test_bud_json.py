...
def test_BudUnit_get_dict_ReturnsDictObject():
    ...
    assert bud_dict["_pecun_id"] == yao_bud._pecun_id
    ...
    _kids = "_kids"
    assert x_idearoot._label == yao_bud._pecun_id
...
def test_BudUnit_get_dict_ReturnsDictWith_idearoot_teamunit():
    ...
    sue_bud.edit_idea_attr(sue_bud._pecun_id, teamunit=x_teamunit)
    ...
    assert idearoot_dict["teamunit"] == {"_teamlinks": [run_str]}
...
def test_BudUnit_get_dict_ReturnsDictWith_idearoot_healerlink():
    ...
    sue_bud.edit_idea_attr(road=sue_bud._pecun_id, healerlink=run_healerlink)
...
def test_BudUnit_get_dict_ReturnsDictWith_ideakid_TeamUnit():
    ...
    team_dict_x = idearoot_dict[_kids][morn_str][_teamunit]
...
def test_BudUnit_get_json_ReturnsCorrectJSON_SimpleExample():
    ...
    zia_bud.edit_idea_attr(road=zia_bud._pecun_id, healerlink=run_healerlink)
    zia_bud.edit_idea_attr(road=zia_bud._pecun_id, problem_bool=True)
    ...
    assert bud_dict["_pecun_id"] == zia_bud._pecun_id
...
def test_budunit_get_from_json_ReturnsCorrectObjSimpleExample():
    ...
    tiger_pecun_id = "tiger"
    zia_bud.set_pecun_id(tiger_pecun_id)
    zia_fund_pool = 80000
    ...
    zia_bud.edit_idea_attr(zia_bud._pecun_id, teamunit=run_teamunit)
    ...
    zia_bud.edit_idea_attr(zia_bud._pecun_id, awardlink=awardlink_shop(sue_str))
    ...
    assert json_bud._pecun_id == zia_bud._pecun_id
...
def test_budunit_get_from_json_ReturnsCorrectIdeaRoot():
    ...
    zia_bud = get_budunit_x1_3levels_1reason_1facts()
    zia_bud.set_max_tree_traverse(23)
    # root_idea = zia_bud.get_idea_obj(zia_bud.get_idea_obj(zia_bud._pecun_id))
    ...
    # THEN
    json_idearoot = json_bud.get_idea_obj(zia_bud._pecun_id)
