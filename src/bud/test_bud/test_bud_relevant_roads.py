...
def test_BudUnit_get_relevant_roads_SimpleReturnsOnlyAncestors():
    ...
    assert relevant_roads == {sue_bud._pecun_id, sun_road, week_road}
...
def test_BudUnit_get_relevant_roads_ReturnsSimpleReasonUnitBase():
    ...
    sue_bud.set_idea(unim_idea, parent_road=sue_bud._pecun_id)
    ...
    assert relevant_roads == {sue_bud._pecun_id, casa_road, status_road, floor_road}
...
def test_BudUnit_get_relevant_roads_ReturnSimple():
    ...
    assert yao_bud._pecun_id in relevant_roads
