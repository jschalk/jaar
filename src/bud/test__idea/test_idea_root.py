...
def test_IdeaUnit_set_label_get_default_tribe_id_roadnode_DoesNotRaisesError():
    # ESTABLISH
    x_idearoot = ideaunit_shop(_root=True)
...
def test_IdeaUnit_set_label_DoesNotRaisesError():
    # ESTABLISH
    el_paso_str = "El Paso"
    x_idearoot = ideaunit_shop(_root=True, _bud_tribe_id=el_paso_str)
...
def test_IdeaUnit_set_label_RaisesErrorWhen_bud_tribe_id_IsNone():
    # ESTABLISH
    x_idearoot = ideaunit_shop(_root=True)
