...
def add_time_hreg_ideaunit(x_budunit: BudUnit) -> BudUnit:
    ...
    x_budunit.add_idea(jaja_idea, time_road)
    ...
    # x_budunit.add_idea(morph_yr2010_idea, yr2010_road)
    x_budunit.add_idea(morph_yr2010_idea, yr2010_road)
    x_budunit.add_idea(morph_yr2011_idea, yr2011_road)
    x_budunit.add_idea(morph_yr2012_idea, yr2012_road)
    x_budunit.add_idea(morph_yr2013_idea, yr2013_road)
    x_budunit.add_idea(morph_yr2014_idea, yr2014_road)
    x_budunit.add_idea(morph_yr2015_idea, yr2015_road)
    x_budunit.add_idea(morph_yr2016_idea, yr2016_road)
    x_budunit.add_idea(morph_yr2017_idea, yr2017_road)
    x_budunit.add_idea(morph_yr2018_idea, yr2018_road)
    x_budunit.add_idea(morph_yr2019_idea, yr2019_road)
    x_budunit.add_idea(morph_yr2020_idea, yr2020_road)
    x_budunit.add_idea(morph_yr2021_idea, yr2021_road)
    x_budunit.add_idea(morph_yr2022_idea, yr2022_road)
    x_budunit.add_idea(morph_yr2023_idea, yr2023_road)
    x_budunit.add_idea(morph_yr2024_idea, yr2024_road)
    x_budunit.add_idea(morph_yr2025_idea, yr2025_road)
    x_budunit.add_idea(morph_yr2026_idea, yr2026_road)
    x_budunit.add_idea(morph_yr2027_idea, yr2027_road)
    x_budunit.add_idea(morph_yr2028_idea, yr2028_road)
    x_budunit.add_idea(morph_yr2029_idea, yr2029_road)
    x_budunit.add_idea(morph_yr2030_idea, yr2030_road)
    ...
    x_budunit.add_idea(i_shop(yr2010yr_str()), yr2010mor_road)
    x_budunit.add_idea(i_shop(yr2011yr_str()), yr2011mor_road)
    x_budunit.add_idea(i_shop(yr2012yr_str()), yr2012mor_road)
    x_budunit.add_idea(i_shop(yr2013yr_str()), yr2013mor_road)
    x_budunit.add_idea(i_shop(yr2014yr_str()), yr2014mor_road)
    x_budunit.add_idea(i_shop(yr2015yr_str()), yr2015mor_road)
    x_budunit.add_idea(i_shop(yr2016yr_str()), yr2016mor_road)
    x_budunit.add_idea(i_shop(yr2017yr_str()), yr2017mor_road)
    x_budunit.add_idea(i_shop(yr2018yr_str()), yr2018mor_road)
    x_budunit.add_idea(i_shop(yr2019yr_str()), yr2019mor_road)
    x_budunit.add_idea(i_shop(yr2020yr_str()), yr2020mor_road)
    x_budunit.add_idea(i_shop(yr2021yr_str()), yr2021mor_road)
    x_budunit.add_idea(i_shop(yr2022yr_str()), yr2022mor_road)
    x_budunit.add_idea(i_shop(yr2023yr_str()), yr2023mor_road)
    x_budunit.add_idea(i_shop(yr2024yr_str()), yr2024mor_road)
    x_budunit.add_idea(i_shop(yr2025yr_str()), yr2025mor_road)
    x_budunit.add_idea(i_shop(yr2026yr_str()), yr2026mor_road)
    x_budunit.add_idea(i_shop(yr2027yr_str()), yr2027mor_road)
    x_budunit.add_idea(i_shop(yr2028yr_str()), yr2028mor_road)
    x_budunit.add_idea(i_shop(yr2029yr_str()), yr2029mor_road)
    x_budunit.add_idea(i_shop(yr2030yr_str()), yr2030mor_road)
    ...
    x_budunit.add_idea(Jan_ideaunit, month_road)
    x_budunit.add_idea(Feb28_ideaunit, month_road)
    x_budunit.add_idea(Feb29_ideaunit, month_road)
    x_budunit.add_idea(Mar_ideaunit, month_road)
    x_budunit.add_idea(Apr_ideaunit, month_road)
    x_budunit.add_idea(May_ideaunit, month_road)
    x_budunit.add_idea(Jun_ideaunit, month_road)
    x_budunit.add_idea(Jul_ideaunit, month_road)
    x_budunit.add_idea(Aug_ideaunit, month_road)
    x_budunit.add_idea(Sep_ideaunit, month_road)
    x_budunit.add_idea(Oct_ideaunit, month_road)
    x_budunit.add_idea(Nov_ideaunit, month_road)
    x_budunit.add_idea(Dec_ideaunit, month_road)
    ...
    x_budunit.add_idea(Jan_days_idea, tech_Jan_road)
    x_budunit.add_idea(Feb28_days_idea, tech_Feb28_road)
    x_budunit.add_idea(Feb29_days_idea, tech_Feb29_road)
    x_budunit.add_idea(Mar_days_idea, tech_Mar_road)
    x_budunit.add_idea(Apr_days_idea, tech_Apr_road)
    x_budunit.add_idea(May_days_idea, tech_May_road)
    x_budunit.add_idea(Jun_days_idea, tech_Jun_road)
    x_budunit.add_idea(Jul_days_idea, tech_Jul_road)
    x_budunit.add_idea(Aug_days_idea, tech_Aug_road)
    x_budunit.add_idea(Sep_days_idea, tech_Sep_road)
    x_budunit.add_idea(Oct_days_idea, tech_Oct_road)
    x_budunit.add_idea(Nov_days_idea, tech_Nov_road)
    x_budunit.add_idea(Dec_days_idea, tech_Dec_road)
    ...
    x_budunit.add_idea(Jan_ideaunit, year365_road)
    x_budunit.add_idea(Feb28_ideaunit, year365_road)
    x_budunit.add_idea(Mar_ideaunit, year365_road)
    x_budunit.add_idea(Apr_ideaunit, year365_road)
    x_budunit.add_idea(May_ideaunit, year365_road)
    x_budunit.add_idea(Jun_ideaunit, year365_road)
    x_budunit.add_idea(Jul_ideaunit, year365_road)
    x_budunit.add_idea(Aug_ideaunit, year365_road)
    x_budunit.add_idea(Sep_ideaunit, year365_road)
    x_budunit.add_idea(Oct_ideaunit, year365_road)
    x_budunit.add_idea(Nov_ideaunit, year365_road)
    x_budunit.add_idea(Dec_ideaunit, year365_road)
    ...
    x_budunit.add_idea(y366_Jan_ideaunit, year366_road)
    x_budunit.add_idea(y366_Feb29_ideaunit, year366_road)
    x_budunit.add_idea(y366_Mar_ideaunit, year366_road)
    x_budunit.add_idea(y366_Apr_ideaunit, year366_road)
    x_budunit.add_idea(y366_May_ideaunit, year366_road)
    x_budunit.add_idea(y366_Jun_ideaunit, year366_road)
    x_budunit.add_idea(y366_Jul_ideaunit, year366_road)
    x_budunit.add_idea(y366_Aug_ideaunit, year366_road)
    x_budunit.add_idea(y366_Sep_ideaunit, year366_road)
    x_budunit.add_idea(y366_Oct_ideaunit, year366_road)
    x_budunit.add_idea(y366_Nov_ideaunit, year366_road)
    x_budunit.add_idea(y366_Dec_ideaunit, year366_road)
    ...
    x_budunit.add_idea(i_shop("0-:00", _begin=0, _close=1), tech_hr_road)
    x_budunit.add_idea(i_shop("1-:01", _begin=1, _close=2), tech_hr_road)
    x_budunit.add_idea(i_shop("2-:02", _begin=2, _close=3), tech_hr_road)
    x_budunit.add_idea(i_shop("3-:03", _begin=3, _close=4), tech_hr_road)
    x_budunit.add_idea(i_shop("4-:04", _begin=4, _close=5), tech_hr_road)
    x_budunit.add_idea(i_shop("5-:05", _begin=5, _close=6), tech_hr_road)
    x_budunit.add_idea(i_shop("6-:06", _begin=6, _close=7), tech_hr_road)
    x_budunit.add_idea(i_shop("7-:07", _begin=7, _close=8), tech_hr_road)
    x_budunit.add_idea(i_shop("8-:08", _begin=8, _close=9), tech_hr_road)
    x_budunit.add_idea(i_shop("9-:09", _begin=9, _close=10), tech_hr_road)
    x_budunit.add_idea(i_shop("10-:10", _begin=10, _close=11), tech_hr_road)
    x_budunit.add_idea(i_shop("11-:11", _begin=11, _close=12), tech_hr_road)
    x_budunit.add_idea(i_shop("12-:12", _begin=12, _close=13), tech_hr_road)
    x_budunit.add_idea(i_shop("13-:13", _begin=13, _close=14), tech_hr_road)
    x_budunit.add_idea(i_shop("14-:14", _begin=14, _close=15), tech_hr_road)
    x_budunit.add_idea(i_shop("15-:15", _begin=15, _close=16), tech_hr_road)
    x_budunit.add_idea(i_shop("16-:16", _begin=16, _close=17), tech_hr_road)
    x_budunit.add_idea(i_shop("17-:17", _begin=17, _close=18), tech_hr_road)
    x_budunit.add_idea(i_shop("18-:18", _begin=18, _close=19), tech_hr_road)
    x_budunit.add_idea(i_shop("19-:19", _begin=19, _close=20), tech_hr_road)
    x_budunit.add_idea(i_shop("20-:20", _begin=20, _close=21), tech_hr_road)
    x_budunit.add_idea(i_shop("21-:21", _begin=21, _close=22), tech_hr_road)
    x_budunit.add_idea(i_shop("22-:22", _begin=22, _close=23), tech_hr_road)
    x_budunit.add_idea(i_shop("23-:23", _begin=23, _close=24), tech_hr_road)
    x_budunit.add_idea(i_shop("24-:24", _begin=24, _close=25), tech_hr_road)
    x_budunit.add_idea(i_shop("25-:25", _begin=25, _close=26), tech_hr_road)
    x_budunit.add_idea(i_shop("26-:26", _begin=26, _close=27), tech_hr_road)
    x_budunit.add_idea(i_shop("27-:27", _begin=27, _close=28), tech_hr_road)
    x_budunit.add_idea(i_shop("28-:28", _begin=28, _close=29), tech_hr_road)
    x_budunit.add_idea(i_shop("29-:29", _begin=29, _close=30), tech_hr_road)
    x_budunit.add_idea(i_shop("30-:30", _begin=30, _close=31), tech_hr_road)
    x_budunit.add_idea(i_shop("31-:31", _begin=31, _close=32), tech_hr_road)
    x_budunit.add_idea(i_shop("32-:32", _begin=32, _close=33), tech_hr_road)
    x_budunit.add_idea(i_shop("33-:33", _begin=33, _close=34), tech_hr_road)
    x_budunit.add_idea(i_shop("34-:34", _begin=34, _close=35), tech_hr_road)
    x_budunit.add_idea(i_shop("35-:35", _begin=35, _close=36), tech_hr_road)
    x_budunit.add_idea(i_shop("36-:36", _begin=36, _close=37), tech_hr_road)
    x_budunit.add_idea(i_shop("37-:37", _begin=37, _close=38), tech_hr_road)
    x_budunit.add_idea(i_shop("38-:38", _begin=38, _close=39), tech_hr_road)
    x_budunit.add_idea(i_shop("39-:39", _begin=39, _close=40), tech_hr_road)
    x_budunit.add_idea(i_shop("40-:40", _begin=40, _close=41), tech_hr_road)
    x_budunit.add_idea(i_shop("41-:41", _begin=41, _close=42), tech_hr_road)
    x_budunit.add_idea(i_shop("42-:42", _begin=42, _close=43), tech_hr_road)
    x_budunit.add_idea(i_shop("43-:43", _begin=43, _close=44), tech_hr_road)
    x_budunit.add_idea(i_shop("44-:44", _begin=44, _close=45), tech_hr_road)
    x_budunit.add_idea(i_shop("45-:45", _begin=45, _close=46), tech_hr_road)
    x_budunit.add_idea(i_shop("46-:46", _begin=46, _close=47), tech_hr_road)
    x_budunit.add_idea(i_shop("47-:47", _begin=47, _close=48), tech_hr_road)
    x_budunit.add_idea(i_shop("48-:48", _begin=48, _close=49), tech_hr_road)
    x_budunit.add_idea(i_shop("49-:49", _begin=49, _close=50), tech_hr_road)
    x_budunit.add_idea(i_shop("50-:50", _begin=50, _close=51), tech_hr_road)
    x_budunit.add_idea(i_shop("51-:51", _begin=51, _close=52), tech_hr_road)
    x_budunit.add_idea(i_shop("52-:52", _begin=52, _close=53), tech_hr_road)
    x_budunit.add_idea(i_shop("53-:53", _begin=53, _close=54), tech_hr_road)
    x_budunit.add_idea(i_shop("54-:54", _begin=54, _close=55), tech_hr_road)
    x_budunit.add_idea(i_shop("55-:55", _begin=55, _close=56), tech_hr_road)
    x_budunit.add_idea(i_shop("56-:56", _begin=56, _close=57), tech_hr_road)
    x_budunit.add_idea(i_shop("57-:57", _begin=57, _close=58), tech_hr_road)
    x_budunit.add_idea(i_shop("58-:58", _begin=58, _close=59), tech_hr_road)
    x_budunit.add_idea(i_shop("59-:59", _begin=59, _close=60), tech_hr_road)
    ...
    x_budunit.add_idea(hr_0_idea, tech_day_road)
    x_budunit.add_idea(hr_1_idea, tech_day_road)
    x_budunit.add_idea(hr_2_idea, tech_day_road)
    x_budunit.add_idea(hr_3_idea, tech_day_road)
    x_budunit.add_idea(hr_4_idea, tech_day_road)
    x_budunit.add_idea(hr_5_idea, tech_day_road)
    x_budunit.add_idea(hr_6_idea, tech_day_road)
    x_budunit.add_idea(hr_7_idea, tech_day_road)
    x_budunit.add_idea(hr_8_idea, tech_day_road)
    x_budunit.add_idea(hr_9_idea, tech_day_road)
    x_budunit.add_idea(hr_10_idea, tech_day_road)
    x_budunit.add_idea(hr_11_idea, tech_day_road)
    x_budunit.add_idea(hr_12_idea, tech_day_road)
    x_budunit.add_idea(hr_13_idea, tech_day_road)
    x_budunit.add_idea(hr_14_idea, tech_day_road)
    x_budunit.add_idea(hr_15_idea, tech_day_road)
    x_budunit.add_idea(hr_16_idea, tech_day_road)
    x_budunit.add_idea(hr_17_idea, tech_day_road)
    x_budunit.add_idea(hr_18_idea, tech_day_road)
    x_budunit.add_idea(hr_19_idea, tech_day_road)
    x_budunit.add_idea(hr_20_idea, tech_day_road)
    x_budunit.add_idea(hr_21_idea, tech_day_road)
    x_budunit.add_idea(hr_22_idea, tech_day_road)
    x_budunit.add_idea(hr_23_idea, tech_day_road)
    ...
    x_budunit.add_idea(x0_year1_ideaunit, year4_noleap_road)
    x_budunit.add_idea(x0_year2_ideaunit, year4_noleap_road)
    x_budunit.add_idea(x0_year3_ideaunit, year4_noleap_road)
    x_budunit.add_idea(x0_year4_ideaunit, year4_noleap_road)
    ...
    x_budunit.add_idea(x1_year1_ideaunit, year4_withleap_road)
    x_budunit.add_idea(x1_year2_ideaunit, year4_withleap_road)
    x_budunit.add_idea(x1_year3_ideaunit, year4_withleap_road)
    x_budunit.add_idea(x1_year4_ideaunit, year4_withleap_road)
    ...
    x_budunit.add_idea(node_0_100_idea, tech_c400_road)
    x_budunit.add_idea(node_1_4_idea, tech_c400_road)
    x_budunit.add_idea(node_1_96_idea, tech_c400_road)
    x_budunit.add_idea(node_2_4_idea, tech_c400_road)
    x_budunit.add_idea(node_2_96_idea, tech_c400_road)
    x_budunit.add_idea(node_3_4_idea, tech_c400_road)
    x_budunit.add_idea(node_3_96_idea, tech_c400_road)
    ...
    x_budunit.add_idea(year_0_withleap_idea, node_0_100_road)
    x_budunit.add_idea(year_x4_no_leap_idea, node_1_4_road)
    x_budunit.add_idea(year_x_withleap_idea, node_1_96_road)
    x_budunit.add_idea(year_x4_no_leap_idea, node_2_4_road)
    x_budunit.add_idea(year_x_withleap_idea, node_2_96_road)
    x_budunit.add_idea(year_x4_no_leap_idea, node_3_4_road)
