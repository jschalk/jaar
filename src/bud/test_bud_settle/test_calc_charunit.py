...
def test_create_lobbyboxs_metrics_SetsAttrScenario1():
    ...
    sue_budunit = budunit_shop(sue_text)
    yao_text = "Yao"
    sue_budunit.add_charunit(yao_text)
    yao_charunit = sue_budunit.get_char(yao_text)
...
def test_BudUnit_calc_charunit_metrics_SetsAttr_scenario0():
    # ESTABLISH
    sue_text = "Sue"
    sue_budunit = budunit_shop(sue_text)
    assert sue_budunit._lobbyboxs == {}
    ...
    # WHEN
    sue_budunit._calc_charunit_metrics()

    # THEN
    assert sue_budunit._lobbyboxs == {}


def test_BudUnit_calc_charunit_metrics_Clears_lobbys():
    # ESTABLISH
    sue_text = "Sue"
    sue_budunit = budunit_shop(sue_text)
...
def test_BudUnit_calc_charunit_metrics_SetsAttr_scenario1():
    # ESTABLISH
    sue_text = "Sue"
    sue_budunit = budunit_shop(sue_text)
    yao_text = "Yao"
    ...
    assert yao_charunit._credor_pool != 0
    assert yao_charunit._debtor_pool != 0
    assert yao_charunit._credor_pool == sue_budunit._credor_respect
    assert yao_charunit._debtor_pool == sue_budunit._debtor_respect
...
def test_BudUnit_calc_charunit_metrics_SetsAttr_scenario2():
    # ESTABLISH
    sue_text = "Sue"
    sue_budunit = budunit_shop(sue_text)
    yao_text = "Yao"
    ...
    # THEN
    assert sue_budunit.get_char(yao_text)._credor_pool != 0
    assert sue_budunit.get_char(yao_text)._debtor_pool != 0
    assert yao_charunit.get_lobbyship(yao_text)._credor_pool != 0
    assert yao_charunit.get_lobbyship(yao_text)._debtor_pool != 0
    yao_yao_lobbyship = yao_charunit.get_lobbyship(yao_text)
...
def test_BudUnit_calc_charunit_metrics_ResetCharUnitsAttrs():
    # ESTABLISH
    sue_text = "Sue"
    sue_budunit = budunit_shop(sue_text)
    yao_text = "Yao"
    zia_text = "Zia"
    sue_budunit.add_charunit(yao_text, 55, 55)
    sue_budunit.add_charunit(zia_text, 55, 55)
    yao_charunit = sue_budunit.get_char(yao_text)
    zia_charunit = sue_budunit.get_char(zia_text)
    ...
    zia_charunit.set_fund_agenda_ratio_give_take(
        ...
        bud_charunit_total_credor_weight=zia_3,
        bud_charunit_total_debtor_weight=zia_4,
    )
    yao_1 = 0.2
    yao_2 = 0.5
    yao_3 = 204
    ...
    yao_charunit.set_fund_agenda_ratio_give_take(
        ...
        bud_charunit_total_credor_weight=yao_3,
        bud_charunit_total_debtor_weight=yao_4,
    )
