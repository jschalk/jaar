...
def test_bud_idearoot_teamunit_CorrectlySets_idea_teamheir():
    ...
    yao_bud.edit_idea_attr(teamunit=x_teamunit, road=yao_bud._pecun_id)
...
def test_BudUnit__get_filtered_awardlinks_idea_CorrectlyFiltersIdea_Teamunit():
    ...
    sue1_bud.set_idea(ideaunit_shop(casa_str), parent_road=sue1_bud._pecun_id)
    sue1_bud.set_idea(ideaunit_shop(swim_str), parent_road=sue1_bud._pecun_id)
