...
def test_BudUnit_settle_bud_WithLevel3AwardLinkAndEmptyAncestorsSetsGroupBox_fund_give_fund_take():
    ...
    # THEN
    x_idearoot = x_bud.get_idea_obj(x_bud._pecun_id)
...
def test_BudUnit_set_awardlink_CorrectlyCalculatesInheritedAwardLinkBudFund():
    ...
    idea_bob = idea_dict.get(sue_bud._pecun_id)
...
def test_BudUnit_settle_bud_CorrectlySetsGroupLinkBudCredAndDebt():
    ...
    yao_bud.edit_idea_attr(yao_bud._pecun_id, awardlink=sue_awardlink)
    yao_bud.edit_idea_attr(yao_bud._pecun_id, awardlink=bob_awardlink)
    yao_bud.edit_idea_attr(yao_bud._pecun_id, awardlink=zia_awardlink)
