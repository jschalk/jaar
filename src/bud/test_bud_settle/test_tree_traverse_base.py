...
from src.bud.reason_idea import factheir_shop
...
def test_BudUnit_settle_bud_NLevelCorrectlySetsDescendantAttributes_1():
    ...
    # test root status:
    x_idearoot = sue_bud.get_idea_obj(sue_bud._tribe_id)
...
def test_BudUnit_get_idea_tree_ordered_road_list_ReturnsCorrectObj():
    ...
    assert x_1st_road_in_ordered_list == sue_bud._tribe_id
    ...
    assert y_1st_road_in_ordered_list == sue_bud._tribe_id
...
def test_BudUnit_settle_bud_WhenIdeaRootHas_massButAll_kidsHaveZero_massAddTo_offtrack_kids_mass_set_Scenario0():
    ...
    # THEN
    assert sue_budunit._offtrack_kids_mass_set == {sue_budunit._tribe_id}
...
def test_BudUnit_settle_bud_CreatesNewGroupBoxsWhenNeeded_Scenario0():
    ...
    x_idearoot = yao_bud.get_idea_obj(yao_bud._tribe_id)
...
def test_BudUnit_settle_bud_Sets_idearoot_factheir_With_range_factheirs():
    ...
    x_tribe_id = yao_bud._tribe_id
    yao_bud.edit_idea_attr(x_tribe_id, reason_base=tue_road, reason_premise=tue_road)
