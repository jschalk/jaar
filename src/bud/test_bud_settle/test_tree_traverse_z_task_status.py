...
def test_BudUnit_settle_bud_CorrectlySets_idea_dict():
    ...
    assert casa_idea._parent_road == sue_budunit._pecun_id
...
def test_BudUnit_settle_bud_CorrectlySetsData_budunit_v001():
    ...
    # day_hour = f"{yao_budunit._pecun_id},day_hour"
...
def test_BudUnit_settle_bud_OptionWeekdaysReturnsCorrectObj_budunit_v001():
    ...
    x_idearoot = yao_budunit.get_idea_obj(yao_budunit._pecun_id)
    ...
    # yao_budunit.set_fact(base=f"{yao_budunit._pecun_id},weekdays", pick=f"{yao_budunit._pecun_id},weekdays,Tuesday")
    # idea_dict = yao_budunit.get_idea_dict()
    # assert YR.get_active(road=bird_idea, idea_dict=idea_dict) is True

    # yao_budunit.set_fact(base=f"{yao_budunit._pecun_id},weekdays", pick=f"{yao_budunit._pecun_id},weekdays,Wednesday")
    # idea_dict = yao_budunit.get_idea_dict()
