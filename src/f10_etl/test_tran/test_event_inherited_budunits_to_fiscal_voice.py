...
from src.f10_etl.transformers import etl_event_inherited_budunits_to_fiscal_voice
from src.f10_etl.examples.etl_env import env_dir_setup_cleanup, get_test_etl_dir
from os.path import exists as os_path_exists

# create test where event create_events_owner_dir_path()
...
def test_WorldUnit_event_inherited_budunits_to_fiscal_voice_SetsFiles_Scenario0(
    ...
    # WHEN
    etl_event_inherited_budunits_to_fiscal_voice(fiscal_mstr_dir)
