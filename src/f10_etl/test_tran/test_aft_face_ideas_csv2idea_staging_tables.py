...
from src.f10_etl.transformers import etl_aft_face_csv_files2idea_staging_tables
from src.f10_etl.examples.etl_env import get_test_etl_dir, env_dir_setup_cleanup
from sqlite3 import connect as sqlite3_connect


def test_etl_aft_face_csv_files2idea_staging_tables_DBChanges(
...
"""
    ...
    with sqlite3_connect(":memory:") as fiscal_db_conn:
        ...
        # ESTABLISH
        etl_aft_face_csv_files2idea_staging_tables(fiscal_db_conn, aft_faces_dir)
