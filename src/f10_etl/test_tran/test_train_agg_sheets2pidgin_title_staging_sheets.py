...
from src.f10_etl.transformers import etl_train_agg_to_pidgin_title_staging
from src.f10_etl.examples.etl_env import get_test_etl_dir, env_dir_setup_cleanup
from pandas import DataFrame, read_excel as pandas_read_excel
from os.path import exists as os_path_exists


def test_etl_train_agg_to_pidgin_title_staging_CreatesFile_Scenario0_SingleIdea(
    ...
    br00116_file_path = create_path(x_train_dir, "br00116.xlsx")
    br00116_columns = [
        face_name_str(),
        event_int_str(),
        fisc_title_str(),
    ...
    # WHEN
    etl_train_agg_to_pidgin_title_staging({event7}, x_train_dir)
...
def test_etl_train_agg_to_pidgin_title_staging_CreatesFile_Scenario1_MultipleIdeasFiles(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bob_str = "Bob"
    ...
    br00044_file_path = create_path(x_train_dir, "br00044.xlsx")
    br00044_columns = [
        face_name_str(),
        event_int_str(),
        otx_title_str(),
    ...
    etl_train_agg_to_pidgin_title_staging(legitimate_events, x_train_dir)
...
def test_etl_train_agg_to_pidgin_title_staging_CreatesFile_Scenario2_WorldUnit_events_Filters(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bob_str = "Bob"
