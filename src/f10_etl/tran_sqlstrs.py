...
CREATE_BUDMEMB_PUT_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_acct_membership_agg (face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, acct_name TEXT, group_label TEXT, credit_vote REAL, debtit_vote REAL)"""
CREATE_BUDMEMB_PUT_STAGING_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_acct_membership_staging (idea_number TEXT, face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, acct_name TEXT, group_label TEXT, credit_vote REAL, debtit_vote REAL, error_message TEXT)"""
CREATE_BUDACCT_PUT_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_acctunit_agg (face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, acct_name TEXT, credit_belief REAL, debtit_belief REAL)"""
CREATE_BUDACCT_PUT_STAGING_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_acctunit_staging (idea_number TEXT, face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, acct_name TEXT, credit_belief REAL, debtit_belief REAL, error_message TEXT)"""
CREATE_BUDAWAR_PUT_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_awardlink_agg (face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, road TEXT, awardee_tag TEXT, give_force REAL, take_force REAL)"""
CREATE_BUDAWAR_PUT_STAGING_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_awardlink_staging (idea_number TEXT, face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, road TEXT, awardee_tag TEXT, give_force REAL, take_force REAL, error_message TEXT)"""
CREATE_BUDFACT_PUT_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_factunit_agg (face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, road TEXT, base TEXT, pick TEXT, fopen REAL, fnigh REAL)"""
CREATE_BUDFACT_PUT_STAGING_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_factunit_staging (idea_number TEXT, face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, road TEXT, base TEXT, pick TEXT, fopen REAL, fnigh REAL, error_message TEXT)"""
CREATE_BUDHEAL_PUT_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_healerlink_agg (face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, road TEXT, healer_name TEXT)"""
CREATE_BUDHEAL_PUT_STAGING_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_healerlink_staging (idea_number TEXT, face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, road TEXT, healer_name TEXT, error_message TEXT)"""
CREATE_BUDPREM_PUT_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_reason_premiseunit_agg (face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, road TEXT, base TEXT, need TEXT, nigh REAL, open REAL, divisor REAL)"""
CREATE_BUDPREM_PUT_STAGING_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_reason_premiseunit_staging (idea_number TEXT, face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, road TEXT, base TEXT, need TEXT, nigh REAL, open REAL, divisor REAL, error_message TEXT)"""
CREATE_BUDREAS_PUT_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_reasonunit_agg (face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, road TEXT, base TEXT, base_item_active_requisite TEXT)"""
CREATE_BUDREAS_PUT_STAGING_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_reasonunit_staging (idea_number TEXT, face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, road TEXT, base TEXT, base_item_active_requisite TEXT, error_message TEXT)"""
CREATE_BUDTEAM_PUT_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_teamlink_agg (face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, road TEXT, team_tag TEXT)"""
CREATE_BUDTEAM_PUT_STAGING_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_teamlink_staging (idea_number TEXT, face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, road TEXT, team_tag TEXT, error_message TEXT)"""
CREATE_BUDITEM_PUT_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_itemunit_agg (face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, parent_road TEXT, item_title TEXT, begin REAL, close REAL, addin REAL, numor REAL, denom REAL, morph INTEGER, gogo_want REAL, stop_want REAL, mass REAL, pledge INTEGER, problem_bool INTEGER)"""
CREATE_BUDITEM_PUT_STAGING_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_itemunit_staging (idea_number TEXT, face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, parent_road TEXT, item_title TEXT, begin REAL, close REAL, addin REAL, numor REAL, denom REAL, morph INTEGER, gogo_want REAL, stop_want REAL, mass REAL, pledge INTEGER, problem_bool INTEGER, error_message TEXT)"""
CREATE_BUDUNIT_PUT_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS budunit_agg (face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, credor_respect REAL, debtor_respect REAL, fund_pool REAL, max_tree_traverse INTEGER, deal_time_int INTEGER, tally REAL, fund_coin REAL, penny REAL, respect_bit REAL)"""
CREATE_BUDUNIT_PUT_STAGING_SQLSTR = """CREATE TABLE IF NOT EXISTS budunit_staging (idea_number TEXT, face_name TEXT, event_int INTEGER, fiscal_title TEXT, owner_name TEXT, credor_respect REAL, debtor_respect REAL, fund_pool REAL, max_tree_traverse INTEGER, deal_time_int INTEGER, tally REAL, fund_coin REAL, penny REAL, respect_bit REAL, error_message TEXT)"""
...
def get_bud_create_table_sqlstrs() -> dict[str, str]:
    return {
        "bud_acct_membership_agg": CREATE_BUDMEMB_PUT_AGG_SQLSTR,
        "bud_acct_membership_staging": CREATE_BUDMEMB_PUT_STAGING_SQLSTR,
        "bud_acctunit_agg": CREATE_BUDACCT_PUT_AGG_SQLSTR,
        "bud_acctunit_staging": CREATE_BUDACCT_PUT_STAGING_SQLSTR,
        "bud_item_awardlink_agg": CREATE_BUDAWAR_PUT_AGG_SQLSTR,
        "bud_item_awardlink_staging": CREATE_BUDAWAR_PUT_STAGING_SQLSTR,
        "bud_item_factunit_agg": CREATE_BUDFACT_PUT_AGG_SQLSTR,
        "bud_item_factunit_staging": CREATE_BUDFACT_PUT_STAGING_SQLSTR,
        "bud_item_healerlink_agg": CREATE_BUDHEAL_PUT_AGG_SQLSTR,
        "bud_item_healerlink_staging": CREATE_BUDHEAL_PUT_STAGING_SQLSTR,
        "bud_item_reason_premiseunit_agg": CREATE_BUDPREM_PUT_AGG_SQLSTR,
        "bud_item_reason_premiseunit_staging": CREATE_BUDPREM_PUT_STAGING_SQLSTR,
        "bud_item_reasonunit_agg": CREATE_BUDREAS_PUT_AGG_SQLSTR,
        "bud_item_reasonunit_staging": CREATE_BUDREAS_PUT_STAGING_SQLSTR,
        "bud_item_teamlink_agg": CREATE_BUDTEAM_PUT_AGG_SQLSTR,
        "bud_item_teamlink_staging": CREATE_BUDTEAM_PUT_STAGING_SQLSTR,
        "bud_itemunit_agg": CREATE_BUDITEM_PUT_AGG_SQLSTR,
        "bud_itemunit_staging": CREATE_BUDITEM_PUT_STAGING_SQLSTR,
        "budunit_agg": CREATE_BUDUNIT_PUT_AGG_SQLSTR,
        "budunit_staging": CREATE_BUDUNIT_PUT_STAGING_SQLSTR,
    }
...
BUDMEMB_PUT_AGG_INSERT_SQLSTR = """INSERT INTO bud_acct_membership_agg (face_name, event_int, fiscal_title, owner_name, acct_name, group_label, credit_vote, debtit_vote)
...
;
"""
BUDACCT_PUT_AGG_INSERT_SQLSTR = """INSERT INTO bud_acctunit_agg (face_name, event_int, fiscal_title, owner_name, acct_name, credit_belief, debtit_belief)
...
;
"""
BUDAWAR_PUT_AGG_INSERT_SQLSTR = """INSERT INTO bud_item_awardlink_agg (face_name, event_int, fiscal_title, owner_name, road, awardee_tag, give_force, take_force)
...
;
"""
BUDFACT_PUT_AGG_INSERT_SQLSTR = """INSERT INTO bud_item_factunit_agg (face_name, event_int, fiscal_title, owner_name, road, base, pick, fopen, fnigh)
...
;
"""
BUDHEAL_PUT_AGG_INSERT_SQLSTR = """INSERT INTO bud_item_healerlink_agg (face_name, event_int, fiscal_title, owner_name, road, healer_name)
SELECT face_name, event_int, fiscal_title, owner_name, road, healer_name
FROM bud_item_healerlink_staging
WHERE error_message IS NULL
GROUP BY face_name, event_int, fiscal_title, owner_name, road, healer_name
;
"""
BUDPREM_PUT_AGG_INSERT_SQLSTR = """INSERT INTO bud_item_reason_premiseunit_agg (face_name, event_int, fiscal_title, owner_name, road, base, need, nigh, open, divisor)
...
;
"""
BUDREAS_PUT_AGG_INSERT_SQLSTR = """INSERT INTO bud_item_reasonunit_agg (face_name, event_int, fiscal_title, owner_name, road, base, base_item_active_requisite)
...
;
"""
BUDTEAM_PUT_AGG_INSERT_SQLSTR = """INSERT INTO bud_item_teamlink_agg (face_name, event_int, fiscal_title, owner_name, road, team_tag)
SELECT face_name, event_int, fiscal_title, owner_name, road, team_tag
FROM bud_item_teamlink_staging
WHERE error_message IS NULL
GROUP BY face_name, event_int, fiscal_title, owner_name, road, team_tag
;
"""
BUDITEM_PUT_AGG_INSERT_SQLSTR = """INSERT INTO bud_itemunit_agg (face_name, event_int, fiscal_title, owner_name, parent_road, item_title, begin, close, addin, numor, denom, morph, gogo_want, stop_want, mass, pledge, problem_bool)
...
;
"""
BUDUNIT_PUT_AGG_INSERT_SQLSTR = """INSERT INTO budunit_agg (face_name, event_int, fiscal_title, owner_name, credor_respect, debtor_respect, fund_pool, max_tree_traverse, deal_time_int, tally, fund_coin, penny, respect_bit)
