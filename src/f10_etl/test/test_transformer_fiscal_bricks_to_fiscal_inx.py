...
from src.f10_etl.transformers import etl_fiscal_bricks_to_fiscal_inx
...
def test_etl_fiscal_bricks_to_fiscal_inx_Scenario0_MultpleFaceIDs_CreatesFiscalInxSheets(
    ...
    x_events = {event3: sue_str, event7: zia_str, event8: zia_str, event9: zia_str}
    x_fiscal_pidgins = {
