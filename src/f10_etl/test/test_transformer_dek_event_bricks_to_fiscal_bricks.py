...
from src.f10_etl.transformers import etl_dek_event_bricks_to_fiscal_bricks
...
def test_WorldUnit_dek_event_bricks_to_fiscal_bricks_CreatesFaceBrickSheets_Scenario0_MultpleFaceIDs(
    ...
    x_faces_dek_dir = get_test_etl_dir()
    sue_dir = create_path(x_faces_dek_dir, sue_str)
    zia_dir = create_path(x_faces_dek_dir, zia_str)
    ...
    # WHEN
    etl_dek_event_bricks_to_fiscal_bricks(x_faces_dek_dir)
