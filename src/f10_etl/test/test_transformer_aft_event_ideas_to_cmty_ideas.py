...
from src.f10_etl.transformers import etl_aft_event_ideas_to_cmty_ideas
...
def test_WorldUnit_aft_event_ideas_to_cmty_ideas_CreatesFaceIdeaSheets_Scenario0_MultpleFaceNames(
    ...
    # WHEN
    etl_aft_event_ideas_to_cmty_ideas(x_faces_aft_dir)
