...
from src.f10_etl.transformers import etl_fish_agg_to_pidgin_road_staging
from src.f10_etl.examples.etl_env import get_test_etl_dir, env_dir_setup_cleanup
from pandas import DataFrame, read_excel as pandas_read_excel
from os.path import exists as os_path_exists


def test_etl_fish_agg_to_pidgin_road_staging_CreatesFile_Scenario0_SingleBrick(
    ...
    br00117_file_path = create_path(x_fish_dir, "br00117.xlsx")
    br00117_columns = [
        face_id_str(),
        event_id_str(),
        fiscal_id_str(),
    ...
    # WHEN
    etl_fish_agg_to_pidgin_road_staging({event7}, x_fish_dir)
...
def test_etl_fish_agg_to_pidgin_road_staging_CreatesFile_Scenario1_MultipleBricksFiles(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bob_str = "Bob"
    ...
    br00045_file_path = create_path(x_fish_dir, "br00045.xlsx")
    br00045_columns = [
        face_id_str(),
        event_id_str(),
        otx_road_str(),
    ...
    etl_fish_agg_to_pidgin_road_staging(legitimate_events, x_fish_dir)
...
def test_etl_fish_agg_to_pidgin_road_staging_CreatesFile_Scenario2_WorldUnit_events_Filters(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bob_str = "Bob"
