...
def test_etl_cmty_csvs_to_jsons_Scenario0_CreateFilesWithOnlyCmtyTitle(
...
def test_etl_cmty_csvs_to_jsons_Scenario1_CreateFilesWithCmtyUnitAttrs(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    accord23_str = "accord23"
...
"""
    ...
    # WHEN
    etl_cmty_csvs_to_jsons(cmty_mstr_dir)
