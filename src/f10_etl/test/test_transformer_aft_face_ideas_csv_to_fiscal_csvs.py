...
def test_populate_fiscal_staging_tables_Scenario5_Idea_br00002_Table_WithAttrs(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
...
def test_populate_fiscal_staging_tables_Scenario7_Idea_br00004_Table_WithAttrs(
    env_dir_setup_cleanup,
):
