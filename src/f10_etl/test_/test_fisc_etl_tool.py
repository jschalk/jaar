...
def test_create_fiscunit_jsons_from_prime_files_Scenario1_IncludeNoneTimeLineUnitParameters(
    ...
    assert accord56_fiscunit
    assert accord56_fiscunit.fisc_title == accord56_str
    assert accord56_fiscunit.present_time == accord56_present_time
    ...
    assert accord56_fiscunit.fisc_title == accord56_str
    assert accord56_fiscunit.present_time != default_fiscunit.present_time
...
def test_collect_events_dir_owner_events_sets_ReturnsObj_Scenario0_none(
    ...
    # ESTABLISH
    fisc_events_dir = get_test_etl_dir()
    # WHEN
