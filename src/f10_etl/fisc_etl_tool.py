...
def create_fiscunit_jsons_from_prime_files(fisc_mstr_dir: str):
    ...
    fiscoffi_df = pandas_read_excel(xp.offi_excel_path, "agg")
    ...
    fiscoffis_dict = dataframe_to_dict(fiscoffi_df, ["fisc_title"])
    ...
    for fisc_attrs in fiscunits_dict.values():
        ...
        _add_time_offis_from_df(fiscunit, fiscoffi_df)
