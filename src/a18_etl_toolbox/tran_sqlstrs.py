...
;
"""
BUDPREM_DEL_AGG_INSERT_SQLSTR = """INSERT INTO bud_idea_reason_premiseunit_del_agg (event_int, face_name, fisc_tag, owner_name, idea_way, rcontext, rbranch_ERASE)
SELECT event_int, face_name, fisc_tag, owner_name, idea_way, rcontext, rbranch_ERASE
FROM bud_idea_reason_premiseunit_del_raw
WHERE error_message IS NULL
GROUP BY event_int, face_name, fisc_tag, owner_name, idea_way, rcontext, rbranch_ERASE
;
"""
