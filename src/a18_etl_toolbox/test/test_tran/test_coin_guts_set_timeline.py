...
from src.a18_etl_toolbox.transformers import add_coin_timeline_to_guts


def test_add_coin_timeline_to_guts_SetsFiles_Scenario0(env_dir_setup_cleanup):
    # ESTABLISH
    a23_str = "amy23"
    ...
    save_json(coin_json_path, None, a23_coin.to_dict())
    ...
    # WHEN
    add_coin_timeline_to_guts(coin_mstr_dir)
