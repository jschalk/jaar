...
from src.a18_etl_toolbox.transformers import etl_event_inherited_planunits_to_belief_gut
...
def test_etl_event_inherited_planunits_to_belief_gut_SetsFiles_Scenario0(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    # WHEN
    etl_event_inherited_planunits_to_belief_gut(belief_mstr_dir)
