...
from src.a12_hub_toolbox.hub_path import create_bank_json_path, create_job_path
...
from src.a18_etl_toolbox.transformers import etl_bank_job_jsons_to_job_tables


def test_etl_bank_job_jsons_to_job_tables_PopulatesTables_Scenario0(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    m23_bank_mstr_dir = get_module_temp_dir()
    m23_str = "music23"
    a23_str = "accord23"
    sue_str = "Sue"
    bob_str = "Bob"
    ...
    save_job_file(m23_bank_mstr_dir, sue_plan)
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        # WHEN
        etl_bank_job_jsons_to_job_tables(cursor, m23_bank_mstr_dir)
...
def test_etl_bank_job_jsons_to_job_tables_PopulatesTables_Scenario1(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    save_file(bank_json_path, None, bankunit_shop(a23_str, bank_mstr_dir).get_json())
    a23_bob_job_path = create_job_path(bank_mstr_dir, a23_str, bob_inx)
    assert os_path_exists(bank_json_path)
    ...
    with sqlite3_connect(":memory:") as db_conn:
        ...
        # WHEN
        etl_bank_job_jsons_to_job_tables(cursor, bank_mstr_dir)
