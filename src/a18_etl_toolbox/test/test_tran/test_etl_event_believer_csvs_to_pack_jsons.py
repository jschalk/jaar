...
def test_etl_event_believer_csvs_to_pack_json_CreatesFiles_Scenario0_IgnoresCSV_believerunit(
    ...
    a23_bob_e3_dir = believer_event_dir(coin_mstr_dir, a23_str, bob_inx, event3)
    e3_put_csv = f"""{event_int_str()},{face_name_str()},coin_label,believer_name,credor_respect,debtor_respect,fund_pool,max_tree_traverse,tally,fund_iota,penny,respect_bit
...
"""
    ...
    # WHEN
    etl_event_believer_csvs_to_pack_json(coin_mstr_dir)
...
def test_etl_event_believer_csvs_to_pack_json_CreatesFiles_Scenario1(
    ...
    # a23_bob_e7_dir = create_path(a23_bob_dir, event7)
    a23_bob_e3_dir = believer_event_dir(coin_mstr_dir, a23_str, bob_inx, event3)
    a23_bob_e7_dir = believer_event_dir(coin_mstr_dir, a23_str, bob_inx, event7)
    e3_put_csv = f"""{event_int_str()},{face_name_str()},{coin_label_str()},{believer_name_str()},{partner_name_str()},{partner_cred_points_str()},{partner_debt_points_str()}
{event3},{sue_inx},{a23_str},{bob_inx},{bob_inx},{credit77},{debt_empty}
"""
    e7_put_csv = f"""{event_int_str()},{face_name_str()},{coin_label_str()},{believer_name_str()},{partner_name_str()},{partner_cred_points_str()},{partner_debt_points_str()}
...
"""
    ...
    # print(e7_insert.get("believer_partnerunit").keys())
    # print(expected_e7_insert.get("believer_partnerunit").keys())
    e7_blrpern = e7_insert.get("believer_partnerunit")
    expected_e7_blrpern = expected_e7_insert.get("believer_partnerunit")
