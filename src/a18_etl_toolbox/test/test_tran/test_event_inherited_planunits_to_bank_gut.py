...
from src.a18_etl_toolbox.transformers import etl_event_inherited_planunits_to_bank_gut
...
def test_etl_event_inherited_planunits_to_bank_gut_SetsFiles_Scenario0(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    a23_bob_e3_dir = create_owner_event_dir_path(
        bank_mstr_dir, a23_str, bob_inx, event3
    )
    a23_bob_e7_dir = create_owner_event_dir_path(
        bank_mstr_dir, a23_str, bob_inx, event7
    )
    ...
    # WHEN
    etl_event_inherited_planunits_to_bank_gut(bank_mstr_dir)
