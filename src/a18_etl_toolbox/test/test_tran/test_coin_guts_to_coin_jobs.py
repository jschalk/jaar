...
from src.a18_etl_toolbox.transformers import etl_coin_guts_to_coin_jobs


def test_etl_coin_guts_to_coin_jobs_SetsFiles_Scenario0(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    # WHEN
    etl_coin_guts_to_coin_jobs(coin_mstr_dir)
