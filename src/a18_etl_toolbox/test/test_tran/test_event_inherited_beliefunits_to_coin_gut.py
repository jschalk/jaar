...
from src.a12_hub_toolbox.a12_path import create_belief_event_dir_path, create_gut_path
from src.a18_etl_toolbox.test._util.a18_env import (
    env_dir_setup_cleanup,
    get_module_temp_dir,
)
from src.a18_etl_toolbox.transformers import etl_event_inherited_beliefunits_to_coin_gut
...
def test_etl_event_inherited_beliefunits_to_coin_gut_SetsFiles_Scenario0(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    # WHEN
    etl_event_inherited_beliefunits_to_coin_gut(coin_mstr_dir)
