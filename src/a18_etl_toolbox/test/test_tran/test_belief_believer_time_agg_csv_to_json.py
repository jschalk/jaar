...
from src.a18_etl_toolbox.transformers import etl_belief_ote1_agg_csvs_to_jsons


def test_etl_belief_ote1_agg_csvs_to_jsons_CreatesFile_Scenaro0(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bob_str = "Bob"
    ...
    a23_event_time_csv = f"""{belief_label_str()},{believer_name_str()},{event_int_str()},{bud_time_str()},{error_message_str()}
{amy23_str},{bob_str},{event3},{timepoint55},
"""
    a45_event_time_csv = f"""{belief_label_str()},{believer_name_str()},{event_int_str()},{bud_time_str()},{error_message_str()}
...
"""
    ...
    # WHEN
    etl_belief_ote1_agg_csvs_to_jsons(belief_mstr_dir)
