...
from src.a18_etl_toolbox.transformers import etl_coin_job_jsons_to_job_tables


def test_etl_coin_job_jsons_to_job_tables_PopulatesTables_Scenario0(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    m23_coin_mstr_dir = get_module_temp_dir()
    m23_str = "music23"
    a23_str = "amy23"
    sue_str = "Sue"
    bob_str = "Bob"
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        # WHEN
        etl_coin_job_jsons_to_job_tables(cursor, m23_coin_mstr_dir)
...
def test_etl_coin_job_jsons_to_job_tables_PopulatesTables_Scenario1(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    save_file(coin_json_path, None, coinunit_shop(a23_str, coin_mstr_dir).get_json())
    a23_bob_job_path = create_job_path(coin_mstr_dir, a23_str, bob_inx)
    assert os_path_exists(coin_json_path)
    ...
    with sqlite3_connect(":memory:") as db_conn:
        ...
        # WHEN
        etl_coin_job_jsons_to_job_tables(cursor, coin_mstr_dir)
