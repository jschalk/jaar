...
from src.a18_etl_toolbox.transformers import etl_bank_guts_to_bank_jobs


def test_etl_bank_guts_to_bank_jobs_SetsFiles_Scenario0(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    bob_gut.add_acctunit(yao_inx, credit44)
    a23_bob_gut_path = create_gut_path(bank_mstr_dir, a23_str, bob_inx)
    ...
    # WHEN
    etl_bank_guts_to_bank_jobs(bank_mstr_dir)
