...
from src.a18_etl_toolbox.transformers import etl_event_owner_csvs_to_pack_json


def test_etl_event_owner_csvs_to_pack_json_CreatesFiles_Scenario0_IgnoresCSV_ownerunit(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    event3 = 3
    a23_str = "amy23"
    put_agg_tablename = create_prime_tablename(ownerunit_str(), "v", "agg", "put")
...
"""
    ...
    # WHEN
    etl_event_owner_csvs_to_pack_json(belief_mstr_dir)
    ...
    expected_ownerdelta = expected_e3_pack._ownerdelta
    generated_e3_ownerdelta = e3_packunit._ownerdelta
    assert generated_e3_ownerdelta.owneratoms == expected_ownerdelta.owneratoms
    assert e3_packunit._ownerdelta == expected_e3_pack._ownerdelta
    assert e3_packunit == expected_e3_pack


def test_etl_event_owner_csvs_to_pack_json_CreatesFiles_Scenario1(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
...
"""
    ...
    assert e3_packunit._ownerdelta == expected_e3_pack._ownerdelta
    assert e3_packunit == expected_e3_pack
    e7_insert = e7_packunit._ownerdelta.owneratoms.get("INSERT")
