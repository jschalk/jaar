...
def test_add_pidgin_rows_to_stance_csv_strs_ReturnsObj():
    # ESTABLISH database with pidgin data
    # - [`br00042`](ideas/br00042.md): event_int, face_name, otx_title, inx_title, otx_knot, inx_knot, unknown_str
    bob_otx = "Bob"
    bob_inx = "Bobby"
...
"""
        ...
        # WHEN
        add_pidgin_rows_to_stance_csv_strs(cursor, x_ideas, csv_delimiter)
