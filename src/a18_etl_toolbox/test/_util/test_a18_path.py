...
COIN_OTE1_AGG_CSV_FILENAME = "coin_ote1_agg.csv"
COIN_OTE1_AGG_JSON_FILENAME = "coin_ote1_agg.json"
...
def test_a18_path_constants_are_values():
    # ESTABLISH / WHEN / THEN
    assert COIN_OTE1_AGG_CSV_FILENAME == "coin_ote1_agg.csv"
    assert COIN_OTE1_AGG_JSON_FILENAME == "coin_ote1_agg.json"
...
def test_create_coin_mstr_path_ReturnsObj():
    # ESTABLISH
    x_world_dir = get_module_temp_dir()

    # WHEN
    gen_last_run_metrics_path = create_coin_mstr_path(x_world_dir)

    # THEN
    expected_path = create_path(x_world_dir, "coin_mstr")
    assert gen_last_run_metrics_path == expected_path


def test_create_coin_mstr_path_HasDocString():
    # ESTABLISH
    doc_str = create_coin_mstr_path(world_dir="world_dir")
    doc_str = f"Returns path: {doc_str}"
    # WHEN / THEN
    assert LINUX_OS or inspect_getdoc(create_coin_mstr_path) == doc_str
...
def test_create_stances_dir_path_ReturnsObj():
    ...
    # WHEN
    gen_bob_stance_dir = create_stances_dir_path(x_coin_mstr_dir)

    # THEN
    expected_stances_dir = create_path(x_coin_mstr_dir, "stances")
...
def test_create_stances_dir_path_HasDocString():
    # ESTABLISH
    doc_str = create_stances_dir_path(coin_mstr_dir="coin_mstr_dir")
    doc_str = f"Returns path: {doc_str}"
    # WHEN / THEN
...
def test_create_coin_ote1_csv_path_ReturnsObj():
    # ESTABLISH
    x_coin_mstr_dir = get_module_temp_dir()
    a23_str = "amy23"

    # WHEN
    gen_a23_te_csv_path = create_coin_ote1_csv_path(x_coin_mstr_dir, a23_str)

    # THEN
    coins_dir = create_path(x_coin_mstr_dir, "coins")
    a23_path = create_path(coins_dir, a23_str)
    expected_a23_te_path = create_path(a23_path, COIN_OTE1_AGG_CSV_FILENAME)
    assert gen_a23_te_csv_path == expected_a23_te_path


def test_create_coin_ote1_json_path_ReturnsObj():
    # ESTABLISH
    x_coin_mstr_dir = get_module_temp_dir()
    a23_str = "amy23"

    # WHEN
    gen_a23_te_csv_path = create_coin_ote1_json_path(x_coin_mstr_dir, a23_str)

    # THEN
    coins_dir = create_path(x_coin_mstr_dir, "coins")
    a23_path = create_path(coins_dir, a23_str)
    expected_a23_te_path = create_path(a23_path, COIN_OTE1_AGG_JSON_FILENAME)
    assert gen_a23_te_csv_path == expected_a23_te_path
...
def test_create_world_db_path_ReturnsObj():
    ...
    # WHEN
    gen_world_db_path = create_world_db_path(x_coin_mstr_dir)

    # THEN
    expected_path = create_path(x_coin_mstr_dir, WORLD_DB_FILENAME)
    assert gen_world_db_path == expected_path


def test_create_coin_ote1_csv_path_HasDocString():
    # ESTABLISH
    doc_str = create_coin_ote1_csv_path("coin_mstr_dir", coin_label_str())
    doc_str = f"Returns path: {doc_str}"
    # WHEN / THEN
    assert LINUX_OS or inspect_getdoc(create_coin_ote1_csv_path) == doc_str


def test_create_coin_ote1_json_path_HasDocString():
    # ESTABLISH
    doc_str = create_coin_ote1_json_path("coin_mstr_dir", coin_label_str())
    doc_str = f"Returns path: {doc_str}"
    # WHEN / THEN
    assert LINUX_OS or inspect_getdoc(create_coin_ote1_json_path) == doc_str


def test_create_world_db_path_HasDocString():
    # ESTABLISH
    doc_str = create_world_db_path("coin_mstr_dir")
    doc_str = f"Returns path: {doc_str}"
    # WHEN / THEN
