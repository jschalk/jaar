...
def test_get_moment_dict_from_voice_tables_ReturnsObj_With_momentunit_Attrs_Scenario0():
    # ESTABLISH
    a23_str = "amy23"
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        momentunit_v_agg_tablename = create_prime_tablename("momentunit", "v", "agg")
        momentunit_insert_sqlstr = f"""INSERT INTO {momentunit_v_agg_tablename} (
  moment_label
, timeline_label
, c400_number
, yr1_jan1_offset
...
;"""
        ...
        # WHEN
        a23_dict = get_moment_dict_from_voice_tables(cursor, a23_str)
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_With_momentunit_Attrs_Scenario1():
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        create_sound_and_voice_tables(cursor)
        momentunit_v_agg_tablename = create_prime_tablename("momentunit", "v", "agg")
        momentunit_insert_sqlstr = f"INSERT INTO {momentunit_v_agg_tablename} (moment_label) VALUES ('{a23_str}');"
        cursor.execute(momentunit_insert_sqlstr)
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_With_blfpayy_Attrs_Scenario0():
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        create_sound_and_voice_tables(cursor)
        momentunit_v_agg_tablename = create_prime_tablename("momentunit", "v", "agg")
        momentpay_v_agg_tablename = create_prime_tablename("blfpayy", "v", "agg")
        momentunit_insert_sqlstr = f"INSERT INTO {momentunit_v_agg_tablename} (moment_label) VALUES ('{a23_str}');"
        cursor.execute(momentunit_insert_sqlstr)
        blfpayy_insert_sqlstr = f"""INSERT INTO {momentpay_v_agg_tablename} (moment_label, belief_name, partner_name, tran_time, amount)
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_With_blfpayy_Attrs_Scenario1():
    # ESTABLISH
    a23_str = "amy23"
    a45_str = "amy45"
    bob_str = "Bob"
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_With_momentbud_Attrs_Scenario0():
    # ESTABLISH
    a23_str = "amy23"
    bob_str = "Bob"
    tp55 = 55
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        create_sound_and_voice_tables(cursor)
        momentunit_v_agg_tablename = create_prime_tablename("momentunit", "v", "agg")
        momentbud_v_agg_tablename = create_prime_tablename("blfbudd", "v", "agg")
        momentunit_insert_sqlstr = f"INSERT INTO {momentunit_v_agg_tablename} (moment_label) VALUES ('{a23_str}');"
        cursor.execute(momentunit_insert_sqlstr)
        blfpayy_insert_sqlstr = f"""INSERT INTO {momentbud_v_agg_tablename} (moment_label, belief_name, bud_time, quota, celldepth)
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_With_blfhour_Attrs_Scenario0():
    # ESTABLISH
    a23_str = "amy23"
    hour3_min = 300
    hour4_min = 400
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        momentunit_insert_sqlstr = f"INSERT INTO {momentunit_v_agg_tablename} (moment_label) VALUES ('{a23_str}');"
        cursor.execute(momentunit_insert_sqlstr)
        blfpayy_insert_sqlstr = f"""INSERT INTO {blfhour_v_agg_tablename} (moment_label, cumulative_minute, hour_label)
VALUES
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_With_blfmont_Attrs_Scenario0():
    # ESTABLISH
    a23_str = "amy23"
    day111_min = 111
    day222_min = 222
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        momentunit_insert_sqlstr = f"INSERT INTO {momentunit_v_agg_tablename} (moment_label) VALUES ('{a23_str}');"
        cursor.execute(momentunit_insert_sqlstr)
        blfpayy_insert_sqlstr = f"""INSERT INTO {blfmont_v_agg_tablename} (moment_label, cumulative_day, month_label)
VALUES
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_With_blfweek_Attrs_Scenario0():
    # ESTABLISH
    a23_str = "amy23"
    ana_order = 1
    bee_order = 2
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        momentunit_insert_sqlstr = f"INSERT INTO {momentunit_v_agg_tablename} (moment_label) VALUES ('{a23_str}');"
        cursor.execute(momentunit_insert_sqlstr)
        blfpayy_insert_sqlstr = f"""INSERT INTO {blfweek_v_agg_tablename} (moment_label, weekday_order, weekday_label)
VALUES
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_With_blfoffi_Attrs_Scenario0():
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        momentunit_insert_sqlstr = f"INSERT INTO {momentunit_v_agg_tablename} (moment_label) VALUES ('{a23_str}');"
        cursor.execute(momentunit_insert_sqlstr)
        blfpayy_insert_sqlstr = f"""INSERT INTO {blfoffi_v_agg_tablename} (moment_label, offi_time)
VALUES
  ('{a23_str}', {offi_time5})
, ('{a23_str}', {offi_time7})
;
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_IsFormatted_Scenario0_momentunit():
    # ESTABLISH
    a23_str = "amy23"
    a23_timeline_label = "timeline88"
    a23_c400_number = 3
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_IsFormatted_Scenario1_blfpayy():
    # ESTABLISH
    a23_str = "amy23"
    bob_str = "Bob"
    sue_str = "Sue"
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_IsFormatted_Scenario2_momentbud():
    # ESTABLISH
    a23_str = "amy23"
    bob_str = "Bob"
    tp55 = 55
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_Scenario3_blfhour():
    # ESTABLISH
    a23_str = "amy23"
    hour3_min = 300
    hour4_min = 400
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_Scenario4_blfmont():
    # ESTABLISH
    a23_str = "amy23"
    day111_min = 111
    day222_min = 222
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_Scenario5_blfweek():
    # ESTABLISH
    a23_str = "amy23"
    ana_order = 1
    bee_order = 2
...
def test_get_moment_dict_from_voice_tables_ReturnsObj_Scenario5_blfoffi():
    # sourcery skip: extract-method
    # ESTABLISH
    a23_str = "amy23"
    offi_time5 = 5
