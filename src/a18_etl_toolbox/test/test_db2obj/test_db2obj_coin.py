...
from src.a15_coin_logic.coin_main import get_from_dict as coinunit_get_from_dict
...
def test_get_coin_dict_from_voice_tables_ReturnsObj_With_coinunit_Attrs_Scenario0():
    # ESTABLISH
    a23_str = "amy23"
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        coinunit_v_agg_tablename = create_prime_tablename("coinunit", "v", "agg")
        coinunit_insert_sqlstr = f"""INSERT INTO {coinunit_v_agg_tablename} (
  coin_label
, timeline_label
, c400_number
, yr1_jan1_offset
...
;"""
        ...
        # WHEN
        a23_dict = get_coin_dict_from_voice_tables(cursor, a23_str)

    # THEN
    assert a23_dict
    assert a23_dict.get("coin_label") == a23_str
    print(f"{a23_dict=}")
...
def test_get_coin_dict_from_voice_tables_ReturnsObj_With_coinunit_Attrs_Scenario1():
...
def test_get_coin_dict_from_voice_tables_ReturnsObj_With_blfpayy_Attrs_Scenario0():
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        create_sound_and_voice_tables(cursor)
        coinunit_v_agg_tablename = create_prime_tablename("coinunit", "v", "agg")
        coinpay_v_agg_tablename = create_prime_tablename("blfpayy", "v", "agg")
        coinunit_insert_sqlstr = (
            f"INSERT INTO {coinunit_v_agg_tablename} (coin_label) VALUES ('{a23_str}');"
        )
        cursor.execute(coinunit_insert_sqlstr)
...
"""
    ...
    assert a23_paybook_dict.get("coin_label") == a23_str
...
def test_get_coin_dict_from_voice_tables_ReturnsObj_With_blfpayy_Attrs_Scenario1():
    # ESTABLISH
    a23_str = "amy23"
    a45_str = "amy45"
    bob_str = "Bob"
...
def test_get_coin_dict_from_voice_tables_ReturnsObj_With_coinbud_Attrs_Scenario0():
    # ESTABLISH
    a23_str = "amy23"
    bob_str = "Bob"
    tp55 = 55
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        create_sound_and_voice_tables(cursor)
        coinunit_v_agg_tablename = create_prime_tablename("coinunit", "v", "agg")
        coinbud_v_agg_tablename = create_prime_tablename("blfbudd", "v", "agg")
        coinunit_insert_sqlstr = (
            f"INSERT INTO {coinunit_v_agg_tablename} (coin_label) VALUES ('{a23_str}');"
        )
        cursor.execute(coinunit_insert_sqlstr)
...
def test_get_coin_dict_from_voice_tables_ReturnsObj_With_blfhour_Attrs_Scenario0():
    # ESTABLISH
    a23_str = "amy23"
    hour3_min = 300
    hour4_min = 400
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        cursor.execute(coinunit_insert_sqlstr)
        blfpayy_insert_sqlstr = f"""INSERT INTO {blfhour_v_agg_tablename} (coin_label, cumulative_minute, hour_label)
VALUES
...
def test_get_coin_dict_from_voice_tables_ReturnsObj_With_blfmont_Attrs_Scenario0():
    # ESTABLISH
    a23_str = "amy23"
    day111_min = 111
    day222_min = 222
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        cursor.execute(coinunit_insert_sqlstr)
        blfpayy_insert_sqlstr = f"""INSERT INTO {blfmont_v_agg_tablename} (coin_label, cumulative_day, month_label)
VALUES
...
def test_get_coin_dict_from_voice_tables_ReturnsObj_With_blfweek_Attrs_Scenario0():
    # ESTABLISH
    a23_str = "amy23"
    ana_order = 1
    bee_order = 2
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        cursor.execute(coinunit_insert_sqlstr)
        blfpayy_insert_sqlstr = f"""INSERT INTO {blfweek_v_agg_tablename} (coin_label, weekday_order, weekday_label)
VALUES
...
def test_get_coin_dict_from_voice_tables_ReturnsObj_With_blfoffi_Attrs_Scenario0():
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        cursor.execute(coinunit_insert_sqlstr)
        blfpayy_insert_sqlstr = f"""INSERT INTO {blfoffi_v_agg_tablename} (coin_label, offi_time)
VALUES
  ('{a23_str}', {offi_time5})
, ('{a23_str}', {offi_time7})
;
...
def test_get_coin_dict_from_voice_tables_ReturnsObj_IsFormatted_Scenario0_coinunit():
    # ESTABLISH
    a23_str = "amy23"
    a23_timeline_label = "timeline88"
    a23_c400_number = 3
...
;"""
    ...
    # WHEN
    a23_coinunit = coinunit_get_from_dict(a23_dict)

    # THEN
    assert a23_coinunit.coin_label == a23_str
    assert a23_coinunit.timeline.timeline_label == a23_timeline_label
    assert a23_coinunit.timeline.c400_number == a23_c400_number
    assert a23_coinunit.timeline.yr1_jan1_offset == a23_yr1_jan1_offset
    assert a23_coinunit.timeline.monthday_distortion == a23_monthday_distortion
    assert a23_coinunit.fund_iota == a23_fund_iota
    assert a23_coinunit.penny == a23_penny
    assert a23_coinunit.respect_bit == a23_respect_bit
    assert a23_coinunit.knot == a23_knot


def test_get_coin_dict_from_voice_tables_ReturnsObj_IsFormatted_Scenario1_blfpayy():
    # ESTABLISH
    a23_str = "amy23"
    bob_str = "Bob"
    sue_str = "Sue"
...
"""
    ...
    # THEN
    assert a23_coinunit.coin_label == a23_str
    assert a23_coinunit.paybook.tranunits.get(bob_str)
    bob_tranunit = a23_coinunit.paybook.tranunits.get(bob_str)
    assert bob_tranunit == {sue_str: {tp55: bob_sue_tp55_amount}}


def test_get_coin_dict_from_voice_tables_ReturnsObj_IsFormatted_Scenario2_coinbud():
    # ESTABLISH
    a23_str = "amy23"
    bob_str = "Bob"
    tp55 = 55
...
"""
    ...
    # THEN
    a23_bob_brokerunit = a23_coinunit.get_brokerunit(bob_str)
...
def test_get_coin_dict_from_voice_tables_ReturnsObj_Scenario3_blfhour():
    # ESTABLISH
    a23_str = "amy23"
    hour3_min = 300
    hour4_min = 400
...
"""
    ...
    # THEN
    a23_coinunit.timeline.hours_config == [
        [hour3_label, hour3_min],
        [hour4_label, hour4_min],
    ]


def test_get_coin_dict_from_voice_tables_ReturnsObj_Scenario4_blfmont():
    # ESTABLISH
    a23_str = "amy23"
    day111_min = 111
    day222_min = 222
...
"""
    ...
    # THEN
    assert a23_coinunit.timeline.months_config == [
        [month111_label, day111_min],
        [month222_label, day222_min],
    ]


def test_get_coin_dict_from_voice_tables_ReturnsObj_Scenario5_blfweek():
    # ESTABLISH
    a23_str = "amy23"
    ana_order = 1
    bee_order = 2
...
"""
    ...
    # THEN
    assert a23_coinunit.timeline.weekdays_config == [ana_label, bee_label]


def test_get_coin_dict_from_voice_tables_ReturnsObj_Scenario5_blfoffi():
    # sourcery skip: extract-method
    # ESTABLISH
    a23_str = "amy23"
    offi_time5 = 5
...
"""
    ...
    # THEN
    assert a23_coinunit.offi_times == {offi_time5, offi_time7}
