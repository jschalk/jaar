...
def etl_brick_raw_db_to_events_brick_agg_db(conn_or_cursor: sqlite3_Cursor):
...
def etl_events_brick_agg_db_to_brick_valid_events_db(conn_or_cursor: sqlite3_Cursor):
...
def idea_raw_tables2fisc_raw_tables(conn_or_cursor: sqlite3_Connection):
    ...
    for idea_number in get_idea_numbers():
        ...
        if db_table_exists(conn_or_cursor, idea_raw):
            ...
            stageble_dimens = IDEA_STAGEBLE_PUT_DIMENS.get(idea_number)
