...
def test_etl_brick_agg_dfs_to_pidgin_name_raw_CreatesFile_Scenario0_SingleCreed(
    ...
    etl_brick_agg_dfs_to_pidgin_name_raw(legitimate_events, x_brick_dir)
...
def test_etl_brick_agg_dfs_to_pidgin_name_raw_CreatesFile_Scenario1_MultipleCreedsFiles(
    ...
    e1_name5 = [b4, event7, yao_str, yao_str, yao_inx, rdx, rdx, ukx]
    e1_name0 = [b3, event1, sue_str, yao_str, yao_inx, None, None, None]
    e1_name1 = [b3, event1, sue_str, bob_str, bob_inx, None, None, None]
...
def test_etl_brick_agg_dfs_to_pidgin_name_raw_CreatesFile_Scenario2_WorldUnit_events_Filters(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bob_str = "Bob"
