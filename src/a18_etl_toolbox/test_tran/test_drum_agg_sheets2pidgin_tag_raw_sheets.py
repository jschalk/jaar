...
from src.a18_etl_toolbox.transformers import etl_drum_agg_to_pidgin_tag_raw
from src.a18_etl_toolbox.examples.etl_env import get_test_etl_dir, env_dir_setup_cleanup
from pandas import DataFrame, read_excel as pandas_read_excel
from os.path import exists as os_path_exists


def test_etl_drum_agg_to_pidgin_tag_raw_CreatesFile_Scenario0_SingleIdea(
    ...
    # WHEN
    etl_drum_agg_to_pidgin_tag_raw({event7}, x_drum_dir)
...
def test_etl_drum_agg_to_pidgin_tag_raw_CreatesFile_Scenario1_MultipleIdeasFiles(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bob_str = "Bob"
    ...
    etl_drum_agg_to_pidgin_tag_raw(legitimate_events, x_drum_dir)
...
def test_etl_drum_agg_to_pidgin_tag_raw_CreatesFile_Scenario2_WorldUnit_events_Filters(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bob_str = "Bob"
