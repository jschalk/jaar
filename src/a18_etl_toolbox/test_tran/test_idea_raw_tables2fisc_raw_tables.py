...
def test_idea_raw_tables2fisc_raw_tables_Scenario0_From_br00011_IdeaFile(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
...
"""
    ...
    with sqlite3_connect(":memory:") as fisc_db_conn:
        ...
        # WHEN
        idea_raw_tables2fisc_raw_tables(cursor)
...
def test_idea_raw_tables2fisc_raw_tables_Scenario1_From_br00011_IdeaTable(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    with sqlite3_connect(":memory:") as fisc_db_conn:
        ...
        insert_raw_sqlstr = f"""
INSERT INTO {br00011_tablename} ({event_int_str()},{face_name_str()},{fisc_label_str()},{owner_name_str()},{acct_name_str()})
VALUES 
  ({event3}, '{sue_inx}', '{accord23_str}', '{bob_inx}', '{bob_inx}')
, ({event3}, '{sue_inx}', '{accord23_str}', '{yao_inx}', '{bob_inx}')
, ({event3}, '{sue_inx}', '{accord23_str}', '{yao_inx}', '{yao_inx}')
...
def test_idea_raw_tables2fisc_raw_tables_Scenario2_Idea_br00000_Table_WithEmptyAttrs(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    with sqlite3_connect(":memory:") as fisc_db_conn:
        ...
        insert_raw_sqlstr = f"""
INSERT INTO {br00000_tablename} ({event_int_str()},{face_name_str()},{fisc_label_str()},{timeline_label_str()},{c400_number_str()},{yr1_jan1_offset_str()},{monthday_distortion_str()},{fund_coin_str()},{penny_str()},{respect_bit_str()},{bridge_str()})
VALUES
...
def test_idea_raw_tables2fisc_raw_tables_Scenario3_Idea_br00000_Table_WithAttrs(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    a23_timeline_label = "accord23_timeline"
...
INSERT INTO {br00000_tablename} ({event_int_str()},{face_name_str()},{fisc_label_str()},{timeline_label_str()},{c400_number_str()},{yr1_jan1_offset_str()},{monthday_distortion_str()},{fund_coin_str()},{penny_str()},{respect_bit_str()},{bridge_str()})
VALUES
  ({event3},'{sue_inx}','{accord23_str}','{a23_timeline_label}',{a23_c400_number},{a23_yr1_jan1_offset},{a23_monthday_distortion},{a23_fund_coin},{a23_penny},{a23_respect_bit},'{a23_bridge}')
, ({event3},'{sue_inx}','{accord23_str}','{a23_timeline_label}',{a23_c400_number},{a23_yr1_jan1_offset},{a23_monthday_distortion},{a23_fund_coin},{a23_penny},{a23_respect_bit},'{a23_bridge}')
, ({event7},'{sue_inx}','{accord23_str}','{a23_timeline_label}',{a23_c400_number},{a23_yr1_jan1_offset},{a23_monthday_distortion},{a23_fund_coin},{a23_penny},{a23_respect_bit},'{a23_bridge}')
;
"""
        ...
        expected_row0 = (
            ...
            sue_inx,
            accord23_str,  # fisc_label
            a23_timeline_label,  # timeline_label
...
def test_idea_raw_tables2fisc_raw_tables_Scenario4_Idea_br00001_Table_WithAttrs(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    with sqlite3_connect(":memory:") as fisc_db_conn:
        ...
        insert_raw_sqlstr = f"""
INSERT INTO {br00001_tablename} ({event_int_str()},{face_name_str()},{fisc_label_str()},{owner_name_str()},{deal_time_str()},{quota_str()}, {celldepth_str()})
VALUES
...
def test_idea_raw_tables2fisc_raw_tables_Scenario5_Idea_br00002_Table_WithAttrs(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    with sqlite3_connect(":memory:") as fisc_db_conn:
        ...
        insert_raw_sqlstr = f"""
INSERT INTO {br00002_tablename} ({event_int_str()},{face_name_str()},{fisc_label_str()},{owner_name_str()},{acct_name_str()},{tran_time_str()},{amount_str()})
VALUES
...
def test_idea_raw_tables2fisc_raw_tables_Scenario6_Idea_br00003_Table_WithAttrs(
    env_dir_setup_cleanup,
):
    ...
    with sqlite3_connect(":memory:") as fisc_db_conn:
        ...
        insert_raw_sqlstr = f"""
INSERT INTO {br00003_tablename} ({event_int_str()},{face_name_str()},{fisc_label_str()},{hour_label_str()},{cumlative_minute_str()})
VALUES
  ({event3},'{sue_inx}','{accord23_str}','{a23_hour_label}',{a23_cumlative_minute})
, ({event3},'{sue_inx}','{accord23_str}','{a23_hour_label}',{a23_cumlative_minute})
, ({event7},'{sue_inx}','{accord23_str}','{a23_hour_label}',{a23_cumlative_minute})
;
"""
        print(f"{insert_raw_sqlstr=}")
        cursor.execute(insert_raw_sqlstr)
...
def test_idea_raw_tables2fisc_raw_tables_Scenario7_Idea_br00004_Table_WithAttrs(
    env_dir_setup_cleanup,
):
    ...
    with sqlite3_connect(":memory:") as fisc_db_conn:
        ...
        insert_raw_sqlstr = f"""
INSERT INTO {br00004_tablename} ({event_int_str()},{face_name_str()},{fisc_label_str()},{month_label_str()},{cumlative_day_str()})
VALUES
  ({event3},'{sue_inx}','{accord23_str}','{a23_month_label}',{a23_cumlative_day})
, ({event3},'{sue_inx}','{accord23_str}','{a23_month_label}',{a23_cumlative_day})
, ({event7},'{sue_inx}','{accord23_str}','{a23_month_label}',{a23_cumlative_day})
;
"""
        print(f"{insert_raw_sqlstr=}")
        cursor.execute(insert_raw_sqlstr)
...
def test_idea_raw_tables2fisc_raw_tables_Scenario8_Idea_br00005_Table_WithAttrs(
    env_dir_setup_cleanup,
):
    ...
    with sqlite3_connect(":memory:") as fisc_db_conn:
        ...
        insert_raw_sqlstr = f"""
INSERT INTO {br00005_tablename} ({event_int_str()},{face_name_str()},{fisc_label_str()},{weekday_label_str()},{weekday_order_str()})
VALUES
  ({event3},'{sue_inx}','{accord23_str}','{a23_weekday_label}',{a23_weekday_order})
, ({event3},'{sue_inx}','{accord23_str}','{a23_weekday_label}',{a23_weekday_order})
, ({event7},'{sue_inx}','{accord23_str}','{a23_weekday_label}',{a23_weekday_order})
;
"""
        print(f"{insert_raw_sqlstr=}")
        cursor.execute(insert_raw_sqlstr)
...
def test_etl_fisc_raw_tables_to_fisc_csvs_CreateFiles(env_dir_setup_cleanup):
    ...
    with sqlite3_connect(":memory:") as fisc_db_conn:
        ...
        insert_raw_sqlstr = f"""
INSERT INTO {x_fisc.unit_raw_tablename} ({idea_number_str()}, {event_int_str()}, {face_name_str()}, {fisc_label_str()})
VALUES 
...
"""
        ...
        assert len(open_file(x_fisc.hour_raw_csv_path)) == 85
        assert len(open_file(x_fisc.mont_raw_csv_path)) == 83
        assert len(open_file(x_fisc.week_raw_csv_path)) == 85
...
VALUES
  ('br00333',{event3},'{sue_inx}','{accord23_str}',{a23_fund_coin},{a23_penny},{a23_respect_bit},'{a23_bridge}',{a23_c400_number},{a23_yr1_jan1_offset},{a23_monthday_distortion},'{a23_timeline_label}',{a23_job_listen_rotations},NULL)
, ('br00333',{event7},'{sue_inx}','{accord23_str}',{a23_fund_coin},{a23_penny},{a23_respect_bit},'{a23_bridge}',{a23_c400_number},{a23_yr1_jan1_offset},{a23_monthday_distortion},'{a23_timeline_label}',{a23_job_listen_rotations},NULL)
;
"""
        print(f"{insert_raw_sqlstr=}")
        cursor.execute(insert_raw_sqlstr)
...
INSERT INTO {x_tablename} ({x_cols.unit_raw_csv_header})
VALUES
  ('br00333',{event3},'{sue_inx}','{accord23_str}',{a23_fund_coin},{a23_penny_1},{a23_respect_bit},'{a23_bridge}',{a23_c400_number},{a23_yr1_jan1_offset},{a23_monthday_distortion},'{a23_timeline_label}',{a23_job_listen_rotations},NULL)
, ('br00333',{event7},'{sue_inx}','{accord23_str}',{a23_fund_coin},{a23_penny_2},{a23_respect_bit},'{a23_bridge}',{a23_c400_number},{a23_yr1_jan1_offset},{a23_monthday_distortion},'{a23_timeline_label}',{a23_job_listen_rotations},NULL)
, ('br00333',{event7},'{sue_inx}','{accord45_str}',{a23_fund_coin},{a23_penny_2},{a23_respect_bit},'{a23_bridge}',{a23_c400_number},{a23_yr1_jan1_offset},{a23_monthday_distortion},'{a23_timeline_label}',{a23_job_listen_rotations},NULL)
;
"""
        print(f"{insert_raw_sqlstr=}")
        cursor.execute(insert_raw_sqlstr)
        assert get_row_count(cursor, x_tablename) == 3
        select_sqlstr = f"SELECT {event_int_str()}, {fisc_label_str()}, error_message FROM {x_tablename};"
        # # select_sqlstr = f"SELECT {event_int_str()} FROM {x_tablename};"
        cursor.execute(select_sqlstr)
        # print(f"{select_sqlstr=}")
        rows = cursor.fetchall()
...
VALUES
  ('br00333',{event3},'{sue_inx}','{accord23_str}',{a23_cumlative_minute_1},'{a23_4hour_label}',NULL)
, ('br00333',{event7},'{sue_inx}','{accord23_str}',{a23_cumlative_minute_1},'{a23_5hour_label}',NULL)
, ('br00333',{event7},'{sue_inx}','{accord45_str}',{a23_cumlative_minute_1},'{a23_4hour_label}',NULL)
;
"""
        print(f"{insert_raw_sqlstr=}")
        cursor.execute(insert_raw_sqlstr)
...
def test_set_fisc_raw_error_message_Scenario3_fishour_Some_error_message(
    ...
    accord23_str = "accord23"
    accord45_str = "accord45"
    a23_month_label_1 = "March"
    a23_month_label_2 = "Marche"
...
VALUES
  ('br00333',{event3},'{sue_inx}','{accord23_str}',{_44_cumlative_day},'{a23_month_label_1}',NULL)
, ('br00333',{event7},'{sue_inx}','{accord23_str}',{_44_cumlative_day},'{a23_month_label_2}',NULL)
, ('br00333',{event7},'{sue_inx}','{accord45_str}',{_44_cumlative_day},'{a23_month_label_2}',NULL)
;
"""
        print(f"{insert_raw_sqlstr=}")
        cursor.execute(insert_raw_sqlstr)
...
"""
        ...
        select_sqlstr = f"SELECT {event_int_str()}, {fisc_label_str()}, {weekday_order_str()}, error_message FROM {x_tablename};"
        cursor.execute(select_sqlstr)
        rows = cursor.fetchall()
        # print(f"{rows=}")
        assert rows == [
...
"""
        ...
        cursor.execute(insert_raw_sqlstr)
        assert get_row_count(cursor, x_tablename) == 5
        select_sqlstr = f"SELECT {event_int_str()}, {fisc_label_str()}, {tran_time_str()}, error_message FROM {x_tablename};"
        # # select_sqlstr = f"SELECT {event_int_str()} FROM {x_tablename};"
        cursor.execute(select_sqlstr)
        # print(f"{select_sqlstr=}")
        rows = cursor.fetchall()
