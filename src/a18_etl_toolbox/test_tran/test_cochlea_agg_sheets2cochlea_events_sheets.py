...
def test_etl_cochlea_agg_to_cochlea_events_CreatesSheets_Scenario0(
    ...
    # WHEN
    etl_cochlea_agg_to_cochlea_events(cochlea_dir)
...
def test_etl_cochlea_agg_to_cochlea_events_CreatesSheets_Scenario1(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    fizz_str = "fizz"
