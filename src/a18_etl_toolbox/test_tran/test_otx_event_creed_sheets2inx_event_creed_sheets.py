...
def test_etl_otz_event_creeds_to_inz_events_Scenario0_NoPidginUnit():
    # ESTABLISH
    sue_otx = "Sue"
    bob_otx = "Bob"
    yao_otx = "Yao"
    ...
    # WHEN
    etl_otz_event_creeds_to_inz_events(x_otz_dir, x_event_pidgins)
...
def test_etl_otz_event_creeds_to_inz_events_Scenario1_MultpleFaceNames_CreatesEventInxSheets(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_otx = "Sue"
