...
# def test_insert_sound_raw_select_into_sound_agg_tables_PopulatesValidTable_Scenario0():
#     # ESTABLISH
#     a23_str = "accord23"
#     bob_str = "Bob"
#     sue_str = "Sue"
...
#         assert get_row_count(cursor, budacct_s_put_raw_tblname) == 5
#         assert get_row_count(cursor, pidroad_s_agg_tablename) == 0
#         assert get_row_count(cursor, budacct_s_put_agg_tblname) == 0

#         # WHEN
#         insert_sound_raw_select_into_sound_agg_tables(cursor)

#         # THEN
#         assert get_row_count(cursor, pidroad_s_agg_tablename) == 2
#         assert get_row_count(cursor, budacct_s_put_agg_tblname) == 1
