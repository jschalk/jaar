...
def test_etl_sound_agg_tables_to_voice_raw_tables_Scenario2_DoesNotSelectWhere_error_message_IsNotNull():
    # ESTABLISH
    a23_str = "accord23"
    bob_str = "Bob"
    sue_str = "Sue"
...
"""
        ...
        # THEN
        assert get_row_count(cursor, budacct_v_raw_put_tablename) == 3
        select_sqlstr = f"""SELECT {event_int_str()}
, {face_name_str()}_inx
, {fisc_label_str()}_inx
, {owner_name_str()}_inx
