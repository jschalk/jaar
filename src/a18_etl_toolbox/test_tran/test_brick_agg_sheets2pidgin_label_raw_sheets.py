...
def test_etl_brick_agg_dfs_to_pidgin_label_raw_CreatesFile_Scenario0_SingleIdea(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bob_str = "Bob"
    ...
    # WHEN
    etl_brick_agg_dfs_to_pidgin_label_raw({event7}, x_brick_dir)
...
def test_etl_brick_agg_dfs_to_pidgin_label_raw_CreatesFile_Scenario1_MultipleIdeasFiles(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bob_str = "Bob"
