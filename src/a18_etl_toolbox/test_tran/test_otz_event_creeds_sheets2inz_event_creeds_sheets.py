...
def test_etl_otz_event_creeds_to_brick_events_Scenario0():
    # ESTABLISH
    sue_otx = "Sue"
    sue_inx = "Suzy"
    bob_inx = "Bob"
    ...
    # WHEN
    etl_otz_inx_event_creeds_to_inz_faces(otz_dir, inz_dir)

    # THEN
    assert sheet_exists(inz_br00011_path, inx_str)
    inz_e3_df = pandas_read_excel(inz_br00011_path, sheet_name=inx_str)
    # sue_i0 = [event3, sue_inx, accord23_str, bob_inx, bob_inx]
    # sue_i1 = [event3, sue_inx, accord23_str, yao_inx, bob_inx]
    # sue_i2 = [event3, sue_inx, accord23_str, yao_inx, yao_inx]
...
#     # WHEN
#     etl_otz_inx_event_creeds_to_inz_faces(x_otz_dir, x_event_pidgins)
