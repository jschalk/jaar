...
def test_WorldUnit_vow_ote1_agg_csvs2jsons_CreatesFile_Scenaro0(
    ...
    a23_event_time_csv = f"""{vow_label_str()},{owner_name_str()},{event_int_str()},{deal_time_str()},error_message
{accord23_str},{bob_str},{event3},{timepoint55},
"""
    a45_event_time_csv = f"""{vow_label_str()},{owner_name_str()},{event_int_str()},{deal_time_str()},error_message
