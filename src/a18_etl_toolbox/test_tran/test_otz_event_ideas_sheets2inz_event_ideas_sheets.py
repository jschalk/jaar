...
def test_etl_otz_event_ideas_to_cochlea_events_Scenario0():
    # ESTABLISH
    sue_otx = "Sue"
    sue_inx = "Suzy"
    bob_inx = "Bob"
    ...
    otz_dir = create_path(get_test_etl_dir(), "syntax_otz")
    ...
    inz_dir = create_path(get_test_etl_dir(), "syntax_inz")
...
# def test_etl_otz_event_ideas_to_cochlea_events_Scenario1_MultpleFaceNames_CreatesEventInxSheets(
