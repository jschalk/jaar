...
def test_etl_idea_raw_to_bud_prime_tables_CreatesBudRawTables(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    raw_srt = "_put_raw"
    ...
    with sqlite3_connect(":memory:") as conn:
        ...
        # WHEN
        etl_idea_raw_to_bud_prime_tables(cursor)
...
def test_etl_idea_raw_to_bud_prime_tables_Bud_dimen_idea_PopulatesFiscRawTables(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
...
def test_etl_idea_raw_to_bud_prime_tables_Sets_error_message(env_dir_setup_cleanup):
    # ESTABLISH
    sue_inx = "Suzy"
    bob_inx = "Bobby"
    yao_inx = "Bobby"
    ...
    with sqlite3_connect(":memory:") as fisc_db_conn:
        ...
        insert_raw_sqlstr = f"""
INSERT INTO {x_tablename} ({idea_number_str()},{event_int_str()},{face_name_str()},{fisc_label_str()},{owner_name_str()},{acct_name_str()},{credit_belief_str()},{debtit_belief_str()})
VALUES
