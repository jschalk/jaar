...
def test_etl_brick_agg_dfs_to_pidgin_way_raw_CreatesFile_Scenario0_SingleCreed(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bob_str = "Bob"
...
def test_etl_brick_agg_dfs_to_pidgin_way_raw_CreatesFile_Scenario1_MultipleCreedsFiles(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bob_str = "Bob"
