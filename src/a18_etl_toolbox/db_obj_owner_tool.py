...
def create_plnmemb_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    real_str = "REAL"
    return f"""INSERT INTO owner_acct_membership_job (belief_label, owner_name, acct_name, group_title, group_cred_points, group_debt_points, _credor_pool, _debtor_pool, _fund_give, _fund_take, _fund_agenda_give, _fund_agenda_take, _fund_agenda_ratio_give, _fund_agenda_ratio_take)
VALUES (
...
def create_plnacct_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    real_str = "REAL"
    return f"""INSERT INTO owner_acctunit_job (belief_label, owner_name, acct_name, acct_cred_points, acct_debt_points, _credor_pool, _debtor_pool, _fund_give, _fund_take, _fund_agenda_give, _fund_agenda_take, _fund_agenda_ratio_give, _fund_agenda_ratio_take, _inallocable_acct_debt_points, _irrational_acct_debt_points)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(acct_name, "TEXT")}
...
def create_plngrou_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    real_str = "REAL"
    return f"""INSERT INTO owner_groupunit_job (belief_label, owner_name, group_title, fund_iota, knot, _credor_pool, _debtor_pool, _fund_give, _fund_take, _fund_agenda_give, _fund_agenda_take)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(group_title, "TEXT")}
...
def create_plnawar_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    _fund_give = values_dict.get("_fund_give")
    _fund_take = values_dict.get("_fund_take")
    return f"""INSERT INTO owner_concept_awardlink_job (belief_label, owner_name, concept_rope, awardee_title, give_force, take_force, _fund_give, _fund_take)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_plnfact_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO owner_concept_factunit_job (belief_label, owner_name, concept_rope, fcontext, fstate, fopen, fnigh)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(rope, "TEXT")}
...
def create_plnheal_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO owner_concept_healerlink_job (belief_label, owner_name, concept_rope, healer_name)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(rope, "TEXT")}
...
def create_plnprem_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO owner_concept_reason_premiseunit_job (belief_label, owner_name, concept_rope, rcontext, pstate, pnigh, popen, pdivisor, _chore, _status)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(rope, "TEXT")}
...
def create_plnreas_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO owner_concept_reasonunit_job (belief_label, owner_name, concept_rope, rcontext, rconcept_active_requisite, _chore, _status, _rconcept_active_value)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(rope, "TEXT")}
...
def create_plnlabo_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO owner_concept_laborlink_job (belief_label, owner_name, concept_rope, labor_title, _owner_name_labor)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(rope, "TEXT")}
...
def create_plnconc_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO owner_conceptunit_job (belief_label, owner_name, concept_rope, begin, close, addin, numor, denom, morph, gogo_want, stop_want, mass, task, problem_bool, fund_iota, _active, _chore, _fund_onset, _fund_cease, _fund_ratio, _gogo_calc, _stop_calc, _level, _range_evaluated, _descendant_task_count, _healerlink_ratio, _all_acct_cred, _all_acct_debt)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(rope, "TEXT")}
...
def create_ownerunit_metrics_insert_sqlstr(values_dict: dict[str,]):
    belief_label = values_dict.get("belief_label")
    owner_name = values_dict.get("owner_name")
    integer_str = "INTEGER"
    real_str = "REAL"
    ...
    return f"""INSERT INTO ownerunit_job (belief_label, owner_name, credor_respect, debtor_respect, fund_pool, max_tree_traverse, tally, fund_iota, penny, respect_bit, _rational, _keeps_justified, _offtrack_fund, _sum_healerlink_share, _keeps_buildable, _tree_traverse_count)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def insert_job_plnunit(
    ...
    insert_sqlstr = create_ownerunit_metrics_insert_sqlstr(x_dict)
    cursor.execute(insert_sqlstr)
...
def insert_job_obj(cursor: sqlite3_Cursor, job_owner: OwnerUnit):
    ...
    for x_concept in job_owner.get_concept_dict().values():
    ...
    for x_factheir in job_owner.conceptroot._factheirs.values():
        x_objkeysholder.fact_rope = job_owner.conceptroot.get_concept_rope()
