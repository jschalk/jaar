...
def create_plnawar_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    _fund_give = values_dict.get("_fund_give")
    _fund_take = values_dict.get("_fund_take")
    return f"""INSERT INTO owner_plan_awardlink_job (belief_label, owner_name, plan_rope, awardee_title, give_force, take_force, _fund_give, _fund_take)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
...
def create_plnfact_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO owner_plan_factunit_job (belief_label, owner_name, plan_rope, fcontext, fstate, fopen, fnigh)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(rope, "TEXT")}
...
def create_plnheal_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO owner_plan_healerlink_job (belief_label, owner_name, plan_rope, healer_name)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(rope, "TEXT")}
...
def create_plnprem_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO owner_plan_reason_premiseunit_job (belief_label, owner_name, plan_rope, rcontext, pstate, pnigh, popen, pdivisor, _chore, _status)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(rope, "TEXT")}
...
def create_plnreas_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO owner_plan_reasonunit_job (belief_label, owner_name, plan_rope, rcontext, rplan_active_requisite, _chore, _status, _rplan_active_value)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(rope, "TEXT")}
...
def create_plnlabo_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO owner_plan_laborlink_job (belief_label, owner_name, plan_rope, labor_title, _owner_name_labor)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(rope, "TEXT")}
...
def create_plnconc_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO owner_planunit_job (belief_label, owner_name, plan_rope, begin, close, addin, numor, denom, morph, gogo_want, stop_want, mass, task, problem_bool, fund_iota, _active, _chore, _fund_onset, _fund_cease, _fund_ratio, _gogo_calc, _stop_calc, _level, _range_evaluated, _descendant_task_count, _healerlink_ratio, _all_acct_cred, _all_acct_debt)
VALUES (
  {sqlite_obj_str(belief_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(rope, "TEXT")}
