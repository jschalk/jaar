...
def collect_stance_csv_strs(bank_mstr_dir: str) -> dict[str, str]:
    ...
    for bank_label in get_level1_dirs(banks_dir):
        ...
        add_bankunit_to_stance_csv_strs(x_bankunit, x_csv_strs, ",")
...
def create_stance0001_file(bank_mstr_dir: str, output_dir: str):
    stance_csv_strs = collect_stance_csv_strs(bank_mstr_dir)
