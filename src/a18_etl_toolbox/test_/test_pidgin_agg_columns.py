...
def test_PidginPrimeColumns_Exists():
    ...
    pidgin_title_agg_args = set(get_pidgin_config_args((pidgin_title_str())).keys())
    ...
    pidgin_title_raw_args = pidgin_title_agg_args.union(raw_args)
    ...
    assert set(x_pidginprimecols.pidgin_title_agg_columns) == pidgin_title_agg_args
    ...
    assert set(x_pidginprimecols.pidgin_title_raw_columns) == pidgin_title_raw_args
