...
def test_create_cochlea_events_path_HasDocString():
    # ESTABLISH
    doc_str = create_cochlea_events_path(cochlea_dir="cochlea_dir")
    doc_str = f"Returns path: {doc_str}"
    # WHEN / THEN
    assert LINUX_OS or inspect_getdoc(create_cochlea_events_path) == doc_str


def test_create_cochlea_pidgin_path_HasDocString():
    # ESTABLISH
    doc_str = create_cochlea_pidgin_path(cochlea_dir="cochlea_dir")
    doc_str = f"Returns path: {doc_str}"
    # WHEN / THEN
    assert LINUX_OS or inspect_getdoc(create_cochlea_pidgin_path) == doc_str
