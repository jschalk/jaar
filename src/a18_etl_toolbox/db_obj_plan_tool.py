...
def create_plnmemb_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    real_str = "REAL"
    return f"""INSERT INTO plan_acct_membership_job (vow_label, owner_name, acct_name, group_title, credit_vote, debt_vote, _credor_pool, _debtor_pool, _fund_give, _fund_take, _fund_agenda_give, _fund_agenda_take, _fund_agenda_ratio_give, _fund_agenda_ratio_take)
VALUES (
...
def create_plnacct_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    real_str = "REAL"
    return f"""INSERT INTO plan_acctunit_job (vow_label, owner_name, acct_name, credit_score, debt_score, _credor_pool, _debtor_pool, _fund_give, _fund_take, _fund_agenda_give, _fund_agenda_take, _fund_agenda_ratio_give, _fund_agenda_ratio_take, _inallocable_debt_score, _irrational_debt_score)
VALUES (
  {sqlite_obj_str(vow_label, "TEXT")}
, {sqlite_obj_str(owner_name, "TEXT")}
, {sqlite_obj_str(acct_name, "TEXT")}
