...
#     # THEN
#     assert a23_dict
#     assert a23_dict.get("pidgin_tag") == a23_str
#     print(f"{a23_dict=}")
...
#             f"INSERT INTO pidginunit_agg (pidgin_tag) VALUES ('{a23_str}');"
#         )
#         cursor.execute(pidginunit_insert_sqlstr)
...
#         )
#         cursor.execute(pidginunit_insert_sqlstr)
#         pidginash_insert_sqlstr = f"""INSERT INTO pidgin_cashbook_agg (pidgin_tag, owner_name, acct_name, tran_time, amount)
...
#     assert a23_cashbook_dict.get("pidgin_tag") == a23_str
...
#         )
#         cursor.execute(pidginunit_insert_sqlstr)
#         pidginash_insert_sqlstr = f"""INSERT INTO pidgin_dealunit_agg (pidgin_tag, owner_name, deal_time, quota, celldepth)
...
#         )
#         cursor.execute(pidginunit_insert_sqlstr)
#         pidginash_insert_sqlstr = f"""INSERT INTO pidgin_timeline_hour_agg (pidgin_tag, cumlative_minute, hour_tag)
# VALUES
...
#         )
#         cursor.execute(pidginunit_insert_sqlstr)
#         pidginash_insert_sqlstr = f"""INSERT INTO pidgin_timeline_month_agg (pidgin_tag, cumlative_day, month_tag)
# VALUES
...
#         )
#         cursor.execute(pidginunit_insert_sqlstr)
#         pidginash_insert_sqlstr = f"""INSERT INTO pidgin_timeline_weekday_agg (pidgin_tag, weekday_order, weekday_tag)
# VALUES
...
#         )
#         cursor.execute(pidginunit_insert_sqlstr)
#         pidginash_insert_sqlstr = f"""INSERT INTO pidgin_timeoffi_agg (pidgin_tag, offi_time)
# VALUES
#   ('{a23_str}', {offi_time5})
# , ('{a23_str}', {offi_time7})
# ;
...
#     assert a23_pidginunit.pidgin_tag == a23_str
#     assert a23_pidginunit.timeline.timeline_tag == a23_timeline_tag
...
#     # THEN
#     assert a23_pidginunit.timeline.weekdays_config == [ana_tag, bee_tag]
