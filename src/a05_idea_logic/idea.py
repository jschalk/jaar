...
class IdeaUnit:
    ...
    def get_kid(self, idea_kid_idea_tag: TagUnit, if_missing_create=False):
    ...
    def del_kid(self, idea_kid_idea_tag: TagUnit):
    ...
    def set_reasonheirs(
        self, bud_idea_dict: dict[WayUnit,], reasonheirs: dict[WayUnit, ReasonCore]
    ):
