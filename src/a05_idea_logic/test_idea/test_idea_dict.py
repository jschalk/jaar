...
def test_IdeaUnit_get_dict_ReturnsCorrectCompleteDict():
    ...
    x1_reasonunits = {
        week_way: reasonunit_shop(week_way, premises={wed_premise.branch: wed_premise}),
        states_way: reasonunit_shop(states_way, {usa_premise.branch: usa_premise}),
    }
    wed_premises = {wed_premise.branch: wed_premise}
    usa_premises = {usa_premise.branch: usa_premise}
    x1_reasonheirs = {
