...
from src.s1_road.road import get_default_fiscal_id_roadnode as root_label
...
def test_BudUnit_edit_idea_label_RaisesErrorForLevel0IdeaWhen_fiscal_id_isNone():
    # ESTABLISH
    yao_str = "Yao"
    ...
    # WHEN
    moon_str = "moon"
    yao_bud.edit_idea_label(old_road=yao_bud._fiscal_id, new_label=moon_str)
    ...
    # assert (
    #     str(excinfo.value)
    #     == f"Cannot set idearoot to string other than '{yao_bud._fiscal_id}'"
    # )
...
def test_BudUnit_edit_idea_label_RaisesErrorForLevel0When_fiscal_id_IsDifferent():
    # ESTABLISH
    yao_str = "Yao"
    yao_bud = budunit_shop(_owner_id=yao_str)
    casa_str = "casa"
    ...
    yao_bud._idearoot._bud_fiscal_id = sun_str
    assert yao_bud._owner_id == yao_str
    assert yao_bud._fiscal_id == sun_str
    assert yao_bud._idearoot._bud_fiscal_id == sun_str
...
def test_bud_set_owner_id_CorrectlyModifiesBoth():
    ...
    assert sue_bud._idearoot._label == sue_bud._fiscal_id
    # mid_label1 = "Yao"
