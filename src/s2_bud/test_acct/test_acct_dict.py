from src.s2_bud.group import membership_shop
from src.s2_bud.acct import (
    acctunit_shop,
    acctunits_get_from_json,
    acctunit_get_from_dict,
    acctunits_get_from_dict,
)
from src.s0_instrument.python_tool import x_is_json, get_json_from_dict
...
def test_AcctUnit_get_dict_ReturnsDictWithNecessaryDataForJSON():
    ...
    assert x_dict == {
        ...
        "_memberships": {
            bob_str: {"group_id": bob_str, "credit_vote": 1, "debtit_vote": 1},
            run_str: {"group_id": run_str, "credit_vote": 1, "debtit_vote": 1},
        },
    }
