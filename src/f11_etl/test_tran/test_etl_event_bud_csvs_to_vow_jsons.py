...
from src.f11_etl.transformers import etl_event_bud_csvs_to_vow_json
from src.f11_etl.examples.etl_env import env_dir_setup_cleanup, get_test_etl_dir
from os.path import exists as os_path_exists


def test_WorldUnit_event_bud_csvs_to_vow_json_CreatesFiles_Scenario0_IgnoresCSV_budunit(
...
"""
    ...
    # WHEN
    etl_event_bud_csvs_to_vow_json(fisc_mstr_dir)
...
def test_WorldUnit_event_bud_csvs_to_vow_json_CreatesFiles_Scenario1(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    sue_inx = "Suzy"
