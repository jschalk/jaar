...
CREATE_FORECAST_BUDGROU_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_groupunit_forecast (fisc_title TEXT, owner_name TEXT, group_label TEXT, _credor_pool REAL, _debtor_pool REAL, _fund_coin REAL, _fund_give REAL, _fund_take REAL, _fund_agenda_give REAL, _fund_agenda_take REAL, _bridge TEXT)"""
...
CREATE_FORECAST_BUDPREM_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_reason_premiseunit_forecast (fisc_title TEXT, owner_name TEXT, road TEXT, base TEXT, need TEXT, nigh REAL, open REAL, divisor INTEGER, _task INTEGER, _status INTEGER)"""
CREATE_FORECAST_BUDREAS_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_item_reasonunit_forecast (fisc_title TEXT, owner_name TEXT, road TEXT, base TEXT, base_item_active_requisite INTEGER, _task INTEGER, _status INTEGER, _base_item_active_value INTEGER)"""
