...
CREATE_FORECAST_BUDGROU_SQLSTR = """CREATE TABLE IF NOT EXISTS bud_groupunit_forecast (fisc_title TEXT, owner_name TEXT, group_label TEXT, fund_coin REAL, bridge TEXT, _credor_pool REAL, _debtor_pool REAL, _fund_give REAL, _fund_take REAL, _fund_agenda_give REAL, _fund_agenda_take REAL)"""
