...
from ch22_etl_config.etl_sqlstr import create_sound_and_heard_tables
...
def test_get_max_b_agg_spark_num_ReturnsObj_Scenario0_NoTables(cursor0: Cursor):
    # ESTABLISH
    ...
    # WHEN / THEN
    assert get_max_b_agg_spark_num(cursor0) == 1


def test_get_max_b_agg_spark_num_ReturnsObj_Scenario1_OneTable(cursor0: Cursor):
    # ESTABLISH
    spark1 = 1
    spark3 = 3
    spark9 = 9
...
"""
    ...
    # WHEN
    max_spark_num = get_max_b_agg_spark_num(cursor0)
...
def test_get_max_b_agg_spark_num_ReturnsObj_Scenario2_MultipleTable(
    cursor0: Cursor,
):
