...
def create_prnplan_metrics_insert_sqlstr(values_dict: dict[str,]):
    ...
    return f"""INSERT INTO person_planunit_job (moment_rope, person_name, plan_rope, begin, close, addin, numor, denom, morph, gogo_want, stop_want, poynt, pledge, problem_bool, fund_grain, knot, plan_active, plan_task, fund_onset, fund_cease, fund_ratio, gogo_calc, stop_calc, tree_level, range_evaluated, descendant_pledge_count, healerunit_ratio, all_contact_cred, all_contact_debt)
VALUES (
  {sqlite_obj_str(moment_rope, "TEXT")}
, {sqlite_obj_str(person_name, "TEXT")}
, {sqlite_obj_str(rope, "TEXT")}
