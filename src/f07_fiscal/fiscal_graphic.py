...
def add_river_rect(fig: plotly_Figure, x0, xw, y0, yh, display_str, x_color=None):
    if x_color is None:
...
def get_fiscal_graphic_base_fig() -> plotly_Figure:
    fig = plotly_Figure()
...
def get_fiscal_structures0_fig(graphics_bool: bool = False) -> plotly_Figure:
    fig = get_fiscal_graphic_base_fig()
    rx0 = 0
    rx1 = 10
    ry0 = 0
    ry1 = 10
    ...
    add_river_rect(fig, 3, 5, 2.0, 6, "People soul", green_str())
    # add_river_rect(fig, 1.0, ry1 - 2, 2.0, ry1 - 6, "People soul", green_str())
    ...
    sue1_p3 = ""
    sue1_p4 = ""
    add_fiscal__rect(fig, rx0, ry0, rx1, ry1, sue1_p1, sue1_p2, sue1_p3, sue1_p4)
    ...
    fig.add_trace(
        plotly_Scatter(
            ...
            text=[
                "fiscality Structure",
                "Flow of souling to Doing",
                "We all have an interior life where we soul. And then there is what we do.",
            ],
            mode="text",
        )
    )
