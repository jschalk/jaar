...
def test_FiscalUnit_Exists(env_dir_setup_cleanup):
    ...
    assert not accord_fiscal.present_time
...
def test_fiscalunit_shop_ReturnsFiscalUnit():
    ...
    assert accord_fiscal.present_time == 0
...
def test_fiscalunit_shop_ReturnsFiscalUnitWith_bridge(env_dir_setup_cleanup):
    ...
    # THEN
    assert accord_fiscal.present_time == x_present_time
...
def test_FiscalUnit_get_owner_voice_from_file_ReturnsObj(env_dir_setup_cleanup):
    # ESTABLISH
    accord45_str = "accord45"
