...
def test_BeliefTimelinePoint_Exists():
    # ESTABLISH / WHEN
    x_timelinepoint = BeliefTimelinePoint()

    # THEN
    assert not x_timelinepoint.x_beliefunit
...
def test_BeliefTimelinePoint_shop_ReturnsObj():
    # ESTABLISH
    ...
    # WHEN
    x_timelinepoint = belieftimelinepoint_shop(
...
def test_BeliefTimelinePoint_set_weekday_SetsAttr():
    # ESTABLISH
    sue_belief = beliefunit_shop("Sue")
    sue_belief = add_time_creg_planunit(sue_belief)
    sue_belief.cashout()
...
def test_BeliefTimelinePoint_set_month_SetsAttr():
    # ESTABLISH
    sue_belief = beliefunit_shop("Sue")
    sue_belief = add_time_creg_planunit(sue_belief)
    sue_belief.cashout()
...
def test_BeliefTimelinePoint_set_hour_SetsAttr():
    # ESTABLISH
    sue_belief = beliefunit_shop("Sue")
    sue_belief = add_time_creg_planunit(sue_belief)
    sue_belief.cashout()
...
def test_BeliefTimelinePoint_set_year_SetsAttr():
    # ESTABLISH
    sue_belief = beliefunit_shop("Sue")
    sue_belief = add_time_creg_planunit(sue_belief)
    sue_belief.cashout()
...
def test_BeliefTimelinePoint_calc_timeline_SetsAttrs():
    # ESTABLISH
    sue_belief = beliefunit_shop("Sue")
    sue_belief = add_time_creg_planunit(sue_belief)
    time_rope = sue_belief.make_l1_rope("time")
...
def test_BeliefTimelinePoint_get_blurb_ReturnsObj():
    # ESTABLISH
    sue_belief = beliefunit_shop("Sue")
    sue_belief = add_time_creg_planunit(sue_belief)
    time_rope = sue_belief.make_l1_rope("time")
...
def test_calc_timeline_SetsAttrFiveTimeLine(graphics_bool):
    ...
    five_timelinepoint = belieftimelinepoint_shop(sue_belief, five_rope, five_min)
...
def test_check_creg_timeline():
    ...
    # THEN
    check_creg_timeline_attr(sue_belief, datetime(2000, 3, 1, 0, 21))
    check_creg_timeline_attr(sue_belief, datetime(2000, 3, 1, 3, 21))
    check_creg_timeline_attr(sue_belief, datetime(2000, 3, 1, 12, 00))
    check_creg_timeline_attr(sue_belief, datetime(2000, 3, 1, 13, 00))
    check_creg_timeline_attr(sue_belief, datetime(2000, 4, 1, 13, 00))
    check_creg_timeline_attr(sue_belief, datetime(2000, 4, 20, 13, 00))
    check_creg_timeline_attr(sue_belief, datetime(2000, 4, 28, 13, 00))
    check_creg_timeline_attr(sue_belief, datetime(2000, 4, 29, 13, 00))
    check_creg_timeline_attr(sue_belief, datetime(2000, 4, 30, 13, 00))
    check_creg_timeline_attr(sue_belief, datetime(2000, 5, 1, 13, 00))
    check_creg_timeline_attr(sue_belief, datetime(2000, 7, 1, 13, 56))
    check_creg_timeline_attr(sue_belief, datetime(2003, 12, 28, 17, 56))
    check_creg_timeline_attr(sue_belief, datetime(2003, 2, 28, 17, 56))
    check_creg_timeline_attr(sue_belief, datetime(432, 3, 4, 2, 0))
