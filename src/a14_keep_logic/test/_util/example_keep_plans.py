from src.a06_plan_logic.plan import PlanUnit, VowLabel, conceptunit_shop, planunit_shop
from src.a14_keep_logic.test._util.a14_env import temp_vow_label
...
def get_2label_plan(vow_label: VowLabel = None) -> PlanUnit:
