...
def test_RiverRun_calc_metrics_SetsAttrsScenario01():
    ...
    x_riverrun.set_keep_credorledger(yao_str, yao_str, yao_voice_cred_points)
...
def test_RiverRun_calc_metrics_SetsAttrsScenario02():
    ...
    yao_voice_cred_points = 500
    bob_str = "Bob"
    bob_voice_debt_points = 350
    x_riverrun = riverrun_shop(yao_hubunit)
    x_riverrun.set_keep_credorledger(yao_str, yao_str, yao_voice_cred_points)
    x_riverrun.set_tax_dues({bob_str: bob_voice_debt_points})
    assert x_riverrun.get_voice_tax_due(yao_str) == 0
...
def test_RiverRun_calc_metrics_SetsAttrsScenario03():
    ...
    yao_voice_cred_points = 500
    bob_str = "Bob"
    bob_voice_debt_points = 25
    sue_str = "Sue"
    sue_voice_debt_points = 75
    x_riverrun = riverrun_shop(yao_hubunit)
    x_riverrun.set_keep_credorledger(yao_str, yao_str, yao_voice_cred_points)
    debtorledger = {bob_str: bob_voice_debt_points, sue_str: sue_voice_debt_points}
...
def test_RiverRun_calc_metrics_SetsAttrsScenario04():
    ...
    yao_hubunit = example_yao_hubunit()
    yao_str = "Yao"
    yao_yao_voice_cred_points = 500
    yao_sue_voice_cred_points = 2000
    bob_str = "Bob"
    bob_voice_debt_points = 25
    sue_str = "Sue"
    sue_voice_debt_points = 75
    x_riverrun = riverrun_shop(yao_hubunit)
    x_riverrun.set_keep_credorledger(yao_str, yao_str, yao_yao_voice_cred_points)
    x_riverrun.set_keep_credorledger(yao_str, sue_str, yao_sue_voice_cred_points)
    debtorledger = {bob_str: bob_voice_debt_points, sue_str: sue_voice_debt_points}
    x_riverrun.set_tax_dues(debtorledger)
    assert x_riverrun.get_voice_tax_due(yao_str) == 0
    keep_money_amount = x_riverrun.hubunit.keep_point_magnitude
