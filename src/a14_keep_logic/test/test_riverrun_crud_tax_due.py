...
def test_get_credorledger_ReturnsObj():
    ...
    yao_believer.add_acctunit(bob_str, yao_acct_cred_points)
    yao_believer.add_acctunit(sue_str, bob_acct_cred_points)
    yao_believer.add_acctunit(yao_str, sue_acct_cred_points)
    ...
    assert yao_credorledger.get(bob_str) == yao_acct_cred_points
    assert yao_credorledger.get(sue_str) == bob_acct_cred_points
    assert yao_credorledger.get(yao_str) == sue_acct_cred_points


def test_get_credorledger_ReturnsObjWithNoEmpty_acct_cred_points():
    # ESTABLISH
    yao_str = "Yao"
    bob_str = "Bob"
    sue_str = "Sue"
    ...
    yao_believer.add_acctunit(sue_str, sue_acct_cred_points)
    ...
    assert yao_credorledger.get(sue_str) == sue_acct_cred_points
    assert yao_credorledger.get(yao_str) == yao_acct_cred_points
...
def test_get_debtorledger_ReturnsObj():
    ...
    yao_believer = believerunit_shop(yao_str)
    yao_believer.add_acctunit(bob_str, 2, bob_acct_debt_points)
    yao_believer.add_acctunit(sue_str, 2, sue_acct_debt_points)
    yao_believer.add_acctunit(yao_str, 2, yao_acct_debt_points)
    ...
    assert yao_debtorledger.get(sue_str) == sue_acct_debt_points
    assert yao_debtorledger.get(yao_str) == yao_acct_debt_points


def test_get_debtorledger_ReturnsObjWithNoEmpty_acct_debt_points():
    # ESTABLISH
    yao_str = "Yao"
    bob_str = "Bob"
    sue_str = "Sue"
...
def test_RiverRun_set_tax_dues_CorrectlySetsAttr():
    ...
    bob_believer.add_acctunit(bob_str, 2, bob_acct_debt_points)
    bob_believer.add_acctunit(sue_str, 2, sue_acct_debt_points)
    bob_believer.add_acctunit(yao_str, 2, yao_acct_debt_points)
