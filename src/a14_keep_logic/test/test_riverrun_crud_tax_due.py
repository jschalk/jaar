...
def test_get_credorledger_ReturnsObj():
    ...
    yao_believer.add_partnerunit(bob_str, yao_partner_cred_points)
    yao_believer.add_partnerunit(sue_str, bob_partner_cred_points)
    yao_believer.add_partnerunit(yao_str, sue_partner_cred_points)
...
def test_get_credorledger_ReturnsObjWithNoEmpty_partner_cred_points():
    ...
    yao_believer.add_partnerunit(sue_str, sue_partner_cred_points)
...
def test_get_debtorledger_ReturnsObj():
    ...
    yao_believer = believerunit_shop(yao_str)
    yao_believer.add_partnerunit(bob_str, 2, bob_partner_debt_points)
    yao_believer.add_partnerunit(sue_str, 2, sue_partner_debt_points)
    yao_believer.add_partnerunit(yao_str, 2, yao_partner_debt_points)
...
def test_RiverRun_set_tax_dues_CorrectlySetsAttr():
    ...
    bob_believer.add_partnerunit(bob_str, 2, bob_partner_debt_points)
    bob_believer.add_partnerunit(sue_str, 2, sue_partner_debt_points)
    bob_believer.add_partnerunit(yao_str, 2, yao_partner_debt_points)
