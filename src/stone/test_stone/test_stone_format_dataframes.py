...
def test_create_stone_df_Arg_stone_format_00020_bud_acct_membership_v0_0_0():
    ...
    assert array_headers == acct_stoneref.get_headers_list()
    assert membership_dataframe.loc[0, pecun_id_str()] == music_pecun_id
    ...
    assert membership_dataframe.loc[2, pecun_id_str()] == music_pecun_id
    ...
    assert membership_dataframe.loc[4, pecun_id_str()] == music_pecun_id
    ...
    assert membership_dataframe.loc[5, pecun_id_str()] == music_pecun_id
...
def test_save_stone_csv_Arg_stone_format_00019_ideaunit_v0_0_0():
    ...
    # csv_example_path = create_file_path(stone_pecuns_dir(), acct_filename)
...
def test_save_stone_csv_Arg_stone_format_00021_bud_acctunit_v0_0_0_SaveToCSV(
    ...
    # WHEN
    save_stone_csv(j1_stonename, sue_budunit, stone_pecuns_dir(), acct_filename)

    # THEN
    assert os_path_exists(csv_example_path)
    sue1_acct_example_csv = """pecun_id,owner_id,acct_id,debtit_belief,credit_belief
music56,Sue,Bob,29,13
music56,Sue,Sue,23,11
music56,Sue,Yao,37,41
"""
    stone_file_str = open_file(stone_pecuns_dir(), acct_filename)
    ...
    # THEN
    assert os_path_exists(csv_example_path)
    sue2_acct_example_csv = """pecun_id,owner_id,acct_id,debtit_belief,credit_belief
music56,Sue,Bob,29,13
music56,Sue,Sue,23,11
music56,Sue,Yao,37,41
music56,Sue,Zia,1,1
"""
    assert open_file(stone_pecuns_dir(), acct_filename) == sue2_acct_example_csv
...
def test_save_stone_csv_Arg_stone_format_00003_ideaunit_v0_0_0(stone_env_setup_cleanup):
    ...
    # WHEN
    save_stone_csv(x_stone_name, sue_budunit, stone_pecuns_dir(), acct_filename)
