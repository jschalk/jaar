...
def test_get_sorted_headers_ReturnsObj():
    ...
    # THEN
    assert headers == "acct_id,credit_belief,debtit_belief,owner_id,tribe_id"
...
def test_get_stoneref_HasCorrectAttrs_stone_format_00021_bud_acctunit_v0_0_0():
    ...
    # THEN
    tribe_id_stonecolumn = format_00001_stoneref.get_stonecolumn(tribe_id_str())
    ...
    assert tribe_id_stonecolumn.column_order == 0
...
def test_get_stoneref_HasCorrectAttrs_stone_format_00020_bud_acct_membership_v0_0_0():
    ...
    # THEN
    tribe_id_stonecolumn = format_00021_stoneref.get_stonecolumn(tribe_id_str())
...
def test_get_stoneref_HasCorrectAttrs_stone_format_00003_ideaunit_v0_0_0():
    ...
    # THEN
    tribe_id_stonecolumn = format_00003_stoneref.get_stonecolumn(tribe_id_str())
...
def test_get_stoneref_HasCorrectAttrs_stone_format_00019_ideaunit_v0_0_0():
    ...
    # THEN
    tribe_id_stonecolumn = format_00019_stoneref.get_stonecolumn(tribe_id_str())
