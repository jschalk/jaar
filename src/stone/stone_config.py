...
def get_stone_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "addin,begin,close,denom,gogo_want,label,morph,numor,owner_id,parent_road,tribe_id,stop_want": stone_format_00019_ideaunit_v0_0_0(),
        ...
        "give_force,group_id,owner_id,tribe_id,road,take_force": stone_format_00022_bud_idea_awardlink_v0_0_0(),
        "base,fnigh,fopen,owner_id,pick,tribe_id,road": stone_format_00023_bud_idea_factunit_v0_0_0(),
        "group_id,owner_id,tribe_id,road": stone_format_00024_bud_idea_teamlink_v0_0_0(),
        "healer_id,owner_id,tribe_id,road": stone_format_00025_bud_idea_healerlink_v0_0_0(),
        "base,divisor,need,nigh,open,owner_id,tribe_id,road": stone_format_00026_bud_idea_reason_premiseunit_v0_0_0(),
        "base,base_idea_active_requisite,owner_id,tribe_id,road": stone_format_00027_bud_idea_reasonunit_v0_0_0(),
        "addin,begin,close,denom,gogo_want,label,mass,morph,numor,owner_id,parent_road,pledge,problem_bool,tribe_id,stop_want": stone_format_00028_bud_ideaunit_v0_0_0(),
        "bit,credor_respect,debtor_respect,fund_coin,fund_pool,max_tree_traverse,monetary_desc,owner_id,penny,tribe_id,tally": stone_format_00029_budunit_v0_0_0(),
