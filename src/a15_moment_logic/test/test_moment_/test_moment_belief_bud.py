...
from src.a15_moment_logic.test._util.a15_env import get_module_temp_dir
...
def test_MomentUnit_set_brokerunit_SetsAttr():
    ...
    # THEN
    assert amy_moment.brokerunits != {}
    assert amy_moment.brokerunits.get(sue_str) == sue_brokerunit
...
def test_MomentUnit_brokerunit_exists_ReturnsObj():
    ...
    # THEN
    assert amy_moment.brokerunit_exists(sue_str)
...
def test_MomentUnit_get_brokerunit_ReturnsObj():
    ...
    # WHEN
    sue_gen_brokerunit = amy_moment.get_brokerunit(sue_str)
...
def test_MomentUnit_del_brokerunit_SetsAttr():
    ...
    # WHEN
    amy_moment.del_brokerunit(sue_str)
...
def test_MomentUnit_add_budunit_SetsAttr():
    ...
    assert amy_moment.get_brokerunit(sue_str) == sue_brokerunit
    assert amy_moment.get_brokerunit(bob_str) == bob_brokerunit
...
def test_MomentUnit_get_budunit_ReturnsObj_Scenario2_BudExists():
    ...
    # THEN
    assert amy_moment.brokerunits != {}
    sue_broker = amy_moment.brokerunits.get(sue_str)
...
def test_MomentUnit_get_brokerunits_bud_times_ReturnsObj():
    ...
    sue_x7_bud_time = 7
    sue_x7_quota = 66
    assert amy_moment.get_brokerunits_bud_times() == set()
    ...
    assert amy_moment.get_brokerunits_bud_times() == all_bud_times
...
def test_MomentUnit_add_budunit_SetsAttr_celldepth():
    ...
    gen_sue_brokerunit = amy_moment.get_brokerunit(sue_str)
    ...
    assert amy_moment.get_brokerunit(sue_str) == expected_sue_brokerunit
