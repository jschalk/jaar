...
from src.a15_moment_logic.moment_cell import set_cell_trees_found_facts
...
def test_set_cell_trees_found_facts_Scenario2_ChildNodeWithOneFactIsAssignedToAncestors(
    ...
    bob5_beliefevent.add_partnerunit(yao_str)
    bob5_yao_beliefevent.add_partnerunit(sue_str)
    bob5_yao_sue_beliefevent.add_partnerunit(bob_str)
