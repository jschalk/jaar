...
from src.hear.hear import hear_to_owner_jobs, create_job_file_from_duty_file
...
# def test_hear_to_owner_jobs_Pipeline_Scenario0(env_dir_setup_cleanup):
#     # ESTABLISH
...
#     # WHEN
#     assert yao_iowa_hubunit.action_file_exists() is False
#     hear_to_owner_jobs(yao_iowa_hubunit)
...
def test_hear_to_owner_jobs_Pipeline_Scenario1_yao_voice_CanOnlyReferenceItself(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    # yao0_voice with 3 debotors of different credit_beliefs
