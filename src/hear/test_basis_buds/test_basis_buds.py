...
from src.hear.basis_buds import (
    create_empty_bud,
    create_hear_basis,
...
def test_create_empty_bud_ReturnsCorrectObj():
    ...
    assert yao_empty_job._pecun_id == yao_voice._pecun_id
...
def test_create_hear_basis_ReturnsCorrectObj():
    # ESTABLISH
    yao_str = "Yao"
    slash_str = "/"
    ...
    # WHEN
    yao_basis_job = create_hear_basis(yao_duty)

    # THEN
    assert yao_basis_job._owner_id == yao_duty._owner_id
    assert yao_basis_job._pecun_id == yao_duty._pecun_id
...
def test_get_default_action_bud_ReturnsCorrectObj():
    ...
    assert default_action_bud._pecun_id == sue_budunit._pecun_id
    assert default_action_bud._pecun_id == blue_str
