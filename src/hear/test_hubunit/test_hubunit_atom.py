...
from src.hear.examples.hear_env import (
    get_hear_temp_env_dir as tribes_dir,
    get_default_tribe_id_roadnode as tribe_id,
...
def test_HubUnit_atom_file_name_ReturnsCorrectObj():
    # ESTABLISH
    yao_str = "Yao"
    yao_hubunit = hubunit_shop(tribes_dir(), tribe_id(), yao_str)
    one_int = 1
...
def test_HubUnit_get_bud_from_atom_files_ReturnsFileWithZeroAtoms(
    ...
    assert yao_bud._tribe_id == yao_hubunit.tribe_id
...
def test_HubUnit_get_bud_from_atom_files_ReturnsCorrectFile_SimpleIdea(
    ...
    # save atom files
    sports_atom = get_atom_example_ideaunit_sports(yao_hubunit.tribe_id)
...
def test_HubUnit_get_bud_from_atom_files_ReturnsCorrectFile_WithFactUnit(
    ...
    # save atom files
    x_tribe_id = yao_hubunit.tribe_id
    yao_hubunit.save_atom_file(get_atom_example_ideaunit_sports(x_tribe_id))
    yao_hubunit.save_atom_file(get_atom_example_ideaunit_ball(x_tribe_id))
    yao_hubunit.save_atom_file(get_atom_example_ideaunit_knee(x_tribe_id))
    yao_hubunit.save_atom_file(get_atom_example_factunit_knee(x_tribe_id))
