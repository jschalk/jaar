...
def test_BankUnit_rotate_job_ReturnsObj_Scenario1(env_dir_setup_cleanup):
    # ESTABLISH
    a23_str = "accord23"
    ...
    # WHEN
    sue_job = a23_bank.rotate_job(sue_str)

    # THEN
    example_plan = planunit_shop(sue_str, a23_str)
    assert sue_job.bank_label == example_plan.bank_label
    assert sue_job.owner_name == example_plan.owner_name


def test_BankUnit_rotate_job_ReturnsObj_Scenario2_EmptyAcctsCause_inallocable_acct_debt_points(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bank_mstr_dir = get_module_temp_dir()
    ...
    save_job_file(bank_mstr_dir, init_sue_job)
    assert job_file_exists(bank_mstr_dir, a23_str, sue_str)
    assert job_file_exists(bank_mstr_dir, a23_str, yao_str) is False
    assert job_file_exists(bank_mstr_dir, a23_str, bob_str) is False
    assert job_file_exists(bank_mstr_dir, a23_str, zia_str) is False

    # WHEN
    rotated_sue_job = a23_bank.rotate_job(sue_str)
    ...
    assert init_sue_job.get_acct(bob_str)._inallocable_acct_debt_points == 0
    assert rotated_sue_job.get_acct(bob_str)._inallocable_acct_debt_points == 1


def a23_job(owner_name: str) -> PlanUnit:
    bank_mstr_dir = get_module_temp_dir()
    return open_job_file(bank_mstr_dir, "accord23", owner_name)


def test_BankUnit_rotate_job_ReturnsObj_Scenario3_job_ChangesFromRotation(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bank_mstr_dir = get_module_temp_dir()
    ...
    save_job_file(bank_mstr_dir, init_sue_job)
    save_job_file(bank_mstr_dir, init_yao_job)
    save_job_file(bank_mstr_dir, init_bob_job)
    ...
    # WHEN / THEN
    assert len(a23_bank.rotate_job(sue_str).get_agenda_dict()) == 0
    assert len(a23_bank.rotate_job(yao_str).get_agenda_dict()) == 1
    assert len(a23_bank.rotate_job(bob_str).get_agenda_dict()) == 0


def test_BankUnit_rotate_job_ReturnsObj_Scenario4_job_SelfReferenceWorks(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bank_mstr_dir = get_module_temp_dir()
    ...
    # WHEN / THEN
    assert len(a23_bank.rotate_job(bob_str).get_agenda_dict()) == 1
    assert len(a23_bank.rotate_job(sue_str).get_agenda_dict()) == 0
    assert len(a23_bank.rotate_job(yao_str).get_agenda_dict()) == 1


# def test_BankUnit_rotate_job_ReturnsObj_Scenario3_Without_healerlink(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     a23_str = "accord23"
...
#     a23_bank = bankunit_shop(a23_str, bank_mstr_dir)
#     bob_str = "Bob"
#     a23_bank.create_init_job_from_guts(bob_str)
#     before_bob_job = a23_bank.rotate_job(bob_str)
#     sue_str = "Sue"
#     assert before_bob_job.acct_exists(sue_str) is False

#     # WHEN
#     bob_gut_plan = open_gut_file(bank_mstr_dir, a23_str, bob_str)
#     bob_gut_plan.add_acctunit(sue_str)
#     save_gut_file(a23_bank.bank_mstr_dir, bob_gut_plan)

#     # WHEN
#     after_bob_job = a23_bank.rotate_job(bob_str)

#     # THEN
#     assert after_bob_job.acct_exists(sue_str)


# def test_BankUnit_rotate_job_ReturnsObj_Scenario4_With_healerlink(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     a23_str = "accord23"
...
# def test_BankUnit_rotate_job_ReturnsObj_Scenario0_Empty_gut(env_dir_setup_cleanup):
#     # ESTABLISH
#     a23_str = "accord23"
#     bank_mstr_dir = get_module_temp_dir()
#     a23_bank = bankunit_shop(a23_str, bank_mstr_dir)
#     sue_str = "Sue"
#     a23_bank.set_gut_if_none(sue_str)
#     sue_gut = open_gut_file(bank_mstr_dir, a23_str, sue_str)
#     assert len(sue_gut.get_acctunits_dict()) == 0

#     # WHEN / THEN
#     assert not a23_bank.rotate_job(sue_str)


# def test_BankUnit_rotate_job_ReturnsObj_Scenario1_gut_accts_Equal_job_accts(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     bank_mstr_dir = get_module_temp_dir()
...
# def test_BankUnit_rotate_job_ReturnsObj_Scenario1_gut_with_Agenda(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     bank_mstr_dir = get_module_temp_dir()
...
#     save_gut_file(bank_mstr_dir, sue_plan)
#     sue_gut = open_gut_file(bank_mstr_dir, a23_str, sue_str)
#     assert len(sue_gut.get_acctunits_dict()) == 0
...
#     assert sue_job.bank_label == expected_job.bank_label
#     assert sue_job.owner_name == expected_job.owner_name
#     assert sue_job.get_agenda_dict() == expected_job.get_agenda_dict()
#     assert sue_job.get_dict() == expected_job.get_dict()


# def test_BankUnit_rotate_job_ReturnsObj_Scenario2_gut_with_FactUnit(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     bank_mstr_dir = get_module_temp_dir()
...
def test_BankUnit_generate_all_jobs_Scenario0_init_job_IsCreated(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    a23_str = "accord23"
    ...
    sue_dir = create_owner_dir_path(bank_mstr_dir, a23_str, sue_str)
    set_dir(sue_dir)
    assert gut_file_exists(bank_mstr_dir, a23_str, bob_str)
    assert gut_file_exists(bank_mstr_dir, a23_str, sue_str) is False
    assert job_file_exists(bank_mstr_dir, a23_str, bob_str) is False
    assert job_file_exists(bank_mstr_dir, a23_str, sue_str) is False

    # WHEN
    a23_bank.generate_all_jobs()

    # THEN
    assert gut_file_exists(bank_mstr_dir, a23_str, bob_str)
    assert gut_file_exists(bank_mstr_dir, a23_str, sue_str)
    assert job_file_exists(bank_mstr_dir, a23_str, bob_str)
    assert job_file_exists(bank_mstr_dir, a23_str, sue_str)


def test_BankUnit_generate_all_jobs_Scenario1_jobs_rotated(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bank_mstr_dir = get_module_temp_dir()
    a23_str = "accord23"
    a23_bank = bankunit_shop(a23_str, bank_mstr_dir, job_listen_rotations=1)
    bob_str = "Bob"
    sue_str = "Sue"
    yao_str = "Yao"
    bob_gut = planunit_shop(bob_str, a23_str)
    ...
    assert not job_file_exists(bank_mstr_dir, a23_str, bob_str)
    assert not job_file_exists(bank_mstr_dir, a23_str, sue_str)
    assert not job_file_exists(bank_mstr_dir, a23_str, yao_str)
...
def test_BankUnit_generate_all_jobs_Scenario2_jobs_rotated_InSortedOrder(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bank_mstr_dir = get_module_temp_dir()
    ...
    assert not job_file_exists(bank_mstr_dir, a23_str, sue_str)
    assert not job_file_exists(bank_mstr_dir, a23_str, yao_str)
    assert not job_file_exists(bank_mstr_dir, a23_str, zia_str)
...
def test_BankUnit_generate_all_jobs_Scenario3_job_listen_rotation_AffectsJobs(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    bank_mstr_dir = get_module_temp_dir()
    ...
    assert not job_file_exists(bank_mstr_dir, a23_str, yao_str)
    assert not job_file_exists(bank_mstr_dir, a23_str, zia_str)
    assert a23_bank.job_listen_rotations == 1
    ...
    # WHEN
    a23_bank.job_listen_rotations = 2
    a23_bank.generate_all_jobs()
...
# def test_BankUnit_generate_all_jobs_Scenario2_job_limit_rotation_Changes_job(
#     env_dir_setup_cleanup,
# ):
#     # ESTABLISH
#     a23_str = "accord23"
...
#         a23_str, bank_mstr_dir, job_listen_rotations=x_job_listen_rotations
#     )
...
#     sue_str = "Sue"
#     a23_bank.create_init_job_from_guts(bob_str)
#     bank_mstr_dir = a23_bank.bank_mstr_dir
#     a23_bank.create_init_job_from_guts(sue_str)
#     bob_gut_plan = a23_bank.rotate_job(bob_str)
#     sue_gut_plan = a23_bank.rotate_job(sue_str)
...
#     sue_gut_plan = open_gut_file(bank_mstr_dir, a23_str, sue_str)
...
#     save_gut_file(a23_bank.bank_mstr_dir, sue_gut_plan)

#     before_bob_job = a23_bank.get_job_file_plan(bob_str)
#     before_sue_job = a23_bank.get_job_file_plan(sue_str)
#     assert a23_bank.job_listen_rotations == 9
...
#     # THEN
#     after_bob_job = a23_bank.get_job_file_plan(bob_str)
#     after_sue_job = a23_bank.get_job_file_plan(sue_str)
#     assert after_bob_job.acct_exists(bob_str)
