...
def create_example_bank2() -> BankUnit:
    # ESTABLISH
    x_bank_mstr_dir = get_module_temp_dir()
    a45_str = "accord45"
    accord_bank = bankunit_shop(a45_str, x_bank_mstr_dir)
    yao_str = "Yao"
    wei_str = "Wei"
    zia_str = "Zia"
    accord_bank.create_init_job_from_guts(yao_str)
    accord_bank.create_init_job_from_guts(wei_str)
    accord_bank.create_init_job_from_guts(zia_str)
    yao_gut_plan = open_gut_file(x_bank_mstr_dir, a45_str, yao_str)
    wei_gut_plan = open_gut_file(x_bank_mstr_dir, a45_str, wei_str)
    zia_gut_plan = open_gut_file(x_bank_mstr_dir, a45_str, zia_str)
    ...
    save_gut_file(x_bank_mstr_dir, wei_gut_plan)
    save_gut_file(x_bank_mstr_dir, zia_gut_plan)
    accord_bank._set_all_healer_dutys(yao_str)
    accord_bank._set_all_healer_dutys(wei_str)
    accord_bank._set_all_healer_dutys(zia_str)

    return accord_bank


def create_example_bank3() -> BankUnit:
    # ESTABLISH
    a45_str = "accord45"
    x_bank_mstr_dir = get_module_temp_dir()
    accord_bank = bankunit_shop(a45_str, x_bank_mstr_dir)
...
def create_example_bank4() -> BankUnit:
    # ESTABLISH
    x_bank_mstr_dir = get_module_temp_dir()
    a45_str = "accord45"
    accord_bank = bankunit_shop(a45_str, x_bank_mstr_dir)
...
def get_bob_mop_with_reason_planunit_example() -> PlanUnit:
    """owner_name: bob, bank_label: accord23"""
