...
from src.a15_bank_logic.bank_cell import set_cell_trees_found_facts
...
def test_set_cell_trees_found_facts_Scenario0_RootOnly_NoFacts(
    ...
    time5 = 5
    das = []
    bob5_dir = cell_dir(bank_mstr_dir, a23_str, bob_str, time5, das)
    ...
    # WHEN
    set_cell_trees_found_facts(bank_mstr_dir, a23_str)
