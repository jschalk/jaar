...
from src.a15_bank_logic.bank_cell import create_bud_mandate_ledgers
...
def test_create_bud_mandate_ledgers_Scenaro0_BudEmpty(env_dir_setup_cleanup):
    ...
    save_json(a23_json_path, None, accord23_bank.get_dict())
    bob_str = "Bob"
    timepoint9 = 9
...
def test_create_bud_mandate_ledgers_Scenaro1_BudExists(env_dir_setup_cleanup):
    ...
    tp37 = 37
    bud1_quota = 450
    accord23_bank.add_budunit(bob_str, tp37, bud1_quota)
    a23_json_path = create_bank_json_path(mstr_dir, a23_str)
    save_json(a23_json_path, None, accord23_bank.get_dict())
    ...
    bob37_budunit = accord23_bank.get_budunit(bob_str, tp37)
    ...
    gen_a23_bankunit.set_all_tranbook()
    ...
    assert gen_a23_bankunit._all_tranbook == expected_a23_all_tranbook
...
def test_create_bud_mandate_ledgers_Scenaro2_Mutliple_cell_acct_mandate_ledgers(
    ...
    gen_a23_bankunit.set_all_tranbook()
    gen_all_tranbook = gen_a23_bankunit._all_tranbook
