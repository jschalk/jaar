...
def test_CoinUnit_create_buds_root_cells_Scenaro0_BudEmpty(
    ...
    a23_beliefs_path = create_coin_beliefs_dir_path(coin_mstr_dir, a23_str)
...
def test_CoinUnit_create_buds_root_cells_Scenaro2_BudExistsButNoBeliefExistsInEventsPast(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    mstr_dir = get_module_temp_dir()
