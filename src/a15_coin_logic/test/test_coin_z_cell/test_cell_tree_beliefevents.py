...
from src.a15_coin_logic.coin_cell import load_cells_beliefevent
...
def test_load_cells_beliefevent_SetsFiles_Scenario0_NoFacts(
    ...
    event300 = 300
    time5 = 5
    save_arbitrary_beliefevent(coin_mstr_dir, a23_str, bob_str, event300)
    ...
    # WHEN
    load_cells_beliefevent(coin_mstr_dir, a23_str)
...
def test_load_cells_beliefevent_SetsFiles_Scenario1_WithFacts(
    ...
    save_arbitrary_beliefevent(coin_mstr_dir, a23_str, bob_str, event300, facts=x_facts)
    bob3_beliefevent_path = create_beliefevent_path(
        coin_mstr_dir, a23_str, bob_str, event300
    )
    print(f"{bob3_beliefevent_path=}")
