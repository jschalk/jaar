...
def test_CoinUnit_Exists():
    ...
    amy_coin = CoinUnit()
    # THEN
    assert not amy_coin.coin_label
    assert not amy_coin.timeline
    assert not amy_coin.brokerunits
    assert not amy_coin.paybook
    assert not amy_coin.offi_times
    assert not amy_coin.knot
    assert not amy_coin.fund_iota
    assert not amy_coin.respect_bit
    assert not amy_coin.penny
    assert not amy_coin.job_listen_rotations
...
def test_coinunit_shop_ReturnsCoinUnit():
    # ESTABLISH
    a23_str = "amy23"

    # WHEN
    a23_coin = coinunit_shop(a23_str, get_module_temp_dir())

    # THEN
    assert a23_coin.coin_label == a23_str
    assert a23_coin.timeline == timelineunit_shop()
    assert a23_coin.brokerunits == {}
    assert a23_coin.paybook == tranbook_shop(a23_str)
    assert a23_coin.offi_times == set()
    assert a23_coin.knot == default_knot_if_None()
    assert a23_coin.fund_iota == default_fund_iota_if_None()
    assert a23_coin.respect_bit == default_RespectBit_if_None()
    assert a23_coin.penny == filter_penny()
...
def test_coinunit_shop_ReturnsCoinUnitWith_coins_dir(env_dir_setup_cleanup):
    # ESTABLISH
    a23_str = "amy23"

    # WHEN
    a23_coin = coinunit_shop(a23_str, coin_mstr_dir=get_module_temp_dir())
...
def test_coinunit_shop_ReturnsCoinUnitWith_knot(env_dir_setup_cleanup):
    # ESTABLISH
    a23_str = "amy23"
    slash_str = "/"
    x_fund_iota = 7.0
    ...
    # THEN
    assert a23_coin.knot == slash_str
    assert a23_coin.fund_iota == x_fund_iota
    assert a23_coin.respect_bit == x_respect_bit
    assert a23_coin.penny == x_penny
    assert a23_coin.offi_times == a45_offi_times
    assert a23_coin.job_listen_rotations == x_job_listen_rotations


def test_CoinUnit_set_coin_dirs_SetsDirsAndFiles(env_dir_setup_cleanup):
    # ESTABLISH
    a23_str = "amy23"
...
def test_coinunit_shop_SetscoinsDirs(env_dir_setup_cleanup):
    # ESTABLISH
    a23_str = "amy23"
...
def test_CoinUnit_create_gut_file_if_none_SetsDirAndFiles_Scenario1_belief_dir_ExistsNoFile(
    ...
    # WHEN
    a23_coin.create_gut_file_if_none(sue_str)
...
def test_CoinUnit_create_gut_file_if_none_SetsDirAndFiles_Scenario2_belief_dir_ExistsNoFile_Create_gut_AndConfirmCoinAttributesPassed(
    ...
    print(f"{coin_mstr_dir=}")
    assert gut_file_exists(coin_mstr_dir, a23_str, sue_str)
    generated_gut = open_gut_file(coin_mstr_dir, a23_str, sue_str)
...
def test_CoinUnit_create_gut_file_if_none_SetsDirAndFiles_Scenario3_FileExistsIsNotReplaced(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    coin_mstr_dir = get_module_temp_dir()
    ...
    print(f"{coin_mstr_dir=}")
    assert gut_file_exists(coin_mstr_dir, a23_str, sue_str)
    assert open_gut_file(coin_mstr_dir, a23_str, sue_str) == sue_gut


def test_CoinUnit_create_init_job_from_guts_Scenario0_CreatesFile(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    coin_mstr_dir = get_module_temp_dir()
    ...
    sue_str = "Sue"
    assert not job_file_exists(coin_mstr_dir, a23_str, sue_str)
...
def test_CoinUnit_create_init_job_from_guts_Scenario1_ReplacesFile(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    coin_mstr_dir = get_module_temp_dir()
...
def test_CoinUnit_create_init_job_from_guts_Scenario2_job_Has_gut_Partners(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    coin_mstr_dir = get_module_temp_dir()
...
def test_CoinUnit_create_init_job_from_guts_Scenario3_gut_FilesAreListenedTo(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    coin_mstr_dir = get_module_temp_dir()
    ...
    save_gut_file(coin_mstr_dir, bob_gut)
    assert not open_job_file(coin_mstr_dir, a23_str, sue_str).get_agenda_dict()

    # WHEN
    a23_coin.create_init_job_from_guts(sue_str)

    # THEN
    assert open_job_file(coin_mstr_dir, a23_str, sue_str).get_agenda_dict()
    sue_agenda = open_job_file(coin_mstr_dir, a23_str, sue_str).get_agenda_dict()
    assert len(sue_agenda) == 1
    assert sue_agenda.get(clean_rope).get_plan_rope() == clean_rope


def test_CoinUnit__set_all_healer_dutys_Setsdutys(
    env_dir_setup_cleanup,
):
    # ESTABLISH
    a23_str = "amy23"
    x_coin_mstr_dir = get_module_temp_dir()
    a23_coin = coinunit_shop(a23_str, x_coin_mstr_dir)
    sue_str = "Sue"
    yao_str = "Yao"
    a23_coin.create_init_job_from_guts(sue_str)
    ...
    # WHEN
    a23_coin._set_all_healer_dutys(sue_str)
    ...
    # WHEN
    a23_coin._set_all_healer_dutys(yao_str)
...
# def test_CoinUnit_set_offi_time_Scenario0_SetsAttr():
#     # ESTABLISH
#     coin_mstr_dir = get_module_temp_dir()
#     time56 = 56
#     a23_coin = coinunit_shop("amy23", coin_mstr_dir, _offi_time_max=time56)
#     assert a23_coin.offi_time == 0
#     assert a23_coin._offi_time_max == time56

#     # WHEN
#     time23 = 23
#     a23_coin.set_offi_time(time23)

#     # THEN
#     assert a23_coin.offi_time == time23
#     assert a23_coin._offi_time_max == time56


# def test_CoinUnit_set_offi_time_Scenario1_SetsAttr():
#     # ESTABLISH
#     a23_coin = coinunit_shop("amy23", get_module_temp_dir())
#     assert a23_coin.offi_time == 0
#     assert a23_coin._offi_time_max == 0
...
#     # THEN
#     assert a23_coin.offi_time == time23
#     assert a23_coin._offi_time_max == time23


def test_CoinUnit_set_offi_time_max_Scenario0_SetsAttr():
    # ESTABLISH
    coin_mstr_dir = get_module_temp_dir()
    time7 = 7
    a23_coin = coinunit_shop("amy23", coin_mstr_dir)
    a23_coin._offi_time_max = time7
    # assert a23_coin.offi_time == 0
    assert a23_coin._offi_time_max == time7

    # WHEN
    time23 = 23
    a23_coin.set_offi_time_max(time23)
...
# def test_CoinUnit_set_offi_time_max_Scenario1_SetsAttr():
#     # ESTABLISH
#     coin_mstr_dir = get_module_temp_dir()
#     time21 = 21
#     time77 = 77
#     a23_coin = coinunit_shop(
#         "amy23", coin_mstr_dir, offi_time=time21, _offi_time_max=time77
#     )
#     assert a23_coin.offi_time == time21
#     assert a23_coin._offi_time_max == time77

#     # WHEN / THEN
#     time11 = 11
#     with pytest_raises(Exception) as excinfo:
#         a23_coin.set_offi_time_max(time11)
...
#     time23 = 23
#     time55 = 55
#     a23_coin.set_offi_time(time23, time55)

#     # THEN
#     assert a23_coin.offi_time == time23
#     assert a23_coin._offi_time_max == time55
