...
def test_CoinUnit_rotate_job_ReturnsObj_Scenario1(env_dir_setup_cleanup):
    ...
    assert sue_job.coin_label == example_belief.coin_label
...
def a23_job(belief_name: str) -> BeliefUnit:
    coin_mstr_dir = get_module_temp_dir()
    return open_job_file(coin_mstr_dir, "amy23", belief_name)
...
def test_CoinUnit_generate_all_jobs_Scenario0_init_job_IsCreated(
    ...
    sue_dir = create_belief_dir_path(coin_mstr_dir, a23_str, sue_str)
    set_dir(sue_dir)
