...
def create_example_coin2() -> CoinUnit:
    ...
    yao_gut_believer = open_gut_file(x_coin_mstr_dir, a45_str, yao_str)
    wei_gut_believer = open_gut_file(x_coin_mstr_dir, a45_str, wei_str)
    zia_gut_believer = open_gut_file(x_coin_mstr_dir, a45_str, zia_str)
    ...
    save_gut_file(x_coin_mstr_dir, wei_gut_believer)
    save_gut_file(x_coin_mstr_dir, zia_gut_believer)
...
def get_bob_mop_with_reason_believerunit_example() -> BelieverUnit:
    """believer_name: bob, coin_label: amy23"""
