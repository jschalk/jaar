...
def create_example_coin2() -> CoinUnit:
    # ESTABLISH
    x_coin_mstr_dir = get_module_temp_dir()
    a45_str = "amy45"
    amy_coin = coinunit_shop(a45_str, x_coin_mstr_dir)
    yao_str = "Yao"
    wei_str = "Wei"
    zia_str = "Zia"
    amy_coin.create_init_job_from_guts(yao_str)
    amy_coin.create_init_job_from_guts(wei_str)
    amy_coin.create_init_job_from_guts(zia_str)
    yao_gut_belief = open_gut_file(x_coin_mstr_dir, a45_str, yao_str)
    wei_gut_belief = open_gut_file(x_coin_mstr_dir, a45_str, wei_str)
    zia_gut_belief = open_gut_file(x_coin_mstr_dir, a45_str, zia_str)
    ...
    yao_gut_belief.add_partnerunit(yao_str, 34, 600)
    yao_gut_belief.add_partnerunit(zia_str, 57, 300)
    yao_gut_belief.add_partnerunit(wei_str, 10, 100)
    wei_gut_belief.add_partnerunit(yao_str, 37, 100)
    wei_gut_belief.add_partnerunit(wei_str, 11, 400)
    wei_gut_belief.add_partnerunit(zia_str, 27, 250)
    zia_gut_belief.add_partnerunit(yao_str, 14, 100)
    zia_gut_belief.add_partnerunit(zia_str, 38, 400)
    texas_str = "Texas"
    ...
    save_gut_file(x_coin_mstr_dir, wei_gut_belief)
    save_gut_file(x_coin_mstr_dir, zia_gut_belief)
    amy_coin._set_all_healer_dutys(yao_str)
    amy_coin._set_all_healer_dutys(wei_str)
    amy_coin._set_all_healer_dutys(zia_str)

    return amy_coin


def create_example_coin3() -> CoinUnit:
    # ESTABLISH
    a45_str = "amy45"
    x_coin_mstr_dir = get_module_temp_dir()
    amy_coin = coinunit_shop(a45_str, x_coin_mstr_dir)
...
def create_example_coin4() -> CoinUnit:
    # ESTABLISH
    x_coin_mstr_dir = get_module_temp_dir()
    a45_str = "amy45"
    amy_coin = coinunit_shop(a45_str, x_coin_mstr_dir)
...
def get_bob_mop_with_reason_beliefunit_example() -> BeliefUnit:
    """belief_name: bob, coin_label: amy23"""
...
def get_bob_mop_fact_clean_beliefunit_example() -> BeliefUnit:
    ...
    bob_belief.add_partnerunit("Bob")
