...
def test_BudUnit_settle_bud_CorrectlySets_item_dict():
    ...
    #     # print("")
    #     # print(f"{x_item._idee=}")
    #     # print(f"{len(x_item.reasonunits)=}")
    #     print(
    #         f"  {x_item._idee} iterate through every reasonheir... {len(x_item._reasonheirs)=} {x_item._idee=}"
    #     )
...
def test_BudUnit_settle_bud_CorrectlySetsData_budunit_v001():
    ...
    #     )
    #     # print(f"{item._idee=}")
    #     if item._idee == laundry_str:
    #         for reason in item.reasonunits.values():
    #             print(f"{item._idee=} {reason.base=}")  # {reason.premises=}")
...
def test_BudUnit_settle_bud_CorrectlySetsItemUnitsActiveWithEvery6WeeksReason_budunit_v001():
    ...
    print(f"{clean_sheet_item._idee=} {ced_week_reason.base=} {ced_week_premise.need=}")
    # print(f"{clean_sheet_item._idee=} {ced_week_reason.base=} {premise_x=}")
    ...
    #     if item._idee == "clean sheets couch blankets":
    ...
    print(f"{clean_couch_item._idee=} {week_reason.base=} {week_premise=}")
...
def test_BudUnit_settle_bud_EveryItemHasActiveStatus_budunit_v001():
    ...
    #     item_kid_count += 1
    #     print(f"{item._idee=} {item_kid_count=}")
...
def test_BudUnit_settle_bud_EveryTwoMonthReturnsCorrectObj_budunit_v001():
    ...
    mat_idee = "deep clean play mat"
    mat_road = yao_budunit.make_road(clean_road, mat_idee)
...
def test_BudUnit_settle_bud_CorrectlySets_sum_healerlink_share(graphics_bool):
    ...
    print(f"{week_item._idee=} {week_item.problem_bool=} {week_item._fund_ratio=}")
    sue_budunit.settle_bud()
    # THEN
