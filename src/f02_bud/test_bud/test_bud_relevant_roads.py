...
def test_BudUnit_get_relevant_roads_SimpleReturnsOnlyAncestors():
    ...
    assert relevant_roads == {sue_bud.fiscal_title, sun_road, week_road}
...
def test_BudUnit_get_relevant_roads_ReturnsSimpleReasonUnitBase():
    ...
    sue_bud.set_item(unim_item, parent_road=sue_bud.fiscal_title)
    ...
    assert relevant_roads == {sue_bud.fiscal_title, casa_road, status_road, floor_road}
...
def test_BudUnit_get_relevant_roads_ReturnSimple():
    ...
    assert yao_bud.fiscal_title in relevant_roads
