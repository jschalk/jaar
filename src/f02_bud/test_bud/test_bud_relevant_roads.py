...
def test_BudUnit_get_relevant_roads_SimpleReturnsOnlyAncestors():
    ...
    assert relevant_roads == {sue_bud.fisc_title, sun_road, week_road}
...
def test_BudUnit_get_relevant_roads_ReturnsSimpleReasonUnitBase():
    ...
    sue_bud.set_item(unim_item, parent_road=sue_bud.fisc_title)
    ...
    assert relevant_roads == {sue_bud.fisc_title, casa_road, status_road, floor_road}
