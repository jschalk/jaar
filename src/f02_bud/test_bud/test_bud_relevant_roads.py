...
def test_BudUnit_get_relevant_roads_SimpleReturnsOnlyAncestors():
    ...
    assert relevant_roads == {sue_bud._fiscal_id, sun_road, week_road}
...
def test_BudUnit_get_relevant_roads_ReturnsSimpleReasonUnitBase():
    ...
    assert relevant_roads == {sue_bud._fiscal_id, casa_road, status_road, floor_road}
