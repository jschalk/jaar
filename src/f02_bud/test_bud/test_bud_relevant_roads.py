...
def test_BudUnit_get_relevant_roads_SimpleReturnsOnlyAncestors():
    ...
    assert relevant_roads == {sue_bud.gov_idea, sun_road, week_road}
...
def test_BudUnit_get_relevant_roads_ReturnsSimpleReasonUnitBase():
    ...
    sue_bud.set_item(unim_item, parent_road=sue_bud.gov_idea)
    ...
    assert relevant_roads == {sue_bud.gov_idea, casa_road, status_road, floor_road}
...
def test_BudUnit_get_relevant_roads_ReturnSimple():
    ...
    assert yao_bud.gov_idea in relevant_roads
