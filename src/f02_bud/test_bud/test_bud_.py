...
def test_BudUnit_Exists():
    ...
    assert x_bud.turn_time_int is None
...
def test_BudUnit_shop_ReturnsCorrectObjectWithFilledFields():
    ...
    assert not x_bud.turn_time_int
...
def test_BudUnit_set_turn_CorrectlySetsAttr():
    # ESTABLISH
    sue_bud = budunit_shop("Sue")
    assert sue_bud.turn_time_int is None

    # WHEN
    sue_turn = 99000
    sue_bud.set_turn_time_int(sue_turn)
    # THEN
    assert sue_bud.turn_time_int == sue_turn

    # WHEN
    sue_bud.set_turn_time_int(None)
    # THEN
    assert sue_bud.turn_time_int is None
