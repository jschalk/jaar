...
def test_BudUnit_get_dict_ReturnsDictObject():
    ...
    x_last_favor_id = 77
    yao_bud.set_last_favor_id(x_last_favor_id)
    ...
    assert bud_dict["last_favor_id"] == yao_bud.last_favor_id
...
def test_budunit_get_from_json_ReturnsObjSimpleExample():
    ...
    zia_last_favor_id = 73
    zia_bud.set_last_favor_id(zia_last_favor_id)
    ...
    assert json_bud.last_favor_id == zia_bud.last_favor_id
    assert json_bud.last_favor_id == zia_last_favor_id
