...
def test_BudUnit_get_dict_ReturnsDictObject():
    ...
    assert bud_dict["_deal_id"] == yao_bud._deal_id
...
def test_BudUnit_get_dict_ReturnsDictWith_itemroot_teamunit():
    ...
    sue_bud.edit_item_attr(sue_bud._deal_id, teamunit=x_teamunit)
    root_item = sue_bud.get_item_obj(sue_bud._deal_id)
    x_gogo_want = 5
    x_stop_want = 11
...
def test_BudUnit_get_dict_ReturnsDictWith_itemroot_healerlink():
    ...
    sue_bud.edit_item_attr(road=sue_bud._deal_id, healerlink=run_healerlink)
...
def test_BudUnit_get_json_ReturnsCorrectJSON_SimpleExample():
    ...
    zia_bud.edit_item_attr(road=zia_bud._deal_id, healerlink=run_healerlink)
    zia_bud.edit_item_attr(road=zia_bud._deal_id, problem_bool=True)
    ...
    assert bud_dict["_deal_id"] == zia_bud._deal_id
...
def test_budunit_get_from_json_ReturnsCorrectObjSimpleExample():
    ...
    tiger_deal_id = "tiger"
    zia_bud.set_deal_id(tiger_deal_id)
    zia_fund_pool = 80000
    ...
    zia_bud.edit_item_attr(zia_bud._deal_id, teamunit=run_teamunit)
    ...
    zia_bud.edit_item_attr(zia_bud._deal_id, awardlink=awardlink_shop(sue_str))
    ...
    assert json_bud._deal_id == zia_bud._deal_id
...
def test_budunit_get_from_json_ReturnsCorrectItemRoot():
    ...
    zia_bud = get_budunit_x1_3levels_1reason_1facts()
    zia_bud.set_max_tree_traverse(23)
    # root_item = zia_bud.get_item_obj(zia_bud.get_item_obj(zia_bud._deal_id))
    ...
    # THEN
    json_itemroot = json_bud.get_item_obj(zia_bud._deal_id)
