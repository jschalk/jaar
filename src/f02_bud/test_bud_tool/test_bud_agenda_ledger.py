...
def test_get_bud_acct_agenda_award_array_ReturnsObj_ScenarioMultipleAcctUnit():
    ...
    # WHEN
    bud_deal_array = get_bud_acct_agenda_award_array(sue_bud)
    ...
    assert bud_deal_array[0][1] == bob_fund_agenda_take
    assert bud_deal_array[0][2] == bob_fund_agenda_give
    assert bud_deal_array[1][1] == yao_fund_agenda_take
    assert bud_deal_array[1][2] == yao_fund_agenda_give
...
def test_get_bud_acct_agenda_award_csv_ReturnsObj_ScenarioMultipleAcctUnit():
    ...
    # WHEN
    bud_deal_csv_str = get_bud_acct_agenda_award_csv(sue_bud)
...
def test_get_bud_acct_agenda_award_csv_ReturnsObj_settle_bud_True():
    ...
    sue_bud.add_acctunit(zia_str)
    empty_deal = f"""acct_name,fund_agenda_take,fund_agenda_give
{bob_str},0,0
{xio_str},0,0
{yao_str},0,0
{zia_str},0,0
"""
    assert empty_deal == get_bud_acct_agenda_award_csv(sue_bud)

    # WHEN
    bud_deal_csv_str = get_bud_acct_agenda_award_csv(sue_bud, settle_bud=True)
