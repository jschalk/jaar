...
class BudUnit:
    ...
    def set_deal_idea(self, deal_idea: str):
        ...
        self.edit_item_idee(old_road=old_deal_idea, new_idee=self._deal_idea)
        self.settle_bud()
...
def budunit_shop(
    ...
    _deal_idea = get_default_deal_idea() if _deal_idea is None else _deal_idea
    x_bud = BudUnit(
