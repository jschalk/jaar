...
from src.s5_listen.hubunit import HubUnit, hubunit_shop, get_keep_path
...
def test_hubunit_shop_ReturnsCorrectObj():
    # ESTABLISH
    x_fiscals_dir = "src/s7_fiscal/examples"
    x_fiscal_id = "music"
    sue_str = "Sue"
    x_road_delimiter = "/"
    x_fund_pool = 13000
    ...
    x_finalpath = f"{x_hubunit.final_dir()}/{x_hubunit.final_file_name()}"
