from src.s4_gift.gift import giftunit_shop, GiftUnit
from src.s5_listen.examples.example_listen_atoms import (
...
def sue_1atomunits_giftunit() -> GiftUnit:
    ...
    x_giftunit._deltaunit.set_atomunit(get_atom_example_ideaunit_sports())
    return x_giftunit


def sue_2atomunits_giftunit() -> GiftUnit:
    x_giftunit = giftunit_shop(owner_id="Sue", _gift_id=53, _face_id="Yao")
    x_giftunit._deltaunit.set_atomunit(get_atom_example_ideaunit_knee())
    x_giftunit._deltaunit.set_atomunit(get_atom_example_ideaunit_sports())
    return x_giftunit
...
def sue_3atomunits_giftunit() -> GiftUnit:
    ...
    x_giftunit._deltaunit.set_atomunit(get_atom_example_ideaunit_ball())
    x_giftunit._deltaunit.set_atomunit(get_atom_example_ideaunit_knee())
    return x_giftunit
