...
- a04_reason_logic: _active, _chore, _status, cases, coin_label, fact_context, fact_lower, fact_state, fact_upper, factunits, reason_active_requisite, reason_context, reason_divisor, reason_lower, reason_state, reason_upper, reasonunits
...
- a18_etl_toolbox: belief_net_amount, brick_agg, brick_raw, brick_valid, coin_event_time_agg, coin_ote1_agg, coin_partner_nets, events_brick_agg, events_brick_valid, sound_agg, sound_raw, voice_agg, voice_raw
- a19_kpi_toolbox: coin_kpi001_partner_nets, coin_kpi002_belief_tasks
- a20_world_logic: 
