...
- a03_group_logic: _credor_pool, _debtor_pool, _fund_agenda_give, _fund_agenda_ratio_give, _fund_agenda_ratio_take, _fund_agenda_take, _fund_give, _fund_take, _inallocable_partner_debt_points, _irrational_partner_debt_points, _memberships, _parent_solo, awardee_title, awardunits, believer_name, fund_give, fund_take, give_force, group_cred_points, group_debt_points, group_title, partner_cred_points, partner_debt_points, partner_name, party_title, respect_bit, solo, take_force
- a04_reason_logic: _active, _chore, _status, coin_label, fact_context, fact_lower, fact_state, fact_upper, factunits, reason_active_requisite, reason_context, reason_divisor, reason_lower, reason_state, reason_upper, reasonunits
...
- a06_believer_logic: _keeps_buildable, _keeps_justified, _offtrack_fund, _offtrack_kids_star_set, _rational, _reason_contexts, _sum_healerunit_share, _tree_traverse_count, ancestors, attributes, believer_partner_membership, believer_partnerunit, believer_plan_awardunit, believer_plan_factunit, believer_plan_healerunit, believer_plan_partyunit, believer_plan_reason_caseunit, believer_plan_reasonunit, believer_planunit, believerunit, credor_respect, debtor_respect, dimen, dimens, jkeys, last_pack_id, mandate, max_tree_traverse, partner_pool, planroot, tally
...
- a12_hub_toolbox: coin_mstr_dir, gut, job
- a13_believer_listen_logic: 
- a14_keep_logic: 
- a15_coin_logic: brokerunits, coin_budunit, coin_paybook, coin_timeline_hour, coin_timeline_month, coin_timeline_weekday, coin_timeoffi, coinunit, cumulative_minute, hour_label, job_listen_rotations, month_label, paybook, weekday_label, weekday_order
...
- a18_etl_toolbox: believer_net_amount, brick_agg, brick_raw, brick_valid, coin_event_time_agg, coin_ote1_agg, coin_partner_nets, events_brick_agg, events_brick_valid, sound_agg, sound_raw, voice_agg, voice_raw
- a19_kpi_toolbox: coin_kpi001_partner_nets, coin_kpi002_believer_tasks
- a20_world_logic: 
