...
- a06_believer_logic: _keeps_buildable, _keeps_justified, _offtrack_fund, _offtrack_kids_mass_set, _rational, _reason_rcontexts, _sum_healerlink_share, _tree_traverse_count, acct_pool, ancestors, attributes, believer_acct_membership, believer_acctunit, believer_plan_awardlink, believer_plan_factunit, believer_plan_healerlink, believer_plan_laborlink, believer_plan_reason_premiseunit, believer_plan_reasonunit, believer_planunit, believerunit, credor_respect, debtor_respect, dimen, dimens, jkeys, last_pack_id, mandate, max_tree_traverse, tally, timeline
...
- a11_bud_logic: amount, believeradjust, believerevent_facts, boss_facts, bud_acct_nets, bud_believer_name, bud_time, celldepth, found_facts, offi_time, quota, tran_time
...
- a18_etl_toolbox: belief_acct_nets, belief_event_time_agg, believer_net_amount, brick_agg, brick_raw, brick_valid, events_brick_agg, events_brick_valid, sound_agg, sound_raw, voice_agg, voice_raw
