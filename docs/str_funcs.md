...
- a04_reason_logic: _active, _chore, _status, belief_label, fact_context, fact_lower, fact_state, fact_upper, factunits, reason_active_requisite, reason_context, reason_divisor, reason_lower, reason_state, reason_upper, reasonunits
