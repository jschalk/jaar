...
- a04_reason_logic: _active, _chore, _status, belief_label, f_context, f_lower, f_state, f_upper, labor_title, reason_active_requisite, reason_context, reason_divisor, reason_lower, reason_state, reason_upper
